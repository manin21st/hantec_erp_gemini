$PBExportHeader$w_pdt_09014.srw
$PBExportComments$생산효율 종합분석-권
forward
global type w_pdt_09014 from w_standard_print
end type
type shl_1 from statichyperlink within w_pdt_09014
end type
type st_1 from statictext within w_pdt_09014
end type
type shl_2 from statichyperlink within w_pdt_09014
end type
type shl_3 from statichyperlink within w_pdt_09014
end type
type st_2 from statictext within w_pdt_09014
end type
type rr_1 from roundrectangle within w_pdt_09014
end type
end forward
...
global w_pdt_09014 w_pdt_09014
...
type p_preview from w_standard_print`p_preview within w_pdt_09014
boolean visible = false
integer x = 3141
integer y = 44
end type

type p_exit from w_standard_print`p_exit within w_pdt_09014
end type

type p_print from w_standard_print`p_print within w_pdt_09014
boolean visible = false
integer x = 3314
integer y = 44
end type

type p_retrieve from w_standard_print`p_retrieve within w_pdt_09014
integer x = 4270
end type
...
type st_10 from w_standard_print`st_10 within w_pdt_09014
end type



type dw_print from w_standard_print`dw_print within w_pdt_09014
string dataobject = "d_pdt_09010_1"
end type

type dw_ip from w_standard_print`dw_ip within w_pdt_09014
integer x = 18
integer y = 96
integer width = 3058
integer height = 152
string dataobject = "d_pdt_09014_2"
end type

type dw_list from w_standard_print`dw_list within w_pdt_09014
event ue_mousemove pbm_mousemove
integer x = 46
integer y = 268
integer width = 4558
integer height = 2052
string dataobject = "d_pdt_09014_3"
...
event dw_list::clicked;call super::clicked;String  	ls_Object, ls_month, ls_gubun, ls_dw
Long	  	ll_Row
Boolean	lb_isopen
Window	lw_window
...
IF mid(ls_Object, 1, 6)  = 'jtime_' or mid(ls_Object, 1, 6)  = 'ntime_' THEN 
	...
	ls_month = mid(ls_Object, 7,2)
	ls_gubun = dw_ip.GetItemString(1, 'timenm')
	
	if row < 1  then return 

	gs_gubun = dw_ip.GetItemString(1, 'year') + ls_month
	gs_code = This.GetItemString(row, 'wkctr') + This.GetItemString(row, 'wcdsc')
	gs_codename  = dw_ip.GetItemString(1, 'wcdsc')
	gs_codename2 = dw_ip.GetItemString(1, 'pdtgu') + ls_gubun
	...
	OpenSheetWithParm(w_pdt_09016, ls_dw, w_mdi_frame, 0, Layered!)
END IF
