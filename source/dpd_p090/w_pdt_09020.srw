$PBExportHeader$w_pdt_09020.srw
$PBExportComments$생산효율 종합분석-권
forward
global type w_pdt_09020 from w_standard_print
end type
type shl_1 from statichyperlink within w_pdt_09020
end type
type shl_2 from statichyperlink within w_pdt_09020
end type
type st_1 from statictext within w_pdt_09020
end type
type rr_1 from roundrectangle within w_pdt_09020
end type
end forward
...
global w_pdt_09020 w_pdt_09020
...
type p_preview from w_standard_print`p_preview within w_pdt_09020
boolean visible = false
integer x = 2843
integer y = 12
end type

type p_exit from w_standard_print`p_exit within w_pdt_09020
end type

type p_print from w_standard_print`p_print within w_pdt_09020
boolean visible = false
integer x = 3017
integer y = 12
end type

type p_retrieve from w_standard_print`p_retrieve within w_pdt_09020
integer x = 4265
end type
...
type st_10 from w_standard_print`st_10 within w_pdt_09020
end type



type dw_print from w_standard_print`dw_print within w_pdt_09020
integer x = 3255
string dataobject = "d_pdt_09020_1"
end type

type dw_ip from w_standard_print`dw_ip within w_pdt_09020
integer x = 14
integer y = 96
integer width = 1426
integer height = 152
string dataobject = "d_pdt_09020_2"
end type

type dw_list from w_standard_print`dw_list within w_pdt_09020
...
IF mid(ls_Object, 1, 5)  = 'jonam' THEN 
	...
	gs_code = dw_ip.GetItemString(1, 'pdtgu')
	gs_codename = This.GetItemString(row, 'jocod')
	gs_codename2 = This.GetItemString(row, 'jonam')
	...
	LOOP
	if lb_isopen then Close(w_pdt_09025)		
