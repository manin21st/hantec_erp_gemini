$PBExportHeader$w_pdt_09070.srw
$PBExportComments$월 생산 계획 및 실적[조]
forward
global type w_pdt_09070 from w_standard_print
end type
type shl_1 from statichyperlink within w_pdt_09070
end type
type shl_2 from statichyperlink within w_pdt_09070
end type
type st_1 from statictext within w_pdt_09070
end type
type shl_3 from statichyperlink within w_pdt_09070
end type
type st_2 from statictext within w_pdt_09070
end type
type st_3 from statictext within w_pdt_09070
end type
type shl_4 from statichyperlink within w_pdt_09070
end type
type rr_1 from roundrectangle within w_pdt_09070
end type
end forward

global type w_pdt_09070 from w_standard_print
string title = "일자별 생산실적"
string menuname = ""
boolean maxbox = true
shl_1 shl_1
shl_2 shl_2
...
global w_pdt_09070 w_pdt_09070
...
ls_pdtgu = dw_ip.GetItemString(1, 'itnbr')
...
this.Control[iCurrent+7]=this.shl_4
this.Control[iCurrent+8]=this.rr_1
end on

on w_pdt_09070.destroy
call super::destroy
destroy(this.shl_1)
destroy(this.shl_2)
destroy(this.st_1)
...
dw_ip.SetItem(1, 'titnm', gs_codename)


wf_retrieve()
end event

type p_preview from w_standard_print`p_preview within w_pdt_09070
boolean visible = false
integer x = 2843
integer y = 12
end type

type p_exit from w_standard_print`p_exit within w_pdt_09070
end type

type p_print from w_standard_print`p_print within w_pdt_09070
boolean visible = false
integer x = 3017
integer y = 12
end type

type p_retrieve from w_standard_print`p_retrieve within w_pdt_09070
integer x = 4265
end type
...
type st_10 from w_standard_print`st_10 within w_pdt_09070
end type



type dw_print from w_standard_print`dw_print within w_pdt_09070
integer x = 3255
string dataobject = "d_pdt_09020_1"
end type

type dw_ip from w_standard_print`dw_ip within w_pdt_09070
integer x = 14
integer y = 96
integer width = 2656
integer height = 152
string dataobject = "d_pdt_09070_2"
end type

type dw_list from w_standard_print`dw_list within w_pdt_09070
event ue_mousemove pbm_mousemove
integer x = 46
integer y = 268
integer width = 4549
integer height = 1996
string dataobject = "d_pdt_09070_1"
