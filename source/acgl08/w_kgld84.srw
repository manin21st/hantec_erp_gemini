$PBExportHeader$w_kgld84.srw
$PBExportComments$신용카드 합계표
forward
global type w_kgld84 from w_standard_print
end type
type dw_proclst from datawindow within w_kgld84
end type
type rr_1 from roundrectangle within w_kgld84
end type
end forward

global type w_kgld84 from w_standard_print
integer height = 2404
string title = "신용카드 합계표 조회출력"
dw_proclst dw_proclst
rr_1 rr_1
end type
global w_kgld84 w_kgld84

forward prototypes
public function integer wf_retrieve ()
end prototypes

public function integer wf_retrieve ();String sSaupj,sDateF,sDateT,sSaupjCode,sSaupjName
...
dw_print.object.t_saupj.text = sSaupjCode + " " + sSaupjName
...
type p_preview from w_standard_print`p_preview within w_kgld84
end type

type p_exit from w_standard_print`p_exit within w_kgld84
end type

type p_print from w_standard_print`p_print within w_kgld84
end type

type p_retrieve from w_standard_print`p_retrieve within w_kgld84
end type



type sle_msg from w_standard_print`sle_msg within w_kgld84
...
type st_10 from w_standard_print`st_10 within w_kgld84
end type



type dw_print from w_standard_print`dw_print within w_kgld84
string dataobject = "dw_kgld842_p"
end type

type dw_ip from w_standard_print`dw_ip within w_kgld84
integer width = 2286
integer height = 164
string dataobject = "dw_kgld841"
end type
...
type dw_list from w_standard_print`dw_list within w_kgld84
integer x = 64
integer y = 208
integer width = 4526
integer height = 2012
string dataobject = "dw_kgld842"
