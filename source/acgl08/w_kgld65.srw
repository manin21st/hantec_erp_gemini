$PBExportHeader$w_kgld65.srw
$PBExportComments$미반제 내역 조회 출력(발생건별)
forward
global type w_kgld65 from w_standard_print
end type
type rr_1 from roundrectangle within w_kgld65
end type
end forward
...
integer x = 0
integer y = 0
string title = "미반제 내역 조회 출력(발생건별)"
rr_1 rr_1
end type
global w_kgld65 w_kgld65
...
public function integer wf_retrieve ();String sSaupj,sBaseDateF,sBaseDateT,sAcc1,sAcc2,sCustF,sCustT,sAcc,sSaupName
...
IF dw_print.Retrieve(sabu_f,	sabu_t,	sAcc,	sBaseDateF,	 sBaseDateT,sCustF,	sCustT) <=0 THEN
	f_Messagechk(14, "")
	dw_list.insertrow(0)
	dw_list.Reset()
...
type p_preview from w_standard_print`p_preview within w_kgld65
integer x = 4087
integer y = 4
end type

type p_exit from w_standard_print`p_exit within w_kgld65
integer x = 4434
integer y = 4
end type

type p_print from w_standard_print`p_print within w_kgld65
integer x = 4261
integer y = 4
end type

type p_retrieve from w_standard_print`p_retrieve within w_kgld65
integer x = 3913
integer y = 4
end type

type st_window from w_standard_print`st_window within w_kgld65
integer x = 2400
integer width = 471
end type

type sle_msg from w_standard_print`sle_msg within w_kgld65
integer width = 2007
end type

type dw_datetime from w_standard_print`dw_datetime within w_kgld65
integer x = 2866
end type

type st_10 from w_standard_print`st_10 within w_kgld65
end type



type dw_print from w_standard_print`dw_print within w_kgld65
string dataobject = "dw_kgld652_p"
end type

type dw_ip from w_standard_print`dw_ip within w_kgld65
integer width = 3671
integer height = 228
string dataobject = "dw_kgld651"
end type
...
type dw_list from w_standard_print`dw_list within w_kgld65
integer x = 50
integer y = 252
integer width = 4544
integer height = 1964
string title = "미반제내역"
string dataobject = "dw_kgld652"
