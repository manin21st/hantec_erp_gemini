$PBExportHeader$w_kgld69cc.srw
$PBExportComments$예산집행 명세서 상세 조회-전표 조회
forward
global type w_kgld69cc from w_inherite
end type
type cb_2 from commandbutton within w_kgld69cc
end type
type cb_yesan from commandbutton within w_kgld69cc
end type
type dw_rtv from datawindow within w_kgld69cc
end type
type dw_kwan from datawindow within w_kgld69cc
end type
type dw_ins2 from u_key_enter within w_kgld69cc
end type
type dw_ins from u_key_enter within w_kgld69cc
end type
type dw_print from datawindow within w_kgld69cc
end type
type dw_sang from datawindow within w_kgld69cc
end type
type dw_sungin from datawindow within w_kgld69cc
end type
type dw_descr from datawindow within w_kgld69cc
end type
type p_yesan from uo_picture within w_kgld69cc
end type
type cb_ins2 from commandbutton within w_kgld69cc
end type
type p_ok from uo_picture within w_kgld69cc
end type
type rr_5 from roundrectangle within w_kgld69cc
end type
end forward
...
type dw_insert from w_inherite`dw_insert within w_kgld69cc
integer x = 3945
integer y = 2812
integer taborder = 0
end type

type p_delrow from w_inherite`p_delrow within w_kgld69cc
...
type p_addrow from w_inherite`p_addrow within w_kgld69cc
boolean visible = false
integer x = 2939
integer taborder = 0
...
type p_search from w_inherite`p_search within w_kgld69cc
integer x = 3392
integer y = 2780
integer taborder = 0
end type

type p_ins from w_inherite`p_ins within w_kgld69cc
integer x = 3566
integer y = 2780
integer taborder = 0
end type

type p_exit from w_inherite`p_exit within w_kgld69cc
boolean visible = false
integer x = 2203
integer taborder = 0
end type

type p_can from w_inherite`p_can within w_kgld69cc
boolean visible = false
integer x = 3461
integer taborder = 0
end type
...
type p_print from w_inherite`p_print within w_kgld69cc
boolean visible = false
integer x = 2021
integer y = 16
integer taborder = 0
...
type p_inq from w_inherite`p_inq within w_kgld69cc
boolean visible = false
integer x = 1833
integer y = 20
integer taborder = 0
...
type p_del from w_inherite`p_del within w_kgld69cc
integer x = 3744
integer y = 2780
integer taborder = 0
end type

type p_mod from w_inherite`p_mod within w_kgld69cc
boolean visible = false
integer x = 3287
integer taborder = 0
end type
...
type cb_exit from w_inherite`cb_exit within w_kgld69cc
integer x = 3803
integer y = 3100
end type

type cb_mod from w_inherite`cb_mod within w_kgld69cc
integer x = 2747
integer y = 3100
string text = "완료(&F)"
end type

type cb_ins from w_inherite`cb_ins within w_kgld69cc
integer x = 1906
integer y = 3100
integer width = 379
string text = "줄저장(&A)"
...
type cb_del from w_inherite`cb_del within w_kgld69cc
integer x = 2299
integer y = 3100
integer width = 379
string text = "줄삭제(&D)"
...
type cb_inq from w_inherite`cb_inq within w_kgld69cc
integer x = 1513
integer y = 3100
end type

type cb_print from w_inherite`cb_print within w_kgld69cc
integer x = 3099
integer y = 3100
end type

type st_1 from w_inherite`st_1 within w_kgld69cc
end type

type cb_can from w_inherite`cb_can within w_kgld69cc
integer x = 3451
integer y = 3100
end type

type cb_search from w_inherite`cb_search within w_kgld69cc
integer x = 1339
integer y = 2804
end type
...
type gb_10 from w_inherite`gb_10 within w_kgld69cc
integer height = 156
end type

type gb_button1 from w_inherite`gb_button1 within w_kgld69cc
integer x = 613
integer y = 3056
integer width = 1257
integer height = 168
...
type gb_button2 from w_inherite`gb_button2 within w_kgld69cc
integer x = 2720
integer y = 3056
integer width = 1445
integer height = 168
...
integer height = 1340
boolean bringtotop = true
string dataobject = "dw_kgld69cc3"
...
integer height = 420
integer taborder = 0
string dataobject = "dw_kgld69cc2"
boolean border = false
end type
...
integer height = 360
integer taborder = 0
string dataobject = "dw_kgld69cc1"
boolean border = false
end type
