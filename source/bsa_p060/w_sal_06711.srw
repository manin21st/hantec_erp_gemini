$PBExportHeader$w_sal_06711.srw
$PBExportComments$ ===> Buyer별 선수금 현황
forward
global type w_sal_06711 from w_standard_print
end type
type pb_1 from u_pb_cal within w_sal_06711
end type
type rr_1 from roundrectangle within w_sal_06711
end type
end forward

global type w_sal_06711 from w_standard_print
string title = " Buyer별 선수금 현황"
pb_1 pb_1
rr_1 rr_1
end type
global w_sal_06711 w_sal_06711

forward prototypes
public function integer wf_retrieve ()
end prototypes

public function integer wf_retrieve ();String sIlja, sArea, sCvcod ,ls_saupj ,tx_name
...
if dw_list.Retrieve(gs_sabu,sArea+'%',sCvcod+'%' ,ls_saupj) < 1 then
...
event ue_open;call super::ue_open;dw_ip.Setitem(1,'symd', f_today())
...
type p_xls from w_standard_print`p_xls within w_sal_06711
end type

type p_sort from w_standard_print`p_sort within w_sal_06711
end type

type p_preview from w_standard_print`p_preview within w_sal_06711
end type

type p_exit from w_standard_print`p_exit within w_sal_06711
end type

type p_print from w_standard_print`p_print within w_sal_06711
end type

type p_retrieve from w_standard_print`p_retrieve within w_sal_06711
end type
...
type st_10 from w_standard_print`st_10 within w_sal_06711
end type



type dw_print from w_standard_print`dw_print within w_sal_06711
string dataobject = "d_sal_06711"
end type

type dw_ip from w_standard_print`dw_ip within w_sal_06711
integer x = 0
integer y = 0
integer width = 2414
integer height = 240
string dataobject = "d_sal_06711_01"
end type

event dw_ip::itemchanged;String sNull, sIoCustArea, sDept, sIoCust, sIocvcodnm , sCvcod, scvnas, sarea, steam, sSaupj, sName1, ls_saupj
...
//		INTO :sIocvcodnm,		:sIoCustArea,			:sDept
//	   FROM "VNDMST","SAREA" 
//   	WHERE "VNDMST"."SAREA" = "SAREA"."SAREA" AND "VNDMST"."CVCOD" = :gs_code;
//	IF SQLCA.SQLCODE = 0 THEN
//	  this.SetItem(1,"cvcodnm",  sIocvcodnm)
...
type dw_list from w_standard_print`dw_list within w_sal_06711
integer x = 27
integer y = 268
integer width = 4581
integer height = 2048
