$PBExportHeader$w_sm01_00015_back.srw
$PBExportComments$월 판매계획 접수
forward
global type w_sm01_00015_back from w_inherite
end type
type dw_temp from datawindow within w_sm01_00015_back
end type
type st_at from statictext within w_sm01_00015_back
end type
type hpb_1 from hprogressbar within w_sm01_00015_back
end type
type dw_save from datawindow within w_sm01_00015_back
end type
type rb_car from radiobutton within w_sm01_00015_back
end type
type rb_itnbr from radiobutton within w_sm01_00015_back
end type
type rr_1 from roundrectangle within w_sm01_00015_back
end type
type dw_1 from u_key_enter within w_sm01_00015_back
end type
type p_1 from uo_picture within w_sm01_00015_back
end type
type p_2 from uo_picture within w_sm01_00015_back
end type
end forward
...
global w_sm01_00015_back w_sm01_00015_back
...
type dw_insert from w_inherite`dw_insert within w_sm01_00015_back
integer x = 32
integer y = 284
integer width = 4553
integer height = 2000
integer taborder = 130
string dataobject = "d_sm01_00015_a"
...
type p_delrow from w_inherite`p_delrow within w_sm01_00015_back
integer x = 3922
integer taborder = 60
end type
...
type p_addrow from w_inherite`p_addrow within w_sm01_00015_back
integer x = 3749
integer taborder = 50
end type
...
type p_search from w_inherite`p_search within w_sm01_00015_back
integer x = 3086
...
event p_search::clicked;String sYear, sCust, sCvcod, sToday , ls_saupj ,ls_factory , ls_sum , ls_carcode_pre = ''
...
type p_ins from w_inherite`p_ins within w_sm01_00015_back
...
type p_exit from w_inherite`p_exit within w_sm01_00015_back
...
type p_can from w_inherite`p_can within w_sm01_00015_back
integer taborder = 90
end type
...
type p_print from w_inherite`p_print within w_sm01_00015_back
integer x = 3259
...
type p_inq from w_inherite`p_inq within w_sm01_00015_back
integer x = 3575
end type
...
type p_del from w_inherite`p_del within w_sm01_00015_back
boolean visible = false
integer x = 3881
integer y = 204
integer taborder = 80
...
type p_mod from w_inherite`p_mod within w_sm01_00015_back
integer x = 4096
integer taborder = 70
end type
...
type cb_exit from w_inherite`cb_exit within w_sm01_00015_back
boolean visible = true
end type

type cb_mod from w_inherite`cb_mod within w_sm01_00015_back
boolean visible = true
end type

type cb_ins from w_inherite`cb_ins within w_sm01_00015_back
boolean visible = true
end type

type cb_del from w_inherite`cb_del within w_sm01_00015_back
boolean visible = true
end type

type cb_inq from w_inherite`cb_inq within w_sm01_00015_back
boolean visible = true
end type

type cb_print from w_inherite`cb_print within w_sm01_00015_back
boolean visible = true
end type

type st_1 from w_inherite`st_1 within w_sm01_00015_back
boolean visible = true
end type

type cb_can from w_inherite`cb_can within w_sm01_00015_back
boolean visible = true
end type

type cb_search from w_inherite`cb_search within w_sm01_00015_back
boolean visible = true
end type

type dw_datetime from w_inherite`dw_datetime within w_sm01_00015_back
boolean visible = true
end type

type sle_msg from w_inherite`sle_msg within w_sm01_00015_back
boolean visible = true
end type

type gb_10 from w_inherite`gb_10 within w_sm01_00015_back
boolean visible = true
end type

type gb_button1 from w_inherite`gb_button1 within w_sm01_00015_back
boolean visible = true
end type

type gb_button2 from w_inherite`gb_button2 within w_sm01_00015_back
boolean visible = true
end type
