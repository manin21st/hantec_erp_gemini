$PBExportHeader$w_sal_02000_vnddan.srw
$PBExportComments$거래처 제품단가 팝업
forward
global type w_sal_02000_vnddan from w_inherite_popup
end type
type cbx_1 from checkbox within w_sal_02000_vnddan
end type
type rr_2 from roundrectangle within w_sal_02000_vnddan
end type
end forward
...
global w_sal_02000_vnddan w_sal_02000_vnddan
...
type dw_jogun from w_inherite_popup`dw_jogun within w_sal_02000_vnddan
integer x = 14
integer y = 32
integer width = 1888
integer height = 260
string dataobject = "d_sal_02000_vnddan_1"
end type
...
type p_exit from w_inherite_popup`p_exit within w_sal_02000_vnddan
integer x = 3022
end type
...
type p_inq from w_inherite_popup`p_inq within w_sal_02000_vnddan
integer x = 2674
...
type p_choose from w_inherite_popup`p_choose within w_sal_02000_vnddan
integer x = 2848
end type
...
type dw_1 from w_inherite_popup`dw_1 within w_sal_02000_vnddan
integer x = 27
integer y = 308
integer width = 3145
integer height = 1356
integer taborder = 100
string dataobject = "d_sal_02000_vnddan"
...
type sle_2 from w_inherite_popup`sle_2 within w_sal_02000_vnddan
end type

type cb_1 from w_inherite_popup`cb_1 within w_sal_02000_vnddan
end type

type cb_return from w_inherite_popup`cb_return within w_sal_02000_vnddan
end type

type cb_inq from w_inherite_popup`cb_inq within w_sal_02000_vnddan
boolean default = false
end type

type sle_1 from w_inherite_popup`sle_1 within w_sal_02000_vnddan
end type

type st_1 from w_inherite_popup`st_1 within w_sal_02000_vnddan
end type
