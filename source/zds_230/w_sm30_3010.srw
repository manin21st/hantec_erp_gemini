$PBExportHeader$w_sm30_3010.srw
$PBExportComments$주간 판매계획 접수
forward
global type w_sm30_3010 from w_inherite
end type
type dw_1 from u_key_enter within w_sm30_3010
end type
type rr_1 from roundrectangle within w_sm30_3010
end type
type p_gen from uo_picture within w_sm30_3010
end type
type hpb_1 from hprogressbar within w_sm30_3010
end type
type pb_1 from u_pb_cal within w_sm30_3010
end type
type dw_excel from datawindow within w_sm30_3010
end type
type p_excel from uo_picture within w_sm30_3010
end type
type cb_1 from commandbutton within w_sm30_3010
end type
type cbx_1 from checkbox within w_sm30_3010
end type
type dw_info from datawindow within w_sm30_3010
end type
type cb_2 from commandbutton within w_sm30_3010
end type
type cb_3 from commandbutton within w_sm30_3010
end type
type rr_2 from roundrectangle within w_sm30_3010
end type
end forward
...
global w_sm30_3010 w_sm30_3010
...
type dw_insert from w_inherite`dw_insert within w_sm30_3010
integer x = 27
integer y = 332
integer width = 4576
integer height = 1392
integer taborder = 140
string dataobject = "d_sm30_3010_a"
...
type p_delrow from w_inherite`p_delrow within w_sm30_3010
integer x = 3922
integer taborder = 70
end type
...
type p_addrow from w_inherite`p_addrow within w_sm30_3010
integer x = 3749
integer taborder = 60
end type
...
type p_search from w_inherite`p_search within w_sm30_3010
integer x = 3922
integer y = 164
...
/* 임시 test 처리 */
If MessageBox('생성 선택', '생성 기준을 선택 하십시오.~r~n~r~n예[Y] : VAN 기준 주/판 생성~r~n아니오[N] : 월간 계획으로 주/판 생성', Question!, YesNo!, 2) = 1 Then
	If wf_cnf_chk() < 0 Then Return
	gs_code = sYymm
...
type p_ins from w_inherite`p_ins within w_sm30_3010
...
type p_exit from w_inherite`p_exit within w_sm30_3010
...
type p_can from w_inherite`p_can within w_sm30_3010
...
type p_print from w_inherite`p_print within w_sm30_3010
boolean visible = false
integer x = 1861
integer y = 80
...
type p_inq from w_inherite`p_inq within w_sm30_3010
integer x = 3575
end type
...
type p_del from w_inherite`p_del within w_sm30_3010
boolean visible = false
integer x = 4247
integer y = 216
integer taborder = 90
...
type p_mod from w_inherite`p_mod within w_sm30_3010
integer x = 4096
integer taborder = 80
end type
...
type cb_exit from w_inherite`cb_exit within w_sm30_3010
boolean visible = true
end type

type cb_mod from w_inherite`cb_mod within w_sm30_3010
boolean visible = true
end type

type cb_ins from w_inherite`cb_ins within w_sm30_3010
boolean visible = true
end type

type cb_del from w_inherite`cb_del within w_sm30_3010
boolean visible = true
end type

type cb_inq from w_inherite`cb_inq within w_sm30_3010
boolean visible = true
end type

type cb_print from w_inherite`cb_print within w_sm30_3010
boolean visible = true
end type

type st_1 from w_inherite`st_1 within w_sm30_3010
boolean visible = true
end type

type cb_can from w_inherite`cb_can within w_sm30_3010
boolean visible = true
end type

type cb_search from w_inherite`cb_search within w_sm30_3010
boolean visible = true
end type

type dw_datetime from w_inherite`dw_datetime within w_sm30_3010
boolean visible = true
end type

type sle_msg from w_inherite`sle_msg within w_sm30_3010
boolean visible = true
end type

type gb_10 from w_inherite`gb_10 within w_sm30_3010
boolean visible = true
end type

type gb_button1 from w_inherite`gb_button1 within w_sm30_3010
boolean visible = true
end type

type gb_button2 from w_inherite`gb_button2 within w_sm30_3010
boolean visible = true
end type
...
string dataobject = "d_sm30_3010_1"
boolean border = false
end type
...
For i =1 To ll_rcnt
	...
	If ls_gubun = 'CKD' or ls_gubun = 'MAS' or ls_gubun = 'MAS1' Then 
...
insert into SM03_WEEKPLAN_ITEM_SALE
 select a.saupj       ,
		  ...
		  0 as qty11    ,
		  0 as jqty11   
  from sm03_weekplan_item_sale a , stock_napum_item b
 where a.saupj = :ls_saupj
...
SELECT A.SAUPJ      , A.YYMMDD     , A.GUBUN      , A.CVCOD      , A.ITNBR      , A.ITM_PRC    ,
  ...
  FROM (  SELECT A1.*, A2.VNDCOD
            FROM SM03_WEEKPLAN_ITEM_SALE A1,
                 STOCK_NAPUM_ITEM        A2
 ...
 WHERE A.SAUPJ  =    :ls_saupj
   ...
   AND NOT EXISTS (  SELECT 'X'
                      FROM SM03_WEEKPLAN_ITEM_SALE AZ
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_sm30_3010_plan"
boolean hscrollbar = true
boolean vscrollbar = true
boolean border = false
boolean hsplitscroll = true
