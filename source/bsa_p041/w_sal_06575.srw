$PBExportHeader$w_sal_06575.srw
$PBExportComments$ ===> Commercial Invoice
forward
global type w_sal_06575 from w_standard_print
end type
type dw_excel from datawindow within w_sal_06575
end type
type dw_1 from datawindow within w_sal_06575
end type
type dw_2 from datawindow within w_sal_06575
end type
type p_excel from uo_picture within w_sal_06575
end type
type p_co from uo_picture within w_sal_06575
end type
type p_1 from uo_picture within w_sal_06575
end type
type p_2 from picture within w_sal_06575
end type
type rr_1 from roundrectangle within w_sal_06575
end type
end forward

global type w_sal_06575 from w_standard_print
string title = "INVOICE 발행(내수)"
string menuname = ""
dw_excel dw_excel
dw_1 dw_1
dw_2 dw_2
...
global w_sal_06575 w_sal_06575
...
type p_preview from w_standard_print`p_preview within w_sal_06575
integer x = 4091
end type

type p_exit from w_standard_print`p_exit within w_sal_06575
integer taborder = 90
end type

type p_print from w_standard_print`p_print within w_sal_06575
integer x = 4265
end type

type p_retrieve from w_standard_print`p_retrieve within w_sal_06575
integer x = 3918
end type
...
type st_10 from w_standard_print`st_10 within w_sal_06575
end type



type dw_print from w_standard_print`dw_print within w_sal_06575
boolean visible = true
integer x = 59
integer y = 212
integer width = 4507
integer height = 2072
string dataobject = "d_sal_06575_a04"
boolean hscrollbar = true
boolean vscrollbar = true
boolean border = false
end type

type dw_ip from w_standard_print`dw_ip within w_sal_06575
integer x = 37
integer y = 28
integer width = 3538
integer height = 160
string dataobject = "d_sal_06575_01"
end type
...
Choose Case GetColumnName()
	Case "cino"
		...
		SetItem(1,"cino",left(gs_code,12))
End Choose
...
Choose Case GetColumnName()
	...
	Case 'gubun'
		...
		If GetText() = '1' Then		// CI
			dw_print.DataObject='d_sal_06575_a04'
			If GetItemString(1, 'gbn1') = 'N' Then
				dw_print.Object.report_detail.DataObject='d_sal_06575_a05'
			Else
				dw_print.Object.report_detail.DataObject='d_sal_06575_a06'
			End If
			dw_print.object.dw_2.dataobject='d_sal_06575_a08'
	   ElseIf GetText() = '2' Then // PACKING
			dw_print.DataObject='d_sal_06575_a04'
			If GetItemString(1, 'gbn1') = 'N' Then
				dw_print.Object.report_detail.DataObject='d_sal_06575_a02'
			Else
				dw_print.Object.report_detail.DataObject='d_sal_06575_a07'
			End If
			dw_print.object.dw_2.dataobject='d_sal_06575_a03'
	   end if
...
type dw_list from w_standard_print`dw_list within w_sal_06575
