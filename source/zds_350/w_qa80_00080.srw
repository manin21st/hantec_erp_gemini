$PBExportHeader$w_qa80_00080.srw
$PBExportComments$제품별 입고/불량집계
forward
global type w_qa80_00080 from w_standard_print
end type
type pb_1 from u_pb_cal within w_qa80_00080
end type
type pb_2 from u_pb_cal within w_qa80_00080
end type
type rr_1 from roundrectangle within w_qa80_00080
end type
end forward

global type w_qa80_00080 from w_standard_print
string title = "수입검사 불량현황"
pb_1 pb_1
pb_2 pb_2
rr_1 rr_1
end type
global w_qa80_00080 w_qa80_00080
...
type p_xls from w_standard_print`p_xls within w_qa80_00080
...
type p_sort from w_standard_print`p_sort within w_qa80_00080
integer x = 4256
integer y = 172
end type

type p_preview from w_standard_print`p_preview within w_qa80_00080
integer x = 4073
end type

type p_exit from w_standard_print`p_exit within w_qa80_00080
integer x = 4421
end type

type p_print from w_standard_print`p_print within w_qa80_00080
boolean visible = false
integer x = 4434
integer y = 176
end type

type p_retrieve from w_standard_print`p_retrieve within w_qa80_00080
integer x = 3899
end type
...
type st_10 from w_standard_print`st_10 within w_qa80_00080
end type



type dw_print from w_standard_print`dw_print within w_qa80_00080
integer x = 4082
integer y = 184
string dataobject = "d_qa80_00080_003"
end type

type dw_ip from w_standard_print`dw_ip within w_qa80_00080
integer x = 37
integer width = 2994
string dataobject = "d_qa80_00080_001"
end type
...
type dw_list from w_standard_print`dw_list within w_qa80_00080
integer x = 50
integer y = 308
integer width = 4535
integer height = 1928
string dataobject = "d_qa80_00080_002"
