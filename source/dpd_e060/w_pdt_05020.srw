...
type dw_1 from datawindow within w_pdt_05020
end type
type rr_1 from roundrectangle within w_pdt_05020
end type
end forward
...
s_depot = dw_1.GetItemString(1,'cvcod')
...
s_yymm = trim(dw_1.GetItemString(1,'yymm'))
s_depot = trim(dw_1.GetItemString(1,'cvcod'))
...
sdepot = dw_1.getitemstring(1, 'cvcod')
