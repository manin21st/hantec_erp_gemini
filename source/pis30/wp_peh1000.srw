$PBExportHeader$wp_peh1000.srw
$PBExportComments$** 학자금 지급 명세서
forward
global type wp_peh1000 from w_standard_print
end type
type rr_1 from roundrectangle within wp_peh1000
end type
end forward

global type wp_peh1000 from w_standard_print
string title = "학자금지급명세서"
string menuname = "m_print"
boolean maxbox = true
rr_1 rr_1
end type
global wp_peh1000 wp_peh1000
...
if li_level = 2 then	 
	IF dw_list.Retrieve(gs_company,syy,sbunki,'%',sdeptcode,ssaupj) <=0 THEN
...
on wp_peh1000.destroy
call super::destroy
if IsValid(MenuID) then destroy(MenuID)
destroy(this.rr_1)
end on

type p_preview from w_standard_print`p_preview within wp_peh1000
end type

type p_exit from w_standard_print`p_exit within wp_peh1000
end type

type p_print from w_standard_print`p_print within wp_peh1000
end type

type p_retrieve from w_standard_print`p_retrieve within wp_peh1000
end type
...
type st_10 from w_standard_print`st_10 within wp_peh1000
end type



type dw_print from w_standard_print`dw_print within wp_peh1000
string dataobject = "dp_peh1000_20"
end type

type dw_ip from w_standard_print`dw_ip within wp_peh1000
integer width = 3314
integer height = 152
string dataobject = "dp_peh1000_10"
end type
...
type dw_list from w_standard_print`dw_list within wp_peh1000
integer x = 50
integer y = 220
integer width = 4539
integer height = 2012
string dataobject = "dp_peh1000_20_1"
