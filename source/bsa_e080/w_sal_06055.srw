...
integer x = 3922
string picturename = "C:\erpman\image\전송처리_up.gif"
end type
...
event p_search::ue_lbuttonup;PictureName = "C:\erpman\image\전송처리_up.gif"
end event

event p_search::ue_lbuttondown;PictureName = "C:\erpman\image\전송처리_dn.gif"
end event
...
string picturename = "C:\erpman\image\전송취소_d.gif"
end type
...
event p_del::ue_lbuttonup;PictureName = "C:\erpman\image\전송취소_up.gif"
end event

event p_del::ue_lbuttondown;PictureName = "C:\erpman\image\전송취소_dn.gif"
end event
...
p_del.Enabled = False
p_search.PictureName = 'C:\erpman\image\전송처리_up.gif'
p_del.PictureName = 'C:\erpman\image\전송취소_d.gif'
...
p_del.Enabled = True
p_search.PictureName = 'C:\erpman\image\전송처리_d.gif'
p_del.PictureName = 'C:\erpman\image\전송취소_up.gif'
