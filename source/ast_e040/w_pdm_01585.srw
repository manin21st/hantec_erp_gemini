$PBExportHeader$w_pdm_01585.srw
$PBExportComments$생산BOM일괄 완료/취소 처리
forward
global type w_pdm_01585 from window
end type
type cbx_1 from checkbox within w_pdm_01585
end type
type p_save from uo_picture within w_pdm_01585
end type
type p_exit from uo_picture within w_pdm_01585
end type
type p_can from uo_picture within w_pdm_01585
end type
type dw_to from datawindow within w_pdm_01585
end type
type dw_2 from datawindow within w_pdm_01585
end type
type rr_1 from roundrectangle within w_pdm_01585
end type
type p_inq from uo_picture within w_pdm_01585
end type
type p_1 from uo_picture within w_pdm_01585
end type
type p_2 from uo_picture within w_pdm_01585
end type
end forward
...
global w_pdm_01585 w_pdm_01585
...
if not(isnull(gs_gubun) or gs_gubun = '') then
	dw_to.setitem(1,'ittyp',gs_gubun)
	dw_to.setcolumn('itnbr')
	dw_to.setfocus( )
end if

end event

on w_pdm_01585.create
...
integer height = 220
integer taborder = 10
string dataobject = "d_pdm_01585_1"
...
integer width = 3931
integer height = 1676
string dataobject = "d_pdm_01585_2"
...
event clicked;call super::clicked;String sIttyp, sitcls, sitnbr, sGubun, ls_itnbr
long   k, get_count
...
ls_itnbr = dw_to.GetItemString(1,"itnbr")
...
dw_2.SetFilter("")
dw_2.Filter( )
dw_2.Retrieve(sittyp, sitcls,ls_itnbr)	
