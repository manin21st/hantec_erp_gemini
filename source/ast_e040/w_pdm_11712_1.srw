$PBExportHeader$w_pdm_11712_1.srw
$PBExportComments$생산bom-정전개/역전개현황
forward
global type w_pdm_11712_1 from w_standard_print
end type
type rb_single from radiobutton within w_pdm_11712_1
end type
type rb_prtgu from radiobutton within w_pdm_11712_1
end type
type cbx_date from checkbox within w_pdm_11712_1
end type
type rb_opseq from radiobutton within w_pdm_11712_1
end type
type rb_usseq from radiobutton within w_pdm_11712_1
end type
type cbx_qty from checkbox within w_pdm_11712_1
end type
type cbx_1 from checkbox within w_pdm_11712_1
end type
type rb_2 from radiobutton within w_pdm_11712_1
end type
type rb_1 from radiobutton within w_pdm_11712_1
end type
type rb_drilldown from radiobutton within w_pdm_11712_1
end type
type rb_drillup from radiobutton within w_pdm_11712_1
end type
type cbx_bomend from checkbox within w_pdm_11712_1
end type
type pb_1 from u_pb_cal within w_pdm_11712_1
end type
type ddlb_1 from dropdownlistbox within w_pdm_11712_1
end type
type gb_5 from groupbox within w_pdm_11712_1
end type
type gb_2 from groupbox within w_pdm_11712_1
end type
type gb_3 from groupbox within w_pdm_11712_1
end type
type gb_4 from groupbox within w_pdm_11712_1
end type
type gb_1 from groupbox within w_pdm_11712_1
end type
end forward
...
global w_pdm_11712_1 w_pdm_11712_1
...
type p_xls from w_standard_print`p_xls within w_pdm_11712_1
...
type p_sort from w_standard_print`p_sort within w_pdm_11712_1
integer x = 4261
integer y = 572
boolean enabled = false
end type

type p_preview from w_standard_print`p_preview within w_pdm_11712_1
end type

type p_exit from w_standard_print`p_exit within w_pdm_11712_1
end type

type p_print from w_standard_print`p_print within w_pdm_11712_1
boolean visible = false
integer x = 4434
integer y = 572
end type

type p_retrieve from w_standard_print`p_retrieve within w_pdm_11712_1
end type
...
type st_10 from w_standard_print`st_10 within w_pdm_11712_1
end type



type dw_print from w_standard_print`dw_print within w_pdm_11712_1
integer x = 219
integer y = 696
integer width = 4366
integer height = 724
...
type dw_ip from w_standard_print`dw_ip within w_pdm_11712_1
integer x = 32
integer y = 188
integer width = 4594
integer height = 148
...
type dw_list from w_standard_print`dw_list within w_pdm_11712_1
integer x = 27
integer height = 1972
