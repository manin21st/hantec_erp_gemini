$PBExportHeader$w_pdm_01560.srw
$PBExportComments$생산bom(대량대체)
forward
global type w_pdm_01560 from window
end type
type cbx_1 from checkbox within w_pdm_01560
end type
type p_save from uo_picture within w_pdm_01560
end type
type dw_list1 from datawindow within w_pdm_01560
end type
type dw_2 from datawindow within w_pdm_01560
end type
type st_4 from statictext within w_pdm_01560
end type
type dw_1 from datawindow within w_pdm_01560
end type
type st_3 from statictext within w_pdm_01560
end type
type dw_list from datawindow within w_pdm_01560
end type
type p_exit from uo_picture within w_pdm_01560
end type
type rr_1 from roundrectangle within w_pdm_01560
end type
type rr_2 from roundrectangle within w_pdm_01560
end type
end forward
...
global w_pdm_01560 w_pdm_01560
...
For Lrow = 1 to dw_list.rowcount()
	 If dw_list.object.choice[Lrow] = 'Y' Then
		 dw_list.object.pstruc_cinbr[Lrow] = Chg_itnbr
	 End if
Next
For Lrow = 1 to dw_list1.rowcount()
	 If dw_list1.object.choice[Lrow] = 'Y' Then	
		 dw_list1.object.pstruc_Pinbr[Lrow] = Chg_itnbr
	 End if
Next
...
string dataobject = "d_pdm_01560_2"
...
integer height = 116
integer taborder = 20
string dataobject = "d_pdm_01560_0"
boolean border = false
boolean livescroll = true
end type
...
integer height = 1640
string dragicon = "Rectangle!"
string dataobject = "d_pdm_01560_1"
boolean hscrollbar = true
boolean vscrollbar = true
boolean border = false
boolean livescroll = true
