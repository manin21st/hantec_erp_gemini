$PBExportHeader$w_pdm_01555.srw
$PBExportComments$생산bom(대량복사-시리즈별)
forward
global type w_pdm_01555 from window
end type
type cbx_1 from checkbox within w_pdm_01555
end type
type p_save from uo_picture within w_pdm_01555
end type
type p_inq2 from uo_picture within w_pdm_01555
end type
type p_exit from uo_picture within w_pdm_01555
end type
type p_inq1 from uo_picture within w_pdm_01555
end type
type st_2 from statictext within w_pdm_01555
end type
type st_1 from statictext within w_pdm_01555
end type
type dw_update from datawindow within w_pdm_01555
end type
type dw_1 from datawindow within w_pdm_01555
end type
type dw_to from datawindow within w_pdm_01555
end type
type dw_from from datawindow within w_pdm_01555
end type
type dw_2 from datawindow within w_pdm_01555
end type
type rr_1 from roundrectangle within w_pdm_01555
end type
type rr_2 from roundrectangle within w_pdm_01555
end type
type p_can from uo_picture within w_pdm_01555
end type
type rr_3 from roundrectangle within w_pdm_01555
end type
type rr_4 from roundrectangle within w_pdm_01555
end type
type rr_5 from roundrectangle within w_pdm_01555
end type
end forward
...
global w_pdm_01555 w_pdm_01555
...
FOR lRow = 1	TO	 dw_2.RowCount()   //품번을 읽고
   if dw_2.getitemstring(lrow, 'opt') = 'Y' then   //체크품번만 복사
		...
		FOR lRow2 = 1	TO	 dw_1.RowCount()  //하위품번을 읽고
			...
			dw_update.setitem(cur_row, "sagub",	dw_1.GetItemString(lRow2, "pstruc_sagub"))
...
integer width = 1303
integer height = 160
string dataobject = "d_pdm_01555_5"
...
integer width = 1755
integer height = 1404
string dataobject = "d_pdm_01555_3"
...
integer width = 1755
integer height = 1404
string dataobject = "d_pdm_01555_4"
boolean hscrollbar = true
boolean vscrollbar = true
boolean border = false
boolean livescroll = true
