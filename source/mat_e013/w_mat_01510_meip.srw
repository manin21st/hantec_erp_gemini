...
type pb_1 from u_pb_cal within w_mat_01510_meip
end type
type pb_2 from u_pb_cal within w_mat_01510_meip
end type
type cb_1 from commandbutton within w_mat_01510_meip
end type
type dw_prt from datawindow within w_mat_01510_meip
end type
type rr_1 from roundrectangle within w_mat_01510_meip
end type
type rr_2 from roundrectangle within w_mat_01510_meip
end type
end forward
...
type p_xls from w_standard_print`p_xls within w_mat_01510_meip
boolean visible = true
integer x = 4270
integer y = 24
end type

type p_sort from w_standard_print`p_sort within w_mat_01510_meip
boolean visible = true
integer x = 4443
integer y = 164
end type

type p_preview from w_standard_print`p_preview within w_mat_01510_meip
end type

type p_exit from w_standard_print`p_exit within w_mat_01510_meip
end type

type p_print from w_standard_print`p_print within w_mat_01510_meip
boolean visible = false
integer x = 4832
integer y = 188
end type

type p_retrieve from w_standard_print`p_retrieve within w_mat_01510_meip
end type
...
type st_10 from w_standard_print`st_10 within w_mat_01510_meip
end type
