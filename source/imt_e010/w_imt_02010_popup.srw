$PBExportHeader$w_imt_02010_popup.srw
$PBExportComments$** 발주검토(자료를 여러건으로 분리하는 POPUP)
forward
global type w_imt_02010_popup from window
end type
type pb_1 from u_pb_cal within w_imt_02010_popup
end type
type st_1 from statictext within w_imt_02010_popup
end type
type p_exit from uo_picture within w_imt_02010_popup
end type
type p_can from uo_picture within w_imt_02010_popup
end type
type p_mod from uo_picture within w_imt_02010_popup
end type
type p_del from uo_picture within w_imt_02010_popup
end type
type p_ins from uo_picture within w_imt_02010_popup
end type
type dw_1 from datawindow within w_imt_02010_popup
end type
type cb_insert from commandbutton within w_imt_02010_popup
end type
type cb_close from commandbutton within w_imt_02010_popup
end type
type cb_cancel from commandbutton within w_imt_02010_popup
end type
type cb_delete from commandbutton within w_imt_02010_popup
end type
type cb_update from commandbutton within w_imt_02010_popup
end type
type dw_list from datawindow within w_imt_02010_popup
end type
type rr_1 from roundrectangle within w_imt_02010_popup
end type
type rr_2 from roundrectangle within w_imt_02010_popup
end type
end forward
...
global w_imt_02010_popup w_imt_02010_popup
...
dw_1.SetColumn('yodat')
IF IsNull(gs_code) THEN Return
ll_row = dw_1.GetRow()
If ll_row < 1 Then Return
dw_1.SetItem(ll_row, 'yodat', gs_code)
...
if 	dw_1.retrieve(gs_sabu, is_estno) <= 0 then 
...
integer height = 424
integer taborder = 10
string dataobject = "d_imt_02010_popup"
