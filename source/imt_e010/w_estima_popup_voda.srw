$PBExportHeader$w_estima_popup_voda.srw
$PBExportComments$** 구매상태별 조회 선택
forward
global type w_estima_popup_voda from w_inherite_popup
end type
type pb_1 from u_pb_cal within w_estima_popup_voda
end type
type pb_2 from u_pb_cal within w_estima_popup_voda
end type
type rb_1 from radiobutton within w_estima_popup_voda
end type
type rb_2 from radiobutton within w_estima_popup_voda
end type
type rr_1 from roundrectangle within w_estima_popup_voda
end type
end forward
...
global w_estima_popup_voda w_estima_popup_voda

on w_estima_popup_voda.create
int iCurrent
call super::create
...
on w_estima_popup_voda.destroy
call super::destroy
destroy(this.pb_1)
destroy(this.pb_2)
destroy(this.rb_1)
...
type dw_jogun from w_inherite_popup`dw_jogun within w_estima_popup_voda
integer x = 23
integer y = 16
integer width = 2002
integer height = 132
string dataobject = "d_estima_popup_voda"
end type
...
type p_exit from w_inherite_popup`p_exit within w_estima_popup_voda
integer x = 3511
integer y = 0
end type
...
type p_inq from w_inherite_popup`p_inq within w_estima_popup_voda
integer x = 3163
integer y = 0
...
IF dw_1.Retrieve(gs_sabu, gs_saupj, sdatef,sdatet, sgubun) <= 0 THEN
...
type p_choose from w_inherite_popup`p_choose within w_estima_popup_voda
integer x = 3337
integer y = 0
end type
...
type dw_1 from w_inherite_popup`dw_1 within w_estima_popup_voda
integer x = 37
integer y = 176
integer width = 3653
integer height = 1536
string dataobject = "d_estima_popup2_voda"
...
gs_code= trim(dw_1.GetItemString(Row, "estno"))  //구매의뢰번호
...
type sle_2 from w_inherite_popup`sle_2 within w_estima_popup_voda
...
type cb_1 from w_inherite_popup`cb_1 within w_estima_popup_voda
integer x = 329
integer y = 2088
end type

type cb_return from w_inherite_popup`cb_return within w_estima_popup_voda
integer x = 951
integer y = 2088
integer taborder = 40
end type

type cb_inq from w_inherite_popup`cb_inq within w_estima_popup_voda
integer x = 640
integer y = 2088
integer taborder = 20
...
type sle_1 from w_inherite_popup`sle_1 within w_estima_popup_voda
boolean visible = false
integer x = 329
integer y = 2048
integer width = 425
...
type st_1 from w_inherite_popup`st_1 within w_estima_popup_voda
boolean visible = false
integer x = 59
integer y = 2068
integer width = 251
...
event clicked;dw_1.dataobject = 'd_estima_popup2_voda'
...
event clicked;dw_1.dataobject = 'd_estima_popup1_voda'
