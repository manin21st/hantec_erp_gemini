$PBExportHeader$w_kfz04om0_popup.srw
$PBExportComments$인명거래처 조회선택(거래처,은행,부서,사원,예적금 등)(POPUP)
forward
global type w_kfz04om0_popup from window
end type
type rb_3 from radiobutton within w_kfz04om0_popup
end type
type rb_2 from radiobutton within w_kfz04om0_popup
end type
type rb_1 from radiobutton within w_kfz04om0_popup
end type
type cb_3 from commandbutton within w_kfz04om0_popup
end type
type cb_2 from commandbutton within w_kfz04om0_popup
end type
type cb_1 from commandbutton within w_kfz04om0_popup
end type
type sle_sano from singlelineedit within w_kfz04om0_popup
end type
type st_6 from statictext within w_kfz04om0_popup
end type
type p_exit from uo_picture within w_kfz04om0_popup
end type
type p_choose from uo_picture within w_kfz04om0_popup
end type
type p_inq from uo_picture within w_kfz04om0_popup
end type
type st_5 from statictext within w_kfz04om0_popup
end type
type dw_1 from u_d_popup_sort within w_kfz04om0_popup
end type
type st_1 from statictext within w_kfz04om0_popup
end type
type sle_name from singlelineedit within w_kfz04om0_popup
end type
type sle_1 from singlelineedit within w_kfz04om0_popup
end type
type gb_1 from groupbox within w_kfz04om0_popup
end type
type rr_1 from roundrectangle within w_kfz04om0_popup
end type
type rr_2 from roundrectangle within w_kfz04om0_popup
end type
type ln_1 from line within w_kfz04om0_popup
end type
type ln_2 from line within w_kfz04om0_popup
end type
type ln_3 from line within w_kfz04om0_popup
end type
end forward
...
global w_kfz04om0_popup w_kfz04om0_popup
