$PBExportHeader$w_kfz01om0_popup1.srw
$PBExportComments$계정과목 조회 선택(전 계정과목)
forward
global type w_kfz01om0_popup1 from window
end type
type cb_3 from commandbutton within w_kfz01om0_popup1
end type
type cb_2 from commandbutton within w_kfz01om0_popup1
end type
type cb_1 from commandbutton within w_kfz01om0_popup1
end type
type ddlb_gb from dropdownlistbox within w_kfz01om0_popup1
end type
type st_22 from statictext within w_kfz01om0_popup1
end type
type st_2 from statictext within w_kfz01om0_popup1
end type
type rr_1 from roundrectangle within w_kfz01om0_popup1
end type
type p_exit from uo_picture within w_kfz01om0_popup1
end type
type p_choose from uo_picture within w_kfz01om0_popup1
end type
type p_inq from uo_picture within w_kfz01om0_popup1
end type
type dw_1 from u_d_popup_sort within w_kfz01om0_popup1
end type
type sle_4 from singlelineedit within w_kfz01om0_popup1
end type
type sle_2 from singlelineedit within w_kfz01om0_popup1
end type
type st_1 from statictext within w_kfz01om0_popup1
end type
type ln_1 from line within w_kfz01om0_popup1
end type
type ln_2 from line within w_kfz01om0_popup1
end type
type ln_4 from line within w_kfz01om0_popup1
end type
type sle_1 from singlelineedit within w_kfz01om0_popup1
end type
type rr_2 from roundrectangle within w_kfz01om0_popup1
end type
end forward
...
global w_kfz01om0_popup1 w_kfz01om0_popup1
...
gs_gubun   	= dw_1.GetItemString(ll_Row, "acc1_nm")
...
integer height = 1764
integer taborder = 60
string dataobject = "dw_kfz01om0_popup1"
...
gs_gubun   	= dw_1.GetItemString(Row, "acc1_nm")
