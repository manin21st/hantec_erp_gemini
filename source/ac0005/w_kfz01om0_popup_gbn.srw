$PBExportHeader$w_kfz01om0_popup_gbn.srw
$PBExportComments$계정과목조회선택(POPUP):전표발행계정만
forward
global type w_kfz01om0_popup_gbn from window
end type
type cb_3 from commandbutton within w_kfz01om0_popup_gbn
end type
type cb_2 from commandbutton within w_kfz01om0_popup_gbn
end type
type cb_1 from commandbutton within w_kfz01om0_popup_gbn
end type
type ddlb_gb from dropdownlistbox within w_kfz01om0_popup_gbn
end type
type st_22 from statictext within w_kfz01om0_popup_gbn
end type
type p_exit from uo_picture within w_kfz01om0_popup_gbn
end type
type p_choose from uo_picture within w_kfz01om0_popup_gbn
end type
type p_inq from uo_picture within w_kfz01om0_popup_gbn
end type
type st_2 from statictext within w_kfz01om0_popup_gbn
end type
type dw_1 from u_d_popup_sort within w_kfz01om0_popup_gbn
end type
type sle_4 from singlelineedit within w_kfz01om0_popup_gbn
end type
type sle_3 from singlelineedit within w_kfz01om0_popup_gbn
end type
type sle_2 from singlelineedit within w_kfz01om0_popup_gbn
end type
type sle_1 from singlelineedit within w_kfz01om0_popup_gbn
end type
type st_1 from statictext within w_kfz01om0_popup_gbn
end type
type rr_1 from roundrectangle within w_kfz01om0_popup_gbn
end type
type ln_1 from line within w_kfz01om0_popup_gbn
end type
type ln_2 from line within w_kfz01om0_popup_gbn
end type
type ln_3 from line within w_kfz01om0_popup_gbn
end type
type ln_4 from line within w_kfz01om0_popup_gbn
end type
type rr_2 from roundrectangle within w_kfz01om0_popup_gbn
end type
end forward
...
global w_kfz01om0_popup_gbn w_kfz01om0_popup_gbn
...
on w_kfz01om0_popup_gbn.create
...
on w_kfz01om0_popup_gbn.destroy
destroy(this.cb_3)
destroy(this.cb_2)
destroy(this.cb_1)
...
dw_1.Reset()
dw_1.Retrieve(ls_gaejung1, ls_gaejung2, name1, name2, scusgbn, ls_gb)
...
integer height = 1892
integer taborder = 70
string dataobject = "dw_kfz01om0_popup_gbn"
