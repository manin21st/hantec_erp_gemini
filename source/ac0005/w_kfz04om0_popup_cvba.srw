$PBExportHeader$w_kfz04om0_popup_cvba.srw
$PBExportComments$인명거래처 조회선택(거래처,은행)(POPUP)
forward
global type w_kfz04om0_popup_cvba from window
end type
type rb_1 from radiobutton within w_kfz04om0_popup_cvba
end type
type rb_2 from radiobutton within w_kfz04om0_popup_cvba
end type
type rb_3 from radiobutton within w_kfz04om0_popup_cvba
end type
type cb_3 from commandbutton within w_kfz04om0_popup_cvba
end type
type cb_2 from commandbutton within w_kfz04om0_popup_cvba
end type
type cb_1 from commandbutton within w_kfz04om0_popup_cvba
end type
type sle_sano from singlelineedit within w_kfz04om0_popup_cvba
end type
type st_6 from statictext within w_kfz04om0_popup_cvba
end type
type p_exit from uo_picture within w_kfz04om0_popup_cvba
end type
type p_choose from uo_picture within w_kfz04om0_popup_cvba
end type
type p_inq from uo_picture within w_kfz04om0_popup_cvba
end type
type st_5 from statictext within w_kfz04om0_popup_cvba
end type
type dw_1 from u_d_popup_sort within w_kfz04om0_popup_cvba
end type
type st_1 from statictext within w_kfz04om0_popup_cvba
end type
type sle_name from singlelineedit within w_kfz04om0_popup_cvba
end type
type sle_1 from singlelineedit within w_kfz04om0_popup_cvba
end type
type gb_1 from groupbox within w_kfz04om0_popup_cvba
end type
type rr_1 from roundrectangle within w_kfz04om0_popup_cvba
end type
type rr_2 from roundrectangle within w_kfz04om0_popup_cvba
end type
type ln_1 from line within w_kfz04om0_popup_cvba
end type
type ln_2 from line within w_kfz04om0_popup_cvba
end type
type ln_3 from line within w_kfz04om0_popup_cvba
end type
end forward
...
global w_kfz04om0_popup_cvba w_kfz04om0_popup_cvba
...
on w_kfz04om0_popup_cvba.create
...
on w_kfz04om0_popup_cvba.destroy
destroy(this.rb_1)
destroy(this.rb_2)
destroy(this.rb_3)
destroy(this.cb_3)
...
dw_1.Retrieve(ls_saup_no,ls_saupnm,scusgbn,ls_sano)
dw_1.SetRedraw(True)
...
integer height = 1880
integer taborder = 50
string dataobject = "dw_kfz04om0_popup_cvba"
