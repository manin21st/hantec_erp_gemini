$PBExportHeader$w_kfm01ot0_popup.srw
$PBExportComments$지급어음 조회선택(POPUP)
forward
global type w_kfm01ot0_popup from window
end type
type cb_3 from commandbutton within w_kfm01ot0_popup
end type
type cb_2 from commandbutton within w_kfm01ot0_popup
end type
type cb_1 from commandbutton within w_kfm01ot0_popup
end type
type p_exit from uo_picture within w_kfm01ot0_popup
end type
type p_choose from uo_picture within w_kfm01ot0_popup
end type
type p_inq from uo_picture within w_kfm01ot0_popup
end type
type dw_1 from u_d_popup_sort within w_kfm01ot0_popup
end type
type sle_no from singlelineedit within w_kfm01ot0_popup
end type
type st_2 from statictext within w_kfm01ot0_popup
end type
type em_date from editmask within w_kfm01ot0_popup
end type
type st_1 from statictext within w_kfm01ot0_popup
end type
type rr_1 from roundrectangle within w_kfm01ot0_popup
end type
type ln_1 from line within w_kfm01ot0_popup
end type
type ln_2 from line within w_kfm01ot0_popup
end type
type rr_3 from roundrectangle within w_kfm01ot0_popup
end type
end forward
...
global w_kfm01ot0_popup w_kfm01ot0_popup
...
//	SELECT MIN("KFM02OT0"."BILL_NO")  
//    	INTO :sbill_no  
//    	FROM "KFM02OT0"  ;
//
	sbill_no ="%"
END IF
IF dw_1.Retrieve(sdate,sbill_no+'%') <= 0 THEN
...
integer height = 1884
integer taborder = 40
string dataobject = "dw_kfm01om0_popup"
