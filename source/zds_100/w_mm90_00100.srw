$PBExportHeader$w_mm90_00100.srw
$PBExportComments$mro 반납현황
forward
global type w_mm90_00100 from w_standard_print
end type
type rr_1 from roundrectangle within w_mm90_00100
end type
type rr_2 from roundrectangle within w_mm90_00100
end type
end forward

global type w_mm90_00100 from w_standard_print
string title = "소모품 반납 현황"
rr_1 rr_1
rr_2 rr_2
end type
global w_mm90_00100 w_mm90_00100
...
type p_xls from w_standard_print`p_xls within w_mm90_00100
end type

type p_sort from w_standard_print`p_sort within w_mm90_00100
end type

type p_preview from w_standard_print`p_preview within w_mm90_00100
end type

type p_exit from w_standard_print`p_exit within w_mm90_00100
end type

type p_print from w_standard_print`p_print within w_mm90_00100
end type

type p_retrieve from w_standard_print`p_retrieve within w_mm90_00100
end type
...
type st_10 from w_standard_print`st_10 within w_mm90_00100
end type



type dw_print from w_standard_print`dw_print within w_mm90_00100
integer x = 3223
integer y = 88
integer height = 76
string dataobject = "d_mm90_00100_p"
end type

type dw_ip from w_standard_print`dw_ip within w_mm90_00100
integer x = 55
integer y = 32
integer width = 2446
integer height = 200
string dataobject = "d_mm90_00100_1"
end type
...
type dw_list from w_standard_print`dw_list within w_mm90_00100
integer x = 46
integer y = 272
integer width = 4562
integer height = 1980
string dataobject = "d_mm90_00100_a"
