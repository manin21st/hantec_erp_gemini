$PBExportHeader$w_mm90_00125.srw
$PBExportComments$mro 출고 현황
forward
global type w_mm90_00125 from w_standard_print
end type
type rr_1 from roundrectangle within w_mm90_00125
end type
type rr_2 from roundrectangle within w_mm90_00125
end type
end forward

global type w_mm90_00125 from w_standard_print
string title = "소모품 출고 현황"
rr_1 rr_1
rr_2 rr_2
end type
global w_mm90_00125 w_mm90_00125
...
ls_sitcls = Trim(dw_ip.Object.sitcls[1])
ls_eitcls = Trim(dw_ip.Object.eitcls[1])

If ls_sdate = '' Or isNull(ls_sdate) Or f_dateChk(ls_sdate) < 1 Then
	f_message_chk(35,'[불출일자]')
	dw_ip.SetFocus()
...
If ls_eitcls = '' Or isNull(ls_eitcls) Then ls_eitcls = 'zzzzzzz'


if dw_print.Retrieve(gs_sabu,ls_sdate ,ls_edate ,ls_sitcls , ls_eitcls ,ls_vendor ) <= 0 then
	f_message_chk(50,'[MOR 출고 현황]')
	dw_ip.Setfocus()
	return -1
Else
...
type p_xls from w_standard_print`p_xls within w_mm90_00125
end type

type p_sort from w_standard_print`p_sort within w_mm90_00125
end type

type p_preview from w_standard_print`p_preview within w_mm90_00125
end type

type p_exit from w_standard_print`p_exit within w_mm90_00125
end type

type p_print from w_standard_print`p_print within w_mm90_00125
end type

type p_retrieve from w_standard_print`p_retrieve within w_mm90_00125
end type

event p_retrieve::clicked;call super::clicked;dw_list.SetSort("IMHIST_IOJPNO D, IMHIST_IO_DATE D") /* 출력물은 정순으로 조회하고 리스트는 역순으로 조회하도록 수정 2023.12.07 by dykim */
dw_list.Sort()
end event
...
type st_10 from w_standard_print`st_10 within w_mm90_00125
end type



type dw_print from w_standard_print`dw_print within w_mm90_00125
integer x = 3456
integer y = 184
integer height = 76
string dataobject = "d_mm90_00125_p"
end type

type dw_ip from w_standard_print`dw_ip within w_mm90_00125
integer x = 50
integer y = 32
integer width = 3173
integer height = 284
string dataobject = "d_mm90_00125_1"
end type
...
ELSEIF this.GetColumnName() = 'edate' THEN
	...
	IF f_datechk(sDate) = -1	then
		...
		return 1
	END IF
ElseIF this.GetColumnName() = 'sitcls' THEN
	s_cod  = TRIM(this.gettext())
	If s_cod = "" Or isNull(s_cod) Then
		Return 1
	End If
	
	Select titnm Into :s_nam1
	  From ITNCT
	 Where ITTYP = 'Z'
	   AND ITCLS = :s_cod ;
	
	If SQLCA.SQLCODE <> 0 Then
		This.Object.sitcls[1] = ''
		This.Object.stitnm[1] = ''
		Return 1
	Else
		This.Object.stitnm[1] = s_nam1
	End If
...
ElseIF this.GetColumnName() = 'eitcls' THEN
	...
	If SQLCA.SQLCODE <> 0 Then
		This.Object.eitcls[1] = ''
		This.Object.etitnm[1] = ''
		Return 1
	Else
		This.Object.etitnm[1] = s_nam1
	End If
...
If this.GetcolumNname() = 'sitcls' then
	gs_gubun = 'Z'
//	open(w_itnct_s_popup9)

	lstr_sitnct = Message.PowerObjectParm
	if isnull(lstr_sitnct.s_ittyp) or lstr_sitnct.s_ittyp = "" then return 
	
	This.Object.sitcls[1] = lstr_sitnct.s_sumgub
...
//	open(w_itnct_s_popup9)
	...
	This.Object.eitcls[1] = lstr_sitnct.s_sumgub
...
type dw_list from w_standard_print`dw_list within w_mm90_00125
integer x = 46
integer y = 360
integer width = 4562
integer height = 1888
string dataobject = "d_mm90_00125_a"
