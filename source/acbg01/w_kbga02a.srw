$PBExportHeader$w_kbga02a.srw
$PBExportComments$현업부서별 예산배정표 조회 출력
forward
global type w_kbga02a from w_standard_print
end type
type st_1 from statictext within w_kbga02a
end type
type rr_1 from roundrectangle within w_kbga02a
end type
end forward

global type w_kbga02a from w_standard_print
string title = "부서별 예산배정표 조회 출력(현업)"
boolean maxbox = true
st_1 st_1
rr_1 rr_1
end type
global w_kbga02a w_kbga02a
...
public function integer wf_retrieve ();string ls_saupj, ls_acc_yy, ls_ye_gu, ls_dept_cd, ls_acc1f, ls_acc1t, & 
       get_code, get_name, snull, sqlfd1, sqlfd2, sempno,sGbn, ls_updept
...
sGbn       = dw_ip.GetItemString(dw_ip.GetRow(), 'gbn')
...
IF dw_print.Retrieve(ls_saupj, ls_acc_yy, ls_ye_gu, ls_dept_cd, ls_acc1f, ls_acc1t,sGbn) < 1 THEN
...
type p_preview from w_standard_print`p_preview within w_kbga02a
integer y = 0
integer taborder = 40
string pointer = ""
end type

type p_exit from w_standard_print`p_exit within w_kbga02a
integer y = 0
integer taborder = 60
string pointer = ""
end type

type p_print from w_standard_print`p_print within w_kbga02a
integer y = 0
integer taborder = 50
string pointer = ""
end type

type p_retrieve from w_standard_print`p_retrieve within w_kbga02a
integer y = 0
integer taborder = 20
string pointer = ""
end type
...
type st_10 from w_standard_print`st_10 within w_kbga02a
end type



type dw_print from w_standard_print`dw_print within w_kbga02a
string dataobject = "dw_kbga02a_2_p"
end type

type dw_ip from w_standard_print`dw_ip within w_kbga02a
integer x = 50
integer y = 8
integer width = 3621
integer height = 192
integer taborder = 10
string dataobject = "dw_kbga02a_1"
end type
...
type dw_list from w_standard_print`dw_list within w_kbga02a
integer x = 73
integer y = 212
integer width = 4512
integer height = 2084
...
string dataobject = "dw_kbga02a_2"
