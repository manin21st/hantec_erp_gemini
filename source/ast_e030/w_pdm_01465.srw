$PBExportHeader$w_pdm_01465.srw
$PBExportComments$기술bom(대량추가 )
forward
global type w_pdm_01465 from window
end type
type cbx_1 from checkbox within w_pdm_01465
end type
type p_exit from uo_picture within w_pdm_01465
end type
type p_can from uo_picture within w_pdm_01465
end type
type p_inq from uo_picture within w_pdm_01465
end type
type st_1 from statictext within w_pdm_01465
end type
type dw_to from datawindow within w_pdm_01465
end type
type dw_from from datawindow within w_pdm_01465
end type
type dw_2 from datawindow within w_pdm_01465
end type
type rr_1 from roundrectangle within w_pdm_01465
end type
type p_mod from uo_picture within w_pdm_01465
end type
type p_add from uo_picture within w_pdm_01465
end type
type p_del from uo_picture within w_pdm_01465
end type
end forward
...
global w_pdm_01465 w_pdm_01465
...
integer height = 80
integer taborder = 30
string dataobject = "d_pdm_01465_1"
...
integer height = 260
integer taborder = 10
string dataobject = "d_pdm_01465_0"
boolean border = false
boolean livescroll = true
end type
...
integer width = 3657
integer height = 1524
string dataobject = "d_pdm_01465_2"
...
FOR lRow = 1	TO	 dw_2.RowCount()   //품번을 읽고
	if dw_2.getitemstring(lrow, 'opt') = 'Y' then   //체크품번만 복사
		...
		if ii = 0 then
			// 최대번호를 구한후 10씩 증가시킨다.
			SetNull(smaxno)
			select max(usseq) into :smaxno from estruc 
			 Where pinbr = :spinbr;
			...
			insert into estruc (pinbr, cinbr, usseq, qtypr, adtin, opsno, efrdt, eftdt, gubun, bomend, gubun2)
