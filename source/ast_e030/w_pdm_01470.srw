$PBExportHeader$w_pdm_01470.srw
$PBExportComments$기술bom(대량복사-시리즈별)
forward
global type w_pdm_01470 from window
end type
type cbx_1 from checkbox within w_pdm_01470
end type
type p_save from uo_picture within w_pdm_01470
end type
type p_inq2 from uo_picture within w_pdm_01470
end type
type p_exit from uo_picture within w_pdm_01470
end type
type p_inq1 from uo_picture within w_pdm_01470
end type
type st_2 from statictext within w_pdm_01470
end type
type st_1 from statictext within w_pdm_01470
end type
type dw_update from datawindow within w_pdm_01470
end type
type dw_1 from datawindow within w_pdm_01470
end type
type dw_to from datawindow within w_pdm_01470
end type
type dw_from from datawindow within w_pdm_01470
end type
type dw_2 from datawindow within w_pdm_01470
end type
type rr_1 from roundrectangle within w_pdm_01470
end type
type rr_2 from roundrectangle within w_pdm_01470
end type
type p_can from uo_picture within w_pdm_01470
end type
type rr_3 from roundrectangle within w_pdm_01470
end type
type rr_4 from roundrectangle within w_pdm_01470
end type
type rr_5 from roundrectangle within w_pdm_01470
end type
end forward
...
global w_pdm_01470 w_pdm_01470
...
FOR lRow = 1	TO	 dw_2.RowCount()   //품번을 읽고
   if dw_2.getitemstring(lrow, 'opt') = 'Y' then   //체크품번만 복사
		...
		FOR lRow2 = 1	TO	 dw_1.RowCount()  //하위품번을 읽고
			...
			dw_update.setitem(cur_row, "sagub",	dw_1.GetItemString(lRow2, "estruc_sagub"))
			dw_update.setitem(cur_row, "gubun2",dw_1.GetItemString(lRow2, "estruc_gubun2"))
			dw_update.setitem(cur_row, "crt_user",gs_userid)
   	NEXT
	end if	
NEXT
...
integer width = 1303
integer height = 160
string dataobject = "d_pdm_01470_5"
...
integer height = 168
integer taborder = 20
string dataobject = "d_pdm_01470_2"
boolean border = false
boolean livescroll = true
end type
...
integer height = 168
integer taborder = 10
string dataobject = "d_pdm_01470_1"
boolean border = false
boolean livescroll = true
end type
...
integer width = 1755
integer height = 1404
string dataobject = "d_pdm_01470_4"
boolean hscrollbar = true
boolean vscrollbar = true
boolean border = false
boolean livescroll = true
