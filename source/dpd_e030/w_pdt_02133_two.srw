$PBExportHeader$w_pdt_02133_two.srw
$PBExportComments$작업실적등록(작업지시번호별) - 처방/장치
forward
global type w_pdt_02133_two from w_inherite
end type
type gb_4 from groupbox within w_pdt_02133_two
end type
type dw_head from datawindow within w_pdt_02133_two
end type
type ds_update from datawindow within w_pdt_02133_two
end type
type dw_hist from datawindow within w_pdt_02133_two
end type
type dw_hist_item from datawindow within w_pdt_02133_two
end type
type p_1 from uo_picture_01 within w_pdt_02133_two
end type
type p_nttabl from uo_picture_02 within w_pdt_02133_two
end type
type p_holdstock from uo_picture_03 within w_pdt_02133_two
end type
type rr_1 from roundrectangle within w_pdt_02133_two
end type
type rr_2 from roundrectangle within w_pdt_02133_two
end type
end forward
...
global w_pdt_02133_two w_pdt_02133_two
...
For lcnt = 1 to lrow
		...
		ds_update.setitem(lirow, "procqty",  dw_insert.getitemdecimal(lcnt, "procqty"))
Next
...
type dw_insert from w_inherite`dw_insert within w_pdt_02133_two
integer x = 32
integer y = 1604
integer width = 4535
integer height = 712
integer taborder = 40
string dataobject = "d_pdt_02130_3_two"
...
type p_delrow from w_inherite`p_delrow within w_pdt_02133_two
integer y = 5000
end type

type p_addrow from w_inherite`p_addrow within w_pdt_02133_two
integer y = 5000
end type

type p_search from w_inherite`p_search within w_pdt_02133_two
integer y = 5000
end type

type p_ins from w_inherite`p_ins within w_pdt_02133_two
integer y = 5000
end type

type p_exit from w_inherite`p_exit within w_pdt_02133_two
integer x = 4407
integer y = 8
end type

type p_can from w_inherite`p_can within w_pdt_02133_two
integer x = 4233
integer y = 8
...
type p_print from w_inherite`p_print within w_pdt_02133_two
integer y = 5000
end type

type p_inq from w_inherite`p_inq within w_pdt_02133_two
integer x = 3712
integer y = 8
end type
...
if dw_head.getitemstring(1, "jagbn") = 'Y' then		/* 신규인 경우 */
   sigbn = dw_head.object.sigbn[1]
	...
	IF sigbn = '1'  then /* 정상 */
		dw_insert.dataobject = "d_pdt_02130_1_two"
	   ...
	   SELECT DATANAME  
		...
		dw_insert.Filter()
	ELSE
		dw_insert.dataobject = "d_pdt_02130_11_two"
		dw_insert.settransobject(sqlca)		
	END IF 
	...
	dw_hist.settransobject(sqlca)			
	dw_insert.dataobject = "d_pdt_02130_3_two"
	dw_insert.settransobject(sqlca)		
...
type p_del from w_inherite`p_del within w_pdt_02133_two
integer x = 4059
integer y = 8
boolean enabled = false
...
type p_mod from w_inherite`p_mod within w_pdt_02133_two
integer x = 3886
integer y = 8
boolean enabled = false
...
String  sPordno 
// 강제완료 여부 확인하여 수정처리........
//if 	dw_head.getitemstring(1, "jagbn") = 'Y' and dw_insert.GetItemString(1, "pdsts_chk") = 'Y'    then // 신규자료  입력 , 강제종료인 경우
if 	dw_insert.GetItemString(1, "pdsts_chk") = 'Y'    then //  강제종료인 경우
	SetPointer(HourGlass!)
	...
	if 	sqlca.sqlcode < 0 then
		rollback;
		w_mdi_frame.sle_msg.text = ''
		f_message_chk(32,'[작업지시 강제종료시 오류]') 	
		SetPointer(Arrow!)
		return 
	end if	
...
type cb_exit from w_inherite`cb_exit within w_pdt_02133_two
integer x = 4229
integer y = 5000
integer taborder = 110
end type

type cb_mod from w_inherite`cb_mod within w_pdt_02133_two
integer x = 3186
integer y = 5000
integer taborder = 80
boolean enabled = false
...
type cb_ins from w_inherite`cb_ins within w_pdt_02133_two
...
type cb_del from w_inherite`cb_del within w_pdt_02133_two
integer x = 3534
integer y = 5000
integer taborder = 90
boolean enabled = false
...
type cb_inq from w_inherite`cb_inq within w_pdt_02133_two
integer x = 2825
integer y = 5000
integer taborder = 20
end type

type cb_print from w_inherite`cb_print within w_pdt_02133_two
boolean visible = false
integer x = 1253
integer y = 2556
end type

type st_1 from w_inherite`st_1 within w_pdt_02133_two
end type

type cb_can from w_inherite`cb_can within w_pdt_02133_two
integer x = 3881
integer y = 5000
...
type cb_search from w_inherite`cb_search within w_pdt_02133_two
boolean visible = false
integer x = 1687
integer y = 2592
boolean enabled = false
...
type gb_button1 from w_inherite`gb_button1 within w_pdt_02133_two
end type

type gb_button2 from w_inherite`gb_button2 within w_pdt_02133_two
end type
...
if Lrow > 0 then
	...
	if 	dw_head.getitemstring(1, "jagbn") = 'Y' then		/* 신규인 경우 */
	   ...
	   SELECT DATANAME  
		...
		scdate = f_today()
		dw_insert.SetItem(1, "pdsts_chk", 'N')
...
integer height = 304
integer taborder = 20
string dataobject = "d_pdt_02133_2_two"
boolean border = false
end type
