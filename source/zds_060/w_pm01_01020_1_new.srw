$PBExportHeader$w_pm01_01020_1_new.srw
$PBExportComments$부하조정-월계획
forward
global type w_pm01_01020_1_new from w_inherite_popup
end type
type st_2 from statictext within w_pm01_01020_1_new
end type
type st_3 from statictext within w_pm01_01020_1_new
end type
type rr_2 from roundrectangle within w_pm01_01020_1_new
end type
type rr_1 from roundrectangle within w_pm01_01020_1_new
end type
type rr_3 from roundrectangle within w_pm01_01020_1_new
end type
end forward
...
global w_pm01_01020_1_new w_pm01_01020_1_new
...
/* 대체작업장 조회 */
dw_1.Retrieve(is_yymm, sWkctr, gs_codename)
...
type dw_jogun from w_inherite_popup`dw_jogun within w_pm01_01020_1_new
integer x = 64
integer y = 200
integer width = 2715
integer height = 744
integer taborder = 30
string dataobject = "d_pm01_01020_1_11_new"
end type

type p_exit from w_inherite_popup`p_exit within w_pm01_01020_1_new
integer x = 2619
integer taborder = 20
end type
...
type p_inq from w_inherite_popup`p_inq within w_pm01_01020_1_new
integer x = 2446
integer taborder = 10
...
type p_choose from w_inherite_popup`p_choose within w_pm01_01020_1_new
...
type dw_1 from w_inherite_popup`dw_1 within w_pm01_01020_1_new
integer x = 55
integer y = 1084
integer width = 2747
integer height = 744
integer taborder = 40
string dataobject = "d_pm01_01020_1_21_new"
end type
...
type sle_2 from w_inherite_popup`sle_2 within w_pm01_01020_1_new
boolean visible = false
integer x = 576
integer y = 2580
end type

type cb_1 from w_inherite_popup`cb_1 within w_pm01_01020_1_new
boolean visible = false
integer x = 1051
integer y = 2328
end type

type cb_return from w_inherite_popup`cb_return within w_pm01_01020_1_new
boolean visible = false
integer x = 1687
integer y = 2328
end type

type cb_inq from w_inherite_popup`cb_inq within w_pm01_01020_1_new
boolean visible = false
integer x = 1371
integer y = 2328
end type

type sle_1 from w_inherite_popup`sle_1 within w_pm01_01020_1_new
boolean visible = false
integer x = 411
integer y = 2464
end type

type st_1 from w_inherite_popup`st_1 within w_pm01_01020_1_new
boolean visible = false
integer x = 133
integer y = 2476
end type
