$PBExportHeader$w_sal_06886.srw
$PBExportComments$년간수주실적 - Level (1-4) - 제품별
forward
global type w_sal_06886 from w_standard_print
end type
type shl_3 from statichyperlink within w_sal_06886
end type
type st_2 from statictext within w_sal_06886
end type
type shl_1 from statichyperlink within w_sal_06886
end type
type shl_2 from statichyperlink within w_sal_06886
end type
type st_1 from statictext within w_sal_06886
end type
type st_3 from statictext within w_sal_06886
end type
type st_4 from statictext within w_sal_06886
end type
type rr_1 from roundrectangle within w_sal_06886
end type
end forward

global type w_sal_06886 from w_standard_print
string title = "년간 수주실적 - 제품별"
string menuname = ""
shl_3 shl_3
st_2 st_2
shl_1 shl_1
...
global w_sal_06886 w_sal_06886
...
ls_last_date = f_last_date(ls_year+ls_month)
IF dw_list.Retrieve(ls_year + ls_month + '01', ls_last_date, ls_steamcd, ls_sarea, ls_cvcod) <= 0 THEN
	f_message_chk(50, '[]')
	Return -1
END IF
...
type p_preview from w_standard_print`p_preview within w_sal_06886
boolean visible = false
integer x = 2843
integer y = 12
end type

type p_exit from w_standard_print`p_exit within w_sal_06886
end type

type p_print from w_standard_print`p_print within w_sal_06886
boolean visible = false
integer x = 3017
integer y = 12
end type

type p_retrieve from w_standard_print`p_retrieve within w_sal_06886
integer x = 4265
end type
...
type st_10 from w_standard_print`st_10 within w_sal_06886
end type



type dw_print from w_standard_print`dw_print within w_sal_06886
integer x = 3255
string dataobject = "d_sal_06886"
end type

type dw_ip from w_standard_print`dw_ip within w_sal_06886
...
type dw_list from w_standard_print`dw_list within w_sal_06886
integer x = 46
integer y = 268
integer width = 4549
integer height = 2040
...
DO WHILE IsValid(lw_window)
	if ClassName(lw_window) = 'w_sal_06884' then
		lb_isopen = TRUE
		Exit
	else		
...
if lb_isopen then
	...
	OpenSheet(w_sal_06884, w_mdi_frame, 0, Layered!)	
end if
end event
