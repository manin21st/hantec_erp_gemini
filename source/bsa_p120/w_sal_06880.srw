$PBExportHeader$w_sal_06880.srw
$PBExportComments$년간수주실적 - Level (1)
forward
global type w_sal_06880 from w_standard_print
end type
type rr_titnm from roundrectangle within w_sal_06880
end type
type rr_team from roundrectangle within w_sal_06880
end type
type shl_1 from statichyperlink within w_sal_06880
end type
type st_team from statictext within w_sal_06880
end type
type dw_list_g from datawindow within w_sal_06880
end type
type st_titnm from statictext within w_sal_06880
end type
type rr_1 from roundrectangle within w_sal_06880
end type
type rr_2 from roundrectangle within w_sal_06880
end type
end forward

global type w_sal_06880 from w_standard_print
string title = "년간 수주실적현황"
string menuname = ""
rr_titnm rr_titnm
rr_team rr_team
shl_1 shl_1
...
global w_sal_06880 w_sal_06880
...
this.Control[iCurrent+1]=this.rr_titnm
this.Control[iCurrent+2]=this.rr_team
this.Control[iCurrent+3]=this.shl_1
this.Control[iCurrent+4]=this.st_team
this.Control[iCurrent+5]=this.dw_list_g
this.Control[iCurrent+6]=this.st_titnm
this.Control[iCurrent+7]=this.rr_1
this.Control[iCurrent+8]=this.rr_2
end on

on w_sal_06880.destroy
call super::destroy
...
type p_preview from w_standard_print`p_preview within w_sal_06880
boolean visible = false
integer x = 3141
integer y = 44
end type

type p_exit from w_standard_print`p_exit within w_sal_06880
end type

type p_print from w_standard_print`p_print within w_sal_06880
boolean visible = false
integer x = 3314
integer y = 44
end type

type p_retrieve from w_standard_print`p_retrieve within w_sal_06880
integer x = 4270
end type
...
type st_10 from w_standard_print`st_10 within w_sal_06880
end type



type dw_print from w_standard_print`dw_print within w_sal_06880
string dataobject = "d_sal_06880"
end type

type dw_ip from w_standard_print`dw_ip within w_sal_06880
integer x = 18
integer y = 96
integer width = 640
integer height = 152
...
//	Case 'tag'
//		If data = '1' Then
//			If dw_list.DataObject <> 'd_sal_06880' Then
//				dw_list.DataObject = 'd_sal_06880'
//			End If
//		Else
//			If dw_list.DataObject <> 'd_sal_06900' Then
//				dw_list.DataObject = 'd_sal_06900'
//			End If
//		End If
//		is_Tag = data
...
type dw_list from w_standard_print`dw_list within w_sal_06880
...
IF mid(ls_Object, 1, 7)  = 'steamcd' THEN 
	...
	DO WHILE IsValid(lw_window)
		if ClassName(lw_window) = 'w_sal_06882' then
			lb_isopen = TRUE
			Exit
		else		
	...
	OpenSheet(w_sal_06882, w_mdi_frame, 0, Layered!)
...
IF mid(ls_Object, 1, 5)  = 'titnm' THEN 
	...
	lw_window = parent.GetFirstSheet()
	DO WHILE IsValid(lw_window)
		if ClassName(lw_window) = 'w_sal_06901' then
			lb_isopen = TRUE
			Exit
		else		
			lw_window = parent.GetNextSheet(lw_window)
	...
	OpenSheet(w_sal_06901, w_mdi_frame, 0, Layered!)
