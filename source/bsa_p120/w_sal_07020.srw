$PBExportHeader$w_sal_07020.srw
$PBExportComments$연동판매계획 - Level (1)
forward
global type w_sal_07020 from w_standard_print
end type
type shl_1 from statichyperlink within w_sal_07020
end type
type rr_1 from roundrectangle within w_sal_07020
end type
end forward

global type w_sal_07020 from w_standard_print
string title = "연동판매계획현황"
string menuname = ""
shl_1 shl_1
rr_1 rr_1
end type
global w_sal_07020 w_sal_07020
...
type p_preview from w_standard_print`p_preview within w_sal_07020
boolean visible = false
integer x = 3141
integer y = 44
end type

type p_exit from w_standard_print`p_exit within w_sal_07020
end type

type p_print from w_standard_print`p_print within w_sal_07020
boolean visible = false
integer x = 3314
integer y = 44
end type

type p_retrieve from w_standard_print`p_retrieve within w_sal_07020
integer x = 4270
end type
...
type st_10 from w_standard_print`st_10 within w_sal_07020
end type



type dw_print from w_standard_print`dw_print within w_sal_07020
string dataobject = "d_pdt_09010_1"
end type

type dw_ip from w_standard_print`dw_ip within w_sal_07020
integer x = 18
integer y = 96
integer width = 658
integer height = 152
...
type dw_list from w_standard_print`dw_list within w_sal_07020
event ue_mousemove pbm_mousemove
integer x = 46
integer y = 268
integer width = 4558
integer height = 2052
string dataobject = "d_sal_07020"
