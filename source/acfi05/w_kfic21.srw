$PBExportHeader$w_kfic21.srw
$PBExportComments$보험관리대장조회출력
forward
global type w_kfic21 from w_standard_print
end type
type rr_1 from roundrectangle within w_kfic21
end type
end forward
...
integer x = 0
integer y = 0
string title = "보험관리대장조회출력"
rr_1 rr_1
end type
global w_kfic21 w_kfic21
...
type p_preview from w_standard_print`p_preview within w_kfic21
end type

type p_exit from w_standard_print`p_exit within w_kfic21
end type

type p_print from w_standard_print`p_print within w_kfic21
end type

type p_retrieve from w_standard_print`p_retrieve within w_kfic21
end type
...
type st_10 from w_standard_print`st_10 within w_kfic21
end type



type dw_print from w_standard_print`dw_print within w_kfic21
string dataobject = "dw_kfic21_p"
end type

type dw_ip from w_standard_print`dw_ip within w_kfic21
integer x = 32
integer y = 20
integer width = 2094
string dataobject = "dw_kfic21_a"
end type
...
type dw_list from w_standard_print`dw_list within w_kfic21
integer x = 82
integer width = 4517
integer height = 2020
string dataobject = "dw_kfic21"
