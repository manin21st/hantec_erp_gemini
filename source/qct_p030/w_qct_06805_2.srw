$PBExportHeader$w_qct_06805_2.srw
$PBExportComments$년간품질현황 - (공정검사) 중분류별
forward
global type w_qct_06805_2 from w_standard_print
end type
type shl_1 from statichyperlink within w_qct_06805_2
end type
type st_1 from statictext within w_qct_06805_2
end type
type shl_2 from statichyperlink within w_qct_06805_2
end type
type shl_3 from statichyperlink within w_qct_06805_2
end type
type st_2 from statictext within w_qct_06805_2
end type
type rr_1 from roundrectangle within w_qct_06805_2
end type
end forward

global type w_qct_06805_2 from w_standard_print
string title = "년간품질현황 - (공정검사) 중분류별"
string menuname = ""
shl_1 shl_1
st_1 st_1
shl_2 shl_2
...
global w_qct_06805_2 w_qct_06805_2
...
type p_preview from w_standard_print`p_preview within w_qct_06805_2
boolean visible = false
integer x = 3141
integer y = 44
end type

type p_exit from w_standard_print`p_exit within w_qct_06805_2
end type

type p_print from w_standard_print`p_print within w_qct_06805_2
boolean visible = false
integer x = 3314
integer y = 44
end type

type p_retrieve from w_standard_print`p_retrieve within w_qct_06805_2
integer x = 4270
end type
...
type st_10 from w_standard_print`st_10 within w_qct_06805_2
end type



type dw_print from w_standard_print`dw_print within w_qct_06805_2
string dataobject = "d_qct_06805_2"
end type

type dw_ip from w_standard_print`dw_ip within w_qct_06805_2
integer x = 18
integer y = 96
integer width = 2249
integer height = 152
...
type dw_list from w_standard_print`dw_list within w_qct_06805_2
...
DO WHILE IsValid(lw_window)
	if ClassName(lw_window) = 'w_qct_06806_2' then
		lb_isopen = TRUE
		Exit
	else		
...
OpenSheet(w_qct_06806_2, w_mdi_frame, 0, Layered!)
