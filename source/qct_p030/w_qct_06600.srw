...
//dw_list.object.txt_title.text = String(ym,"@@@@년 @@월 고객 불만 처리 현황")
//
//if dw_list.Retrieve(gs_sabu, ym) <= 0 then
//	f_message_chk(50,'[고객 불만 처리 현황]')
//	dw_ip.Setfocus()
//	return -1
//end if
...
dw_print.object.txt_title.text = String(ym,"@@@@년 @@월 고객 불만 처리 현황")
