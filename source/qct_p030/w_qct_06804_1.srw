$PBExportHeader$w_qct_06804_1.srw
$PBExportComments$년간품질현황 - (출고검사) 대분류별
forward
global type w_qct_06804_1 from w_standard_print
end type
type shl_1 from statichyperlink within w_qct_06804_1
end type
type st_1 from statictext within w_qct_06804_1
end type
type shl_2 from statichyperlink within w_qct_06804_1
end type
type rr_1 from roundrectangle within w_qct_06804_1
end type
end forward

global type w_qct_06804_1 from w_standard_print
string title = "년간품질현황 - (출고검사) 대분류별"
string menuname = ""
shl_1 shl_1
st_1 st_1
shl_2 shl_2
...
global w_qct_06804_1 w_qct_06804_1
...
type p_preview from w_standard_print`p_preview within w_qct_06804_1
boolean visible = false
integer x = 3141
integer y = 44
end type

type p_exit from w_standard_print`p_exit within w_qct_06804_1
end type

type p_print from w_standard_print`p_print within w_qct_06804_1
boolean visible = false
integer x = 3314
integer y = 44
end type

type p_retrieve from w_standard_print`p_retrieve within w_qct_06804_1
integer x = 4270
end type
...
type st_10 from w_standard_print`st_10 within w_qct_06804_1
end type



type dw_print from w_standard_print`dw_print within w_qct_06804_1
string dataobject = "d_qct_06802"
end type

type dw_ip from w_standard_print`dw_ip within w_qct_06804_1
integer x = 18
integer y = 96
integer width = 658
integer height = 152
...
type dw_list from w_standard_print`dw_list within w_qct_06804_1
event ue_mousemove pbm_mousemove
integer x = 46
integer y = 268
integer width = 4558
integer height = 2052
string dataobject = "d_qct_06804_1"
...
/*
String	ls_Object, ls_seq, ls_year, ls_month
Long		ll_Row
Int		li_int
