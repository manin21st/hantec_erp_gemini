$PBExportHeader$w_pdt_02160_popup.srw
$PBExportComments$*비가동 일괄 등록
forward
global type w_pdt_02160_popup from w_inherite
end type
type dw_1 from datawindow within w_pdt_02160_popup
end type
type pb_1 from u_pb_cal within w_pdt_02160_popup
end type
type p_1 from uo_picture within w_pdt_02160_popup
end type
type rr_4 from roundrectangle within w_pdt_02160_popup
end type
end forward
...
global w_pdt_02160_popup w_pdt_02160_popup
...
type dw_insert from w_inherite`dw_insert within w_pdt_02160_popup
integer x = 59
integer y = 216
integer width = 3579
integer height = 580
integer taborder = 40
string dataobject = "d_pdt_02160_popup"
...
type p_delrow from w_inherite`p_delrow within w_pdt_02160_popup
...
type p_addrow from w_inherite`p_addrow within w_pdt_02160_popup
boolean visible = false
integer x = 4741
integer y = 792
integer taborder = 0
...
type p_search from w_inherite`p_search within w_pdt_02160_popup
boolean visible = false
integer x = 4722
integer y = 328
integer taborder = 0
...
type p_ins from w_inherite`p_ins within w_pdt_02160_popup
integer x = 2825
integer taborder = 30
end type

event p_ins::clicked;call super::clicked;string sdate, sjonam, sjocod, sWkctr
int    row
...
dw_insert.SetItem(row,'nttabl_jocod',sjocod)
...
dw_insert.SetColumn('nttabl_stime')

dw_1.Enabled = False   // 추가중 일자변경 불가

end event

type p_exit from w_inherite`p_exit within w_pdt_02160_popup
integer x = 3520
end type

type p_can from w_inherite`p_can within w_pdt_02160_popup
integer x = 3346
end type
...
type p_print from w_inherite`p_print within w_pdt_02160_popup
boolean visible = false
integer x = 4741
integer y = 484
integer taborder = 0
...
type p_inq from w_inherite`p_inq within w_pdt_02160_popup
integer x = 2647
integer taborder = 20
end type
...
type p_del from w_inherite`p_del within w_pdt_02160_popup
integer x = 3173
end type

event p_del::clicked;call super::clicked;string sdate, sjocod, swkctr, sntcod, snrmks, sdptno,dstime, detime
int    rcnt,row, nRow, ix
Dec    dntime, dsloss, dsinwon
...
if wf_recordcheck(nRow) <> 0 	then
	dw_insert.SetRow(nRow)
	dw_insert.setfocus()
	Return
End if

 sntcod 	= dw_insert.getitemstring(nRow, "nttabl_ntcod")
 snrmks 	= dw_insert.getitemstring(nRow, "nttabl_nrmks")
 sdptno 	= dw_insert.getitemstring(nRow, "nttabl_dptno")
 dsinwon	= dw_insert.getitemDecimal(nRow, "nttabl_sinwon")
 dstime 	= dw_insert.getitemstring(nRow, "nttabl_stime")
 detime 	= dw_insert.getitemstring(nRow, "nttabl_etime")
 dntime 	= dw_insert.getitemDecimal(nRow, "nttabl_ntime")
 
 delete from nttabl where sabu   = :gs_sabu
							 and ntdat  = :sdate
							 and ntcod  = :sntcod
							 and jocod  = :sjocod
							 and stime  = :dstime
...
type p_mod from w_inherite`p_mod within w_pdt_02160_popup
integer x = 2999
end type

event p_mod::clicked;call super::clicked;string sdate, sjocod, swkctr, sntcod, snrmks, sdptno,dstime, detime
int    rcnt,row, nRow, ix
Dec    dntime, dsloss, dsinwon, nmax
...
select max(ntseq) into :nmax from nttabl where sabu = :gs_sabu and ntdat = :sdate;
If IsNull(nmax) Then nMax = 0

For ix = 1 To nRow

	 sntcod 	= dw_insert.getitemstring(ix, "nttabl_ntcod")
	 snrmks 	= dw_insert.getitemstring(ix, "nttabl_nrmks")
	 sdptno 	= dw_insert.getitemstring(ix, "nttabl_dptno")
	 dstime 	= dw_insert.getitemstring(ix, "nttabl_stime")
	 detime 	= dw_insert.getitemstring(ix, "nttabl_etime")
	 dntime 	= dw_insert.getitemDecimal(ix, "nttabl_ntime")
	 dsloss 	= dw_insert.getitemDecimal(ix, "nttabl_ntime")
	 
	 nMax = nMax + 1
	 insert into nttabl ( SABU, NTDAT, JOCOD,  NTCOD,  NTIME, NRMKS,  
	                      SHPJPNO,  DPTNO,  WKCTR,  SINWON,  SLOSS,  STIME,  ETIME, SOS_GB, NTSEQ)
	    select :gs_sabu, :sdate, :sjocod, :sntcod, :dntime, :snrmks,
		        '.', :sdptno, a.wkctr, a.inwon, :dsloss * a.inwon, :dstime, :detime, 'Y',  :nMax + rownum
		   from wrkctr a
		  where jocod = :sjocod;
...
type cb_exit from w_inherite`cb_exit within w_pdt_02160_popup
integer x = 3195
integer y = 2716
end type

type cb_mod from w_inherite`cb_mod within w_pdt_02160_popup
integer x = 1701
integer y = 2716
end type

type cb_ins from w_inherite`cb_ins within w_pdt_02160_popup
integer x = 393
integer y = 2716
string text = "추가(&I)"
end type

type cb_del from w_inherite`cb_del within w_pdt_02160_popup
integer x = 2053
integer y = 2716
end type

type cb_inq from w_inherite`cb_inq within w_pdt_02160_popup
integer x = 41
integer y = 2716
end type

type cb_print from w_inherite`cb_print within w_pdt_02160_popup
integer x = 1742
integer y = 2716
end type

type st_1 from w_inherite`st_1 within w_pdt_02160_popup
end type

type cb_can from w_inherite`cb_can within w_pdt_02160_popup
integer x = 2405
integer y = 2716
end type

type cb_search from w_inherite`cb_search within w_pdt_02160_popup
integer x = 4274
integer y = 592
integer width = 320
...
type gb_button1 from w_inherite`gb_button1 within w_pdt_02160_popup
end type

type gb_button2 from w_inherite`gb_button2 within w_pdt_02160_popup
end type
...
string dataobject = "d_pdt_02160_popup_1"
boolean border = false
