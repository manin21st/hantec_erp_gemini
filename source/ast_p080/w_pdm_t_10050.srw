$PBExportHeader$w_pdm_t_10050.srw
$PBExportComments$원가 계산서(갑지)
forward
global type w_pdm_t_10050 from w_standard_print
end type
type rr_1 from roundrectangle within w_pdm_t_10050
end type
type rr_2 from roundrectangle within w_pdm_t_10050
end type
end forward

global type w_pdm_t_10050 from w_standard_print
string title = "원가 계산서(갑지)"
rr_1 rr_1
rr_2 rr_2
end type
global w_pdm_t_10050 w_pdm_t_10050
...
type p_preview from w_standard_print`p_preview within w_pdm_t_10050
end type

type p_exit from w_standard_print`p_exit within w_pdm_t_10050
end type

type p_print from w_standard_print`p_print within w_pdm_t_10050
end type

type p_retrieve from w_standard_print`p_retrieve within w_pdm_t_10050
end type
...
type st_10 from w_standard_print`st_10 within w_pdm_t_10050
end type



type dw_print from w_standard_print`dw_print within w_pdm_t_10050
string dataobject = "d_pdm_t_10050_p"
end type

type dw_ip from w_standard_print`dw_ip within w_pdm_t_10050
integer x = 64
integer y = 100
integer width = 1787
integer height = 240
string dataobject = "d_pdm_t_10050_h"
end type
...
type dw_list from w_standard_print`dw_list within w_pdm_t_10050
integer x = 23
integer y = 408
integer height = 1856
string dataobject = "d_pdm_t_10050_d"
