$PBExportHeader$w_sm40_itemas_popup.srw
$PBExportComments$판매매출/반품/단가소급 등록
forward
global type w_sm40_itemas_popup from w_inherite_popup
end type
type cbx_1 from checkbox within w_sm40_itemas_popup
end type
type rb_1 from radiobutton within w_sm40_itemas_popup
end type
type rb_2 from radiobutton within w_sm40_itemas_popup
end type
type rr_2 from roundrectangle within w_sm40_itemas_popup
end type
end forward
...
global w_sm40_itemas_popup w_sm40_itemas_popup
...
on w_sm40_itemas_popup.destroy
call super::destroy
destroy(this.cbx_1)
destroy(this.rb_1)
destroy(this.rb_2)
...
type dw_jogun from w_inherite_popup`dw_jogun within w_sm40_itemas_popup
integer x = 14
integer y = 32
integer width = 2610
integer height = 260
...
type p_exit from w_inherite_popup`p_exit within w_sm40_itemas_popup
integer x = 3520
end type
...
type p_inq from w_inherite_popup`p_inq within w_sm40_itemas_popup
integer x = 3173
...
type p_choose from w_inherite_popup`p_choose within w_sm40_itemas_popup
integer x = 3346
end type
...
type dw_1 from w_inherite_popup`dw_1 within w_sm40_itemas_popup
integer x = 27
integer y = 308
integer width = 3662
integer height = 1356
...
type sle_2 from w_inherite_popup`sle_2 within w_sm40_itemas_popup
end type

type cb_1 from w_inherite_popup`cb_1 within w_sm40_itemas_popup
end type

type cb_return from w_inherite_popup`cb_return within w_sm40_itemas_popup
end type

type cb_inq from w_inherite_popup`cb_inq within w_sm40_itemas_popup
boolean default = false
end type

type sle_1 from w_inherite_popup`sle_1 within w_sm40_itemas_popup
end type

type st_1 from w_inherite_popup`st_1 within w_sm40_itemas_popup
end type
