$PBExportHeader$w_kbga08.srw
$PBExportComments$부서별 예산집행 명세서
forward
global type w_kbga08 from w_standard_print
end type
type rr_1 from roundrectangle within w_kbga08
end type
end forward
...
integer x = 0
integer y = 0
string title = "부서 예산집행 명세서"
rr_1 rr_1
end type
global w_kbga08 w_kbga08
...
public function integer wf_retrieve ();string ls_saupj, ls_acc_yy, ls_acc_mm, ls_dept_cd, ls_acc1f, ls_acc2f,ls_acc1t, ls_acc2t, & 
       get_code, get_name, snull, sqlfd1, sqlfd2, s_yesanname
...
IF dw_print.Retrieve(ls_saupj, ls_acc_yy, ls_acc_mm, &
                    ls_dept_cd, ls_acc1f+ls_acc2f, ls_acc1t+ls_acc2t) < 1 then 
	f_message_chk(50, '')
	dw_list.Reset()
	dw_ip.SetColumn('saupj')
	dw_ip.SetFocus()
...
type p_preview from w_standard_print`p_preview within w_kbga08
string pointer = ""
end type

type p_exit from w_standard_print`p_exit within w_kbga08
string pointer = ""
end type

type p_print from w_standard_print`p_print within w_kbga08
string pointer = ""
end type

type p_retrieve from w_standard_print`p_retrieve within w_kbga08
string pointer = ""
end type
...
type st_10 from w_standard_print`st_10 within w_kbga08
end type



type dw_print from w_standard_print`dw_print within w_kbga08
string dataobject = "dw_kbga08_2_p"
end type

type dw_ip from w_standard_print`dw_ip within w_kbga08
integer x = 32
integer y = 8
integer width = 3232
integer height = 184
string dataobject = "dw_kbga08_1"
end type
...
type dw_list from w_standard_print`dw_list within w_kbga08
integer x = 55
integer y = 208
integer width = 4530
integer height = 2096
string title = "부서 예산집행 명세서"
string dataobject = "dw_kbga08_2"
boolean hscrollbar = false
boolean border = false
boolean hsplitscroll = false
end type

event dw_list::buttonclicked;call super::buttonclicked;This.AcceptText()

Gs_Gubun = dw_ip.GetItemString(1,"saupj")

OpenWithParm(w_kgld69bb, This.GetItemString(This.GetRow(),"acc_yy")+This.GetItemString(This.GetRow(),"acc_mm")+&
                         This.GetItemString(This.GetRow(),"acc1_cd")+This.GetItemString(This.GetRow(),"acc2_cd")+&
