$PBExportHeader$w_kbga12.srw
$PBExportComments$분기별 예산 총괄표
forward
global type w_kbga12 from w_standard_print
end type
type st_1 from statictext within w_kbga12
end type
type rr_1 from roundrectangle within w_kbga12
end type
end forward
...
integer x = 0
integer y = 0
string title = "분기별 예산 총괄표  조회 및 출력"
st_1 st_1
rr_1 rr_1
end type
global w_kbga12 w_kbga12
...
type p_preview from w_standard_print`p_preview within w_kbga12
integer taborder = 40
string pointer = ""
end type

type p_exit from w_standard_print`p_exit within w_kbga12
integer taborder = 60
string pointer = ""
end type

type p_print from w_standard_print`p_print within w_kbga12
integer taborder = 50
string pointer = ""
end type

type p_retrieve from w_standard_print`p_retrieve within w_kbga12
integer taborder = 20
string pointer = ""
end type
...
type st_10 from w_standard_print`st_10 within w_kbga12
end type



type dw_print from w_standard_print`dw_print within w_kbga12
string dataobject = "dw_kbga12_2_p"
end type

type dw_ip from w_standard_print`dw_ip within w_kbga12
integer width = 2807
integer height = 272
integer taborder = 10
string dataobject = "dw_kbga12_1"
end type
...
type dw_list from w_standard_print`dw_list within w_kbga12
integer x = 55
integer y = 304
integer width = 4539
integer height = 2012
integer taborder = 30
string title = "분기별 예산 총괄표"
string dataobject = "dw_kbga12_2"
