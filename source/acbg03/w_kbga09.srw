$PBExportHeader$w_kbga09.srw
$PBExportComments$부서별 예실차이 분석표
forward
global type w_kbga09 from w_standard_print
end type
type rr_1 from roundrectangle within w_kbga09
end type
end forward
...
integer x = 0
integer y = 0
string title = "부서별 예실차이 분석표 조회 및 출력"
rr_1 rr_1
end type
global w_kbga09 w_kbga09
...
public function integer wf_retrieve ();string ls_saupj, ls_acc_yy, ls_acc_mm, ls_dept_cd, ls_acc1f, ls_acc2f,ls_acc1t, ls_acc2t,& 
       get_code, get_name, snull, sqlfd1, sqlfd2, s_yesanname, ls_ye_gu, ls_updept
...
type p_preview from w_standard_print`p_preview within w_kbga09
integer taborder = 40
string pointer = ""
end type

type p_exit from w_standard_print`p_exit within w_kbga09
integer taborder = 60
string pointer = ""
end type

type p_print from w_standard_print`p_print within w_kbga09
integer taborder = 50
string pointer = ""
end type

type p_retrieve from w_standard_print`p_retrieve within w_kbga09
integer taborder = 20
string pointer = ""
end type
...
type st_10 from w_standard_print`st_10 within w_kbga09
end type



type dw_print from w_standard_print`dw_print within w_kbga09
string dataobject = "dw_kbga09_2_p"
end type

type dw_ip from w_standard_print`dw_ip within w_kbga09
integer width = 3461
integer height = 200
integer taborder = 10
string dataobject = "dw_kbga09_1"
end type
...
type dw_list from w_standard_print`dw_list within w_kbga09
integer x = 50
integer y = 232
integer width = 4539
integer height = 2064
integer taborder = 30
string title = "부서별 예실차이 분석표"
string dataobject = "dw_kbga09_2"
