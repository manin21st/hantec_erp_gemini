$PBExportHeader$w_kfga07.srw
$PBExportComments$전년대비 재무제표 비교표
forward
global type w_kfga07 from w_standard_print
end type
type rr_1 from roundrectangle within w_kfga07
end type
end forward
...
integer x = 0
integer y = 0
string title = "전년대비 재무제표 비교표 조회 출력"
rr_1 rr_1
end type
global w_kfga07 w_kfga07
...
public function integer wf_retrieve ();String  sFsGbn, sFromYm_Bef,sToYm_Bef, sFromYm_Cur,sToYm_Cur

IF dw_ip.AcceptText() = -1 THEN RETURN -1

sToYm_Cur = dw_ip.GetItemString(1,"acymf") 
...
IF sToYm_Cur = "" OR IsNull(sToYm_Cur) THEN
	...
	Return -1	
ELSE
	sFromYm_Cur = Left(sToYm_Cur,4)+'01'
	
	sFromYm_Bef = String(Long(Left(sToYm_Cur,4)) - 1,'0000')+'01'
	sToYm_Bef   = String(Long(Left(sToYm_Cur,4)) - 1,'0000')+'12'
END IF
...
IF dw_list.Retrieve(sFsGbn,sFromYm_Cur,sToYm_Cur,sFromYm_Bef,sToYm_Bef) <= 0 THEN
	F_MessageChk(14,'')
...
type p_preview from w_standard_print`p_preview within w_kfga07
integer y = 0
integer taborder = 30
string pointer = ""
end type

type p_exit from w_standard_print`p_exit within w_kfga07
integer y = 0
integer taborder = 50
string pointer = ""
end type

type p_print from w_standard_print`p_print within w_kfga07
integer y = 0
integer taborder = 40
string pointer = ""
end type

type p_retrieve from w_standard_print`p_retrieve within w_kfga07
integer y = 0
integer taborder = 20
string pointer = ""
end type

type st_window from w_standard_print`st_window within w_kfga07
integer y = 2788
end type

type sle_msg from w_standard_print`sle_msg within w_kfga07
integer y = 2788
end type

type dw_datetime from w_standard_print`dw_datetime within w_kfga07
integer y = 2788
end type

type st_10 from w_standard_print`st_10 within w_kfga07
integer y = 2640
end type

type gb_10 from w_standard_print`gb_10 within w_kfga07
integer y = 2752
end type

type dw_print from w_standard_print`dw_print within w_kfga07
integer x = 3397
integer y = 20
string dataobject = "d_kfga072_p"
end type

type dw_ip from w_standard_print`dw_ip within w_kfga07
integer x = 64
integer y = 20
integer width = 2295
integer height = 124
integer taborder = 10
string dataobject = "d_kfga071"
end type
...
type dw_list from w_standard_print`dw_list within w_kfga07
integer x = 82
integer y = 164
integer width = 4507
integer height = 2136
string dataobject = "d_kfga072"
