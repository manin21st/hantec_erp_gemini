$PBExportHeader$w_date_select_p.srw
$PBExportComments$일자선택(달력)-현장용
forward
global type w_date_select_p from window
end type
type cb_1 from commandbutton within w_date_select_p
end type
type pb_next from picturebutton within w_date_select_p
end type
type pb_prev from picturebutton within w_date_select_p
end type
type dw_cal from datawindow within w_date_select_p
end type
end forward
...
global w_date_select_p w_date_select_p
...
integer height = 1724
integer taborder = 10
string dataobject = "d_dateselect_02"
