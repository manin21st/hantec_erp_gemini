$PBExportHeader$w_tht_4552.srw
$PBExportComments$초중종물 실적 현황
forward
global type w_tht_4552 from w_standard_print
end type
type rr_1 from roundrectangle within w_tht_4552
end type
end forward
...
public function integer wf_retrieve ();string	sSidat1, sSidat2, sPdtgu, sJocod, sWkctr, sItnbr, sRqcgu, sChk, sDaygbn
...
sDaygbn		=	dw_ip.getitemstring(1, 'daygbn')
...
dw_list.retrieve( sSidat1, sSidat2, sItnbr, sChk, sPdtgu, sDaygbn)

return 1
end function

on w_tht_4552.create
int iCurrent
call super::create
...
dw_ip.setitem(1, 'sidat1', Left(sToday,6)+'01')
dw_ip.setitem(1, 'sidat2', sToday)

end event

type p_xls from w_standard_print`p_xls within w_tht_4552
boolean visible = true
integer x = 3671
integer y = 24
end type

type p_sort from w_standard_print`p_sort within w_tht_4552
integer x = 3493
integer y = 32
end type

type p_preview from w_standard_print`p_preview within w_tht_4552
boolean enabled = true
end type

type p_exit from w_standard_print`p_exit within w_tht_4552
end type

type p_print from w_standard_print`p_print within w_tht_4552
boolean enabled = true
end type

type p_retrieve from w_standard_print`p_retrieve within w_tht_4552
end type
...
type st_10 from w_standard_print`st_10 within w_tht_4552
end type



type dw_print from w_standard_print`dw_print within w_tht_4552
integer x = 3831
integer y = 180
string dataobject = "d_tht_4552_p"
end type

type dw_ip from w_standard_print`dw_ip within w_tht_4552
integer x = 37
integer y = 32
integer width = 3433
integer height = 220
string dataobject = "d_tht_4552_c"
end type
...
type dw_list from w_standard_print`dw_list within w_tht_4552
integer x = 50
integer y = 264
integer width = 4544
integer height = 1936
string dataobject = "d_tht_4552_l"
