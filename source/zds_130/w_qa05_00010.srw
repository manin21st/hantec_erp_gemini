$PBExportHeader$w_qa05_00010.srw
$PBExportComments$검교정 대상 선정
forward
global type w_qa05_00010 from w_inherite
end type
type dw_1 from datawindow within w_qa05_00010
end type
type rb_delete from radiobutton within w_qa05_00010
end type
type rb_insert from radiobutton within w_qa05_00010
end type
type cbx_1 from checkbox within w_qa05_00010
end type
type rr_1 from roundrectangle within w_qa05_00010
end type
type rr_2 from roundrectangle within w_qa05_00010
end type
end forward
...
global w_qa05_00010 w_qa05_00010
...
public function integer wf_save_mesplan ();long		lcnt, lseq, lmax, lrow, lpoint, i
...
FOR lrow = 1 TO dw_insert.rowcount()
	...
	syymm  = dw_insert.getitemstring(lrow,'chagi')
	smchno = dw_insert.getitemstring(lrow,'mchno')
	ssilgu = dw_insert.getitemstring(lrow,'silgu')
	sgikwan= dw_insert.getitemstring(lrow,'gikwan')
	lpoint = dw_insert.GetItemNumber(lrow,'bulrate')
	
	If IsNull(lpoint) OR lpoint < 1 Then lpoint = 1
	...
	For i = 1 To lpoint
		...
		insert into meskwa
		 ( sabu, 			mchno, 			seq, 				plnyymm, 			sidat,
			yudat,			sigbn,			sikwan,			bulrat, 				siamt,
			crtgu,			crtdat )
		values
		 ( :gs_sabu,		:smchno,			:i + :lmax,		:syymm, 				NULL, 
			NULL,        	:ssilgu,			NULL, 		0.0, 					0.0, 
...
if smodstatus = '1' then
	dw_insert.dataobject = 'd_qa05_00010_2'
else
	dw_insert.dataobject = 'd_qa05_00010_3'
end if
...
type dw_insert from w_inherite`dw_insert within w_qa05_00010
integer x = 37
integer y = 216
integer width = 4562
integer height = 1932
integer taborder = 20
string dataobject = "d_qa05_00010_2"
...
type p_delrow from w_inherite`p_delrow within w_qa05_00010
...
type p_addrow from w_inherite`p_addrow within w_qa05_00010
boolean visible = false
integer x = 1714
integer y = 2420
boolean enabled = false
...
type p_search from w_inherite`p_search within w_qa05_00010
boolean visible = false
integer x = 1385
integer y = 2424
boolean enabled = false
...
type p_ins from w_inherite`p_ins within w_qa05_00010
boolean visible = false
integer x = 1541
integer y = 2420
boolean enabled = false
...
type p_exit from w_inherite`p_exit within w_qa05_00010
integer x = 4425
end type

type p_can from w_inherite`p_can within w_qa05_00010
integer x = 4251
end type
...
type p_print from w_inherite`p_print within w_qa05_00010
boolean visible = false
integer x = 4713
integer y = 340
end type
...
type p_inq from w_inherite`p_inq within w_qa05_00010
integer x = 3730
end type
...
//dw_insert.filter()
//
if dw_insert.retrieve(gs_sabu,silgu,sfryymm, stoyymm) < 1 then
	dw_insert.setredraw(true)
...
type p_del from w_inherite`p_del within w_qa05_00010
integer x = 4078
...
if messagebox('확인','선택된 자료에 대한 검교정 계획을 삭제합니다',question!,yesno!,1) = 2 then return
...
type p_mod from w_inherite`p_mod within w_qa05_00010
integer x = 3904
end type
...
type cb_exit from w_inherite`cb_exit within w_qa05_00010
end type

type cb_mod from w_inherite`cb_mod within w_qa05_00010
integer x = 672
integer y = 2452
integer taborder = 40
end type

type cb_ins from w_inherite`cb_ins within w_qa05_00010
integer x = 311
integer y = 2452
integer taborder = 30
end type

type cb_del from w_inherite`cb_del within w_qa05_00010
integer x = 1033
integer y = 2452
integer taborder = 50
end type

type cb_inq from w_inherite`cb_inq within w_qa05_00010
integer x = 1403
integer y = 2460
integer taborder = 60
end type

type cb_print from w_inherite`cb_print within w_qa05_00010
integer x = 1755
integer y = 2452
integer taborder = 70
end type

type st_1 from w_inherite`st_1 within w_qa05_00010
end type

type cb_can from w_inherite`cb_can within w_qa05_00010
end type

type cb_search from w_inherite`cb_search within w_qa05_00010
end type
...
type gb_button1 from w_inherite`gb_button1 within w_qa05_00010
end type

type gb_button2 from w_inherite`gb_button2 within w_qa05_00010
end type
...
string dataobject = "d_qa05_00010_1"
boolean border = false
end type
