$PBExportHeader$w_cic00140.srw
$PBExportComments$제품별 제조원가 명세서
forward
global type w_cic00140 from w_standard_print
end type
type rr_1 from roundrectangle within w_cic00140
end type
end forward
...
IF sGubun = '1' THEN
	dw_list.DataObject = "dw_cic00140_2"   /*전체*/
   dw_print.DataObject = "dw_cic00140_2_p" 
ELSEIF sGubun = '2' THEN	
	dw_list.DataObject = "dw_cic00140_3"   /*요약*/
   dw_print.DataObject = "dw_cic00140_3_p"   
ELSEIF sGubun = '3' THEN	
	dw_list.DataObject = "dw_cic00140_4"   /*요약*/
   dw_print.DataObject = "dw_cic00140_4_p"   
...
type p_preview from w_standard_print`p_preview within w_cic00140
end type

type p_exit from w_standard_print`p_exit within w_cic00140
end type

type p_print from w_standard_print`p_print within w_cic00140
end type

type p_retrieve from w_standard_print`p_retrieve within w_cic00140
end type
...
type st_10 from w_standard_print`st_10 within w_cic00140
end type



type dw_print from w_standard_print`dw_print within w_cic00140
integer x = 4343
integer y = 132
string dataobject = "dw_cic00140_2_p"
end type

type dw_ip from w_standard_print`dw_ip within w_cic00140
integer x = 37
integer width = 3931
integer height = 196
string dataobject = "dw_cic00140_1"
end type
...
type dw_list from w_standard_print`dw_list within w_cic00140
integer x = 55
integer y = 228
integer width = 4544
integer height = 1976
string dataobject = "dw_cic00140_2"
...
sArg =  this.GetItemString(row,"pdtgu") + dw_ip.GetItemString(1,"sym") + this.GetItemString(row,"itnbr")
