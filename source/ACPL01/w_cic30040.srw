$PBExportHeader$w_cic30040.srw
$PBExportComments$기초재공재고현황
forward
global type w_cic30040 from w_standard_print
end type
type rr_1 from roundrectangle within w_cic30040
end type
end forward

global type w_cic30040 from w_standard_print
string title = "기초재공재고 현황"
rr_1 rr_1
end type
global w_cic30040 w_cic30040
...
type p_preview from w_standard_print`p_preview within w_cic30040
end type

type p_exit from w_standard_print`p_exit within w_cic30040
end type

type p_print from w_standard_print`p_print within w_cic30040
end type

type p_retrieve from w_standard_print`p_retrieve within w_cic30040
end type
...
type st_10 from w_standard_print`st_10 within w_cic30040
end type



type dw_print from w_standard_print`dw_print within w_cic30040
string dataobject = "dw_cic30040_2_p"
end type

type dw_ip from w_standard_print`dw_ip within w_cic30040
integer x = 0
integer y = 0
integer width = 3735
integer height = 208
string dataobject = "dw_ciC30040_1"
end type
...
type dw_list from w_standard_print`dw_list within w_cic30040
integer x = 23
integer y = 216
integer width = 4558
integer height = 1980
string dataobject = "dw_cic30040_2"
