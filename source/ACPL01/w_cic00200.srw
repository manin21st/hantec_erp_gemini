$PBExportHeader$w_cic00200.srw
$PBExportComments$원가계산 실행
forward
global type w_cic00200 from w_inherite
end type
type dw_cond from datawindow within w_cic00200
end type
end forward
...
type dw_insert from w_inherite`dw_insert within w_cic00200
boolean visible = false
integer x = 137
integer y = 2600
end type

type p_delrow from w_inherite`p_delrow within w_cic00200
boolean visible = false
integer x = 4119
integer y = 3320
end type

type p_addrow from w_inherite`p_addrow within w_cic00200
boolean visible = false
integer x = 3945
integer y = 3320
end type

type p_search from w_inherite`p_search within w_cic00200
boolean visible = false
integer x = 3250
integer y = 3320
end type

type p_ins from w_inherite`p_ins within w_cic00200
boolean visible = false
integer x = 3771
integer y = 3320
end type

type p_exit from w_inherite`p_exit within w_cic00200
end type

type p_can from w_inherite`p_can within w_cic00200
boolean visible = false
integer x = 3968
integer y = 3088
end type

type p_print from w_inherite`p_print within w_cic00200
boolean visible = false
integer x = 3424
integer y = 3320
end type

type p_inq from w_inherite`p_inq within w_cic00200
boolean visible = false
integer x = 3598
integer y = 3320
end type

type p_del from w_inherite`p_del within w_cic00200
boolean visible = false
integer x = 3794
integer y = 3088
end type

type p_mod from w_inherite`p_mod within w_cic00200
integer x = 4270
...
event p_mod::clicked;String  sYearMonth,sYearMonthT,sClearGbn,sCalc1,sCalc2,sCalc3,sCalc4,sCalc5,sCalc6,sCalc7,sCalc9,&
		  sErrors,sNextYearMonth,sSabu = '1',sCurrYearMonth
...
Integer iRtnValue,iJCnt,iFrom,iTo,k
...
IF sCalc6 = 'Y' THEN							/*원가계산(공정수불) = 'Y'*/
	sErrMsg[] = {'LOW LEVEL CODE로 처리할 품번의 순서 확정',				&
...
type cb_exit from w_inherite`cb_exit within w_cic00200
boolean visible = false
integer x = 2665
integer y = 3288
integer taborder = 30
...
type cb_mod from w_inherite`cb_mod within w_cic00200
boolean visible = false
integer x = 2277
integer y = 3288
integer width = 361
...
type cb_ins from w_inherite`cb_ins within w_cic00200
boolean visible = false
integer x = 475
integer y = 3020
end type

type cb_del from w_inherite`cb_del within w_cic00200
boolean visible = false
integer x = 1577
integer y = 2988
end type

type cb_inq from w_inherite`cb_inq within w_cic00200
boolean visible = false
integer x = 114
integer y = 3020
end type

type cb_print from w_inherite`cb_print within w_cic00200
boolean visible = false
integer x = 2752
integer y = 2900
end type

type st_1 from w_inherite`st_1 within w_cic00200
boolean visible = false
end type

type cb_can from w_inherite`cb_can within w_cic00200
boolean visible = false
integer x = 1934
integer y = 2988
end type

type cb_search from w_inherite`cb_search within w_cic00200
boolean visible = false
integer x = 2208
integer y = 2888
end type

type dw_datetime from w_inherite`dw_datetime within w_cic00200
boolean visible = false
integer x = 2871
end type

type sle_msg from w_inherite`sle_msg within w_cic00200
boolean visible = false
integer width = 2487
end type

type gb_10 from w_inherite`gb_10 within w_cic00200
boolean visible = false
end type

type gb_button1 from w_inherite`gb_button1 within w_cic00200
boolean visible = false
integer x = 78
integer y = 2960
end type

type gb_button2 from w_inherite`gb_button2 within w_cic00200
boolean visible = false
integer x = 2235
integer y = 3232
integer width = 795
...
string dataobject = "dw_cic002001"
