$PBExportHeader$w_psd1220.srw
$PBExportComments$고과계산중간자료표
forward
global type w_psd1220 from w_standard_print
end type
type rr_1 from roundrectangle within w_psd1220
end type
type rr_2 from roundrectangle within w_psd1220
end type
end forward

global type w_psd1220 from w_standard_print
string title = "고과계산중간결과표"
rr_1 rr_1
rr_2 rr_2
end type
global w_psd1220 w_psd1220
...
if dw_list.retrieve( is_dept, is_ym, is_empno, is_saupcd) < 1 then 
...
type p_xls from w_standard_print`p_xls within w_psd1220
end type

type p_sort from w_standard_print`p_sort within w_psd1220
end type

type p_preview from w_standard_print`p_preview within w_psd1220
end type

type p_exit from w_standard_print`p_exit within w_psd1220
end type

type p_print from w_standard_print`p_print within w_psd1220
end type

type p_retrieve from w_standard_print`p_retrieve within w_psd1220
end type
...
type st_10 from w_standard_print`st_10 within w_psd1220
end type



type dw_print from w_standard_print`dw_print within w_psd1220
string dataobject = "d_psd1220_2_p"
end type

type dw_ip from w_standard_print`dw_ip within w_psd1220
integer x = 119
integer y = 24
integer width = 3163
integer height = 228
string dataobject = "d_psd1220_1"
end type
...
type dw_list from w_standard_print`dw_list within w_psd1220
integer x = 64
integer y = 348
integer width = 4503
integer height = 1872
string dataobject = "d_psd1220_2"
