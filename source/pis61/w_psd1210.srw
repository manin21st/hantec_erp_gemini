$PBExportHeader$w_psd1210.srw
$PBExportComments$고과점수등록표조회출력
forward
global type w_psd1210 from w_standard_print
end type
type rr_1 from roundrectangle within w_psd1210
end type
type rr_2 from roundrectangle within w_psd1210
end type
end forward

global type w_psd1210 from w_standard_print
string title = "고과점수등록표"
rr_1 rr_1
rr_2 rr_2
end type
global w_psd1210 w_psd1210
...
public function integer wf_retrieve ();
string is_ym, is_dept, is_empno//, is_saupcd
...
if dw_list.retrieve(  is_ym,is_empno, is_dept, is_saupcd) < 1 then 
...
type p_xls from w_standard_print`p_xls within w_psd1210
end type

type p_sort from w_standard_print`p_sort within w_psd1210
end type

type p_preview from w_standard_print`p_preview within w_psd1210
end type

type p_exit from w_standard_print`p_exit within w_psd1210
end type

type p_print from w_standard_print`p_print within w_psd1210
end type

type p_retrieve from w_standard_print`p_retrieve within w_psd1210
end type
...
type st_10 from w_standard_print`st_10 within w_psd1210
end type



type dw_print from w_standard_print`dw_print within w_psd1210
string dataobject = "d_psd1210_2_p"
end type

type dw_ip from w_standard_print`dw_ip within w_psd1210
integer x = 96
integer y = 48
integer width = 2949
integer height = 216
string dataobject = "d_psd1210_1"
end type
...
type dw_list from w_standard_print`dw_list within w_psd1210
integer x = 78
integer y = 348
integer width = 4489
integer height = 1868
string dataobject = "d_psd1210_2"
