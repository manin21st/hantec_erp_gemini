$PBExportHeader$w_pdt_04037.srw
$PBExportComments$출고등록(직접출고)-재고조회
forward
global type w_pdt_04037 from window
end type
type p_exit from uo_picture within w_pdt_04037
end type
type p_choose from uo_picture within w_pdt_04037
end type
type p_inq from uo_picture within w_pdt_04037
end type
type dw_2 from datawindow within w_pdt_04037
end type
type dw_1 from datawindow within w_pdt_04037
end type
type rr_1 from roundrectangle within w_pdt_04037
end type
end forward
...
global w_pdt_04037 w_pdt_04037
