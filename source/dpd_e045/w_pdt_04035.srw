$PBExportHeader$w_pdt_04035.srw
$PBExportComments$출고등록(직접출고)
forward
global type w_pdt_04035 from w_inherite
end type
type dw_detail from datawindow within w_pdt_04035
end type
type dw_list from datawindow within w_pdt_04035
end type
type dw_hidden from datawindow within w_pdt_04035
end type
type dw_imhist from datawindow within w_pdt_04035
end type
type dw_imhist_in from datawindow within w_pdt_04035
end type
type dw_print from datawindow within w_pdt_04035
end type
type dw_prt from datawindow within w_pdt_04035
end type
type cbx_2 from checkbox within w_pdt_04035
end type
type cbx_1 from checkbox within w_pdt_04035
end type
type rb_delete from radiobutton within w_pdt_04035
end type
type rb_insert from radiobutton within w_pdt_04035
end type
type pb_1 from picturebutton within w_pdt_04035
end type
type p_1 from uo_picture within w_pdt_04035
end type
type p_3 from picture within w_pdt_04035
end type
type gb_2 from groupbox within w_pdt_04035
end type
type rr_1 from roundrectangle within w_pdt_04035
end type
end forward
...
global w_pdt_04035 w_pdt_04035
...
type dw_insert from w_inherite`dw_insert within w_pdt_04035
...
type p_delrow from w_inherite`p_delrow within w_pdt_04035
integer x = 3557
end type
...
type p_addrow from w_inherite`p_addrow within w_pdt_04035
integer x = 3383
end type
...
type p_search from w_inherite`p_search within w_pdt_04035
boolean visible = false
integer y = 260
boolean enabled = false
end type

type p_ins from w_inherite`p_ins within w_pdt_04035
boolean visible = false
integer y = 260
boolean enabled = false
end type

type p_exit from w_inherite`p_exit within w_pdt_04035
end type

type p_can from w_inherite`p_can within w_pdt_04035
end type
...
type p_print from w_inherite`p_print within w_pdt_04035
boolean visible = false
integer x = 3195
integer y = 252
boolean enabled = false
...
type p_inq from w_inherite`p_inq within w_pdt_04035
integer x = 3749
boolean enabled = false
...
type p_del from w_inherite`p_del within w_pdt_04035
boolean enabled = false
...
type p_mod from w_inherite`p_mod within w_pdt_04035
end type
...
type cb_exit from w_inherite`cb_exit within w_pdt_04035
end type

type cb_mod from w_inherite`cb_mod within w_pdt_04035
end type

type cb_ins from w_inherite`cb_ins within w_pdt_04035
end type

type cb_del from w_inherite`cb_del within w_pdt_04035
end type

type cb_inq from w_inherite`cb_inq within w_pdt_04035
end type

type cb_print from w_inherite`cb_print within w_pdt_04035
end type

type st_1 from w_inherite`st_1 within w_pdt_04035
end type

type cb_can from w_inherite`cb_can within w_pdt_04035
end type

type cb_search from w_inherite`cb_search within w_pdt_04035
end type
...
type gb_button1 from w_inherite`gb_button1 within w_pdt_04035
end type

type gb_button2 from w_inherite`gb_button2 within w_pdt_04035
end type
...
integer taborder = 40
boolean bringtotop = true
string dataobject = "d_pdt_04035_2"
...
dw_list.DataObject = 'd_pdt_04035_2'
dw_list.SetTransObject(SQLCA)
...
dw_detail.SetItem(1, 'gubun' , 'OM6'  )  //수불구분(공장간 창고이동)
...
For i = 1 To UpperBound(lstr_code.code[])
	...
	dw_list.SetItem(li_ins, 'lotsno', lstr_code.sgubun3[i])
	dw_list.SetItem(li_ins, 'outqty', lstr_code.dgubun1[i])
