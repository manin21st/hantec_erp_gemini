$PBExportHeader$w_pdt_04036.srw
$PBExportComments$출고등록(직접출고)
forward
global type w_pdt_04036 from window
end type
type dw_hidden from datawindow within w_pdt_04036
end type
type p_print from uo_picture within w_pdt_04036
end type
type p_2 from uo_picture within w_pdt_04036
end type
type p_1 from uo_picture within w_pdt_04036
end type
type p_retrieve from uo_picture within w_pdt_04036
end type
type p_save from uo_picture within w_pdt_04036
end type
type p_delete from uo_picture within w_pdt_04036
end type
type p_cancel from uo_picture within w_pdt_04036
end type
type p_exit from uo_picture within w_pdt_04036
end type
type p_addrow from uo_picture within w_pdt_04036
end type
type p_delrow from uo_picture within w_pdt_04036
end type
type dw_print from datawindow within w_pdt_04036
end type
type cbx_1 from checkbox within w_pdt_04036
end type
type dw_imhist_in from datawindow within w_pdt_04036
end type
type rb_delete from radiobutton within w_pdt_04036
end type
type rb_insert from radiobutton within w_pdt_04036
end type
type dw_imhist from datawindow within w_pdt_04036
end type
type dw_list from datawindow within w_pdt_04036
end type
type gb_2 from groupbox within w_pdt_04036
end type
type rr_1 from roundrectangle within w_pdt_04036
end type
type dw_detail from datawindow within w_pdt_04036
end type
end forward
...
global w_pdt_04036 w_pdt_04036
...
FOR	lRow = 1		TO		dw_list.RowCount()
	...
	IF abs(dOutQty) > 0		THEN
		...
		dw_imhist.SetItem(lRowHist, "jnpcrt",	'041')			// 전표생성구분
...
// 	dw_imhist.SetItem(lRowHist, "outchk",  'Y') 			// 출고의뢰완료
		...
		IF sHouseGubun = 'Y'	and dOutQty > 0	THEN
			...
			dw_imHist_in.SetItem(lRowHist_in, "jnpcrt",	'042')			// 전표생성구분
...
integer height = 1872
integer taborder = 30
string dataobject = "d_pdt_04036_2"
boolean hscrollbar = true
boolean vscrollbar = true
...
integer height = 312
integer taborder = 10
string dataobject = "d_pdt_04036_1"
boolean border = false
boolean livescroll = true
end type
