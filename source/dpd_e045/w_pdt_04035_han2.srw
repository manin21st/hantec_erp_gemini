$PBExportHeader$w_pdt_04035_han2.srw
$PBExportComments$외주사급출고(무상사급) - 한텍
forward
global type w_pdt_04035_han2 from window
end type
type cb_1 from commandbutton within w_pdt_04035_han2
end type
type p_3 from picture within w_pdt_04035_han2
end type
type dw_hidden from datawindow within w_pdt_04035_han2
end type
type p_print from uo_picture within w_pdt_04035_han2
end type
type p_2 from uo_picture within w_pdt_04035_han2
end type
type p_1 from uo_picture within w_pdt_04035_han2
end type
type p_retrieve from uo_picture within w_pdt_04035_han2
end type
type p_save from uo_picture within w_pdt_04035_han2
end type
type p_delete from uo_picture within w_pdt_04035_han2
end type
type p_cancel from uo_picture within w_pdt_04035_han2
end type
type p_exit from uo_picture within w_pdt_04035_han2
end type
type p_addrow from uo_picture within w_pdt_04035_han2
end type
type p_delrow from uo_picture within w_pdt_04035_han2
end type
type dw_print from datawindow within w_pdt_04035_han2
end type
type cbx_1 from checkbox within w_pdt_04035_han2
end type
type dw_imhist_in from datawindow within w_pdt_04035_han2
end type
type rb_delete from radiobutton within w_pdt_04035_han2
end type
type rb_insert from radiobutton within w_pdt_04035_han2
end type
type dw_imhist from datawindow within w_pdt_04035_han2
end type
type dw_list from datawindow within w_pdt_04035_han2
end type
type gb_2 from groupbox within w_pdt_04035_han2
end type
type rr_1 from roundrectangle within w_pdt_04035_han2
end type
type dw_detail from datawindow within w_pdt_04035_han2
end type
end forward
...
global w_pdt_04035_han2 w_pdt_04035_han2
...
//			end if
			...
			dw_imHist_in.SetItem(lRowHist_in, "facgbn", '.')  //공장 필수(조회조건) - Null 허용 안됨.
...
sArg_sdate = dw_detail.getitemstring(1,'jpno')
if dw_print.retrieve(gs_sabu, sArg_sDate, sArg_sDate, gs_saupj) > 0 then
...
integer height = 104
boolean titlebar = true
string title = "직접출고 출력 - d_pdt_04035_02_p(BACK)"
string dataobject = "d_pdt_04035_02_p1"
boolean livescroll = true
borderstyle borderstyle = stylelowered!
end type
...
integer height = 1872
integer taborder = 30
string dataobject = "d_pdt_04035_han2_1"
boolean hscrollbar = true
boolean vscrollbar = true
...
integer height = 312
integer taborder = 10
string dataobject = "d_pdt_04035_han2"
boolean border = false
boolean livescroll = true
end type
