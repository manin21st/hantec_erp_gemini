$PBExportHeader$w_pdt_04035_back.srw
$PBExportComments$출고등록(직접출고)
forward
global type w_pdt_04035_back from window
end type
type pb_1 from picturebutton within w_pdt_04035_back
end type
type p_3 from picture within w_pdt_04035_back
end type
type dw_prt from datawindow within w_pdt_04035_back
end type
type cbx_2 from checkbox within w_pdt_04035_back
end type
type dw_hidden from datawindow within w_pdt_04035_back
end type
type p_print from uo_picture within w_pdt_04035_back
end type
type p_2 from uo_picture within w_pdt_04035_back
end type
type p_1 from uo_picture within w_pdt_04035_back
end type
type p_retrieve from uo_picture within w_pdt_04035_back
end type
type p_save from uo_picture within w_pdt_04035_back
end type
type p_delete from uo_picture within w_pdt_04035_back
end type
type p_cancel from uo_picture within w_pdt_04035_back
end type
type p_exit from uo_picture within w_pdt_04035_back
end type
type p_addrow from uo_picture within w_pdt_04035_back
end type
type p_delrow from uo_picture within w_pdt_04035_back
end type
type dw_print from datawindow within w_pdt_04035_back
end type
type cbx_1 from checkbox within w_pdt_04035_back
end type
type dw_imhist_in from datawindow within w_pdt_04035_back
end type
type rb_delete from radiobutton within w_pdt_04035_back
end type
type rb_insert from radiobutton within w_pdt_04035_back
end type
type dw_imhist from datawindow within w_pdt_04035_back
end type
type dw_list from datawindow within w_pdt_04035_back
end type
type gb_2 from groupbox within w_pdt_04035_back
end type
type rr_1 from roundrectangle within w_pdt_04035_back
end type
type dw_detail from datawindow within w_pdt_04035_back
end type
end forward
...
global w_pdt_04035_back w_pdt_04035_back
...
event ue_keydown;messagebox('a', 'a')
end event
...
FOR	lRow = 1		TO		dw_list.RowCount()
	...
	IF abs(dOutQty) > 0		THEN
		...
		*/
		...
		dw_imhist.SetItem(lRowHist, "io_empno",'')			// 수불승인자=담당자	
...
event key;//messagebox('1', '1')

messagebox('1', String(key))
messagebox('2', keyflags)
