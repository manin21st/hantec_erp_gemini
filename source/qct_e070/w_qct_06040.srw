$PBExportHeader$w_qct_06040.srw
$PBExportComments$계측기 주유실적 등록
forward
global type w_qct_06040 from w_inherite
end type
type dw_1 from datawindow within w_qct_06040
end type
type gb_4 from groupbox within w_qct_06040
end type
type gb_2 from groupbox within w_qct_06040
end type
type gb_3 from groupbox within w_qct_06040
end type
type gb_1 from groupbox within w_qct_06040
end type
type rb_insert from radiobutton within w_qct_06040
end type
type rb_update from radiobutton within w_qct_06040
end type
type st_3 from statictext within w_qct_06040
end type
type st_yymm from statictext within w_qct_06040
end type
end forward

global type w_qct_06040 from w_inherite
integer height = 2392
string title = "계측기 주유실적 등록"
dw_1 dw_1
gb_4 gb_4
gb_2 gb_2
gb_3 gb_3
...
global w_qct_06040 w_qct_06040
...
For i = 1 to lCount
	...
	IF sOption = 'Y' then 
		...
		if IsNull(dSutim) or dSutim <= 0 then
...
type dw_insert from w_inherite`dw_insert within w_qct_06040
integer x = 59
integer y = 248
integer width = 3529
integer height = 1608
integer taborder = 30
string dataobject = "d_qct_06040_02"
boolean vscrollbar = true
boolean border = true
borderstyle borderstyle = stylelowered!
end type

event dw_insert::itemchanged;string sCode, s_nam1, s_nam2, snull, sInspbody, sItnbr, sITdsc, sUnmsr, sdepot_no, sFind, buncd
...
ELSEIF this.GetColumnName() = 'mchno' THEN
   sCode = this.gettext()
	...
	Setitem(lRow, 'mchmst_buncd', buncd) 
	wf_setnull(lRow, 'N')
...
type cb_exit from w_inherite`cb_exit within w_qct_06040
integer y = 1928
end type

type cb_mod from w_inherite`cb_mod within w_qct_06040
integer x = 2162
integer y = 1928
integer taborder = 60
end type
...
type cb_ins from w_inherite`cb_ins within w_qct_06040
integer y = 1928
integer width = 379
integer taborder = 40
string text = "행추가(&A)"
...
event cb_ins::clicked;call super::clicked;Long   ll_row
String  sSidat
...
type cb_del from w_inherite`cb_del within w_qct_06040
integer x = 2514
integer y = 1928
integer taborder = 70
end type

event cb_del::clicked;call super::clicked;int    iseq 
long   lReturnRow, lCount, k
...
type cb_inq from w_inherite`cb_inq within w_qct_06040
integer x = 96
integer y = 1928
integer taborder = 20
end type

event cb_inq::clicked;call super::clicked;String  sSidat, sTodate, ls_wiemp, ls_widpt
...
if ic_status = '1' then //실적 등록시
	...
	if dw_insert.retrieve(gs_sabu, sSidat) <= 0 then
		f_message_chk(50, "")
	end if
   ...
   dw_1.Object.sidat.Background.Color= 79741120
	...
	if dw_insert.retrieve(gs_sabu, sSidat, sTodate, ls_widpt, ls_wiemp) <= 0 then
		f_message_chk(50, "")
	end if
	cb_del.Enabled = true
...
type cb_print from w_inherite`cb_print within w_qct_06040
integer x = 937
integer y = 1928
integer width = 379
string text = "행삭제(&L)"
...
event cb_print::clicked;call super::clicked;Long   lRow
...
type st_1 from w_inherite`st_1 within w_qct_06040
end type

type cb_can from w_inherite`cb_can within w_qct_06040
integer x = 2866
integer y = 1928
integer taborder = 80
end type

event cb_can::clicked;call super::clicked;rb_insert.checked = true
...
type cb_search from w_inherite`cb_search within w_qct_06040
...
type gb_button1 from w_inherite`gb_button1 within w_qct_06040
end type

type gb_button2 from w_inherite`gb_button2 within w_qct_06040
end type
...
string dataobject = "d_qct_06040_01"
...
dw_insert.DataObject = 'd_qct_06040_02'
...
dw_insert.DataObject = 'd_qct_06040_03'
dw_insert.SetTransObject(sqlca)
dw_insert.Reset()
