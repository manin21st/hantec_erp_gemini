$PBExportHeader$w_qct_05030.srw
$PBExportComments$계측기인수등록
forward
global type w_qct_05030 from w_inherite
end type
type gb_3 from groupbox within w_qct_05030
end type
type gb_2 from groupbox within w_qct_05030
end type
type dw_1 from datawindow within w_qct_05030
end type
end forward
...
integer width = 3653
integer height = 2428
string title = "계측기 인수 등록"
gb_3 gb_3
gb_2 gb_2
dw_1 dw_1
end type
global w_qct_05030 w_qct_05030
...
type dw_insert from w_inherite`dw_insert within w_qct_05030
integer x = 41
integer y = 272
integer width = 3543
integer height = 1596
integer taborder = 30
string dataobject = "d_qct_05030_1"
...
type cb_exit from w_inherite`cb_exit within w_qct_05030
integer x = 3214
integer y = 1924
integer taborder = 60
end type

type cb_mod from w_inherite`cb_mod within w_qct_05030
integer x = 2510
integer y = 1924
integer taborder = 40
end type
...
type cb_ins from w_inherite`cb_ins within w_qct_05030
...
type cb_del from w_inherite`cb_del within w_qct_05030
boolean visible = false
integer x = 1143
integer y = 2392
integer taborder = 0
...
type cb_inq from w_inherite`cb_inq within w_qct_05030
integer x = 82
integer y = 1924
integer taborder = 20
end type
...
type cb_print from w_inherite`cb_print within w_qct_05030
boolean visible = false
integer x = 645
integer y = 2324
integer taborder = 0
...
type st_1 from w_inherite`st_1 within w_qct_05030
end type

type cb_can from w_inherite`cb_can within w_qct_05030
integer x = 2862
integer y = 1924
integer taborder = 50
end type
...
type cb_search from w_inherite`cb_search within w_qct_05030
boolean visible = false
integer x = 2619
integer y = 2532
integer taborder = 0
...
type gb_10 from w_inherite`gb_10 within w_qct_05030
integer y = 2076
integer height = 144
integer textsize = -9
...
type gb_button1 from w_inherite`gb_button1 within w_qct_05030
end type

type gb_button2 from w_inherite`gb_button2 within w_qct_05030
end type
...
string dataobject = "d_qct_05030_a"
