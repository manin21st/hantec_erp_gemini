$PBExportHeader$w_pdt_t_00420.srw
$PBExportComments$외주 가공비 지급 현황
forward
global type w_pdt_t_00420 from w_standard_print
end type
type rr_3 from roundrectangle within w_pdt_t_00420
end type
end forward

global type w_pdt_t_00420 from w_standard_print
string title = "외주 가공비 지급 현황"
rr_3 rr_3
end type
global w_pdt_t_00420 w_pdt_t_00420
...
type p_preview from w_standard_print`p_preview within w_pdt_t_00420
end type

type p_exit from w_standard_print`p_exit within w_pdt_t_00420
end type

type p_print from w_standard_print`p_print within w_pdt_t_00420
end type

type p_retrieve from w_standard_print`p_retrieve within w_pdt_t_00420
end type
...
type dw_print from w_standard_print`dw_print within w_pdt_t_00420
integer x = 3744
integer y = 40
string dataobject = "d_pdt_t_00420_p"
end type

type dw_ip from w_standard_print`dw_ip within w_pdt_t_00420
integer x = 37
integer y = 36
integer width = 2770
integer height = 152
...
type dw_list from w_standard_print`dw_list within w_pdt_t_00420
integer x = 59
integer y = 216
integer width = 4539
integer height = 2096
string dataobject = "d_pdt_t_00420_d"
