$PBExportHeader$w_qa06_00070.srw
$PBExportComments$**ISIR 정보 등록_한텍(17.12.04)
forward
global type w_qa06_00070 from w_inherite
end type
type cb_1 from commandbutton within w_qa06_00070
end type
type dw_ip from datawindow within w_qa06_00070
end type
type dw_list from datawindow within w_qa06_00070
end type
type p_1 from picture within w_qa06_00070
end type
type pb_1 from picturebutton within w_qa06_00070
end type
type p_2 from picture within w_qa06_00070
end type
type dw_hidden from datawindow within w_qa06_00070
end type
type rr_3 from roundrectangle within w_qa06_00070
end type
type rr_2 from roundrectangle within w_qa06_00070
end type
type rr_1 from roundrectangle within w_qa06_00070
end type
end forward
...
global w_qa06_00070 w_qa06_00070
...
type dw_insert from w_inherite`dw_insert within w_qa06_00070
integer x = 59
integer y = 1796
integer width = 4453
integer height = 472
...
Choose Case ls_col
	...
	Case "gritu" 
		...
		Select rfna2
		  Into :ls_cvcod
		  From reffpf
		  Where rfcod = '2A' and rfgub = :ls_cod ;
		If sqlca.sqlcode <> 0 Then
			f_message_chk(33, "[공장코드]")
	...
	Case "req_emp"
		If Trim(ls_cod) = '' OR IsNull(ls_cod) Then
			This.SetItem(getrow(), 'reqname', snull)
			Return
		End If
		
		This.SetItem(getrow(), 'reqname', f_get_name5('02', ls_cod, ''))
...
//		gs_code = this.GetText()
	...
	Case 'req_emp'
		...
		open(w_sawon_popup)
		if isnull(gs_code) or gs_code = '' then return
		This.Object.req_emp[ll_row] = gs_code
...
type p_delrow from w_inherite`p_delrow within w_qa06_00070
...
type p_addrow from w_inherite`p_addrow within w_qa06_00070
boolean visible = false
integer x = 5015
integer y = 108
integer taborder = 0
...
type p_search from w_inherite`p_search within w_qa06_00070
boolean visible = false
integer x = 3488
integer y = 3320
integer taborder = 0
...
type p_ins from w_inherite`p_ins within w_qa06_00070
boolean visible = false
integer x = 4009
integer y = 3320
integer taborder = 0
...
type p_exit from w_inherite`p_exit within w_qa06_00070
integer x = 4425
integer y = 36
end type

type p_can from w_inherite`p_can within w_qa06_00070
integer x = 4242
integer y = 36
integer taborder = 60
end type
...
type p_print from w_inherite`p_print within w_qa06_00070
boolean visible = false
integer x = 3662
integer y = 3320
integer taborder = 0
...
type p_inq from w_inherite`p_inq within w_qa06_00070
integer x = 3694
integer y = 36
end type
...
type p_del from w_inherite`p_del within w_qa06_00070
integer x = 4059
integer y = 36
integer taborder = 50
end type
...
Else
	...
	f_message_chk(32, '[ISIR 정보 삭제 실패!]')
	Return
End If
...
type p_mod from w_inherite`p_mod within w_qa06_00070
integer x = 3877
integer y = 36
integer taborder = 40
end type
...
String ls_vnd
ls_vnd = dw_insert.GetItemString(row, 'gritu')
...
type cb_exit from w_inherite`cb_exit within w_qa06_00070
integer x = 2825
integer y = 3292
end type

type cb_mod from w_inherite`cb_mod within w_qa06_00070
integer x = 1783
integer y = 3292
boolean enabled = false
end type

type cb_ins from w_inherite`cb_ins within w_qa06_00070
integer x = 942
integer y = 2344
integer taborder = 90
boolean enabled = false
...
type cb_del from w_inherite`cb_del within w_qa06_00070
integer x = 2130
integer y = 3292
boolean enabled = false
end type

type cb_inq from w_inherite`cb_inq within w_qa06_00070
integer x = 1422
integer y = 3296
end type

type cb_print from w_inherite`cb_print within w_qa06_00070
integer x = 1874
integer y = 2348
boolean enabled = false
end type

type st_1 from w_inherite`st_1 within w_qa06_00070
integer x = 0
integer y = 3520
end type

type cb_can from w_inherite`cb_can within w_qa06_00070
integer x = 2478
integer y = 3292
end type

type cb_search from w_inherite`cb_search within w_qa06_00070
integer x = 1371
integer y = 2348
boolean enabled = false
end type

type dw_datetime from w_inherite`dw_datetime within w_qa06_00070
integer x = 2843
integer y = 3520
end type

type sle_msg from w_inherite`sle_msg within w_qa06_00070
integer x = 352
integer y = 3520
end type

type gb_10 from w_inherite`gb_10 within w_qa06_00070
integer y = 3488
integer height = 140
integer textsize = -8
...
type gb_button1 from w_inherite`gb_button1 within w_qa06_00070
end type

type gb_button2 from w_inherite`gb_button2 within w_qa06_00070
end type
...
integer taborder = 90
string title = "none"
string dataobject = "d_qa06_00070_0"
boolean border = false
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_qa06_00070_1"
