$PBExportHeader$w_qa06_00020.srw
$PBExportComments$**시험/측정결과 등록_한텍(17.08.24)
forward
global type w_qa06_00020 from w_inherite
end type
type cb_1 from commandbutton within w_qa06_00020
end type
type dw_ip from datawindow within w_qa06_00020
end type
type dw_list from datawindow within w_qa06_00020
end type
type p_1 from picture within w_qa06_00020
end type
type pb_1 from picturebutton within w_qa06_00020
end type
type p_2 from picture within w_qa06_00020
end type
type dw_hidden from datawindow within w_qa06_00020
end type
type rr_3 from roundrectangle within w_qa06_00020
end type
type rr_2 from roundrectangle within w_qa06_00020
end type
type rr_1 from roundrectangle within w_qa06_00020
end type
end forward
...
global w_qa06_00020 w_qa06_00020
...
type dw_insert from w_inherite`dw_insert within w_qa06_00020
integer x = 55
integer y = 1320
integer width = 4489
integer height = 976
integer taborder = 20
string dataobject = "d_qa06_00020_3"
...
type p_delrow from w_inherite`p_delrow within w_qa06_00020
...
type p_addrow from w_inherite`p_addrow within w_qa06_00020
boolean visible = false
integer x = 5015
integer y = 108
integer taborder = 0
...
type p_search from w_inherite`p_search within w_qa06_00020
boolean visible = false
integer x = 3488
integer y = 3320
integer taborder = 0
...
type p_ins from w_inherite`p_ins within w_qa06_00020
boolean visible = false
integer x = 4009
integer y = 3320
integer taborder = 0
...
type p_exit from w_inherite`p_exit within w_qa06_00020
integer x = 4398
integer y = 72
end type

type p_can from w_inherite`p_can within w_qa06_00020
integer x = 4224
integer y = 72
integer taborder = 60
end type
...
type p_print from w_inherite`p_print within w_qa06_00020
boolean visible = false
integer x = 3662
integer y = 3320
integer taborder = 0
...
type p_inq from w_inherite`p_inq within w_qa06_00020
integer x = 3867
integer y = 72
end type
...
type p_del from w_inherite`p_del within w_qa06_00020
boolean visible = false
integer x = 4745
integer y = 448
integer taborder = 50
...
type p_mod from w_inherite`p_mod within w_qa06_00020
integer x = 4046
integer y = 72
integer taborder = 40
end type
...
String ls_date
ls_date = dw_insert.GetItemString(row, 'mesrst_plndat')
If Trim(ls_date) = '' OR IsNull(ls_date) Then
	f_message_chk(1400, '[계획일자]')
	dw_insert.SetColumn('mesrst_plndat')
	dw_insert.SetFocus()
	Return
End If
...
// 완료일자로 상태 기록
String ls_wadate
ls_wadate = dw_insert.GetItemString(row, 'mesrst_wadat')
If Trim(ls_wadate) = '' OR IsNull(ls_wadate) Then
	dw_insert.SetItem(row, 'mesrst_ests', 'N' )
Else
	dw_insert.SetItem(row, 'mesrst_ests', 'Y' )
End If
...
type cb_exit from w_inherite`cb_exit within w_qa06_00020
integer x = 2825
integer y = 3292
end type

type cb_mod from w_inherite`cb_mod within w_qa06_00020
integer x = 1783
integer y = 3292
boolean enabled = false
end type

type cb_ins from w_inherite`cb_ins within w_qa06_00020
integer x = 942
integer y = 2344
integer taborder = 90
boolean enabled = false
...
type cb_del from w_inherite`cb_del within w_qa06_00020
integer x = 2130
integer y = 3292
boolean enabled = false
end type

type cb_inq from w_inherite`cb_inq within w_qa06_00020
integer x = 1422
integer y = 3296
end type

type cb_print from w_inherite`cb_print within w_qa06_00020
integer x = 1874
integer y = 2348
boolean enabled = false
end type

type st_1 from w_inherite`st_1 within w_qa06_00020
integer x = 0
integer y = 3520
end type

type cb_can from w_inherite`cb_can within w_qa06_00020
integer x = 2478
integer y = 3292
end type

type cb_search from w_inherite`cb_search within w_qa06_00020
integer x = 1371
integer y = 2348
boolean enabled = false
end type

type dw_datetime from w_inherite`dw_datetime within w_qa06_00020
integer x = 2843
integer y = 3520
end type

type sle_msg from w_inherite`sle_msg within w_qa06_00020
integer x = 352
integer y = 3520
end type

type gb_10 from w_inherite`gb_10 within w_qa06_00020
integer y = 3488
integer height = 140
integer textsize = -8
...
type gb_button1 from w_inherite`gb_button1 within w_qa06_00020
end type

type gb_button2 from w_inherite`gb_button2 within w_qa06_00020
end type
...
integer taborder = 90
string title = "none"
string dataobject = "d_qa06_00020_1"
boolean border = false
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_qa06_00020_2"
