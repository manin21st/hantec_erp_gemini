$PBExportHeader$w_mm03_00030_popup.srw
$PBExportComments$** 자재실사 등록/조정 사유 팝업
forward
global type w_mm03_00030_popup from window
end type
type p_1 from uo_picture within w_mm03_00030_popup
end type
type p_2 from uo_picture within w_mm03_00030_popup
end type
type dw_detail from datawindow within w_mm03_00030_popup
end type
end forward
...
global w_mm03_00030_popup w_mm03_00030_popup

type variables

end variables

on w_mm03_00030_popup.create
this.p_1=create p_1
this.p_2=create p_2
...
on w_mm03_00030_popup.destroy
destroy(this.p_1)
destroy(this.p_2)
destroy(this.dw_detail)
end on

event open;string sname
...
integer height = 628
integer taborder = 10
string dataobject = "d_mm03_00030_popup"
