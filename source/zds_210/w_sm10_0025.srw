$PBExportHeader$w_sm10_0025.srw
$PBExportComments$영업 관리품번 등록
forward
global type w_sm10_0025 from w_inherite
end type
type dw_1 from datawindow within w_sm10_0025
end type
type dw_list from datawindow within w_sm10_0025
end type
type p_2 from uo_picture within w_sm10_0025
end type
type rb_1 from radiobutton within w_sm10_0025
end type
type rb_2 from radiobutton within w_sm10_0025
end type
type p_excel from uo_picture within w_sm10_0025
end type
type dw_excel from datawindow within w_sm10_0025
end type
type gb_1 from groupbox within w_sm10_0025
end type
type rr_1 from roundrectangle within w_sm10_0025
end type
type rr_2 from roundrectangle within w_sm10_0025
end type
end forward
...
global w_sm10_0025 w_sm10_0025
...
this.Control[iCurrent+6]=this.p_excel
...
type dw_insert from w_inherite`dw_insert within w_sm10_0025
integer x = 1531
integer y = 208
integer width = 3058
integer height = 2032
string dataobject = "d_sm10_0025_b2"
...
type p_delrow from w_inherite`p_delrow within w_sm10_0025
boolean visible = false
end type

type p_addrow from w_inherite`p_addrow within w_sm10_0025
boolean visible = false
end type

type p_search from w_inherite`p_search within w_sm10_0025
boolean visible = false
end type

type p_ins from w_inherite`p_ins within w_sm10_0025
integer x = 3922
end type
...
ElseIf rb_2.Checked Then
	If is_cvcod = '' Or isNull(is_cvcod) Then
		MessageBox('확인','거래처를 선택 후 품번-관리품번을 추가할 수 있습니다.')
		Return
	End If
	...
	dw_insert.SetFocus()
	dw_insert.ScrollToRow(ll_row)
	dw_insert.Object.cvcod[ll_row] = is_cvcod
...
type p_exit from w_inherite`p_exit within w_sm10_0025
end type
...
type p_can from w_inherite`p_can within w_sm10_0025
end type
...
type p_print from w_inherite`p_print within w_sm10_0025
boolean visible = false
end type

type p_inq from w_inherite`p_inq within w_sm10_0025
integer x = 3575
end type
...
type p_del from w_inherite`p_del within w_sm10_0025
end type

event p_del::clicked;call super::clicked;String ls_new , ls_cvcod  , ls_itnbr
...
For i = ll_r To 1 Step -1
	...
	If dw_insert.IsSelected(i) Then
		...
		If ls_new = 'N' Then
			...
			Delete From itmbuy Where cvcod = :ls_cvcod 
										and itnbr = :ls_itnbr
										and seqno = 1 ;
...
type p_mod from w_inherite`p_mod within w_sm10_0025
integer x = 3749
end type

event p_mod::clicked;call super::clicked;Long i , ll_r , ll_cnt=0 ,ll_cnt2 = 0 ,ll_rtn=0  , ll_f ,ii
String ls_new ,ls_null , ls_itnbr ,ls_bunbr,ls,ls_cvcod,ls_chek
...
For i = 1 To ll_r
	...
	If ls_new = 'Y' Then
		...
		ii = i + 1
		If ii < ll_r Then
			ll_f = dw_insert.Find("cvcod = '"+ls_cvcod+"' and itnbr='"+ls_itnbr+"' and bunbr='"+ls_bunbr+"'", ii, ll_r )
...
type cb_exit from w_inherite`cb_exit within w_sm10_0025
end type

type cb_mod from w_inherite`cb_mod within w_sm10_0025
end type

type cb_ins from w_inherite`cb_ins within w_sm10_0025
end type

type cb_del from w_inherite`cb_del within w_sm10_0025
end type

type cb_inq from w_inherite`cb_inq within w_sm10_0025
end type

type cb_print from w_inherite`cb_print within w_sm10_0025
end type

type st_1 from w_inherite`st_1 within w_sm10_0025
end type

type cb_can from w_inherite`cb_can within w_sm10_0025
end type

type cb_search from w_inherite`cb_search within w_sm10_0025
end type
...
type gb_button1 from w_inherite`gb_button1 within w_sm10_0025
end type

type gb_button2 from w_inherite`gb_button2 within w_sm10_0025
end type
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_sm10_0025_a2"
boolean hscrollbar = true
boolean vscrollbar = true
boolean border = false
boolean hsplitscroll = true
...
ELSE
	...
	ElseIf rb_2.Checked Then
		...
		is_cvcod = Trim(This.Object.cvcod[row])
		dw_insert.Retrieve( is_cvcod)
