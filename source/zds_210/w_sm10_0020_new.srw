$PBExportHeader$w_sm10_0020_new.srw
$PBExportComments$품번조회수정-NEW
forward
global type w_sm10_0020_new from w_inherite
end type
type dw_1 from datawindow within w_sm10_0020_new
end type
type p_excel from uo_picture within w_sm10_0020_new
end type
type rr_1 from roundrectangle within w_sm10_0020_new
end type
end forward
...
integer width = 4649
integer height = 2460
string title = "품번마스타 수정-NEW"
dw_1 dw_1
p_excel p_excel
rr_1 rr_1
end type
global w_sm10_0020_new w_sm10_0020_new
...
type dw_insert from w_inherite`dw_insert within w_sm10_0020_new
integer x = 37
integer y = 264
integer width = 4562
integer height = 1996
integer taborder = 10
string dataobject = "d_sm10_0020_new_2"
...
type p_delrow from w_inherite`p_delrow within w_sm10_0020_new
...
type p_addrow from w_inherite`p_addrow within w_sm10_0020_new
boolean visible = false
integer x = 2871
integer y = 16
integer width = 174
...
type p_search from w_inherite`p_search within w_sm10_0020_new
boolean visible = false
integer x = 1792
integer taborder = 0
...
type p_ins from w_inherite`p_ins within w_sm10_0020_new
integer x = 3922
integer taborder = 0
end type

event p_ins::clicked;call super::clicked;String ls_factory, ls_cvcod, ls_cvnas

dw_1.AcceptText() 

ls_factory = Trim(dw_1.Object.factory[1])
If ls_factory = '' Or ls_factory = '.' Or isNull(ls_factory) Then
...
dw_insert.SetItem(ll_r, 'factory', ls_factory)
dw_insert.SetItem(ll_r, 'cvcod', ls_cvcod)
dw_insert.SetItem(ll_r, 'vndmst_cvnas', ls_cvnas)
...
type p_exit from w_inherite`p_exit within w_sm10_0020_new
integer taborder = 0
end type
...
type p_can from w_inherite`p_can within w_sm10_0020_new
integer taborder = 0
end type
...
type p_print from w_inherite`p_print within w_sm10_0020_new
boolean visible = false
integer taborder = 0
end type

type p_inq from w_inherite`p_inq within w_sm10_0020_new
integer x = 3401
integer taborder = 0
end type

event p_inq::clicked;call super::clicked;String ls_saupj , ls_itnbr ,ls_factory
...
dw_insert.SetRedraw(False)
If dw_insert.Retrieve(ls_itnbr, ls_factory) > 0 Then
...
type p_del from w_inherite`p_del within w_sm10_0020_new
integer taborder = 0
end type
...
type p_mod from w_inherite`p_mod within w_sm10_0020_new
integer x = 3749
integer taborder = 0
end type

event p_mod::clicked;call super::clicked;string ls_cvcod , ls_itnbr ,ls_mulgbn , ls_mdepot, ls_factory
Long i 
...
For i = 1 To dw_insert.Rowcount()
	...
	Else
		...
		If l_status = New! OR l_status = NewModified! Then
			...
			If ll_chk > 0 Then
				MessageBox('등록 된 품번', '"' + ls_itnbr + '"' + ' 품번은 이미 등록된 품번 입니다.~r~n~n "품목마스터 등록" 화면에서 사용중지(단종) 여부를 확인 하십시오.')
				Return
			End If
		End If
	End If
...
type cb_exit from w_inherite`cb_exit within w_sm10_0020_new
end type

type cb_mod from w_inherite`cb_mod within w_sm10_0020_new
end type

type cb_ins from w_inherite`cb_ins within w_sm10_0020_new
end type

type cb_del from w_inherite`cb_del within w_sm10_0020_new
end type

type cb_inq from w_inherite`cb_inq within w_sm10_0020_new
end type

type cb_print from w_inherite`cb_print within w_sm10_0020_new
end type

type st_1 from w_inherite`st_1 within w_sm10_0020_new
end type

type cb_can from w_inherite`cb_can within w_sm10_0020_new
end type

type cb_search from w_inherite`cb_search within w_sm10_0020_new
end type
...
type gb_button1 from w_inherite`gb_button1 within w_sm10_0020_new
end type

type gb_button2 from w_inherite`gb_button2 within w_sm10_0020_new
end type
...
string title = "none"
string dataobject = "d_sm10_0020_new_1"
boolean border = false
