$PBExportHeader$w_sm10_0010.srw
$PBExportComments$참조코드 등록(영업용)
forward
global type w_sm10_0010 from w_inherite
end type
type rb_1 from radiobutton within w_sm10_0010
end type
type cbx_account from checkbox within w_sm10_0010
end type
type dw_detail from u_key_enter within w_sm10_0010
end type
type dw_remark from datawindow within w_sm10_0010
end type
type dw_list from u_d_popup_sort within w_sm10_0010
end type
type cbx_1 from checkbox within w_sm10_0010
end type
type rb_2 from radiobutton within w_sm10_0010
end type
type rb_3 from radiobutton within w_sm10_0010
end type
type gb_1 from groupbox within w_sm10_0010
end type
type rr_1 from roundrectangle within w_sm10_0010
end type
type rr_2 from roundrectangle within w_sm10_0010
end type
type rr_3 from roundrectangle within w_sm10_0010
end type
type rr_4 from roundrectangle within w_sm10_0010
end type
end forward
...
global w_sm10_0010 w_sm10_0010
...
type dw_insert from w_inherite`dw_insert within w_sm10_0010
...
type p_delrow from w_inherite`p_delrow within w_sm10_0010
boolean visible = false
integer x = 2560
integer y = 2344
integer taborder = 0
...
type p_addrow from w_inherite`p_addrow within w_sm10_0010
boolean visible = false
integer x = 2386
integer y = 2344
integer taborder = 0
...
type p_search from w_inherite`p_search within w_sm10_0010
boolean visible = false
integer x = 2907
integer y = 2344
integer taborder = 0
...
type p_ins from w_inherite`p_ins within w_sm10_0010
integer x = 3479
boolean originalsize = true
end type

event p_ins::clicked;call super::clicked;String ls_rfcod
...
type p_exit from w_inherite`p_exit within w_sm10_0010
integer x = 4174
integer taborder = 110
boolean originalsize = true
end type

type p_can from w_inherite`p_can within w_sm10_0010
integer x = 4000
...
type p_print from w_inherite`p_print within w_sm10_0010
boolean visible = false
integer x = 3086
integer y = 2340
integer taborder = 0
...
type p_inq from w_inherite`p_inq within w_sm10_0010
boolean visible = false
integer x = 2734
integer y = 2344
integer taborder = 0
...
type p_del from w_inherite`p_del within w_sm10_0010
integer x = 3826
integer taborder = 80
boolean originalsize = true
end type

event p_del::clicked;call super::clicked;String ls_rfcod

ls_rfcod = Trim(Dw_detail.GetItemString(1,"rfcod"))
...
type p_mod from w_inherite`p_mod within w_sm10_0010
integer x = 3653
integer taborder = 60
boolean originalsize = true
end type
...
string   ls_rfcod, ls_rfgub, ls_rfna2
...
IF ls_rfcod = '01' then
	dw_detail.accepttext()	
	FOR i = 1 TO dw_detail.RowCount()
		ls_rfna2 = Trim(Dw_detail.GetItemString(i,"rfna2"))
		ls_rfgub = Trim(Dw_detail.GetItemString(i,"rfgub"))
		
		UPDATE REFFPF 
			SET rfna2   = :ls_rfna2
			where rfcod = :ls_rfcod
 			  and rfgub = :ls_rfgub;
	NEXT
Else
		IF dw_detail.Update() <> 1 THEN
...
type cb_exit from w_inherite`cb_exit within w_sm10_0010
integer x = 3433
integer y = 2684
integer taborder = 120
end type

type cb_mod from w_inherite`cb_mod within w_sm10_0010
integer x = 2350
integer y = 2684
integer taborder = 70
end type

type cb_ins from w_inherite`cb_ins within w_sm10_0010
integer x = 379
integer y = 2684
integer taborder = 50
string text = "추가(&A)"
...
type cb_del from w_inherite`cb_del within w_sm10_0010
integer x = 2711
integer y = 2684
integer taborder = 90
end type

type cb_inq from w_inherite`cb_inq within w_sm10_0010
integer x = 987
integer y = 2688
end type

type cb_print from w_inherite`cb_print within w_sm10_0010
integer x = 1353
integer y = 2692
end type

type st_1 from w_inherite`st_1 within w_sm10_0010
end type

type cb_can from w_inherite`cb_can within w_sm10_0010
integer x = 3072
integer y = 2684
end type

type cb_search from w_inherite`cb_search within w_sm10_0010
integer x = 1723
integer y = 2696
end type
...
type gb_button1 from w_inherite`gb_button1 within w_sm10_0010
integer x = 334
integer y = 2628
integer width = 421
end type

type gb_button2 from w_inherite`gb_button2 within w_sm10_0010
integer x = 2318
integer y = 2628
end type
...
integer taborder = 30
boolean bringtotop = true
string dataobject = "d_sm10_0010_b"
...
integer height = 1972
integer taborder = 10
string dataobject = "d_sm10_0010_a"
boolean vscrollbar = true
boolean border = false
end type
...
event clicked;dw_detail.DataObject = 'd_sm10_0010_b'
...
long textcolor = 33554432
long backcolor = 32106727
string text = "관리항목 4,5,6"
end type

event clicked;dw_detail.DataObject = 'd_sm10_0010_b2'
dw_detail.SetTransObject(SQLCA)
