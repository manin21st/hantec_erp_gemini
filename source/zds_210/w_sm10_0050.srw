...
type rr_1 from roundrectangle within w_sm10_0050
end type
type dw_1 from datawindow within w_sm10_0050
end type
type pb_1 from u_pb_cal within w_sm10_0050
end type
type pb_2 from u_pb_cal within w_sm10_0050
end type
...
public function string wf_choose (string as_gubun);Choose Case as_gubun
	Case '1'
		...
		If rb_2.Checked Then
			dw_1.Modify("t_hi.visible = 1 ")
			dw_1.Modify("jisi_date.visible = 1")
			dw_1.Modify("jisi_date2.visible = 1")
			dw_1.Modify("jisi_mon.visible = 0")
	...
	Case '2'
		...
		dw_insert.SetTransObject(SQLCA)
		If rb_2.Checked Then
			dw_1.Modify("t_hi.visible = 0 ")
			dw_1.Modify("jisi_date.visible = 0")
			dw_1.Modify("jisi_date2.visible = 0")
			dw_1.Modify("jisi_mon.visible = 1")
			pb_1.visible = False
			pb_2.visible = False
		End If
...
dw_1.Object.jisi_mon[1] = Left(is_today,6)
...
Else
	...
	ls_ymd = Trim(dw_1.Object.jisi_mon[1])
