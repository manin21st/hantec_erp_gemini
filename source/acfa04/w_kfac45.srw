$PBExportHeader$w_kfac45.srw
$PBExportComments$감가상각비조정명세서(정율법-집계)
forward
global type w_kfac45 from w_standard_print
end type
type st_wait from statictext within w_kfac45
end type
type rr_1 from roundrectangle within w_kfac45
end type
end forward
...
type p_xls from w_standard_print`p_xls within w_kfac45
end type

type p_sort from w_standard_print`p_sort within w_kfac45
end type

type p_preview from w_standard_print`p_preview within w_kfac45
...
type p_exit from w_standard_print`p_exit within w_kfac45
integer taborder = 0
end type

type p_print from w_standard_print`p_print within w_kfac45
integer taborder = 0
end type

type p_retrieve from w_standard_print`p_retrieve within w_kfac45
integer x = 4096
integer taborder = 0
end type
...
type st_10 from w_standard_print`st_10 within w_kfac45
end type



type dw_print from w_standard_print`dw_print within w_kfac45
string dataobject = "dw_kfac45_2"
end type

type dw_ip from w_standard_print`dw_ip within w_kfac45
integer x = 37
integer y = 20
integer width = 3698
integer height = 164
integer taborder = 0
string dataobject = "dw_kfac45_1"
end type
...
IF dwo.name ="kfcod1" THEN
	...
	IF data = "1" THEN       //정율법 상각부인액//
		dw_list.DataObject ="dw_kfac45_2"
	ELSEif data = "2" THEN   //정율법 시인부족액//
		dw_list.DataObject ="dw_kfac45_3"
	else                     //전체//
		dw_list.DataObject ="dw_kfac45_4"
	END IF
...
type dw_list from w_standard_print`dw_list within w_kfac45
integer x = 64
integer y = 196
integer width = 4526
integer height = 1992
