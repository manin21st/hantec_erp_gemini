$PBExportHeader$w_kfac27.srw
$PBExportComments$감가상각비조정명세서(정액법-집계)
forward
global type w_kfac27 from w_standard_print
end type
type st_wait from statictext within w_kfac27
end type
type rr_1 from roundrectangle within w_kfac27
end type
end forward
...
type p_xls from w_standard_print`p_xls within w_kfac27
end type

type p_sort from w_standard_print`p_sort within w_kfac27
end type

type p_preview from w_standard_print`p_preview within w_kfac27
...
type p_exit from w_standard_print`p_exit within w_kfac27
integer x = 4439
integer y = 20
integer taborder = 0
end type

type p_print from w_standard_print`p_print within w_kfac27
integer x = 4265
integer y = 20
integer taborder = 0
end type

type p_retrieve from w_standard_print`p_retrieve within w_kfac27
integer x = 4091
integer y = 20
integer taborder = 0
end type
...
type st_10 from w_standard_print`st_10 within w_kfac27
end type



type dw_print from w_standard_print`dw_print within w_kfac27
string dataobject = "dw_kfac27_2"
end type

type dw_ip from w_standard_print`dw_ip within w_kfac27
integer x = 32
integer y = 20
integer width = 3712
integer height = 156
...
IF dwo.name ="kfcod1" THEN
	...
	IF data = "1" THEN      //정액법 상각부인액//
		dw_list.DataObject ="dw_kfac27_2"
	ELSEif data = "2" THEN  //정액법 시인부족액//
		dw_list.DataObject ="dw_kfac27_3"
	else                    //전체//
		dw_list.DataObject ="dw_kfac27_4"		
	END IF
...
type dw_list from w_standard_print`dw_list within w_kfac27
integer x = 64
integer y = 196
integer width = 4512
integer height = 1996
