$PBExportHeader$w_kfad52.srw
$PBExportComments$감가상각집계표 조회 출력
forward
global type w_kfad52 from w_standard_print
end type
type st_wait from statictext within w_kfad52
end type
type rr_1 from roundrectangle within w_kfad52
end type
end forward
...
integer x = 0
integer y = 0
string title = "감가상각집계표 조회 출력"
st_wait st_wait
rr_1 rr_1
end type
global w_kfad52 w_kfad52
...
type p_preview from w_standard_print`p_preview within w_kfad52
integer y = 0
end type

type p_exit from w_standard_print`p_exit within w_kfad52
integer y = 0
end type

type p_print from w_standard_print`p_print within w_kfad52
integer y = 0
end type

type p_retrieve from w_standard_print`p_retrieve within w_kfad52
integer y = 0
end type
...
type st_10 from w_standard_print`st_10 within w_kfad52
end type



type dw_print from w_standard_print`dw_print within w_kfad52
string dataobject = "dw_kfad202_p"
end type

type dw_ip from w_standard_print`dw_ip within w_kfad52
integer x = 27
integer y = 20
integer width = 2130
integer height = 116
string dataobject = "dw_kfad521"
end type
...
type dw_list from w_standard_print`dw_list within w_kfad52
integer x = 41
integer y = 164
integer width = 4571
integer height = 2032
string dataobject = "dw_kfad522"
