$PBExportHeader$w_kfac20.srw
$PBExportComments$감가상각비조정명세서(정액법)
forward
global type w_kfac20 from w_standard_print
end type
type st_wait from statictext within w_kfac20
end type
type rr_1 from roundrectangle within w_kfac20
end type
end forward
...
integer x = 0
integer y = 0
string title = "감가상각비 조정명세서(정액법)"
st_wait st_wait
rr_1 rr_1
end type
global w_kfac20 w_kfac20
...
type p_xls from w_standard_print`p_xls within w_kfac20
end type

type p_sort from w_standard_print`p_sort within w_kfac20
end type

type p_preview from w_standard_print`p_preview within w_kfac20
...
type p_exit from w_standard_print`p_exit within w_kfac20
integer x = 4434
integer y = 12
integer taborder = 0
end type

type p_print from w_standard_print`p_print within w_kfac20
integer x = 4261
integer y = 12
integer taborder = 0
end type

type p_retrieve from w_standard_print`p_retrieve within w_kfac20
integer x = 4087
integer y = 12
integer taborder = 0
end type
...
type st_10 from w_standard_print`st_10 within w_kfac20
end type



type dw_print from w_standard_print`dw_print within w_kfac20
string dataobject = "dw_kfac20_2"
end type

type dw_ip from w_standard_print`dw_ip within w_kfac20
integer x = 27
integer width = 3707
integer height = 164
integer taborder = 0
string dataobject = "dw_kfac20_1"
end type
...
IF dwo.name ="kfcod1" THEN
	...
	IF data = "1" THEN      //정액법 상각부인액//
		dw_list.DataObject ="dw_kfac20_2"
		dw_print.DataObject ="dw_kfac20_2"
	ELSEif data = "2" THEN  //정액법 시인부족액//
		dw_list.DataObject ="dw_kfac20_3"
		dw_print.DataObject ="dw_kfac20_3"
	else                    //전체//
		dw_list.DataObject ="dw_kfac20_4"
		dw_print.DataObject ="dw_kfac20_4"
	END IF
...
type dw_list from w_standard_print`dw_list within w_kfac20
integer x = 64
integer y = 196
integer width = 4530
integer height = 2004
