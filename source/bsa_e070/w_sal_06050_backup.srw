$PBExportHeader$w_sal_06050_backup.srw
$PBExportComments$C/I 등록
forward
global type w_sal_06050_backup from w_inherite
end type
type tab_1 from tab within w_sal_06050_backup
end type
...
type dw_key from datawindow within w_sal_06050_backup
end type
type rb_new from radiobutton within w_sal_06050_backup
end type
type rb_upd from radiobutton within w_sal_06050_backup
end type
type pb_1 from u_pb_cal within w_sal_06050_backup
end type
type rr_1 from roundrectangle within w_sal_06050_backup
end type
end forward
...
global w_sal_06050_backup w_sal_06050_backup
...
type dw_insert from w_inherite`dw_insert within w_sal_06050_backup
...
type p_delrow from w_inherite`p_delrow within w_sal_06050_backup
boolean visible = false
integer x = 3863
integer y = 2444
...
type p_addrow from w_inherite`p_addrow within w_sal_06050_backup
boolean visible = false
integer x = 3689
integer y = 2444
boolean enabled = false
...
type p_search from w_inherite`p_search within w_sal_06050_backup
boolean visible = false
integer x = 3758
integer y = 2444
boolean enabled = false
...
type p_ins from w_inherite`p_ins within w_sal_06050_backup
integer x = 3749
integer y = 16
end type
...
type p_exit from w_inherite`p_exit within w_sal_06050_backup
integer y = 16
end type

type p_can from w_inherite`p_can within w_sal_06050_backup
integer y = 16
end type
...
type p_print from w_inherite`p_print within w_sal_06050_backup
boolean visible = false
integer x = 3931
integer y = 2444
boolean enabled = false
...
type p_inq from w_inherite`p_inq within w_sal_06050_backup
integer x = 3575
integer y = 16
end type
...
type p_del from w_inherite`p_del within w_sal_06050_backup
integer y = 16
end type
...
type p_mod from w_inherite`p_mod within w_sal_06050_backup
integer y = 16
end type
...
type cb_exit from w_inherite`cb_exit within w_sal_06050_backup
end type

type cb_mod from w_inherite`cb_mod within w_sal_06050_backup
end type

type cb_ins from w_inherite`cb_ins within w_sal_06050_backup
end type

type cb_del from w_inherite`cb_del within w_sal_06050_backup
end type

type cb_inq from w_inherite`cb_inq within w_sal_06050_backup
end type

type cb_print from w_inherite`cb_print within w_sal_06050_backup
integer x = 1367
integer y = 2440
integer width = 498
boolean enabled = false
...
type st_1 from w_inherite`st_1 within w_sal_06050_backup
end type

type cb_can from w_inherite`cb_can within w_sal_06050_backup
end type

type cb_search from w_inherite`cb_search within w_sal_06050_backup
integer x = 1413
integer y = 2376
integer width = 498
integer taborder = 50
...
type gb_button1 from w_inherite`gb_button1 within w_sal_06050_backup
end type

type gb_button2 from w_inherite`gb_button2 within w_sal_06050_backup
end type
...
//여기서부터  
	If sCvcod= '205005' then
		messagebox('','미쯔비시후소')
//		tab_1.tabpage_3.t_30.visible = true
	else 
		messagebox('','그외')
//		tab_1.tabpage_3.t_29.visible = true
	end if 
