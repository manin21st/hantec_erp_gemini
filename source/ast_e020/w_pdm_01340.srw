$PBExportHeader$w_pdm_01340.srw
$PBExportComments$품목정보 변경(영업)
forward
global type w_pdm_01340 from w_inherite
end type
type gb_3 from groupbox within w_pdm_01340
end type
type gb_2 from groupbox within w_pdm_01340
end type
type dw_1 from datawindow within w_pdm_01340
end type
type dw_2 from u_d_popup_sort within w_pdm_01340
end type
type cbx_1 from checkbox within w_pdm_01340
end type
type dw_3 from uo_multi_select within w_pdm_01340
end type
type p_1 from picture within w_pdm_01340
end type
type rr_1 from roundrectangle within w_pdm_01340
end type
end forward

global type w_pdm_01340 from w_inherite
string title = "품목정보 변경"
gb_3 gb_3
gb_2 gb_2
dw_1 dw_1
dw_2 dw_2
...
global w_pdm_01340 w_pdm_01340
...
type dw_insert from w_inherite`dw_insert within w_pdm_01340
integer x = 471
integer y = 796
integer width = 2295
integer height = 648
...
type p_delrow from w_inherite`p_delrow within w_pdm_01340
...
type p_addrow from w_inherite`p_addrow within w_pdm_01340
boolean visible = false
integer x = 3867
integer y = 2792
integer taborder = 80
...
type p_search from w_inherite`p_search within w_pdm_01340
boolean visible = false
integer x = 3173
integer y = 2792
...
type p_ins from w_inherite`p_ins within w_pdm_01340
boolean visible = false
integer x = 3694
integer y = 2792
integer taborder = 50
...
type p_exit from w_inherite`p_exit within w_pdm_01340
integer taborder = 160
end type

type p_can from w_inherite`p_can within w_pdm_01340
...
type p_print from w_inherite`p_print within w_pdm_01340
boolean visible = false
integer x = 3346
integer y = 2792
...
type p_inq from w_inherite`p_inq within w_pdm_01340
integer x = 3922
end type
...
type p_del from w_inherite`p_del within w_pdm_01340
boolean visible = false
integer x = 4389
integer y = 2792
...
type p_mod from w_inherite`p_mod within w_pdm_01340
integer x = 4096
...
type cb_exit from w_inherite`cb_exit within w_pdm_01340
integer x = 2825
integer y = 2640
integer taborder = 140
end type

type cb_mod from w_inherite`cb_mod within w_pdm_01340
integer x = 2126
integer y = 2640
...
type cb_ins from w_inherite`cb_ins within w_pdm_01340
integer x = 581
integer y = 2816
string text = "추가(&A)"
end type

type cb_del from w_inherite`cb_del within w_pdm_01340
integer x = 1184
integer y = 2736
end type

type cb_inq from w_inherite`cb_inq within w_pdm_01340
integer x = 1641
integer y = 2648
integer width = 329
integer taborder = 60
...
type cb_print from w_inherite`cb_print within w_pdm_01340
integer x = 686
integer y = 2668
boolean enabled = false
end type

type st_1 from w_inherite`st_1 within w_pdm_01340
end type

type cb_can from w_inherite`cb_can within w_pdm_01340
integer x = 2473
integer y = 2640
...
type cb_search from w_inherite`cb_search within w_pdm_01340
integer x = 2661
integer y = 2876
end type
...
type gb_10 from w_inherite`gb_10 within w_pdm_01340
integer y = 2976
integer height = 144
integer textsize = -9
...
type gb_button1 from w_inherite`gb_button1 within w_pdm_01340
end type

type gb_button2 from w_inherite`gb_button2 within w_pdm_01340
end type
		...
		For i = 1 To This.RowCount()
			IF IsSelected(i) Then
				If lb_char Then
					...
					IF this.GetColumnName() = "itemas_useyn"	THEN
						ls_itnbr = this.getitemstring(i, "itemas_itnbr")
						ls_old   = this.getitemstring(i, "itemas_useyn")
						if ls_old = '0' then 
...
Choose Case ls_col
	Case 'itcls'
		If Not IsNull(ls_col) Then
			...
			ls_ittyp = This.GetItemString(row, 'itemas_ittyp')
			...
			If cbx_1.Checked = True Then
				For i = 1 To This.RowCount()
					IF IsSelected(i) Then
						This.SetItem(i, 'itemas_ittyp', lstr_sitnct.s_ittyp)
				...
				SelectRow(0, False)
			Else
				This.SetItem(row, 'itemas_ittyp', lstr_sitnct.s_ittyp)
