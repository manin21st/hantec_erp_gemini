$PBExportHeader$w_imt_04780.srw
$PBExportComments$금형/치공구 회수등록
forward
global type w_imt_04780 from w_inherite
end type
type gb_3 from groupbox within w_imt_04780
end type
type gb_2 from groupbox within w_imt_04780
end type
type dw_1 from datawindow within w_imt_04780
end type
end forward

global type w_imt_04780 from w_inherite
boolean TitleBar=true
string Title="금형/치공구 회수 등록"
gb_3 gb_3
gb_2 gb_2
dw_1 dw_1
end type
global w_imt_04780 w_imt_04780
...
type dw_insert from w_inherite`dw_insert within w_imt_04780
int X=41
int Y=200
int Width=3543
int Height=1664
int TabOrder=30
string DataObject="d_imt_04780_1"
boolean Border=true
...
type cb_exit from w_inherite`cb_exit within w_imt_04780
int X=3214
int Y=1924
int TabOrder=60
end type

type cb_mod from w_inherite`cb_mod within w_imt_04780
int X=2510
int Y=1924
int TabOrder=40
end type
...
type cb_ins from w_inherite`cb_ins within w_imt_04780
int X=539
int Y=2472
int TabOrder=0
...
type cb_del from w_inherite`cb_del within w_imt_04780
int X=1143
int Y=2392
int TabOrder=0
boolean Visible=false
...
type cb_inq from w_inherite`cb_inq within w_imt_04780
int X=82
int Y=1924
int TabOrder=20
end type
...
type cb_print from w_inherite`cb_print within w_imt_04780
int X=645
int Y=2324
int TabOrder=0
boolean Visible=false
...
type cb_can from w_inherite`cb_can within w_imt_04780
int X=2862
int Y=1924
int TabOrder=50
end type
...
type cb_search from w_inherite`cb_search within w_imt_04780
int X=2619
int Y=2532
int TabOrder=0
boolean Visible=false
...
type gb_10 from w_inherite`gb_10 within w_imt_04780
int Y=2076
int Height=144
int TextSize=-9
string FaceName="굴림체"
...
string DataObject="d_imt_04780_a"
