$PBExportHeader$w_pdt_06040.srw
$PBExportComments$비가동 요인 등록
forward
global type w_pdt_06040 from window
end type
type p_exit from uo_picture within w_pdt_06040
end type
type p_can from uo_picture within w_pdt_06040
end type
type p_print from uo_picture within w_pdt_06040
end type
type p_mod from uo_picture within w_pdt_06040
end type
type p_delrow from uo_picture within w_pdt_06040
end type
type p_addrow from uo_picture within w_pdt_06040
end type
type p_inq from uo_picture within w_pdt_06040
end type
type cb_1 from commandbutton within w_pdt_06040
end type
type dw_detail from datawindow within w_pdt_06040
end type
type dw_list from datawindow within w_pdt_06040
end type
type rr_1 from roundrectangle within w_pdt_06040
end type
end forward
...
global w_pdt_06040 w_pdt_06040

type variables
char c_status
string is_key, is_rfcod = '35'
...
//		return -1
//	else
		dw_list.setitem(row_count,'rfna3',is_key)
...
dw_list.setitem(dw_list.rowcount(),'rfna3',is_key)
...
where sabu = :gs_sabu and 
	...
	if row_count = 0 or isnull(row_count) then
		if dw_list.rowcount() <= 0 then
			...
			dw_list.setitem(1,'rfna3',is_key)
			dw_list.setfocus()
		end if
	else
...
integer taborder = 10
string title = "none"
string dataobject = "d_pdt_06040_1"
...
string dataobject = "d_pdt_06040_2"
