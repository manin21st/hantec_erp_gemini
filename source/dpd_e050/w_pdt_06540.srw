$PBExportHeader$w_pdt_06540.srw
$PBExportComments$**정기점검 계획서(년간)
forward
global type w_pdt_06540 from w_standard_print
end type
type rr_1 from roundrectangle within w_pdt_06540
end type
end forward
...
global w_pdt_06540 w_pdt_06540
...
type p_preview from w_standard_print`p_preview within w_pdt_06540
end type

type p_exit from w_standard_print`p_exit within w_pdt_06540
end type

type p_print from w_standard_print`p_print within w_pdt_06540
end type

type p_retrieve from w_standard_print`p_retrieve within w_pdt_06540
end type
...
type st_10 from w_standard_print`st_10 within w_pdt_06540
end type



type dw_print from w_standard_print`dw_print within w_pdt_06540
string dataobject = "d_pdt_06540_02"
end type

type dw_ip from w_standard_print`dw_ip within w_pdt_06540
integer x = 14
integer y = 20
integer width = 1765
integer height = 244
string dataobject = "d_pdt_06540_01"
end type
...
type dw_list from w_standard_print`dw_list within w_pdt_06540
integer x = 32
integer y = 288
integer width = 4571
integer height = 1960
