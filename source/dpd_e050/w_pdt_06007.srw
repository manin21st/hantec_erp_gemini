$PBExportHeader$w_pdt_06007.srw
$PBExportComments$** 설비회수등록
forward
global type w_pdt_06007 from w_inherite
end type
type dw_1 from datawindow within w_pdt_06007
end type
type rr_1 from roundrectangle within w_pdt_06007
end type
end forward

global type w_pdt_06007 from w_inherite
string title = "설비 회수 등록"
dw_1 dw_1
rr_1 rr_1
end type
global w_pdt_06007 w_pdt_06007
...
type dw_insert from w_inherite`dw_insert within w_pdt_06007
integer x = 320
integer y = 488
integer width = 3995
integer height = 1736
integer taborder = 30
string dataobject = "d_pdt_06007_1"
...
type p_delrow from w_inherite`p_delrow within w_pdt_06007
integer y = 5000
end type

type p_addrow from w_inherite`p_addrow within w_pdt_06007
integer y = 5000
end type

type p_search from w_inherite`p_search within w_pdt_06007
integer y = 5000
end type

type p_ins from w_inherite`p_ins within w_pdt_06007
integer y = 5000
end type

type p_exit from w_inherite`p_exit within w_pdt_06007
integer x = 4155
integer y = 312
end type

type p_can from w_inherite`p_can within w_pdt_06007
integer x = 3982
integer y = 312
end type
...
type p_print from w_inherite`p_print within w_pdt_06007
integer y = 5000
end type

type p_inq from w_inherite`p_inq within w_pdt_06007
integer x = 3634
integer y = 312
end type
...
type p_del from w_inherite`p_del within w_pdt_06007
integer y = 5000
end type

type p_mod from w_inherite`p_mod within w_pdt_06007
integer x = 3808
integer y = 312
end type
...
type cb_exit from w_inherite`cb_exit within w_pdt_06007
integer x = 3392
integer y = 5000
integer taborder = 60
end type

type cb_mod from w_inherite`cb_mod within w_pdt_06007
integer x = 2688
integer y = 5000
integer taborder = 40
end type

type cb_ins from w_inherite`cb_ins within w_pdt_06007
...
type cb_del from w_inherite`cb_del within w_pdt_06007
boolean visible = false
integer x = 1143
integer y = 2392
end type

type cb_inq from w_inherite`cb_inq within w_pdt_06007
integer x = 2345
integer y = 5000
integer taborder = 20
end type

type cb_print from w_inherite`cb_print within w_pdt_06007
boolean visible = false
integer x = 645
integer y = 2324
...
type st_1 from w_inherite`st_1 within w_pdt_06007
end type

type cb_can from w_inherite`cb_can within w_pdt_06007
integer x = 3040
integer y = 5000
integer taborder = 50
end type

type cb_search from w_inherite`cb_search within w_pdt_06007
boolean visible = false
integer x = 2619
integer y = 2532
end type
...
type gb_10 from w_inherite`gb_10 within w_pdt_06007
integer y = 5000
integer height = 144
integer textsize = -9
...
type gb_button1 from w_inherite`gb_button1 within w_pdt_06007
end type

type gb_button2 from w_inherite`gb_button2 within w_pdt_06007
end type
...
string dataobject = "d_pdt_06007_a"
boolean border = false
