$PBExportHeader$w_pdt_06500_kum.srw
$PBExportComments$** 금형이력카드
forward
global type w_pdt_06500_kum from w_standard_print
end type
type rr_1 from roundrectangle within w_pdt_06500_kum
end type
end forward

global type w_pdt_06500_kum from w_standard_print
string title = "금형 관리 대장"
rr_1 rr_1
end type
global w_pdt_06500_kum w_pdt_06500_kum
...
on w_pdt_06500_kum.destroy
call super::destroy
if IsValid(MenuID) then destroy(MenuID)
destroy(this.rr_1)
end on

type p_xls from w_standard_print`p_xls within w_pdt_06500_kum
end type

type p_sort from w_standard_print`p_sort within w_pdt_06500_kum
end type

type p_preview from w_standard_print`p_preview within w_pdt_06500_kum
end type

type p_exit from w_standard_print`p_exit within w_pdt_06500_kum
end type

type p_print from w_standard_print`p_print within w_pdt_06500_kum
end type

type p_retrieve from w_standard_print`p_retrieve within w_pdt_06500_kum
end type
...
type st_10 from w_standard_print`st_10 within w_pdt_06500_kum
end type



type dw_print from w_standard_print`dw_print within w_pdt_06500_kum
boolean visible = true
integer x = 46
integer y = 284
integer width = 4567
integer height = 1960
string dataobject = "d_pdt_06500_02_kum"
boolean hscrollbar = true
boolean vscrollbar = true
boolean border = false
end type

type dw_ip from w_standard_print`dw_ip within w_pdt_06500_kum
integer x = 37
integer y = 24
integer width = 1458
integer height = 224
string dataobject = "d_pdt_06500_01_kum"
end type
...
type dw_list from w_standard_print`dw_list within w_pdt_06500_kum
