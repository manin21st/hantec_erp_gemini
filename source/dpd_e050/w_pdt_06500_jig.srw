$PBExportHeader$w_pdt_06500_jig.srw
$PBExportComments$** 치공구이력카드
forward
global type w_pdt_06500_jig from w_standard_print
end type
type rr_1 from roundrectangle within w_pdt_06500_jig
end type
end forward

global type w_pdt_06500_jig from w_standard_print
string title = "치공구 관리대장"
rr_1 rr_1
end type
global w_pdt_06500_jig w_pdt_06500_jig
...
if (IsNull(mchno1) or mchno1 = "") then 
	f_message_chk(50,"[금형 이력 카드-[기본정보]]")
	dw_ip.Setfocus()
	return -1
end if
mchno2 = mchno1
...
on w_pdt_06500_jig.destroy
call super::destroy
if IsValid(MenuID) then destroy(MenuID)
destroy(this.rr_1)
end on

type p_xls from w_standard_print`p_xls within w_pdt_06500_jig
end type

type p_sort from w_standard_print`p_sort within w_pdt_06500_jig
end type

type p_preview from w_standard_print`p_preview within w_pdt_06500_jig
end type

type p_exit from w_standard_print`p_exit within w_pdt_06500_jig
end type

type p_print from w_standard_print`p_print within w_pdt_06500_jig
end type

type p_retrieve from w_standard_print`p_retrieve within w_pdt_06500_jig
end type
...
type st_10 from w_standard_print`st_10 within w_pdt_06500_jig
end type



type dw_print from w_standard_print`dw_print within w_pdt_06500_jig
boolean visible = true
integer x = 46
integer y = 284
integer width = 4567
integer height = 1960
string dataobject = "d_pdt_06500_02_jig"
boolean hscrollbar = true
boolean vscrollbar = true
boolean border = false
end type

type dw_ip from w_standard_print`dw_ip within w_pdt_06500_jig
integer x = 37
integer y = 20
integer width = 1454
integer height = 224
string dataobject = "d_pdt_06500_01_jig"
end type
...
if this.GetColumnName() = "mchno1" then 
	...
	select kumname into :s_nam1 from kummst
...
ElseIf This.GetColumnName() = 'gbn' Then
	This.SetItem(1, 'mchno1', '')
	This.SetItem(1, 'mchnam1', '')
	If data = '1' Then
		dw_print.DataObject = 'd_pdt_06500_02_kum'
	Else
		dw_print.DataObject = 'd_pdt_06500_02_kum-1'
	End If
...
if this.GetColumnName() = "mchno1" then
	gs_gubun = 'J'
//	gs_code = This.GetItemString(1, 'gbn')
...
type dw_list from w_standard_print`dw_list within w_pdt_06500_jig
