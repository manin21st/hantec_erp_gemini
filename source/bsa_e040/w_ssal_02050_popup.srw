$PBExportHeader$w_ssal_02050_popup.srw
forward
global type w_ssal_02050_popup from w_inherite_popup
end type
type dw_2 from datawindow within w_ssal_02050_popup
end type
type rb_1 from radiobutton within w_ssal_02050_popup
end type
type rb_2 from radiobutton within w_ssal_02050_popup
end type
type rb_3 from radiobutton within w_ssal_02050_popup
end type
type rr_1 from roundrectangle within w_ssal_02050_popup
end type
type rr_2 from roundrectangle within w_ssal_02050_popup
end type
end forward
...
global w_ssal_02050_popup w_ssal_02050_popup

type variables
string isJuncrt1, isJuncrt2, is_saupj
end variables

on w_ssal_02050_popup.create
int iCurrent
call super::create
...
type dw_jogun from w_inherite_popup`dw_jogun within w_ssal_02050_popup
...
type p_exit from w_inherite_popup`p_exit within w_ssal_02050_popup
integer x = 3351
integer y = 16
end type
...
type p_inq from w_inherite_popup`p_inq within w_ssal_02050_popup
integer x = 3003
integer y = 16
end type

event p_inq::clicked;call super::clicked;String sdatef,sdatet,scvcod,sItnbr,sIojpno
...
IF dw_1.Retrieve(gs_sabu,sdatef,sdatet,scvcod+'%',sitnbr+'%',sIojpno+'%', is_saupj) <= 0 THEN
	dw_2.SetColumn("fr_date")
	dw_2.SetFocus()
	Return
END IF
...
type p_choose from w_inherite_popup`p_choose within w_ssal_02050_popup
integer x = 3177
integer y = 16
end type
...
type dw_1 from w_inherite_popup`dw_1 within w_ssal_02050_popup
integer x = 41
integer y = 404
integer width = 3470
integer height = 1464
string dataobject = "d_ssal_02050_popup"
...
type sle_2 from w_inherite_popup`sle_2 within w_ssal_02050_popup
boolean visible = false
integer x = 1015
integer y = 176
integer width = 1001
...
type cb_1 from w_inherite_popup`cb_1 within w_ssal_02050_popup
integer x = 2871
integer y = 2216
end type

type cb_return from w_inherite_popup`cb_return within w_ssal_02050_popup
integer x = 3209
integer y = 2172
integer taborder = 40
end type

type cb_inq from w_inherite_popup`cb_inq within w_ssal_02050_popup
integer x = 2491
integer y = 2196
integer taborder = 20
...
type sle_1 from w_inherite_popup`sle_1 within w_ssal_02050_popup
boolean visible = false
integer x = 352
integer y = 152
integer width = 425
...
type st_1 from w_inherite_popup`st_1 within w_ssal_02050_popup
boolean visible = false
integer x = 82
integer y = 172
integer width = 251
...
string dataobject = "d_ssal_02050_popup1"
