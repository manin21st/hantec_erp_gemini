$PBExportHeader$w_explc_popup.srw
$PBExportComments$L/C NO 선택 POPUP
forward
global type w_explc_popup from w_inherite_popup
end type
type pb_1 from u_pb_cal within w_explc_popup
end type
type pb_2 from u_pb_cal within w_explc_popup
end type
type rr_1 from roundrectangle within w_explc_popup
end type
end forward
...
global w_explc_popup w_explc_popup

on w_explc_popup.create
int iCurrent
call super::create
...
dw_jogun.SetItem(1, 'sdatef', Left(f_today(),4) + '0101')
...
type dw_jogun from w_inherite_popup`dw_jogun within w_explc_popup
integer y = 172
integer width = 2336
integer height = 140
string dataobject = "d_explc_popup_1"
end type
...
type p_exit from w_inherite_popup`p_exit within w_explc_popup
integer x = 2135
integer y = 12
end type
...
type p_inq from w_inherite_popup`p_inq within w_explc_popup
integer x = 1787
integer y = 12
end type
...
type p_choose from w_inherite_popup`p_choose within w_explc_popup
integer x = 1961
integer y = 12
end type
...
type dw_1 from w_inherite_popup`dw_1 within w_explc_popup
integer x = 32
integer y = 320
integer width = 2267
integer height = 1500
integer taborder = 20
string dataobject = "d_explc_popup"
end type
...
type sle_2 from w_inherite_popup`sle_2 within w_explc_popup
...
type cb_1 from w_inherite_popup`cb_1 within w_explc_popup
boolean visible = false
integer x = 1211
integer y = 1920
boolean enabled = false
...
type cb_return from w_inherite_popup`cb_return within w_explc_popup
boolean visible = false
integer x = 1842
integer y = 1920
boolean enabled = false
...
type cb_inq from w_inherite_popup`cb_inq within w_explc_popup
boolean visible = false
integer x = 1531
integer y = 1920
boolean enabled = false
...
type sle_1 from w_inherite_popup`sle_1 within w_explc_popup
boolean visible = false
integer x = 521
integer y = 1972
integer width = 471
...
type st_1 from w_inherite_popup`st_1 within w_explc_popup
boolean visible = false
integer y = 1916
integer width = 494
