$PBExportHeader$w_kglb10.srw
$PBExportComments$받을어음 만기결제전표 처리
forward
global type w_kglb10 from w_inherite
end type
type gb_1 from groupbox within w_kglb10
end type
type rb_1 from radiobutton within w_kglb10
end type
type rb_2 from radiobutton within w_kglb10
end type
type dw_ip from u_key_enter within w_kglb10
end type
type dw_junpoy from datawindow within w_kglb10
end type
type dw_sungin from datawindow within w_kglb10
end type
type dw_print from datawindow within w_kglb10
end type
type dw_rbill from datawindow within w_kglb10
end type
type rr_1 from roundrectangle within w_kglb10
end type
type cbx_all from checkbox within w_kglb10
end type
type dw_rtv from datawindow within w_kglb10
end type
type dw_delete from datawindow within w_kglb10
end type
end forward

global type w_kglb10 from w_inherite
string title = "받을어음 만기결제전표 처리"
gb_1 gb_1
rb_1 rb_1
rb_2 rb_2
dw_ip dw_ip
...
type dw_insert from w_inherite`dw_insert within w_kglb10
boolean visible = false
integer taborder = 0
end type

type p_delrow from w_inherite`p_delrow within w_kglb10
boolean visible = false
integer x = 3703
integer y = 2608
integer taborder = 0
...
type p_addrow from w_inherite`p_addrow within w_kglb10
boolean visible = false
integer x = 3529
integer y = 2608
integer taborder = 0
...
type p_search from w_inherite`p_search within w_kglb10
boolean visible = false
integer x = 3003
integer y = 2608
integer taborder = 0
...
type p_ins from w_inherite`p_ins within w_kglb10
boolean visible = false
integer x = 3355
integer y = 2608
integer taborder = 0
...
type p_exit from w_inherite`p_exit within w_kglb10
integer taborder = 60
end type

type p_can from w_inherite`p_can within w_kglb10
boolean visible = false
integer x = 4055
integer y = 2608
integer taborder = 0
...
type p_print from w_inherite`p_print within w_kglb10
boolean visible = false
integer x = 3177
integer y = 2608
integer taborder = 0
...
type p_inq from w_inherite`p_inq within w_kglb10
integer x = 4096
integer taborder = 20
end type
...
type p_del from w_inherite`p_del within w_kglb10
boolean visible = false
integer x = 3881
integer y = 2608
integer taborder = 0
...
type p_mod from w_inherite`p_mod within w_kglb10
integer x = 4270
...
type cb_exit from w_inherite`cb_exit within w_kglb10
boolean visible = false
integer x = 3360
integer y = 2828
end type

type cb_mod from w_inherite`cb_mod within w_kglb10
boolean visible = false
integer x = 3013
integer y = 2824
string text = "처리(&P)"
...
type cb_ins from w_inherite`cb_ins within w_kglb10
boolean visible = false
integer x = 2437
integer y = 2580
...
type cb_del from w_inherite`cb_del within w_kglb10
boolean visible = false
integer x = 2085
integer y = 2580
end type

type cb_inq from w_inherite`cb_inq within w_kglb10
boolean visible = false
integer x = 2651
integer y = 2824
end type

type cb_print from w_inherite`cb_print within w_kglb10
boolean visible = false
integer x = 1728
integer y = 2580
end type

type st_1 from w_inherite`st_1 within w_kglb10
boolean visible = false
end type

type cb_can from w_inherite`cb_can within w_kglb10
boolean visible = false
integer x = 2789
integer y = 2580
end type

type cb_search from w_inherite`cb_search within w_kglb10
boolean visible = false
integer x = 3141
integer y = 2580
integer width = 334
...
type dw_datetime from w_inherite`dw_datetime within w_kglb10
boolean visible = false
end type

type sle_msg from w_inherite`sle_msg within w_kglb10
boolean visible = false
end type

type gb_10 from w_inherite`gb_10 within w_kglb10
boolean visible = false
end type

type gb_button1 from w_inherite`gb_button1 within w_kglb10
boolean visible = false
integer x = 1687
integer y = 2524
end type

type gb_button2 from w_inherite`gb_button2 within w_kglb10
boolean visible = false
integer x = 2597
integer y = 2768
integer width = 1138
