$PBExportHeader$w_kglb12.srw
$PBExportComments$지급어음 만기결제전표 처리
forward
global type w_kglb12 from w_inherite
end type
type gb_1 from groupbox within w_kglb12
end type
type rb_1 from radiobutton within w_kglb12
end type
type rb_2 from radiobutton within w_kglb12
end type
type dw_ip from u_key_enter within w_kglb12
end type
type dw_junpoy from datawindow within w_kglb12
end type
type dw_sungin from datawindow within w_kglb12
end type
type dw_print from datawindow within w_kglb12
end type
type dw_jbill from datawindow within w_kglb12
end type
type cbx_all from checkbox within w_kglb12
end type
type rr_1 from roundrectangle within w_kglb12
end type
type dw_rtv from datawindow within w_kglb12
end type
type dw_delete from datawindow within w_kglb12
end type
end forward
...
//		dw_rtv.SetItem(k,"mbal_date",sBalDate)
//		dw_rtv.SetItem(k,"mupmu_gu", sUpmuGbn)
//		dw_rtv.SetItem(k,"mjun_no",  lJunNo)
//		dw_rtv.SetItem(k,"mlin_no",  lLinNo)
//		dw_rtv.SetItem(k,"status",   '2')
...
type dw_insert from w_inherite`dw_insert within w_kglb12
...
type p_delrow from w_inherite`p_delrow within w_kglb12
boolean visible = false
integer y = 2736
integer taborder = 0
end type

type p_addrow from w_inherite`p_addrow within w_kglb12
boolean visible = false
integer y = 2736
integer taborder = 0
end type

type p_search from w_inherite`p_search within w_kglb12
boolean visible = false
integer y = 2736
integer taborder = 0
end type

type p_ins from w_inherite`p_ins within w_kglb12
boolean visible = false
integer y = 2736
integer taborder = 0
end type

type p_exit from w_inherite`p_exit within w_kglb12
integer taborder = 60
end type

type p_can from w_inherite`p_can within w_kglb12
boolean visible = false
integer y = 2736
integer taborder = 0
end type

type p_print from w_inherite`p_print within w_kglb12
boolean visible = false
integer y = 2736
integer taborder = 0
end type
...
type p_inq from w_inherite`p_inq within w_kglb12
integer x = 4096
end type
...
type p_del from w_inherite`p_del within w_kglb12
boolean visible = false
integer y = 2736
integer taborder = 0
end type

type p_mod from w_inherite`p_mod within w_kglb12
integer x = 4270
...
type cb_exit from w_inherite`cb_exit within w_kglb12
integer x = 2258
integer y = 2768
end type

type cb_mod from w_inherite`cb_mod within w_kglb12
integer x = 1911
integer y = 2768
string text = "처리(&P)"
end type

type cb_ins from w_inherite`cb_ins within w_kglb12
integer x = 2235
integer y = 2776
boolean enabled = false
end type

type cb_del from w_inherite`cb_del within w_kglb12
integer x = 2089
integer y = 2580
end type

type cb_inq from w_inherite`cb_inq within w_kglb12
integer x = 1550
integer y = 2768
end type

type cb_print from w_inherite`cb_print within w_kglb12
integer x = 2437
integer y = 2580
end type

type st_1 from w_inherite`st_1 within w_kglb12
end type

type cb_can from w_inherite`cb_can within w_kglb12
integer x = 2789
integer y = 2580
end type

type cb_search from w_inherite`cb_search within w_kglb12
integer x = 3122
integer y = 2580
integer width = 334
string text = "변경(&E)"
...
type gb_button1 from w_inherite`gb_button1 within w_kglb12
integer x = 2066
integer y = 2692
end type

type gb_button2 from w_inherite`gb_button2 within w_kglb12
integer x = 1495
integer y = 2712
integer width = 1138
end type
...
event itemchanged;String  snull,ssql,ssqlb,sSaupj,sDate,sBnkNo,sChoose,sBnkCd
Integer i
