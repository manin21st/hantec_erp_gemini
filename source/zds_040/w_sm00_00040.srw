$PBExportHeader$w_sm00_00040.srw
$PBExportComments$년 판매계획 현황
forward
global type w_sm00_00040 from w_standard_print
end type
type rr_2 from roundrectangle within w_sm00_00040
end type
type rr_1 from roundrectangle within w_sm00_00040
end type
end forward
...
global w_sm00_00040 w_sm00_00040
...
If sItem = 'Z' Then
	dw_print.DataObject = 'd_sm00_00040_6_p'
	dw_list.DataObject  = 'd_sm00_00040_6'
Elseif sItem = 'Y' Then
		dw_print.DataObject = 'd_sm00_00040_5_p'
		dw_list.DataObject = 'd_sm00_00040_5'
Else
		dw_print.DataObject = 'd_sm00_00040_7_p'
		dw_list.DataObject = 'd_sm00_00040_7'
End If

dw_print.SetTransObject(sqlca)
dw_print.ShareData(dw_list)

If dw_print.Retrieve(gs_sabu, sYear, nChasu, sPlnt , sItcls , sType ) <= 0 Then
	f_message_chk(50,'')
End If
...
type p_preview from w_standard_print`p_preview within w_sm00_00040
end type

type p_exit from w_standard_print`p_exit within w_sm00_00040
end type

type p_print from w_standard_print`p_print within w_sm00_00040
end type

type p_retrieve from w_standard_print`p_retrieve within w_sm00_00040
end type
...
type st_10 from w_standard_print`st_10 within w_sm00_00040
end type



type dw_print from w_standard_print`dw_print within w_sm00_00040
string dataobject = "d_sm00_00040_2_p"
end type

type dw_ip from w_standard_print`dw_ip within w_sm00_00040
integer y = 48
integer width = 3799
integer height = 256
string dataobject = "d_sm00_00040_9"
end type
...
type dw_list from w_standard_print`dw_list within w_sm00_00040
integer x = 32
integer y = 332
integer height = 1876
string dataobject = "d_sm00_00040_5"
