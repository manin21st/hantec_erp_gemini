$PBExportHeader$w_pdt_04020_1.srw
$PBExportComments$입고승인등록(생산창고용)
forward
global type w_pdt_04020_1 from window
end type
type pb_3 from u_pb_cal within w_pdt_04020_1
end type
type pb_2 from u_pb_cal within w_pdt_04020_1
end type
type pb_1 from u_pb_cal within w_pdt_04020_1
end type
type cbx_select from checkbox within w_pdt_04020_1
end type
type p_exit from uo_picture within w_pdt_04020_1
end type
type p_can from uo_picture within w_pdt_04020_1
end type
type p_mod from uo_picture within w_pdt_04020_1
end type
type p_inq from uo_picture within w_pdt_04020_1
end type
type p_search from uo_picture within w_pdt_04020_1
end type
type dw_list from u_d_select_sort within w_pdt_04020_1
end type
type cb_1 from commandbutton within w_pdt_04020_1
end type
type dw_1 from datawindow within w_pdt_04020_1
end type
type rb_2 from radiobutton within w_pdt_04020_1
end type
type rb_1 from radiobutton within w_pdt_04020_1
end type
type cb_cancel from commandbutton within w_pdt_04020_1
end type
type cb_retrieve from commandbutton within w_pdt_04020_1
end type
type cb_exit from commandbutton within w_pdt_04020_1
end type
type cb_save from commandbutton within w_pdt_04020_1
end type
type rr_1 from roundrectangle within w_pdt_04020_1
end type
type rr_2 from roundrectangle within w_pdt_04020_1
end type
type rr_3 from roundrectangle within w_pdt_04020_1
end type
end forward
...
global w_pdt_04020_1 w_pdt_04020_1
...
//생산창고 지정
SELECT CVCOD INTO :sHouse FROM VNDMST WHERE CVGU = '5' AND INGUAN = 'Y' AND IPJOGUN = :gs_saupj;
...
integer height = 176
integer taborder = 10
string dataobject = "d_pdt_04020_1"
boolean border = false
