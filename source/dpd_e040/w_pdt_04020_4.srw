$PBExportHeader$w_pdt_04020_4.srw
$PBExportComments$입고승인등록(사업장이동입고)
forward
global type w_pdt_04020_4 from window
end type
type pb_3 from u_pb_cal within w_pdt_04020_4
end type
type pb_2 from u_pb_cal within w_pdt_04020_4
end type
type pb_1 from u_pb_cal within w_pdt_04020_4
end type
type cbx_select from checkbox within w_pdt_04020_4
end type
type p_exit from uo_picture within w_pdt_04020_4
end type
type p_can from uo_picture within w_pdt_04020_4
end type
type p_mod from uo_picture within w_pdt_04020_4
end type
type p_inq from uo_picture within w_pdt_04020_4
end type
type p_search from uo_picture within w_pdt_04020_4
end type
type dw_list from u_d_select_sort within w_pdt_04020_4
end type
type cb_1 from commandbutton within w_pdt_04020_4
end type
type rb_2 from radiobutton within w_pdt_04020_4
end type
type rb_1 from radiobutton within w_pdt_04020_4
end type
type cb_cancel from commandbutton within w_pdt_04020_4
end type
type cb_retrieve from commandbutton within w_pdt_04020_4
end type
type cb_exit from commandbutton within w_pdt_04020_4
end type
type cb_save from commandbutton within w_pdt_04020_4
end type
type rr_1 from roundrectangle within w_pdt_04020_4
end type
type rr_2 from roundrectangle within w_pdt_04020_4
end type
type rr_3 from roundrectangle within w_pdt_04020_4
end type
type dw_1 from datawindow within w_pdt_04020_4
end type
end forward
...
global w_pdt_04020_4 w_pdt_04020_4
...
// 자재창고 지정
SELECT CVCOD INTO :sHouse
  FROM VNDMST
 WHERE CVGU = '5' AND SOGUAN = '3' AND IPJOGUN = :gs_saupj AND JUMAECHUL NOT IN ('3', '4') AND ROWNUM = 1 ;
...
////////////////////////////////////////////////////////
string	sDate, sEmpno, sHouse, sCheck, sNull, sSalegu, ls_saupj, sIpjpno, ls_err
dec{3}	dQty
dec{5}   dPrice
long		lRow, ll_err
...
FOR  lRow = 1	TO		dw_list.RowCount()
	...
	sIpjpno   = dw_list.GetItemString(lRow, "ip_jpno")
	...
	if rb_1.checked then
		...
		IF sCheck = 'Y'	THEN		// 승인
			...
			/* 상대 출고 승인 */
			UPDATE IMHIST
				SET IOAMT = IOQTY * IOPRC, IOQTY = :dQty, IO_DATE = :sDate
				    /*, IO_EMPNO = :sEmpno 출고담당자 정보로 사용되기 때문에 같이 UPDATE하면 않됨 - BY SHINGOON 2016.10.05 */
			 WHERE SABU = '1' AND IOJPNO = :sIpjpno ;
			If SQLCA.SQLCODE <> 0 Then
		...
		IF sCheck = 'Y'	THEN		// 승인취소
			...
			/* 상대출고 취소 */
			UPDATE IMHIST
				SET IOAMT = 0, IOQTY = 0, IO_DATE = NULL
				    /*, IO_EMPNO = NULL 출고담당자 정보로 사용되기 때문에 같이 UPDATE하면 않됨 - BY SHINGOON 2016.10.05 */
			 WHERE SABU = '1' AND IOJPNO = :sIpjpno ;
			If SQLCA.SQLCODE <> 0 Then
				ll_err = SQLCA.SQLDBCODE ; ls_err = SQLCA.SQLERRTEXT
				ROLLBACK USING SQLCA;
...
string	sHouse, sGubun, sDate, sTitle, siogbn, pdtgu, sidate, stdate, sempno, sCvcod, sItnbr, sSAupj
...
IF rb_1.checked  = true		THEN
	sGubun = 'N'
	sTitle = '[입고미승인현황]'
	lRowCount = dw_list.Retrieve(gs_sabu, sidate, stdate, sSaupj, sItnbr, sHouse)
ELSE
	sGubun = 'Y'
	sTitle = '[입고승인현황]'
	lRowCount = dw_list.Retrieve(gs_sabu, sHouse, siDate, stdate, siogbn, sempno, sSaupj, sCvcod, sItnbr)
END IF
...
integer height = 1796
integer taborder = 20
string dataobject = "d_pdt_04020_4_01"
...
dw_list.DataObject = 'd_pdt_04020_4_02'
dw_list.SetTransObject(sqlca)
pb_1.visible = False
...
dw_list.DataObject = 'd_pdt_04020_4_01'
dw_list.SetTransObject(sqlca)
pb_1.visible = True
...
integer height = 192
integer taborder = 10
string dataobject = "d_pdt_04020_4"
boolean border = false
