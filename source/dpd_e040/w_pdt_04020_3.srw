$PBExportHeader$w_pdt_04020_3.srw
$PBExportComments$입고승인등록(제품 입고 승인 등록)
forward
global type w_pdt_04020_3 from window
end type
type pb_3 from u_pb_cal within w_pdt_04020_3
end type
type pb_2 from u_pb_cal within w_pdt_04020_3
end type
type pb_1 from u_pb_cal within w_pdt_04020_3
end type
type cbx_select from checkbox within w_pdt_04020_3
end type
type p_exit from uo_picture within w_pdt_04020_3
end type
type p_can from uo_picture within w_pdt_04020_3
end type
type p_mod from uo_picture within w_pdt_04020_3
end type
type p_inq from uo_picture within w_pdt_04020_3
end type
type p_search from uo_picture within w_pdt_04020_3
end type
type dw_list from u_d_select_sort within w_pdt_04020_3
end type
type cb_1 from commandbutton within w_pdt_04020_3
end type
type dw_1 from datawindow within w_pdt_04020_3
end type
type rb_2 from radiobutton within w_pdt_04020_3
end type
type rb_1 from radiobutton within w_pdt_04020_3
end type
type cb_cancel from commandbutton within w_pdt_04020_3
end type
type cb_retrieve from commandbutton within w_pdt_04020_3
end type
type cb_exit from commandbutton within w_pdt_04020_3
end type
type cb_save from commandbutton within w_pdt_04020_3
end type
type rr_1 from roundrectangle within w_pdt_04020_3
end type
type rr_2 from roundrectangle within w_pdt_04020_3
end type
type rr_3 from roundrectangle within w_pdt_04020_3
end type
end forward
...
global w_pdt_04020_3 w_pdt_04020_3
...
// MRO창고 지정
select cvcod into :sHouse from vndmst where cvgu = '5' and deptcode = :GS_DEPT and juprod = 'Z' ;
...
integer height = 176
integer taborder = 10
string dataobject = "d_pdt_04020_3"
boolean border = false
