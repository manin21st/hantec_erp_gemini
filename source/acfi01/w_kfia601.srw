$PBExportHeader$w_kfia601.srw
$PBExportComments$금융기관,거래처별 할인한도 등록
forward
global type w_kfia601 from w_inherite
end type
type dw_ip from datawindow within w_kfia601
end type
type dw_list from datawindow within w_kfia601
end type
type gb_2 from groupbox within w_kfia601
end type
type cb_1 from commandbutton within w_kfia601
end type
type rr_1 from roundrectangle within w_kfia601
end type
end forward

global type w_kfia601 from w_inherite
string title = "금융기관,거래처별 할인한도 등록"
dw_ip dw_ip
dw_list dw_list
gb_2 gb_2
cb_1 cb_1
...
type dw_insert from w_inherite`dw_insert within w_kfia601
boolean visible = false
integer taborder = 0
end type

type p_delrow from w_inherite`p_delrow within w_kfia601
integer x = 3689
integer taborder = 50
end type

event p_delrow::clicked;call super::clicked;Int iCurrow
...
type p_addrow from w_inherite`p_addrow within w_kfia601
integer x = 3515
integer taborder = 40
end type
...
IF sSaupNo = "" OR Isnull(sSaupNo) THEN
	MessageBox("확 인", "[거래처]는 필수입력항목입니다.!!")
	Return
END IF
...
type p_search from w_inherite`p_search within w_kfia601
boolean visible = false
integer x = 3237
integer y = 3188
integer taborder = 0
...
type p_ins from w_inherite`p_ins within w_kfia601
boolean visible = false
integer x = 3758
integer y = 3188
integer taborder = 0
...
type p_exit from w_inherite`p_exit within w_kfia601
integer x = 4416
integer taborder = 90
end type

type p_can from w_inherite`p_can within w_kfia601
integer x = 4242
integer taborder = 80
end type
...
type p_print from w_inherite`p_print within w_kfia601
boolean visible = false
integer x = 3410
integer y = 3188
integer taborder = 0
...
type p_inq from w_inherite`p_inq within w_kfia601
integer x = 3342
integer taborder = 20
end type
...
type p_del from w_inherite`p_del within w_kfia601
integer x = 4069
integer taborder = 70
end type
...
type p_mod from w_inherite`p_mod within w_kfia601
integer x = 3895
integer taborder = 60
end type
...
type cb_exit from w_inherite`cb_exit within w_kfia601
boolean visible = false
integer x = 3648
integer y = 2764
end type

type cb_mod from w_inherite`cb_mod within w_kfia601
boolean visible = false
integer x = 2592
integer y = 2764
end type

type cb_ins from w_inherite`cb_ins within w_kfia601
boolean visible = false
integer x = 3150
integer y = 2960
integer width = 375
...
type cb_del from w_inherite`cb_del within w_kfia601
boolean visible = false
integer x = 2944
integer y = 2764
end type

type cb_inq from w_inherite`cb_inq within w_kfia601
boolean visible = false
integer x = 2798
integer y = 2960
end type

type cb_print from w_inherite`cb_print within w_kfia601
boolean visible = false
integer x = 2299
integer y = 2796
...
type st_1 from w_inherite`st_1 within w_kfia601
boolean visible = false
end type

type cb_can from w_inherite`cb_can within w_kfia601
boolean visible = false
integer x = 3296
integer y = 2764
end type

type cb_search from w_inherite`cb_search within w_kfia601
boolean visible = false
integer x = 1458
integer y = 2792
boolean enabled = false
...
type dw_datetime from w_inherite`dw_datetime within w_kfia601
boolean visible = false
end type

type sle_msg from w_inherite`sle_msg within w_kfia601
boolean visible = false
end type

type gb_10 from w_inherite`gb_10 within w_kfia601
boolean visible = false
end type

type gb_button1 from w_inherite`gb_button1 within w_kfia601
boolean visible = false
integer x = 64
integer y = 1868
integer width = 1202
...
type gb_button2 from w_inherite`gb_button2 within w_kfia601
boolean visible = false
integer x = 2135
integer y = 1868
integer width = 1454
...
string dataobject = "d_kfia601_01"
...
IF this.GetColumnName() ="saup_no" THEN
	...
	SELECT "KFZ04OM0"."PERSON_NM"
   	INTO :sSql
   	FROM "KFZ04OM0"  
   	WHERE ( "KFZ04OM0"."PERSON_CD" = :sSaupNo ) AND  
	...
	IF SQLCA.SQLCODE <> 0 THEN
		...
		Return 1
	ELSE
		this.SetItem(this.GetRow(), "in_nm",sSql)
	END IF
...
integer taborder = 30
boolean bringtotop = true
string dataobject = "d_kfia601_02"
