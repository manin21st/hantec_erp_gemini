$PBExportHeader$w_kfia65.srw
$PBExportComments$차입금 등록2(상환횟수)
forward
global type w_kfia65 from w_inherite
end type
type dw_list from datawindow within w_kfia65
end type
type gb_5 from groupbox within w_kfia65
end type
type gb_plan from groupbox within w_kfia65
end type
type gb_1 from groupbox within w_kfia65
end type
type dw_1 from u_key_enter within w_kfia65
end type
type rb_1 from radiobutton within w_kfia65
end type
type rb_2 from radiobutton within w_kfia65
end type
type pb_2 from picturebutton within w_kfia65
end type
type pb_3 from picturebutton within w_kfia65
end type
type dw_2 from u_d_popup_sort within w_kfia65
end type
type st_2 from statictext within w_kfia65
end type
type sle_1 from singlelineedit within w_kfia65
end type
type rr_1 from roundrectangle within w_kfia65
end type
type rr_2 from roundrectangle within w_kfia65
end type
type rr_3 from roundrectangle within w_kfia65
end type
type ln_1 from line within w_kfia65
end type
end forward
...
public function integer wf_requiredchk (integer icurrow);String  sLoName,sBal,sAtGbn,sAtBank,sAtBankNo,sBnkCd,sIjaDay,sLocd,sacc1_cd,sacc2_cd, &
		  sBnkNo,satdt ,slosgbn ,slocurr ,ssaupj ,salcgu,sWcond
...
type dw_insert from w_inherite`dw_insert within w_kfia65
...
type p_delrow from w_inherite`p_delrow within w_kfia65
boolean visible = false
integer x = 4128
integer y = 3024
end type

type p_addrow from w_inherite`p_addrow within w_kfia65
boolean visible = false
integer x = 3954
integer y = 3024
end type

type p_search from w_inherite`p_search within w_kfia65
integer x = 3273
integer y = 28
integer width = 306
...
type p_ins from w_inherite`p_ins within w_kfia65
integer x = 3749
end type
...
type p_exit from w_inherite`p_exit within w_kfia65
end type

type p_can from w_inherite`p_can within w_kfia65
end type
...
type p_print from w_inherite`p_print within w_kfia65
boolean visible = false
integer x = 3575
integer y = 3016
end type

type p_inq from w_inherite`p_inq within w_kfia65
integer x = 3575
end type

event p_inq::clicked;call super::clicked;dw_2.retrieve()
...
type p_del from w_inherite`p_del within w_kfia65
end type
...
type p_mod from w_inherite`p_mod within w_kfia65
end type
...
type cb_exit from w_inherite`cb_exit within w_kfia65
boolean visible = false
integer x = 3461
integer y = 2688
integer width = 293
...
type cb_mod from w_inherite`cb_mod within w_kfia65
boolean visible = false
integer x = 2487
integer y = 2688
integer width = 293
...
type cb_ins from w_inherite`cb_ins within w_kfia65
boolean visible = false
integer x = 955
integer y = 2928
integer width = 293
...
type cb_del from w_inherite`cb_del within w_kfia65
boolean visible = false
integer x = 2811
integer y = 2688
integer width = 293
...
type cb_inq from w_inherite`cb_inq within w_kfia65
boolean visible = false
integer x = 343
integer y = 2688
integer width = 293
...
type cb_print from w_inherite`cb_print within w_kfia65
boolean visible = false
integer x = 1262
integer y = 2928
integer width = 293
...
type st_1 from w_inherite`st_1 within w_kfia65
boolean visible = false
integer width = 288
end type

type cb_can from w_inherite`cb_can within w_kfia65
boolean visible = false
integer x = 3136
integer y = 2688
integer width = 293
...
type cb_search from w_inherite`cb_search within w_kfia65
boolean visible = false
integer x = 1024
integer y = 2688
integer width = 672
...
type dw_datetime from w_inherite`dw_datetime within w_kfia65
boolean visible = false
integer x = 2848
end type

type sle_msg from w_inherite`sle_msg within w_kfia65
boolean visible = false
integer x = 325
integer width = 2523
end type

type gb_10 from w_inherite`gb_10 within w_kfia65
boolean visible = false
integer width = 3598
end type

type gb_button1 from w_inherite`gb_button1 within w_kfia65
boolean visible = false
integer x = 302
integer y = 2636
integer width = 384
...
type gb_button2 from w_inherite`gb_button2 within w_kfia65
boolean visible = false
integer x = 2427
integer y = 2636
integer width = 1385
