$PBExportHeader$w_flow_activity_sub.srw
$PBExportComments$Workflow ActivitySub 콘트롤
forward
global type w_flow_activity_sub from w_flow
end type
end forward

global type w_flow_activity_sub from w_flow
end type
global w_flow_activity_sub w_flow_activity_sub
...
int ii_activity_display_seq

end variables

on w_flow_activity_sub.create
call super::create
end on

on w_flow_activity_sub.destroy
call super::destroy
end on

event open;call super::open;is_flow_type = 'activity_sub'
is_default_box_object_name = 'u_box_activity_sub'
is_default_progress_box_object_name = 'u_box_prgss_activity_sub'

is_default_progress_dw_detail = 'dm_flow_activity_sub_prgss'
is_default_progress_dw_remark = 'dm_flow_activity_sub_prgss_remark'
...
li_activity_sub_seq = auo_box.dw_info.getitemnumber(1, 'activity_sub_seq')
...
ll_row = dw_box.find('proj_code = "' + ls_proj_code + &
			...
			' and activity_sub_seq = ' + string(li_activity_sub_seq), 1, dw_box.rowcount())
if ll_row <= 0 then
...
dw_box.object.activity_sub_seq[ll_row]  = auo_box.dw_info.getitemnumber(1, 'activity_sub_seq')
...
int li_gateway_seq
int li_activity_seq
int li_activity_sub_seq, li_pre_activity_sub_seq
...
li_activity_seq = ii_activity_seq
li_pre_activity_sub_seq = luo_target1.dw_info.getitemnumber(1, 'activity_sub_seq')
li_activity_sub_seq = luo_target2.dw_info.getitemnumber(1, 'activity_sub_seq')
...
ll_row = dw_branch.find('proj_code = "' + ls_proj_code + &
			...
			' and gateway_seq = ' + string(li_gateway_seq) + &
			' and activity_seq = ' + string(li_activity_seq) + &
			' and activity_sub_seq = ' + string(li_activity_sub_seq) + &
			' and pre_activity_sub_seq = ' + string(li_pre_activity_sub_seq), 1, dw_branch.rowcount())
if ll_row <= 0 then
...
dw_branch.object.activity_seq[ll_row] = li_activity_seq
dw_branch.object.activity_sub_seq[ll_row] = luo_target2.dw_info.getitemnumber(1, 'activity_sub_seq')
dw_branch.object.pre_activity_sub_seq[ll_row] = luo_target1.dw_info.getitemnumber(1, 'activity_sub_seq')
...
auo_box.dw_info.setitem(1, 'activity_seq', ii_activity_seq)
ii_max_seq++
auo_box.dw_info.setitem(1, 'activity_sub_seq', ii_max_seq)

end event

event ue_retrieve_page;call super::ue_retrieve_page;string ls_gateway_display_seq
string ls_activity_display_seq

is_proj_code = f_get_token(as_arg, '~n')
ii_proj_seq = integer(f_get_token(as_arg, '~n'))
ii_gateway_seq = integer(f_get_token(as_arg, '~n'))
ii_activity_seq = integer(f_get_token(as_arg, '~n'))
ls_gateway_display_seq = f_get_token(as_arg, '~n')
ls_activity_display_seq = f_get_token(as_arg, '~n')
ii_gateway_display_seq = integer(ls_gateway_display_seq)
ii_activity_display_seq = integer(ls_activity_display_seq)
is_parent_display_seq = ls_gateway_display_seq + '-' + &
								ls_activity_display_seq

dw_summary.retrieve(is_proj_code, ii_proj_seq, ii_gateway_seq, ii_activity_seq)
dw_box.retrieve(is_proj_code, ii_proj_seq, ii_gateway_seq, ii_activity_seq)
dw_branch.retrieve(is_proj_code, ii_proj_seq, ii_gateway_seq, ii_activity_seq)
...
//iuo_box[li_box].dw_info.retrieve(dw_box.object.proj_code[al_row], dw_box.object.proj_seq[al_row], dw_box.object.gateway_seq[al_row], dw_box.object.activity_seq[al_row], dw_box.object.activity_sub_seq[al_row])
...
iuo_box[li_box].dw_info.setitem(1, 'activity_sub_seq',  dw_box.object.activity_sub_seq[al_row])
...
li_target1 = dw_branch.object.pre_activity_sub_seq[al_row]
li_target2 = dw_branch.object.activity_sub_seq[al_row]
...
event ue_retrieve_detail;call super::ue_retrieve_detail;dw_detail.retrieve(auo_box.dw_info.object.proj_code[1], auo_box.dw_info.object.proj_seq[1], auo_box.dw_info.object.gateway_seq[1], auo_box.dw_info.object.activity_seq[1], auo_box.dw_info.object.activity_sub_seq[1])

end event

event ue_retrieve_remark;call super::ue_retrieve_remark;dw_remark.retrieve(auo_box.dw_info.object.proj_code[1], auo_box.dw_info.object.proj_seq[1], auo_box.dw_info.object.gateway_seq[1], auo_box.dw_info.object.activity_seq[1], auo_box.dw_info.object.activity_sub_seq[1])
...
li_activity_sub_seq = dw_remark.getitemnumber(1, 'activity_sub_seq')
...
dw_box.object.activity_sub_seq[ll_row]  = dw_remark.getitemnumber(1, 'activity_sub_seq')
...
li_activity_sub_seq = dw_detail.getitemnumber(1, 'activity_sub_seq')
...
dw_box.object.activity_sub_seq[ll_row]  = dw_detail.getitemnumber(1, 'activity_sub_seq')
...
type dw_print from w_flow`dw_print within w_flow_activity_sub
boolean visible = true
end type

type dw_grid_property from w_flow`dw_grid_property within w_flow_activity_sub
boolean visible = true
end type

type dw_remark from w_flow`dw_remark within w_flow_activity_sub
boolean visible = true
integer x = 2034
integer y = 524
integer width = 654
integer height = 1588
string dataobject = "dm_flow_activity_sub_remark"
end type

event dw_remark::clicked;string 	ls_column, ls_filepath, ls_proj_code, ls_path
string 	ls_Null
long   	ll_rc
int    	li_proj_seq, li_gateway_seq, li_activity_seq, li_activity_sub_seq
...
//	ls_path = "c:\erpman"
	...
	li_activity_sub_seq = This.object.activity_sub_seq[1] 
	...
	if ls_column = 'PRODUCT_FILE1' then 
		...
		SELECTBLOB PRODUCT_FILE_BLOB1  
			  ...
			  where PROJ_CODE  = :ls_proj_code and
					  ...
					  activity_seq = :li_activity_seq and
					  activity_sub_seq = :li_activity_sub_seq;
	...
	End if 
		...
		IF SQLCA.SQLCode = 0 AND Not IsNull(lbb_file_data) THEN
			...
			IF li_fp = -1 or IsNull(li_fp) then
				messagebox('확인',' 해당 폴더가 사용중입니다. 잠시만 기다려주세요~~')
				close(w_getblob)
			Else
...
if dwo.type = 'button' then
	...
	ls_str_parm.s_parm[7] = string(this.object.activity_sub_seq[1] )
	
	openwithparm(w_wflow_file_copy_sub, ls_str_parm)
	...
	//Dynamic Sql Query
   ls_sql = "       	 update flow_activity_sub " 
   ...
   ls_sql = ls_sql + "   and activity_seq = to_number('" +   string(li_activity_seq) + "')  "  
	ls_sql = ls_sql + "   and activity_sub_seq = to_number('" +   string(li_activity_sub_seq) + "')  "  
...
event dw_remark::editchanged;call super::editchanged;//string ls_column, ls_proj_code, ls_file_name, ls_blob_str , ls_sql, ls_filepath
//int 	 li_proj_seq, li_gateway_seq, li_activity_seq, li_activity_sub_seq 
//
//
...
//			
//			//BLOB 데이타 삭제	
//			ls_sql = "       	 update flow_activity_sub_blob " 
...
if upper(dwo.name) = 'PRODUCT_FILE1' OR upper(dwo.name) = 'PRODUCT_FILE2'  OR upper(dwo.name) = 'PRODUCT_FILE3' OR & 
	...
	li_activity_sub_seq 	= This.object.activity_sub_seq[1] 
	ls_blob_str     		= mid(ls_column, 1, len(ls_column) - 1 ) + "_BLOB" + mid(ls_column, len(ls_column) , 1 )
	ls_org_filename   	= this.Getitemstring(row, ls_column ) 
...
//
//
//string ls_column, ls_proj_code, ls_file_name, ls_blob_str , ls_sql, ls_filepath, ls_org_filename
...
//					this.setitem ( row, ls_column ,ls_org_filename )
////					ls_column.setfocus()
////					this.object.product_file2[1] = 'gggggg'
//					return 0
//				END IF
//
//	end if 
...
type st_box_white_6 from w_flow`st_box_white_6 within w_flow_activity_sub
end type

type st_box_white_5 from w_flow`st_box_white_5 within w_flow_activity_sub
end type

type st_box_white_7 from w_flow`st_box_white_7 within w_flow_activity_sub
end type

type st_box_white_8 from w_flow`st_box_white_8 within w_flow_activity_sub
end type

type st_box_white_4 from w_flow`st_box_white_4 within w_flow_activity_sub
end type

type st_box_white_3 from w_flow`st_box_white_3 within w_flow_activity_sub
end type

type st_box_white_1 from w_flow`st_box_white_1 within w_flow_activity_sub
end type

type st_box_white_2 from w_flow`st_box_white_2 within w_flow_activity_sub
end type

type dw_branch_property from w_flow`dw_branch_property within w_flow_activity_sub
boolean visible = true
end type

type st_box_red_2 from w_flow`st_box_red_2 within w_flow_activity_sub
end type

type dw_detail from w_flow`dw_detail within w_flow_activity_sub
boolean visible = true
integer width = 654
integer height = 592
string dataobject = "dm_flow_activity_sub_info"
end type

type dw_branch from w_flow`dw_branch within w_flow_activity_sub
boolean visible = true
integer x = 2574
integer y = 476
string dataobject = "dm_flow_activity_sub_branch"
end type

type dw_box from w_flow`dw_box within w_flow_activity_sub
boolean visible = true
string dataobject = "dm_flow_activity_sub"
end type

type st_box_red_1 from w_flow`st_box_red_1 within w_flow_activity_sub
end type

type dw_summary from w_flow`dw_summary within w_flow_activity_sub
integer width = 4315
string dataobject = "dm_flow_activity_sub_summary"
end type
