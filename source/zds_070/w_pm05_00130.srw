$PBExportHeader$w_pm05_00130.srw
$PBExportComments$작업실적 종합효율
forward
global type w_pm05_00130 from w_standard_print
end type
type pb_3 from u_pb_cal within w_pm05_00130
end type
type pb_1 from u_pb_cal within w_pm05_00130
end type
type rr_2 from roundrectangle within w_pm05_00130
end type
end forward

global type w_pm05_00130 from w_standard_print
string title = "작업실적 종합효율"
pb_3 pb_3
pb_1 pb_1
rr_2 rr_2
end type
global w_pm05_00130 w_pm05_00130

forward prototypes
public function integer wf_retrieve ()
end prototypes

public function integer wf_retrieve ();String sFrom, sTo, sPdtgu, sJocod, swkctr, sempno, smchno
...
IF dw_print.Retrieve(gs_sabu, sFrom, sTo, sPdtgu, swkctr) < 1 THEN
	f_message_chk(50,'')
	dw_ip.Setfocus()
	return -1
end if
...
type p_preview from w_standard_print`p_preview within w_pm05_00130
end type

type p_exit from w_standard_print`p_exit within w_pm05_00130
end type

type p_print from w_standard_print`p_print within w_pm05_00130
end type

type p_retrieve from w_standard_print`p_retrieve within w_pm05_00130
end type
...
type st_10 from w_standard_print`st_10 within w_pm05_00130
end type



type dw_print from w_standard_print`dw_print within w_pm05_00130
string dataobject = "d_pm05_00130_2_p"
end type

type dw_ip from w_standard_print`dw_ip within w_pm05_00130
integer width = 3241
integer height = 200
string dataobject = "d_pm05_00130_1"
end type
...
type dw_list from w_standard_print`dw_list within w_pm05_00130
integer x = 50
integer y = 236
integer width = 4558
string dataobject = "d_pm05_00130_2"
