$PBExportHeader$w_sal_06550.srw
$PBExportComments$ ===> 관할구역별 Buyer별 미선적 현황
forward
global type w_sal_06550 from w_standard_print
end type
type rr_1 from roundrectangle within w_sal_06550
end type
end forward

global type w_sal_06550 from w_standard_print
string title = "관할구역별 Buyer별 미선적 현황"
rr_1 rr_1
end type
global w_sal_06550 w_sal_06550

forward prototypes
public function integer wf_retrieve ()
end prototypes

public function integer wf_retrieve ();String sS, sS_Name, sCvcod , ls_saupj , tx_name
...
if dw_print.Retrieve(gs_sabu, sS, sCvcod +'%',ls_saupj) < 1 then
...
type p_preview from w_standard_print`p_preview within w_sal_06550
end type

type p_exit from w_standard_print`p_exit within w_sal_06550
end type

type p_print from w_standard_print`p_print within w_sal_06550
end type

type p_retrieve from w_standard_print`p_retrieve within w_sal_06550
end type
...
type st_10 from w_standard_print`st_10 within w_sal_06550
end type



type dw_print from w_standard_print`dw_print within w_sal_06550
string dataobject = "d_sal_06550"
end type

type dw_ip from w_standard_print`dw_ip within w_sal_06550
integer x = 9
integer y = 8
integer width = 2144
integer height = 216
string dataobject = "d_sal_06550_01"
end type

event dw_ip::itemerror;return 1
end event

event dw_ip::itemchanged;call super::itemchanged;String  sIoCust,sIoCustArea,sIoCustName,sDept,sDeptname,sDateFrom,sDateTo,snull
...
type dw_list from w_standard_print`dw_list within w_sal_06550
integer y = 244
integer width = 4571
integer height = 2092
string dataobject = "d_sal_06550"
