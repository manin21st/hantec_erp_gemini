$PBExportHeader$w_sal_06210.srw
$PBExportComments$ASN 현황
forward
global type w_sal_06210 from w_standard_print
end type
type pb_1 from u_pb_cal within w_sal_06210
end type
type pb_2 from u_pb_cal within w_sal_06210
end type
type rr_1 from roundrectangle within w_sal_06210
end type
end forward
...
global w_sal_06210 w_sal_06210
...
type p_xls from w_standard_print`p_xls within w_sal_06210
end type

type p_sort from w_standard_print`p_sort within w_sal_06210
end type

type p_preview from w_standard_print`p_preview within w_sal_06210
end type

type p_exit from w_standard_print`p_exit within w_sal_06210
end type

type p_print from w_standard_print`p_print within w_sal_06210
end type

type p_retrieve from w_standard_print`p_retrieve within w_sal_06210
end type
...
type st_10 from w_standard_print`st_10 within w_sal_06210
end type



type dw_print from w_standard_print`dw_print within w_sal_06210
string dataobject = "d_sal_06210_p"
end type

type dw_ip from w_standard_print`dw_ip within w_sal_06210
integer x = 14
integer y = 56
integer width = 2482
integer height = 168
string dataobject = "d_sal_06210_1"
end type
...
type dw_list from w_standard_print`dw_list within w_sal_06210
integer y = 264
integer width = 4576
integer height = 2064
string dataobject = "d_sal_06210"
