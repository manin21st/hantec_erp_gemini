$PBExportHeader$w_sal_06571.srw
$PBExportComments$ ===> Commercial Invoice 발행현황
forward
global type w_sal_06571 from w_standard_print
end type
type pb_1 from u_pb_cal within w_sal_06571
end type
type pb_2 from u_pb_cal within w_sal_06571
end type
type rr_1 from roundrectangle within w_sal_06571
end type
end forward

global type w_sal_06571 from w_standard_print
string title = "Commercial Invoice 발행현황"
pb_1 pb_1
pb_2 pb_2
rr_1 rr_1
end type
global w_sal_06571 w_sal_06571

forward prototypes
public function integer wf_retrieve ()
end prototypes

public function integer wf_retrieve ();String sFrom, sTo, sS, sS_Name, sCists, sCust, ls_saupj, tx_name ,ls_prtgbn, ls_emp_id
...
sCists = Trim(dw_ip.GetItemString(1,'cists'))

if dw_print.Retrieve(gs_sabu, sFrom, sTo, sS, sCust+'%', sCists ,ls_saupj, ls_emp_id) < 1 then
...
dw_list.object.tx_sarea.Text = sS_Name
...
event ue_open;call super::ue_open;dw_ip.setitem(1,'d_from',left(f_today(),6) + '01')
...
type p_xls from w_standard_print`p_xls within w_sal_06571
end type

type p_sort from w_standard_print`p_sort within w_sal_06571
end type

type p_preview from w_standard_print`p_preview within w_sal_06571
end type

type p_exit from w_standard_print`p_exit within w_sal_06571
end type

type p_print from w_standard_print`p_print within w_sal_06571
end type

type p_retrieve from w_standard_print`p_retrieve within w_sal_06571
end type
...
type st_10 from w_standard_print`st_10 within w_sal_06571
end type



type dw_print from w_standard_print`dw_print within w_sal_06571
string dataobject = "d_sal_06571_p"
end type

type dw_ip from w_standard_print`dw_ip within w_sal_06571
integer x = 14
integer y = 8
integer width = 3456
integer height = 256
string dataobject = "d_sal_06571_01"
end type

event dw_ip::itemchanged;String sCol_Name, sNull, svndcod, scvname, sPrtgbn
String sIocust, sIoCustName, sIoCustArea, sDept,sCvcod, scvnas, sarea, steam, sSaupj, sName1, ls_saupj, scode
...
Choose Case sCol_Name
   ...
   Case "d_to"
	...
	Case 'prtgbn'
		...
		/* Invoice or Buyer 기준 */
		If sPrtGbn = '0' Then
			dw_list.DataObject = 'd_sal_06571'
			dw_print.DataObject = 'd_sal_06571_p'
			dw_list.SetTransObject(SQLCA)
		   dw_print.SetTransObject(SQLCA)
	   Else
			dw_list.DataObject = 'd_sal_06571_1'
			dw_print.DataObject = 'd_sal_06571_1_p'
			dw_list.SetTransObject(SQLCA)
	      dw_print.SetTransObject(SQLCA) 	
	   End If
...
type dw_list from w_standard_print`dw_list within w_sal_06571
integer x = 32
integer y = 296
integer width = 4581
integer height = 1952
string dataobject = "d_sal_06571"
