$PBExportHeader$w_imt_05030.srw
$PBExportComments$년간 구매계획 대 실적[품목별]
forward
global type w_imt_05030 from w_standard_print
end type
type shl_1 from statichyperlink within w_imt_05030
end type
type shl_2 from statichyperlink within w_imt_05030
end type
type st_1 from statictext within w_imt_05030
end type
type st_5 from statictext within w_imt_05030
end type
type shl_3 from statichyperlink within w_imt_05030
end type
type shl_4 from statichyperlink within w_imt_05030
end type
type st_2 from statictext within w_imt_05030
end type
type rr_1 from roundrectangle within w_imt_05030
end type
end forward

global type w_imt_05030 from w_standard_print
string title = "년간 구매계획 대 실적[품목별]"
string menuname = ""
shl_1 shl_1
shl_2 shl_2
st_1 st_1
...
global w_imt_05030 w_imt_05030
...
String	ls_yymm, ls_itcls, ls_mitcls, ls_saupj, ls_iogbn
...
IF dw_list.Retrieve(ls_yymm, gs_codename2 , ls_mitcls, ls_saupj, ls_iogbn ) <= 0 THEN
	f_message_chk(50, '[]')
	Return -1
END IF
...
type p_preview from w_standard_print`p_preview within w_imt_05030
boolean visible = false
integer x = 2843
integer y = 12
end type

type p_exit from w_standard_print`p_exit within w_imt_05030
end type

type p_print from w_standard_print`p_print within w_imt_05030
boolean visible = false
integer x = 3017
integer y = 12
end type

type p_retrieve from w_standard_print`p_retrieve within w_imt_05030
integer x = 4265
end type
...
type st_10 from w_standard_print`st_10 within w_imt_05030
end type



type dw_print from w_standard_print`dw_print within w_imt_05030
integer x = 3255
string dataobject = "d_imt_05030_1"
end type

type dw_ip from w_standard_print`dw_ip within w_imt_05030
integer y = 96
integer width = 4215
integer height = 144
string dataobject = "d_imt_05030"
end type

type dw_list from w_standard_print`dw_list within w_imt_05030
