...
type cb_1 from commandbutton within w_pdm_11560
end type
type cb_2 from commandbutton within w_pdm_11560
end type
type rr_1 from roundrectangle within w_pdm_11560
end type
end forward
...
type p_xls from w_standard_print`p_xls within w_pdm_11560
...
type p_sort from w_standard_print`p_sort within w_pdm_11560
boolean visible = true
integer x = 3863
integer y = 20
end type

type p_preview from w_standard_print`p_preview within w_pdm_11560
integer x = 4037
end type

type p_exit from w_standard_print`p_exit within w_pdm_11560
integer x = 4384
end type

type p_print from w_standard_print`p_print within w_pdm_11560
boolean visible = false
integer x = 4983
integer y = 152
end type

type p_retrieve from w_standard_print`p_retrieve within w_pdm_11560
integer x = 3685
end type
