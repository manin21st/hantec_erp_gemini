...
type dw_cond from u_key_enter within w_sal_06100
end type
...
type pb_1 from u_pb_cal within w_sal_06100
end type
type rr_4 from roundrectangle within w_sal_06100
end type
type rr_1 from roundrectangle within w_sal_06100
end type
type rr_3 from roundrectangle within w_sal_06100
end type
type rr_2 from roundrectangle within w_sal_06100
end type
...
//sDepotNo	= dw_cond.GetItemString(1, 'depot_no')
...
this.Control[iCurrent+5]=this.st_haldang
this.Control[iCurrent+6]=this.st_list
...
this.Control[iCurrent+12]=this.dw_haldang_list
this.Control[iCurrent+13]=this.dw_lot
this.Control[iCurrent+14]=this.dw_haldang
...
rtncode 	= dw_cond.GetChild('crt_user', state_child)
...
dw_cond.SetItem(1,'crt_user',gs_empno)
...
dw_cond.Modify("iogbn.background.color = 80859087")
...
sconemp = dw_cond.object.crt_user[1]
