...
type pb_1 from u_pb_cal within w_mat_02530
end type
type pb_2 from u_pb_cal within w_mat_02530
end type
...
type rr_1 from roundrectangle within w_mat_02530
end type
end forward
...
type p_xls from w_standard_print`p_xls within w_mat_02530
...
type p_sort from w_standard_print`p_sort within w_mat_02530
end type

type p_preview from w_standard_print`p_preview within w_mat_02530
integer x = 3936
end type

type p_exit from w_standard_print`p_exit within w_mat_02530
integer x = 4457
end type

type p_print from w_standard_print`p_print within w_mat_02530
integer x = 4283
end type

type p_retrieve from w_standard_print`p_retrieve within w_mat_02530
integer x = 3762
end type
...
type st_10 from w_standard_print`st_10 within w_mat_02530
end type
