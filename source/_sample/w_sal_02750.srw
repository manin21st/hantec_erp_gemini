...
type rr_1 from roundrectangle within w_sal_02750
end type
type rr_2 from roundrectangle within w_sal_02750
end type
type dw_2 from datawindow within w_sal_02750
end type
type dw_1 from datawindow within w_sal_02750
end type
type pb_1 from u_pb_cal within w_sal_02750
end type
type pb_2 from u_pb_cal within w_sal_02750
end type
type pb_3 from u_pb_cal within w_sal_02750
end type
end forward
...
IF arg_status = 'I' THEN
	...
	p_search.PictureName = 'C:\erpman\image\외화단가적용_up.gif'
...
ELSE
	...
	p_search.PictureName = 'C:\erpman\image\외화단가적용_d.gif'
...
integer y = 88
integer width = 384
string picturename = "C:\erpman\image\외화단가적용_up.gif"
end type

event p_search::clicked;call super::clicked;wf_danga()
end event

event p_search::ue_lbuttondown;call super::ue_lbuttondown;p_search.PictureName = 'C:\erpman\image\외화단가적용_d.gif'
end event

event p_search::ue_lbuttonup;call super::ue_lbuttonup;p_search.PictureName = 'C:\erpman\image\외화단가적용_up.gif'
end event
