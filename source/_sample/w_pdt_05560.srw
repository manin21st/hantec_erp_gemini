...
type pb_1 from u_pb_cal within w_pdt_05560
end type
type pb_2 from u_pb_cal within w_pdt_05560
end type
...
type p_preview from w_standard_print`p_preview within w_pdt_05560
end type

type p_exit from w_standard_print`p_exit within w_pdt_05560
end type

type p_print from w_standard_print`p_print within w_pdt_05560
end type

type p_retrieve from w_standard_print`p_retrieve within w_pdt_05560
end type
...
type st_10 from w_standard_print`st_10 within w_pdt_05560
end type
