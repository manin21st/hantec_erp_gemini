...
this.Control[iCurrent+2]=this.ddlb_select
this.Control[iCurrent+3]=this.st_1
this.Control[iCurrent+4]=this.dw_jidat
this.Control[iCurrent+5]=this.rr_2
this.Control[iCurrent+6]=this.dw_sort
end on
...
type p_preview from w_standard_print`p_preview within w_pdt_02630
end type

type p_exit from w_standard_print`p_exit within w_pdt_02630
end type

type p_print from w_standard_print`p_print within w_pdt_02630
end type

type p_retrieve from w_standard_print`p_retrieve within w_pdt_02630
end type
