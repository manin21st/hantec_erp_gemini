...
type dw_ip from datawindow within w_res01_00010
end type
...
type rr_3 from roundrectangle within w_res01_00010
end type
end forward
...
ls_eo_no = Trim(dw_ip.Object.eo_no[1])
...
event ue_lbuttondown;PictureName = "C:\erpman\image\행추가_dn.gif"
end event

event ue_lbuttonup;PictureName = "C:\erpman\image\행추가_up.gif"
end event
...
event ue_lbuttondown;PictureName = "C:\erpman\image\행삭제_dn.gif"
end event

event ue_lbuttonup;PictureName = "C:\erpman\image\행삭제_up.gif"
end event
