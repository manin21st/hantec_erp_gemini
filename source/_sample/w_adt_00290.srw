...
type pb_3 from u_pb_cal within tabpage_1
end type
...
tab_1.tabpage_2.p_jaje.PictureName = "C:\erpman\image\소요자재_d.gif"				// 작업지시button
...
tab_1.tabpage_2.p_last.PictureName = "C:\erpman\image\작업지시_up.gif"
...
Else
	...
	If state_child.RowCount() > 0 Then
		...
		tab_1.tabpage_2.p_jaje.picturename = 'C:\erpman\image\소요자재_up.gif'
...
integer width = 178
boolean enabled = false
string picturename = "C:\erpman\image\소요자재_d.gif"
end type

event ue_lbuttonup;call super::ue_lbuttonup;PictureName = 'C:\erpman\image\소요자재_up.gif'
end event

event ue_lbuttondown;call super::ue_lbuttondown;PictureName = 'C:\erpman\image\소요자재_dn.gif'
end event
...
p_jaje.enabled = true
p_jaje.PictureName = "C:\erpman\image\소요자재_up.gif"
