...
type p_xls from w_standard_print`p_xls within w_pdt_05570
boolean visible = true
integer x = 4270
integer y = 24
end type

type p_sort from w_standard_print`p_sort within w_pdt_05570
end type

type p_preview from w_standard_print`p_preview within w_pdt_05570
end type

type p_exit from w_standard_print`p_exit within w_pdt_05570
end type

type p_print from w_standard_print`p_print within w_pdt_05570
boolean visible = false
integer x = 3726
integer y = 152
end type

type p_retrieve from w_standard_print`p_retrieve within w_pdt_05570
end type
...
type st_10 from w_standard_print`st_10 within w_pdt_05570
end type
