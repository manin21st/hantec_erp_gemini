$PBExportHeader$w_pu01_00040.srw
$PBExportComments$** 주간 구매 발주 취소
forward
global type w_pu01_00040 from window
end type
type cbx_del from checkbox within w_pu01_00040
end type
type pb_1 from u_pb_cal within w_pu01_00040
end type
type dw_2 from datawindow within w_pu01_00040
end type
type dw_1 from datawindow within w_pu01_00040
end type
type p_delrow from uo_picture within w_pu01_00040
end type
type p_addrow from uo_picture within w_pu01_00040
end type
type p_search from uo_picture within w_pu01_00040
end type
type p_exit from uo_picture within w_pu01_00040
end type
type p_can from uo_picture within w_pu01_00040
end type
type p_del from uo_picture within w_pu01_00040
end type
type p_mod from uo_picture within w_pu01_00040
end type
type p_inq from uo_picture within w_pu01_00040
end type
type cb_1 from commandbutton within w_pu01_00040
end type
type cb_delete from commandbutton within w_pu01_00040
end type
type cb_cancel from commandbutton within w_pu01_00040
end type
type rb_delete from radiobutton within w_pu01_00040
end type
type rb_insert from radiobutton within w_pu01_00040
end type
type dw_detail from datawindow within w_pu01_00040
end type
type cb_save from commandbutton within w_pu01_00040
end type
type cb_exit from commandbutton within w_pu01_00040
end type
type cb_retrieve from commandbutton within w_pu01_00040
end type
type rr_1 from roundrectangle within w_pu01_00040
end type
type rr_2 from roundrectangle within w_pu01_00040
end type
type rr_3 from roundrectangle within w_pu01_00040
end type
type dw_list from datawindow within w_pu01_00040
end type
type rr_4 from roundrectangle within w_pu01_00040
end type
type cbx_1 from checkbox within w_pu01_00040
end type
end forward
...
global w_pu01_00040 w_pu01_00040
...
FOR lrow = 1 TO dw_list.rowcount()
	...
	subject = '[계획일자:' + string(syymmdd,'@@@@.@@.@@') + '] 주간 구매계획 취소 통보!!!'
...
If DayNumber(Date( Left(syymmdd,4)+'-'+Mid(syymmdd,5,2) +'-'+Right(syymmdd,2) )) <> 2 Then
	MessageBox('확 인','계획일자는 월요일만 가능합니다.!!')
	Return
End If
...
sgubun = trim(dw_detail.getitemstring(1,'cargbn1'))

setpointer(hourglass!)
if dw_list.retrieve(gs_sabu,syymmdd,scvcod,gs_saupj,sgubun) < 1 then
	f_message_chk(50, '[주간 발주 취소]')
	dw_detail.setfocus()
	return
end if
end event
...
integer height = 112
integer taborder = 10
string dataobject = "d_pu01_00040_1"
boolean border = false
boolean livescroll = true
end type
...
string dataobject = "d_pu01_00040_a"
