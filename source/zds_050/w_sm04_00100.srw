$PBExportHeader$w_sm04_00100.srw
$PBExportComments$추정 손익 현황
forward
global type w_sm04_00100 from w_standard_print
end type
type rr_2 from roundrectangle within w_sm04_00100
end type
type p_mod from picture within w_sm04_00100
end type
type p_gwins from uo_picture within w_sm04_00100
end type
type dw_1 from datawindow within w_sm04_00100
end type
type dw_2 from datawindow within w_sm04_00100
end type
type rr_1 from roundrectangle within w_sm04_00100
end type
end forward

global type w_sm04_00100 from w_standard_print
integer height = 2500
string title = "추정 손익 현황"
rr_2 rr_2
p_mod p_mod
p_gwins p_gwins
dw_1 dw_1
...
global w_sm04_00100 w_sm04_00100
...
type p_preview from w_standard_print`p_preview within w_sm04_00100
end type

type p_exit from w_standard_print`p_exit within w_sm04_00100
end type

type p_print from w_standard_print`p_print within w_sm04_00100
end type

type p_retrieve from w_standard_print`p_retrieve within w_sm04_00100
end type
...
type st_10 from w_standard_print`st_10 within w_sm04_00100
end type



type dw_print from w_standard_print`dw_print within w_sm04_00100
integer x = 3666
integer y = 20
string dataobject = "d_sm04_00100_p"
end type

type dw_ip from w_standard_print`dw_ip within w_sm04_00100
integer x = 105
integer y = 96
integer width = 3150
integer height = 96
...
type dw_list from w_standard_print`dw_list within w_sm04_00100
integer x = 73
integer y = 260
integer width = 4512
integer height = 2004
