...
p_ins.Enabled = True
p_ins.PictureName = 'C:\erpman\image\송장선택_up.gif'
...
If wf_chk(newrow) = 0 Then
	p_del.Enabled = True
	p_ins.PictureName = 'C:\erpman\image\삭제_d.gif'
Else
	p_del.Enabled = False
	p_ins.PictureName = 'C:\erpman\image\삭제_up.gif'
End If
...
string picturename = "C:\erpman\image\송장선택_up.gif"
end type
...
event p_ins::ue_lbuttondown;PictureName = "C:\erpman\image\송장선택_dn.gif"
end event

event p_ins::ue_lbuttonup;PictureName = "C:\erpman\image\송장선택_up.gif"
end event
...
IF dw_imhist_ins.Retrieve(gs_sabu,sIoJpNo) > 0 THEN
	...
	p_ins.PictureName = 'C:\erpman\image\송장선택_d.gif'
	ib_any_typing = False
ELSE
	wf_init()
	f_message_chk(50,'')
