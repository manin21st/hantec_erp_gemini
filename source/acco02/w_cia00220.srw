$PBExportHeader$w_cia00220.srw
$PBExportComments$자재투입명세와 제조원가명세서 비교
forward
global type w_cia00220 from w_standard_print
end type
type rr_1 from roundrectangle within w_cia00220
end type
end forward
...
type p_preview from w_standard_print`p_preview within w_cia00220
...
type p_exit from w_standard_print`p_exit within w_cia00220
integer y = 0
integer taborder = 40
end type

type p_print from w_standard_print`p_print within w_cia00220
boolean visible = false
integer x = 4018
integer y = 0
integer taborder = 0
...
type p_retrieve from w_standard_print`p_retrieve within w_cia00220
integer x = 4270
integer y = 0
end type
...
type st_10 from w_standard_print`st_10 within w_cia00220
end type



type dw_print from w_standard_print`dw_print within w_cia00220
integer x = 3598
integer y = 16
string dataobject = "dw_cia002202"
end type

type dw_ip from w_standard_print`dw_ip within w_cia00220
integer x = 18
integer y = 0
integer width = 2830
integer height = 172
string dataobject = "dw_cia002201"
end type
...
type dw_list from w_standard_print`dw_list within w_cia00220
integer x = 50
integer y = 184
integer width = 4562
integer height = 2028
