$PBExportHeader$w_qct_01004.srw
$PBExportComments$검사코드등록
forward
global type w_qct_01004 from window
end type
type p_exit from uo_picture within w_qct_01004
end type
type p_can from uo_picture within w_qct_01004
end type
type p_print from uo_picture within w_qct_01004
end type
type p_mod from uo_picture within w_qct_01004
end type
type p_delrow from uo_picture within w_qct_01004
end type
type p_addrow from uo_picture within w_qct_01004
end type
type p_inq from uo_picture within w_qct_01004
end type
type cb_1 from commandbutton within w_qct_01004
end type
type dw_detail from datawindow within w_qct_01004
end type
type dw_list from datawindow within w_qct_01004
end type
type rr_1 from roundrectangle within w_qct_01004
end type
end forward
...
global w_qct_01004 w_qct_01004

type variables
char c_status
string is_key, is_rfcod = '32'
...
for row_count = 1 to dw_list.rowcount()
	...
	if dw_list.getitemstring(row_count, "rfna1") = "" or &
		...
		dw_list.setrow(row_count)
		messagebox("검사명","검사명을 입력하세요1",stopsign!)
		dw_list.setfocus()
		return -1
	end if
next
...
string dataobject = "d_qct_01004_1"
