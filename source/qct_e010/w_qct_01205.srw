$PBExportHeader$w_qct_01205.srw
$PBExportComments$시료수량 기준관리
forward
global type w_qct_01205 from window
end type
type dw_2 from u_key_enter within w_qct_01205
end type
type p_exit from uo_picture within w_qct_01205
end type
type p_save from uo_picture within w_qct_01205
end type
type p_retrieve from uo_picture within w_qct_01205
end type
type p_delrow from uo_picture within w_qct_01205
end type
type p_addrow from uo_picture within w_qct_01205
end type
type dw_1 from datawindow within w_qct_01205
end type
type dw_list from datawindow within w_qct_01205
end type
type rr_1 from roundrectangle within w_qct_01205
end type
type rr_2 from roundrectangle within w_qct_01205
end type
end forward
...
global w_qct_01205 w_qct_01205
...
sGubun = dw_2.GetItemString(nrow, 'itnbr')

FOR  lRow = 1	TO		dw_list.RowCount()

	dw_list.SetItem(lRow, "qcseq", 	 dw_list.GetItemNumber(lRow, "no"))
	dw_list.SetItem(lRow, "itnbr", sGubun)
...
integer height = 2184
integer taborder = 40
string dataobject = "d_qct_01205_2"
...
sGubun = GetItemString(nRow, 'itnbr')
...
event clicked;call super::clicked;long	lRow, nRow
...
integer height = 2184
integer taborder = 30
string dataobject = "d_qct_01205_1"
boolean vscrollbar = true
boolean border = false
boolean livescroll = true
end type
