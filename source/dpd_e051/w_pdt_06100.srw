$PBExportHeader$w_pdt_06100.srw
$PBExportComments$정기점검 실시결과 등록
forward
global type w_pdt_06100 from w_inherite
end type
type gb_3 from groupbox within w_pdt_06100
end type
type rb_1 from radiobutton within w_pdt_06100
end type
type rb_2 from radiobutton within w_pdt_06100
end type
type dw_list from datawindow within w_pdt_06100
end type
type dw_item from datawindow within w_pdt_06100
end type
type st_2 from statictext within w_pdt_06100
end type
type st_3 from statictext within w_pdt_06100
end type
type st_4 from statictext within w_pdt_06100
end type
type st_yymm from statictext within w_pdt_06100
end type
type rr_1 from roundrectangle within w_pdt_06100
end type
type dw_1 from datawindow within w_pdt_06100
end type
type rr_2 from roundrectangle within w_pdt_06100
end type
end forward
...
global w_pdt_06100 w_pdt_06100
...
type dw_insert from w_inherite`dw_insert within w_pdt_06100
integer x = 2587
integer y = 216
integer width = 1879
integer height = 1288
...
type p_delrow from w_inherite`p_delrow within w_pdt_06100
integer x = 4233
integer y = 5000
end type

type p_addrow from w_inherite`p_addrow within w_pdt_06100
integer x = 4443
integer y = 5000
end type

type p_search from w_inherite`p_search within w_pdt_06100
integer x = 4411
integer y = 1540
...
type p_ins from w_inherite`p_ins within w_pdt_06100
integer x = 4238
integer y = 1540
...
type p_exit from w_inherite`p_exit within w_pdt_06100
integer x = 4256
integer y = 52
end type

type p_can from w_inherite`p_can within w_pdt_06100
integer x = 4082
integer y = 52
end type
...
type p_print from w_inherite`p_print within w_pdt_06100
integer x = 1829
integer y = 156
...
type p_inq from w_inherite`p_inq within w_pdt_06100
integer x = 3561
integer y = 52
end type

event p_inq::clicked;call super::clicked;String sSidat, smchno
Int    iseq
...
type p_del from w_inherite`p_del within w_pdt_06100
integer x = 3909
integer y = 52
...
type p_mod from w_inherite`p_mod within w_pdt_06100
integer x = 3735
integer y = 52
end type
...
type cb_exit from w_inherite`cb_exit within w_pdt_06100
integer y = 5000
integer taborder = 120
end type

type cb_mod from w_inherite`cb_mod within w_pdt_06100
integer x = 2176
integer y = 5000
integer taborder = 90
end type

type cb_ins from w_inherite`cb_ins within w_pdt_06100
integer x = 2130
integer y = 5000
integer width = 393
integer taborder = 60
...
type cb_del from w_inherite`cb_del within w_pdt_06100
integer x = 2523
integer y = 5000
...
type cb_inq from w_inherite`cb_inq within w_pdt_06100
integer x = 3301
integer y = 5000
end type

type cb_print from w_inherite`cb_print within w_pdt_06100
integer x = 2126
integer y = 52
integer width = 329
integer taborder = 20
...
type st_1 from w_inherite`st_1 within w_pdt_06100
end type

type cb_can from w_inherite`cb_can within w_pdt_06100
integer x = 2871
integer y = 5000
integer taborder = 110
end type

type cb_search from w_inherite`cb_search within w_pdt_06100
integer x = 2542
integer y = 5000
integer width = 389
string text = "행삭제(&L)"
...
type gb_button1 from w_inherite`gb_button1 within w_pdt_06100
end type

type gb_button2 from w_inherite`gb_button2 within w_pdt_06100
end type
...
integer taborder = 30
boolean bringtotop = true
string dataobject = "d_pdt_06100_1"
