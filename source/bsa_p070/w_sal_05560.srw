$PBExportHeader$w_sal_05560.srw
$PBExportComments$거래처별 출고 현항(요약)
forward
global type w_sal_05560 from w_standard_print
end type
type pb_1 from u_pb_cal within w_sal_05560
end type
type pb_2 from u_pb_cal within w_sal_05560
end type
type rr_1 from roundrectangle within w_sal_05560
end type
end forward

global type w_sal_05560 from w_standard_print
string title = "거래처별 출고 현항(요약)"
pb_1 pb_1
pb_2 pb_2
rr_1 rr_1
end type
global w_sal_05560 w_sal_05560

forward prototypes
public function integer wf_retrieve ()
end prototypes

public function integer wf_retrieve ();String sFrom,sTo,sTeam,sArea,sCust,sTeamName,sAreaName, sFacgbn, sSaupj, tx_name, sPacprc, tx_name1
...
sFacgbn      = Trim(dw_ip.GetItemString(1,"Facgbn"))
...
If IsNull(sFacgbn) or sFacgbn = '' or sFacgbn = '.' then sFacgbn = '%'
...
//IF dw_list.Retrieve(gs_sabu, sFrom, sTo, sArea+'%', sCust+'%', sFacgbn, sSaupj) <=0 THEN
//	f_message_chk(50,'')
//   dw_ip.setcolumn('sdatef')
//	Return -1
//End If

IF dw_print.Retrieve(gs_sabu, sFrom, sTo, sArea+'%', sCust+'%', sSaupj, spacprc,sFacgbn) <=0 THEN
	f_message_chk(50,'')
   dw_ip.setcolumn('sdatef')
	Return -1
End If
...
type p_preview from w_standard_print`p_preview within w_sal_05560
end type

type p_exit from w_standard_print`p_exit within w_sal_05560
end type

type p_print from w_standard_print`p_print within w_sal_05560
end type

type p_retrieve from w_standard_print`p_retrieve within w_sal_05560
end type
...
type dw_print from w_standard_print`dw_print within w_sal_05560
string dataobject = "d_sal_05560_5p"
end type

type dw_ip from w_standard_print`dw_ip within w_sal_05560
integer x = 23
integer y = 32
integer width = 3913
integer height = 212
string dataobject = "d_sal_05560_5"
end type
...
type dw_list from w_standard_print`dw_list within w_sal_05560
integer y = 272
integer width = 4585
integer height = 2024
string dataobject = "d_sal_05560_51"
