$PBExportHeader$w_kgld98.srw
$PBExportComments$발행부서별 계정명세서
forward
global type w_kgld98 from w_standard_print
end type
type rr_1 from roundrectangle within w_kgld98
end type
end forward
...
integer x = 0
integer y = 0
string title = "발행부서별 계정명세서"
rr_1 rr_1
end type
global w_kgld98 w_kgld98
...
type p_preview from w_standard_print`p_preview within w_kgld98
end type

type p_exit from w_standard_print`p_exit within w_kgld98
end type

type p_print from w_standard_print`p_print within w_kgld98
end type

type p_retrieve from w_standard_print`p_retrieve within w_kgld98
end type
...
type st_10 from w_standard_print`st_10 within w_kgld98
end type



type dw_print from w_standard_print`dw_print within w_kgld98
string dataobject = "dw_kgld982_p"
end type

type dw_ip from w_standard_print`dw_ip within w_kgld98
integer x = 37
integer width = 3205
integer height = 236
string dataobject = "dw_kgld981"
end type
...
type dw_list from w_standard_print`dw_list within w_kgld98
integer x = 50
integer y = 264
integer width = 4553
integer height = 1940
string title = "발행부서별 계정명세서"
string dataobject = "dw_kgld982"
