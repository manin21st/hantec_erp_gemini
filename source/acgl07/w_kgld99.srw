$PBExportHeader$w_kgld99.srw
$PBExportComments$발행부서별 계정집계표
forward
global type w_kgld99 from w_standard_print
end type
type rr_1 from roundrectangle within w_kgld99
end type
end forward
...
integer x = 0
integer y = 0
string title = "발행부서별 계정집계표"
rr_1 rr_1
end type
global w_kgld99 w_kgld99
...
dw_ip.SetItem(1,"k_symd", left(f_today(), 4) + "01")
...
ELSE
	...
	//dw_ip.Modify("dept_cd.background.color ='"+String(RGB(190,225,184))+"'")
END IF

end event

type p_preview from w_standard_print`p_preview within w_kgld99
end type

type p_exit from w_standard_print`p_exit within w_kgld99
end type

type p_print from w_standard_print`p_print within w_kgld99
end type

type p_retrieve from w_standard_print`p_retrieve within w_kgld99
end type
...
type st_10 from w_standard_print`st_10 within w_kgld99
end type



type dw_print from w_standard_print`dw_print within w_kgld99
string dataobject = "dw_kgld992_p"
end type

type dw_ip from w_standard_print`dw_ip within w_kgld99
integer width = 3122
integer height = 220
string dataobject = "dw_kgld991"
end type
...
type dw_list from w_standard_print`dw_list within w_kgld99
integer x = 59
integer y = 252
integer width = 4549
integer height = 1956
string title = "발행부서별 수익비용집계표"
string dataobject = "dw_kgld992"
