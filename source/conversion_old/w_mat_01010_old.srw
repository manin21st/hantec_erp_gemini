$PBExportHeader$w_mat_01010_old.srw
$PBExportComments$기타 입고의뢰 등록
forward
global type w_mat_01010_old from window
end type
type cb_1 from commandbutton within w_mat_01010_old
end type
type p_bar from uo_picture within w_mat_01010_old
end type
type pb_1 from u_pb_cal within w_mat_01010_old
end type
type p_print from uo_picture within w_mat_01010_old
end type
type p_2 from uo_picture within w_mat_01010_old
end type
type p_copy from uo_picture within w_mat_01010_old
end type
type p_exit from uo_picture within w_mat_01010_old
end type
type p_cancel from uo_picture within w_mat_01010_old
end type
type p_delete from uo_picture within w_mat_01010_old
end type
type p_save from uo_picture within w_mat_01010_old
end type
type p_inq from uo_picture within w_mat_01010_old
end type
type p_delrow from uo_picture within w_mat_01010_old
end type
type p_addrow from uo_picture within w_mat_01010_old
end type
type dw_print from datawindow within w_mat_01010_old
end type
type dw_imhist from datawindow within w_mat_01010_old
end type
type dw_copy from datawindow within w_mat_01010_old
end type
type rb_delete from radiobutton within w_mat_01010_old
end type
type rb_insert from radiobutton within w_mat_01010_old
end type
type dw_detail from datawindow within w_mat_01010_old
end type
type gb_2 from groupbox within w_mat_01010_old
end type
type rr_1 from roundrectangle within w_mat_01010_old
end type
type dw_list from datawindow within w_mat_01010_old
end type
end forward
...
global w_mat_01010_old w_mat_01010_old
