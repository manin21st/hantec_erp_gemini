$PBExportHeader$w_qct_03020.srw
$PBExportComments$비가동 요인 등록
forward
global type w_qct_03020 from window
end type
type p_exit from uo_picture within w_qct_03020
end type
type p_can from uo_picture within w_qct_03020
end type
type p_print from uo_picture within w_qct_03020
end type
type p_mod from uo_picture within w_qct_03020
end type
type p_delrow from uo_picture within w_qct_03020
end type
type p_addrow from uo_picture within w_qct_03020
end type
type p_inq from uo_picture within w_qct_03020
end type
type cb_1 from commandbutton within w_qct_03020
end type
type dw_detail from datawindow within w_qct_03020
end type
type dw_list from datawindow within w_qct_03020
end type
type rr_1 from roundrectangle within w_qct_03020
end type
end forward
...
global w_qct_03020 w_qct_03020

type variables
char c_status
string is_key, is_rfcod = '13'
...
integer taborder = 10
string title = "none"
string dataobject = "d_qct_03020_1"
...
string dataobject = "d_qct_03020_2"
