$PBExportHeader$w_kifa88.srw
$PBExportComments$본점 송부전표 처리(반제기준)
forward
global type w_kifa88 from w_inherite
end type
type rr_1 from roundrectangle within w_kifa88
end type
type gb_1 from groupbox within w_kifa88
end type
type rb_1 from radiobutton within w_kifa88
end type
type rb_2 from radiobutton within w_kifa88
end type
type dw_junpoy from datawindow within w_kifa88
end type
type dw_sungin from datawindow within w_kifa88
end type
type dw_print from datawindow within w_kifa88
end type
type dw_sang from datawindow within w_kifa88
end type
type dw_ip from u_key_enter within w_kifa88
end type
type cbx_all from checkbox within w_kifa88
end type
type dw_rtv from datawindow within w_kifa88
end type
type dw_delete from datawindow within w_kifa88
end type
end forward
...
public function integer wf_insert_sang (integer icurrow, string ssaupj, string sbaldate, string supmugu, long ljunno, integer llinno)
public function integer wf_create_kfz12ot0_rcv (string ssaupj, string sbaldate)
end prototypes
...
sAcc1_Cha = Left(dw_ip.GetItemString(1,"accd"),5)
sAcc2_Cha = Right(dw_ip.GetItemString(1,"accd"),2)
...
if sChaDae = '1' then							/*자산계정*/
	...
	FOR k = 1 TO dw_rtv.RowCount()	
		IF dw_rtv.GetItemString(k,"chk") = '1' THEN
			...
			dw_junpoy.SetItem(iCurRow,"in_nm",   f_get_personlst('1',dw_rtv.GetItemString(k,"saup_no"),'%'))
			
			Wf_Insert_Sang(k,sSaupj,sBalDate,sUpmuGbn,lJunNo,lLinNo) 
...
public function integer wf_insert_sang (integer icurrow, string ssaupj, string sbaldate, string supmugu, long ljunno, integer llinno);Integer iInsertrow

	
iInsertRow = dw_sang.InsertRow(0)
	
dw_sang.SetItem(iInsertRow,"saupj",    dw_rtv.GetItemString(iCurRow,"saupj"))
dw_sang.SetItem(iInsertRow,"acc_date", dw_rtv.GetItemString(iCurRow,"acc_date"))
dw_sang.SetItem(iInsertRow,"upmu_gu",  dw_rtv.GetItemString(iCurRow,"upmu_gu"))
dw_sang.SetItem(iInsertRow,"jun_no",   dw_rtv.GetItemNumber(iCurRow,"jun_no"))
dw_sang.SetItem(iInsertRow,"lin_no",   dw_rtv.GetItemNumber(iCurRow,"lin_no"))
dw_sang.SetItem(iInsertRow,"jbal_date",dw_rtv.GetItemString(iCurRow,"bal_date"))
dw_sang.SetItem(iInsertRow,"bjun_no",  dw_rtv.GetItemNumber(iCurRow,"bjun_no"))
...
dw_sang.SetItem(iInsertRow,"amt_s",    dw_rtv.GetItemNumber(iCurRow,"amt"))
...
type dw_insert from w_inherite`dw_insert within w_kifa88
...
type p_delrow from w_inherite`p_delrow within w_kifa88
boolean visible = false
integer y = 3120
integer taborder = 0
end type

type p_addrow from w_inherite`p_addrow within w_kifa88
boolean visible = false
integer y = 3120
integer taborder = 0
end type

type p_search from w_inherite`p_search within w_kifa88
boolean visible = false
integer x = 3776
integer y = 2940
integer taborder = 0
...
type p_ins from w_inherite`p_ins within w_kifa88
boolean visible = false
integer y = 3120
integer taborder = 0
end type

type p_exit from w_inherite`p_exit within w_kifa88
integer y = 16
integer taborder = 60
end type

type p_can from w_inherite`p_can within w_kifa88
boolean visible = false
integer y = 3120
integer taborder = 0
end type

type p_print from w_inherite`p_print within w_kifa88
boolean visible = false
integer y = 3120
integer taborder = 0
end type
...
type p_inq from w_inherite`p_inq within w_kifa88
integer x = 4096
integer y = 16
integer taborder = 20
end type
...
type p_del from w_inherite`p_del within w_kifa88
boolean visible = false
integer y = 3120
integer taborder = 0
end type

type p_mod from w_inherite`p_mod within w_kifa88
integer x = 4270
integer y = 16
...
IF rb_1.Checked =True THEN
	...
	IF LsAutoSungGbn = 'Y' THEN
		...
		ELSE
			...
			/*인수전표 생성*/
			select nvl(dataname,'N') into :sRcvGbn from syscnfg where sysgu = 'A' and serial = 21 and lineno = '3';
			if sRcvGbn = 'Y' then
...
type cb_exit from w_inherite`cb_exit within w_kifa88
boolean visible = false
integer x = 4302
integer y = 2752
end type

type cb_mod from w_inherite`cb_mod within w_kifa88
boolean visible = false
integer x = 3941
integer y = 2752
string text = "처리(&P)"
...
type cb_ins from w_inherite`cb_ins within w_kifa88
boolean visible = false
integer x = 2350
integer y = 2748
...
type cb_del from w_inherite`cb_del within w_kifa88
boolean visible = false
integer x = 2693
integer y = 2748
end type

type cb_inq from w_inherite`cb_inq within w_kifa88
boolean visible = false
integer x = 3579
integer y = 2752
end type

type cb_print from w_inherite`cb_print within w_kifa88
boolean visible = false
integer x = 2706
integer y = 2748
end type

type st_1 from w_inherite`st_1 within w_kifa88
boolean visible = false
end type

type cb_can from w_inherite`cb_can within w_kifa88
boolean visible = false
integer x = 2345
integer y = 2628
end type

type cb_search from w_inherite`cb_search within w_kifa88
boolean visible = false
integer x = 3113
integer y = 2756
integer width = 439
...
type dw_datetime from w_inherite`dw_datetime within w_kifa88
boolean visible = false
end type

type sle_msg from w_inherite`sle_msg within w_kifa88
boolean visible = false
integer height = 88
end type

type gb_10 from w_inherite`gb_10 within w_kifa88
boolean visible = false
end type

type gb_button1 from w_inherite`gb_button1 within w_kifa88
boolean visible = false
integer x = 2304
integer y = 2580
integer height = 308
...
type gb_button2 from w_inherite`gb_button2 within w_kifa88
boolean visible = false
integer x = 3067
integer y = 2696
integer width = 1609
