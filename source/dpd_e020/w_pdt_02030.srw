$PBExportHeader$w_pdt_02030.srw
$PBExportComments$작업지시등록(품목)
forward
global type w_pdt_02030 from w_inherite
end type
type gb_2 from groupbox within w_pdt_02030
end type
type gb_1 from groupbox within w_pdt_02030
end type
type cb_suju from commandbutton within w_pdt_02030
end type
type gb_3 from groupbox within w_pdt_02030
end type
type tab_1 from tab within w_pdt_02030
end type
...
type pb_3 from u_pb_cal within tabpage_3
end type
type tabpage_3 from userobject within tab_1
rr_6 rr_6
rr_5 rr_5
...
type dw_ban from datawindow within w_pdt_02030
end type
type dw_jaje from datawindow within w_pdt_02030
end type
type st_2 from statictext within w_pdt_02030
end type
type sle_bal from singlelineedit within w_pdt_02030
end type
type st_3 from statictext within w_pdt_02030
end type
type dw_saupj from datawindow within w_pdt_02030
end type
type rr_1 from roundrectangle within w_pdt_02030
end type
end forward
...
global w_pdt_02030 w_pdt_02030
...
For lrow = 1 to tab_1.tabpage_2.dw_tabpage2.rowcount()
	...
	Select   count(*)  into :nCnt
	    from  morout_copy 
	where   pordno like :isPordno||'%'   and itnbr = :sItnbr 
	    and  (esdat is null or fsdat is null);
	If	nCnt > 0 	then
...
String	schk, sToday, sPdtgu, sItgu, sItnbr, sCvcod, sCvnas, stuncu, sRtnbr, sWanch, sBanch, &
		   sIttyp, sGubun, sAuto, sJasacode, sPorgu, sitcls, nToday, sOrdgbn
Decimal {5} dUnprc, dPdprc
String 	sTditnbr[], sTpdtgu[], sCitnbr, sGbn, sNapgi , ls_saupj, ls_mchno
Decimal {3} dTqty[], dArrcnt, dArrMax, dOrqty, dOptqty, dpdqty, dmod 
String		ls_pspec, sTpspec[]
...
if sauto = '1' and sOrdgbn = 'N' and (sGubun = '1' or sGubun = '2' or sGubun = '3') then   
	...
	For Lrow = 1 to lCount	
		 ...
		 sItnbr   	= tab_1.tabpage_1.dw_plnlist.getitemstring(Lrow, "itnbr")			 
		 ls_pspec	= tab_1.tabpage_1.dw_plnlist.getitemstring(Lrow, "pspec")			 
...
type dw_insert from w_inherite`dw_insert within w_pdt_02030
...
type p_delrow from w_inherite`p_delrow within w_pdt_02030
integer x = 3333
integer y = 2476
integer taborder = 70
end type

type p_addrow from w_inherite`p_addrow within w_pdt_02030
integer x = 3159
integer y = 2476
integer taborder = 50
end type

type p_search from w_inherite`p_search within w_pdt_02030
integer x = 2464
integer y = 2476
integer taborder = 140
end type

type p_ins from w_inherite`p_ins within w_pdt_02030
integer x = 2985
integer y = 2476
integer taborder = 30
end type

type p_exit from w_inherite`p_exit within w_pdt_02030
integer x = 4027
integer y = 2476
integer taborder = 130
end type

type p_can from w_inherite`p_can within w_pdt_02030
integer x = 3854
integer y = 2476
integer taborder = 120
end type

type p_print from w_inherite`p_print within w_pdt_02030
integer x = 2638
integer y = 2476
integer taborder = 150
end type

type p_inq from w_inherite`p_inq within w_pdt_02030
integer x = 2811
integer y = 2476
end type

type p_del from w_inherite`p_del within w_pdt_02030
integer x = 3680
integer y = 2476
integer taborder = 110
end type

type p_mod from w_inherite`p_mod within w_pdt_02030
integer x = 3506
integer y = 2476
integer taborder = 90
end type

type cb_exit from w_inherite`cb_exit within w_pdt_02030
integer x = 1650
integer y = 2708
boolean enabled = false
string text = "종료"
...
type cb_mod from w_inherite`cb_mod within w_pdt_02030
integer x = 955
integer y = 2708
boolean enabled = false
string text = "계산"
...
type cb_ins from w_inherite`cb_ins within w_pdt_02030
integer x = 261
integer y = 2956
boolean enabled = false
string text = "추가"
...
type cb_del from w_inherite`cb_del within w_pdt_02030
integer x = 613
integer y = 2956
boolean enabled = false
string text = "삭제"
...
type cb_inq from w_inherite`cb_inq within w_pdt_02030
integer x = 965
integer y = 2956
boolean enabled = false
string text = "조회"
...
type cb_print from w_inherite`cb_print within w_pdt_02030
integer x = 1303
integer y = 2952
boolean enabled = false
string text = "출력"
...
type st_1 from w_inherite`st_1 within w_pdt_02030
integer x = 37
end type

type cb_can from w_inherite`cb_can within w_pdt_02030
integer x = 1298
integer y = 2708
boolean enabled = false
string text = "취소"
...
type cb_search from w_inherite`cb_search within w_pdt_02030
integer x = 1669
integer y = 2956
boolean enabled = false
string text = "자료조회"
...
type gb_10 from w_inherite`gb_10 within w_pdt_02030
integer x = 27
end type

type gb_button1 from w_inherite`gb_button1 within w_pdt_02030
end type

type gb_button2 from w_inherite`gb_button2 within w_pdt_02030
end type
...
if s_wkctr = '' or isnull(s_wkctr) then
	...
	Choose Case sGbn
		Case '1'
			dw_plnlist.dataobject = 'd_pdt_02030_10a'     //연동계획
		Case '6'
			dw_plnlist.dataobject = 'd_pdt_02030_109a'   //주간계획
		Case '2'
			dw_plnlist.dataobject = 'd_pdt_02030_101a'	 //작업예정		
		Case '3'
			dw_plnlist.dataobject = 'd_pdt_02030_102a'  // 할당기준으로 수주조회
		Case '4'
...
event clicked;call super::clicked;dw_date.Setcolumn('edate')
IF gs_code = '' Or IsNull(gs_code) THEN Return
dw_date.SetItem(1, 'edate', gs_code)
end event
...
event clicked;call super::clicked;dw_date.Setcolumn('sdate')
IF gs_code = '' Or IsNull(gs_code) THEN Return
dw_date.SetItem(1, 'sdate', gs_code)
end event
...
string text = "사양 기입 :  ~'A/S, CKD, S/P~'로 하시고, OEM은 현행대로 ~'.~' 입력"
...
Insert Into momast 
	(sabu, 	pordno, 	jidat,	itnbr,	pspec,		porgu, 		pdtgu,		esdat,	eedat,
	 ...
	 master_no,			master_parent,		kumno,      untno,      kestno)
 Select 
	 sabu, 	pordno, 	jidat,	itnbr,	pspec,		porgu, 		pdtgu,		esdat,	eedat,
	 fsdat,	fedat,	pdqty,	roqty,	peqty,		wtqty,		waqty,		paqty,	pdsts,
	 purgc,	cvcod,	unprc,	assiqt,	pa_pordno,	pa_ospeq,	st_opseq,	system_end_date,	bajpno,	
...
integer taborder = 40
boolean bringtotop = true
string dataobject = "d_pdt_02030_13"
boolean hscrollbar = true
boolean vscrollbar = true
boolean border = false
...
event itemchanged;string   snull, sitnbr, sreff, sreff1, sitdsc, sispec, sjijil, sispec_code, scvcod, &
			sdptno, spurgc, sporgu, scvnas, stuncu, sIogbn, sDptstock, sPordno, usechk
String   ls_pspec
...
event clicked;call super::clicked;dw_tabpage3_1.Setcolumn('momast_copy_jidat')
IF gs_code = '' Or IsNull(gs_code) THEN Return
dw_tabpage3_1.SetItem(1, 'momast_copy_jidat', gs_code)
end event
...
integer taborder = 10
boolean bringtotop = true
string dataobject = "d_pdt_02030_12"
boolean hscrollbar = true
boolean vscrollbar = true
boolean border = false
boolean hsplitscroll = true
