$PBExportHeader$w_pdt_02030_8.srw
$PBExportComments$작업지시시 공정편집 화면(MULTI)
forward
global type w_pdt_02030_8 from window
end type
type p_1 from uo_picture within w_pdt_02030_8
end type
type p_addrow from uo_picture within w_pdt_02030_8
end type
type p_4 from uo_picture within w_pdt_02030_8
end type
type p_3 from uo_picture within w_pdt_02030_8
end type
type dw_1 from datawindow within w_pdt_02030_8
end type
type rr_1 from roundrectangle within w_pdt_02030_8
end type
end forward
...
global w_pdt_02030_8 w_pdt_02030_8

type variables
string is_sysno, is_pordno, is_uptgbn
end variables
...
// 작업지시의 기본적인 내역을 Move
Select itnbr, pspec, master_no, pdqty into :sitnbr, :spspec, :smaster_no, :dpdqty
  From Momast_copy
 Where Sabu = :gs_sabu And Pordno = :is_pordno and master_no = :is_sysno;
...
dw_1.setitem(nRow, "morout_copy_pspec", 		sPspec)
dw_1.setitem(nRow, "morout_copy_pdqty", 		dpdqty)
dw_1.setitem(nRow, "morout_copy_master_no",	smaster_no)	
dw_1.setitem(nRow, "morout_copy_mogub",		'Y')
dw_1.setitem(nRow, "morout_copy_moseq",		10)

dw_1.setitem(nRow, "uptgbn", is_uptgbn)
...
integer height = 920
integer taborder = 10
string dataobject = "d_pdt_02030_8a"
