$PBExportHeader$w_qct_01547.srw
$PBExportComments$** 생산입고검사 이상발생통보서현황
forward
global type w_qct_01547 from w_standard_print
end type
type rr_1 from roundrectangle within w_qct_01547
end type
end forward

global type w_qct_01547 from w_standard_print
string title = "출하 이상 발생 통보서 현황"
rr_1 rr_1
end type
global w_qct_01547 w_qct_01547
...
if (IsNull(itnbr2) or itnbr2 = "")  then itnbr2 = "ZZZZZZ"
...
type p_preview from w_standard_print`p_preview within w_qct_01547
end type

type p_exit from w_standard_print`p_exit within w_qct_01547
end type

type p_print from w_standard_print`p_print within w_qct_01547
end type

type p_retrieve from w_standard_print`p_retrieve within w_qct_01547
end type
...
type st_10 from w_standard_print`st_10 within w_qct_01547
end type



type dw_print from w_standard_print`dw_print within w_qct_01547
string dataobject = "d_qct_01547_03_p"
end type

type dw_ip from w_standard_print`dw_ip within w_qct_01547
integer x = 55
integer y = 24
integer width = 3607
integer height = 136
...
type dw_list from w_standard_print`dw_list within w_qct_01547
integer x = 59
integer y = 188
integer width = 4530
integer height = 2124
string dataobject = "d_qct_01547_03"
