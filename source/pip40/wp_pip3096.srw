$PBExportHeader$wp_pip3096.srw
$PBExportComments$** 소급비교대장
forward
global type wp_pip3096 from w_standard_print
end type
type dw_1 from datawindow within wp_pip3096
end type
type dw_3 from datawindow within wp_pip3096
end type
type rb_1 from radiobutton within wp_pip3096
end type
type rb_2 from radiobutton within wp_pip3096
end type
type st_1 from statictext within wp_pip3096
end type
type rr_2 from roundrectangle within wp_pip3096
end type
end forward
	...
	IF sdwgubn = 'Y' then
		...
		INSERT INTO "P3_SOKUB_TMP_PAY"	 
		 ...
		 SELECT p8_eeditdatachild.empno as empno,  /*기타수당*/
				 ...
				 p8_eeditdatachild.rvbfamt  as amt,
				 p8_eeditdatachild.rvafamt  as samt,
...
//		WF_SETTEXT2()
	...
	END IF
//else
//	dw_list.dataobject = "dp_pip3110_21_ya"
//	dw_list.settransobject(sqlca)
//	
//	IF dw_list.Retrieve(sSaup,sStartYear,sStartYear,ls_gubun,sDeptcode,ls_JikJong) <=0 THEN
//		MessageBox("확 인","조회한 자료가 없습니다!!")
//		dw_list.SetRedraw(True)
//		Return -1
//		
...
type p_preview from w_standard_print`p_preview within wp_pip3096
integer y = 28
end type

type p_exit from w_standard_print`p_exit within wp_pip3096
end type

type p_print from w_standard_print`p_print within wp_pip3096
end type

type p_retrieve from w_standard_print`p_retrieve within wp_pip3096
end type

type st_window from w_standard_print`st_window within wp_pip3096
boolean visible = false
integer x = 2789
integer y = 2900
end type

type sle_msg from w_standard_print`sle_msg within wp_pip3096
boolean visible = false
integer x = 814
integer y = 2900
end type

type dw_datetime from w_standard_print`dw_datetime within wp_pip3096
boolean visible = false
integer x = 3282
integer y = 2900
end type

type st_10 from w_standard_print`st_10 within wp_pip3096
boolean visible = false
integer x = 453
integer y = 2900
end type

type gb_10 from w_standard_print`gb_10 within wp_pip3096
boolean visible = false
integer x = 439
integer y = 2864
end type

type dw_print from w_standard_print`dw_print within wp_pip3096
integer x = 3849
integer y = 2296
string dataobject = "dp_pip3095_1_p"
end type

type dw_ip from w_standard_print`dw_ip within wp_pip3096
integer x = 9
integer y = 24
integer width = 2304
integer height = 412
...
type dw_list from w_standard_print`dw_list within wp_pip3096
integer x = 50
integer y = 456
integer width = 4535
integer height = 1860
string dataobject = "dp_pip3096_1"
