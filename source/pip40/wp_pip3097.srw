$PBExportHeader$wp_pip3097.srw
$PBExportComments$** 소급집계표
forward
global type wp_pip3097 from w_standard_print
end type
type dw_1 from datawindow within wp_pip3097
end type
type dw_3 from datawindow within wp_pip3097
end type
type rb_1 from radiobutton within wp_pip3097
end type
type rb_2 from radiobutton within wp_pip3097
end type
type st_1 from statictext within wp_pip3097
end type
type rr_2 from roundrectangle within wp_pip3097
end type
end forward
...
type p_preview from w_standard_print`p_preview within wp_pip3097
end type

type p_exit from w_standard_print`p_exit within wp_pip3097
end type

type p_print from w_standard_print`p_print within wp_pip3097
end type

type p_retrieve from w_standard_print`p_retrieve within wp_pip3097
end type

type st_window from w_standard_print`st_window within wp_pip3097
boolean visible = false
end type

type sle_msg from w_standard_print`sle_msg within wp_pip3097
boolean visible = false
end type

type dw_datetime from w_standard_print`dw_datetime within wp_pip3097
boolean visible = false
end type

type st_10 from w_standard_print`st_10 within wp_pip3097
boolean visible = false
end type

type gb_10 from w_standard_print`gb_10 within wp_pip3097
boolean visible = false
end type

type dw_print from w_standard_print`dw_print within wp_pip3097
string dataobject = "dp_pip3095_1_s_p"
end type

type dw_ip from w_standard_print`dw_ip within wp_pip3097
integer x = 73
integer y = 28
integer width = 2002
integer height = 288
string dataobject = "dp_pip3095_s"
end type
...
type dw_list from w_standard_print`dw_list within wp_pip3097
integer x = 105
integer y = 344
integer width = 4407
integer height = 1960
string dataobject = "dp_pip3095_1_s"
