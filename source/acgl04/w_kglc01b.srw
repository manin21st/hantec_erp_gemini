$PBExportHeader$w_kglc01b.srw
$PBExportComments$미승인 전표 수정
forward
global type w_kglc01b from w_inherite
end type
type cb_2 from commandbutton within w_kglc01b
end type
type cb_yesan from commandbutton within w_kglc01b
end type
type dw_rtv from datawindow within w_kglc01b
end type
type dw_kwan from datawindow within w_kglc01b
end type
type dw_ins2 from u_key_enter within w_kglc01b
end type
type dw_ins from u_key_enter within w_kglc01b
end type
type dw_print from datawindow within w_kglc01b
end type
type dw_sang from datawindow within w_kglc01b
end type
type dw_sungin from datawindow within w_kglc01b
end type
type dw_descr from datawindow within w_kglc01b
end type
type p_yesan from uo_picture within w_kglc01b
end type
type cb_ins2 from commandbutton within w_kglc01b
end type
type p_detail from uo_picture within w_kglc01b
end type
type rr_5 from roundrectangle within w_kglc01b
end type
end forward
...
IF sColId = 'acc1_cd' or sColId = 'acc2_cd' or sColId = 'dcr_gu' THEN
	...
	dw_ins2.SetItem(iCurRow,"gita1",snull)
...
this.Control[iCurrent+13]=this.p_detail
this.Control[iCurrent+14]=this.rr_5
end on

on w_kglc01b.destroy
call super::destroy
...
dw_ins.SetItem(1,"saupj",    lstr_jpra.saupjang)
dw_ins.SetItem(1,"bal_date", lstr_jpra.baldate)
dw_ins.SetItem(1,"upmu_gu",  lstr_jpra.upmugu)
dw_ins.SetItem(1,"bjun_no",  lstr_jpra.bjunno)
dw_ins.SetItem(1,"jun_gu",   lstr_jpra.jun_gu)
...
type dw_insert from w_inherite`dw_insert within w_kglc01b
...
type p_delrow from w_inherite`p_delrow within w_kglc01b
integer x = 4078
end type
...
type p_addrow from w_inherite`p_addrow within w_kglc01b
integer x = 3904
...
type p_search from w_inherite`p_search within w_kglc01b
boolean visible = false
integer x = 3392
integer y = 2780
integer taborder = 0
...
type p_ins from w_inherite`p_ins within w_kglc01b
boolean visible = false
integer x = 3566
integer y = 2780
integer taborder = 0
...
type p_exit from w_inherite`p_exit within w_kglc01b
boolean visible = false
integer x = 2203
integer taborder = 0
end type

type p_can from w_inherite`p_can within w_kglc01b
integer x = 4425
integer taborder = 60
end type
...
type p_print from w_inherite`p_print within w_kglc01b
boolean visible = false
integer x = 2021
integer y = 16
integer taborder = 0
...
type p_inq from w_inherite`p_inq within w_kglc01b
boolean visible = false
integer x = 1833
integer y = 20
integer taborder = 0
...
type p_del from w_inherite`p_del within w_kglc01b
boolean visible = false
integer x = 3744
integer y = 2780
integer taborder = 0
...
type p_mod from w_inherite`p_mod within w_kglc01b
integer x = 4251
end type
...
type cb_exit from w_inherite`cb_exit within w_kglc01b
integer x = 3803
integer y = 3100
end type

type cb_mod from w_inherite`cb_mod within w_kglc01b
integer x = 2747
integer y = 3100
string text = "완료(&F)"
end type

type cb_ins from w_inherite`cb_ins within w_kglc01b
integer x = 1906
integer y = 3100
integer width = 379
string text = "줄저장(&A)"
...
type cb_del from w_inherite`cb_del within w_kglc01b
integer x = 2299
integer y = 3100
integer width = 379
string text = "줄삭제(&D)"
...
type cb_inq from w_inherite`cb_inq within w_kglc01b
integer x = 1513
integer y = 3100
end type

type cb_print from w_inherite`cb_print within w_kglc01b
integer x = 3099
integer y = 3100
end type

type st_1 from w_inherite`st_1 within w_kglc01b
end type

type cb_can from w_inherite`cb_can within w_kglc01b
integer x = 3451
integer y = 3100
end type

type cb_search from w_inherite`cb_search within w_kglc01b
integer x = 1339
integer y = 2804
end type
...
type gb_10 from w_inherite`gb_10 within w_kglc01b
integer height = 156
end type

type gb_button1 from w_inherite`gb_button1 within w_kglc01b
integer x = 613
integer y = 3056
integer width = 1257
integer height = 168
...
type gb_button2 from w_inherite`gb_button2 within w_kglc01b
integer x = 2720
integer y = 3056
integer width = 1445
integer height = 168
...
IF dw_ins.Retrieve(sSaupj,sBalDate,sUpmuGu,lJunNo,lLinNo,dw_ins.GetItemString(1,"jun_gu")) <=0 then Return
dw_ins2.Retrieve(sSaupj,sBalDate,sUpmuGu,lJunNo,lLinNo,dw_ins.GetItemString(1,"jun_gu"))
