$PBExportHeader$w_kglc02.srw
$PBExportComments$전표 승인 취소 처리
forward
global type w_kglc02 from w_inherite
end type
type dw_cond from u_key_enter within w_kglc02
end type
type dw_2 from u_d_select_sort within w_kglc02
end type
type dw_rtv from datawindow within w_kglc02
end type
type dw_1 from datawindow within w_kglc02
end type
type rr_1 from roundrectangle within w_kglc02
end type
type rr_2 from roundrectangle within w_kglc02
end type
end forward

global type w_kglc02 from w_inherite
string title = "전표 승인 취소 처리"
...
forward prototypes
public function integer wf_junpoyno (string sSaupj, string sUpmuGbn, string sYearMonth)
public function integer wf_check_junno (string ssaupj, string saccym, string supmugbn)
public function integer wf_check_standarddate (string saccdate)
end prototypes

public function integer wf_junpoyno (string sSaupj, string sUpmuGbn, string sYearMonth);Long iJunNo

iJunNo = Sqlca.Fun_Calc_JunNo(sJunpoyGbn,sSaupj,sUpmuGbn,sYearMonth)
...
type dw_insert from w_inherite`dw_insert within w_kglc02
...
type p_delrow from w_inherite`p_delrow within w_kglc02
boolean visible = false
integer x = 1975
integer y = 2984
integer taborder = 0
...
type p_addrow from w_inherite`p_addrow within w_kglc02
boolean visible = false
integer x = 1801
integer y = 2984
integer taborder = 0
...
type p_search from w_inherite`p_search within w_kglc02
integer x = 4270
integer taborder = 40
...
DO WHILE true
	...
	//일계 감산
	If F_Ilgye_Minus(dw_rtv) < 0 Then
		Rollback;
		Return
	End if
...
w_mdi_frame.SLE_MSG.TEXT ="승인 취소 처리 완료!!"
...
type p_ins from w_inherite`p_ins within w_kglc02
boolean visible = false
integer x = 1627
integer y = 2984
integer taborder = 0
...
type p_exit from w_inherite`p_exit within w_kglc02
integer taborder = 50
end type

type p_can from w_inherite`p_can within w_kglc02
boolean visible = false
integer x = 2496
integer y = 2984
integer taborder = 0
...
type p_print from w_inherite`p_print within w_kglc02
boolean visible = false
integer x = 1847
integer y = 3148
integer taborder = 0
...
type p_inq from w_inherite`p_inq within w_kglc02
integer x = 4096
integer taborder = 20
end type
...
type p_del from w_inherite`p_del within w_kglc02
boolean visible = false
integer x = 2322
integer y = 2984
integer taborder = 0
...
type p_mod from w_inherite`p_mod within w_kglc02
boolean visible = false
integer x = 2149
integer y = 2984
integer taborder = 0
...
type cb_exit from w_inherite`cb_exit within w_kglc02
integer x = 3264
integer y = 2584
end type

type cb_mod from w_inherite`cb_mod within w_kglc02
integer x = 2807
integer y = 2560
integer width = 439
integer height = 116
...
type cb_ins from w_inherite`cb_ins within w_kglc02
integer x = 2043
integer y = 2472
end type

type cb_del from w_inherite`cb_del within w_kglc02
integer x = 1641
integer y = 2616
end type

type cb_inq from w_inherite`cb_inq within w_kglc02
integer x = 2235
integer y = 2544
end type
...
type cb_print from w_inherite`cb_print within w_kglc02
integer x = 1687
integer y = 2484
end type

type st_1 from w_inherite`st_1 within w_kglc02
end type

type cb_can from w_inherite`cb_can within w_kglc02
integer x = 2034
integer y = 2616
end type

type cb_search from w_inherite`cb_search within w_kglc02
integer x = 1806
integer y = 2768
end type
...
type gb_button1 from w_inherite`gb_button1 within w_kglc02
integer x = 2171
integer y = 2500
integer width = 416
integer height = 176
...
type gb_button2 from w_inherite`gb_button2 within w_kglc02
integer x = 2770
integer y = 2524
integer width = 864
integer height = 176
...
integer height = 756
boolean bringtotop = true
string dataobject = "dw_kglc022_1"
boolean vscrollbar = true
boolean border = false
boolean livescroll = true
end type
