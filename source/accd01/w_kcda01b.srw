...
type rr_1 from roundrectangle within w_kcda01b
end type
type rr_2 from roundrectangle within w_kcda01b
end type
end forward
...
event open;String sMsgParm,sAcc1Name,sAcc2Name
...
IF ib_Changed = True THEN
	IF MessageBox("확 인","저장하지 않은 자료가 있습니다!!"+"~n"+&
...
event clicked;call super::clicked;String  sKwanColName
Integer i
