$PBExportHeader$w_mat_05060.srw
$PBExportComments$자재 입출고 현황[품목별]
forward
global type w_mat_05060 from w_standard_print
end type
type shl_1 from statichyperlink within w_mat_05060
end type
type shl_2 from statichyperlink within w_mat_05060
end type
type st_1 from statictext within w_mat_05060
end type
type st_5 from statictext within w_mat_05060
end type
type shl_3 from statichyperlink within w_mat_05060
end type
type shl_5 from statichyperlink within w_mat_05060
end type
type st_2 from statictext within w_mat_05060
end type
type rr_1 from roundrectangle within w_mat_05060
end type
end forward

global type w_mat_05060 from w_standard_print
string title = "자재 입출고 현황[품목별]"
string menuname = ""
shl_1 shl_1
shl_2 shl_2
st_1 st_1
...
global w_mat_05060 w_mat_05060
...
type p_preview from w_standard_print`p_preview within w_mat_05060
boolean visible = false
integer x = 2843
integer y = 12
end type

type p_exit from w_standard_print`p_exit within w_mat_05060
end type

type p_print from w_standard_print`p_print within w_mat_05060
boolean visible = false
integer x = 3017
integer y = 12
end type

type p_retrieve from w_standard_print`p_retrieve within w_mat_05060
integer x = 4265
end type
...
type st_10 from w_standard_print`st_10 within w_mat_05060
end type



type dw_print from w_standard_print`dw_print within w_mat_05060
integer x = 3255
string dataobject = "d_mat_05060_1"
end type

type dw_ip from w_standard_print`dw_ip within w_mat_05060
integer y = 96
integer width = 2912
integer height = 144
string dataobject = "d_mat_05060"
end type

type dw_list from w_standard_print`dw_list within w_mat_05060
...
lw_window = parent.GetFirstSheet()
DO WHILE IsValid(lw_window)
	if ClassName(lw_window) = 'w_mat_05050' then
		lb_isopen = TRUE
		Exit
	else		
		lw_window = parent.GetNextSheet(lw_window)
