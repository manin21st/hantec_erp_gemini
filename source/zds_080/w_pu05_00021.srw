$PBExportHeader$w_pu05_00021.srw
$PBExportComments$** 주간 외주계획 마감
forward
global type w_pu05_00021 from w_inherite
end type
type dw_weekplan from datawindow within w_pu05_00021
end type
type p_1 from picture within w_pu05_00021
end type
type dw_1 from datawindow within w_pu05_00021
end type
type rr_2 from roundrectangle within w_pu05_00021
end type
type dw_insert2 from datawindow within w_pu05_00021
end type
type dw_7 from datawindow within w_pu05_00021
end type
type st_2 from statictext within w_pu05_00021
end type
type cbx_qty from checkbox within w_pu05_00021
end type
type pb_1 from u_pb_cal within w_pu05_00021
end type
type dw_pomast from datawindow within w_pu05_00021
end type
type dw_poblkt from datawindow within w_pu05_00021
end type
type p_2 from picture within w_pu05_00021
end type
type cb_1 from commandbutton within w_pu05_00021
end type
type dw_weekplan2 from datawindow within w_pu05_00021
end type
type cb_2 from commandbutton within w_pu05_00021
end type
type rr_3 from roundrectangle within w_pu05_00021
end type
type rr_1 from roundrectangle within w_pu05_00021
end type
end forward
...
global w_pu05_00021 w_pu05_00021
...
long		lrow1, lrow2, lrow3, lins1, lins2, lfrow, lcnt, lins3
...
//		 where cvgu = '5' and soguan = '1' and ipjogun = :ssaupj and jumaechul = '2' and juhandle = '1' and rownum = 1 ;
		select cvcod into :sdepot from vndmst
		 where cvgu = '5' and soguan = '1' and ipjogun = :ssaupj and jumaechul = '2' and juhandle = '1'
		   and email = 'Y' and homepage = 'N' and rownum = 1 ;
...
//		messagebox(sittyp, sdepot)
		...
		seono    = dw_weekplan.getitemstring(lrow2, 'eo_no')  		/* EO NO */
		seodate = dw_weekplan.getitemstring(lrow2, 'eo_date')		/* 시작일자 */
		...
		if dm01 > 0 and wf_balju_cnt(arg_yymmdd, date01, scvcod, sitnbr) = 0 then
			...
			dw_poblkt.SetItem(lins2,'eo_no',seono)
			dw_poblkt.SetItem(lins2,'eo_date',seodate)
		end if
...
Long   ll_chk
Long   ll_scm
String ls_baljpno, ls_eono, ls_eodate

For i = 1 To ll_cnt
	ls_baljpno = dw_weekplan.GetItemString(i, 'baljpno')
	ls_eono = dw_weekplan.GetItemString(i, 'eo_no')
	ls_eodate = dw_weekplan.GetItemString(i, 'eo_date')
...
// 주간발주내역만 가져와 발주확정한다
if dw_weekplan.retrieve(ssaupj,arg_yymmdd, arg_webcnf) < 1 then return -1
...
dw_weekplan.Retrieve(ssaupj, arg_yymmdd, arg_webcnf)
...
type dw_insert from w_inherite`dw_insert within w_pu05_00021
integer x = 69
integer y = 332
integer width = 4489
integer height = 1856
...
type p_delrow from w_inherite`p_delrow within w_pu05_00021
...
type p_addrow from w_inherite`p_addrow within w_pu05_00021
boolean visible = false
integer x = 5486
integer y = 592
boolean enabled = false
...
type p_search from w_inherite`p_search within w_pu05_00021
integer x = 3680
integer y = 16
...
type p_ins from w_inherite`p_ins within w_pu05_00021
boolean visible = false
integer x = 5312
integer y = 592
boolean enabled = false
...
type p_exit from w_inherite`p_exit within w_pu05_00021
integer x = 4338
integer y = 16
end type
...
type p_can from w_inherite`p_can within w_pu05_00021
integer x = 4160
integer y = 16
end type
...
type p_print from w_inherite`p_print within w_pu05_00021
boolean visible = false
integer x = 4965
integer y = 592
boolean enabled = false
...
type p_inq from w_inherite`p_inq within w_pu05_00021
integer x = 3323
integer y = 16
end type
...
type p_del from w_inherite`p_del within w_pu05_00021
boolean visible = false
integer x = 5129
integer y = 312
boolean enabled = false
...
type p_mod from w_inherite`p_mod within w_pu05_00021
integer x = 3502
integer y = 16
...
type cb_exit from w_inherite`cb_exit within w_pu05_00021
end type

type cb_mod from w_inherite`cb_mod within w_pu05_00021
end type

type cb_ins from w_inherite`cb_ins within w_pu05_00021
end type

type cb_del from w_inherite`cb_del within w_pu05_00021
end type

type cb_inq from w_inherite`cb_inq within w_pu05_00021
end type

type cb_print from w_inherite`cb_print within w_pu05_00021
end type

type st_1 from w_inherite`st_1 within w_pu05_00021
end type

type cb_can from w_inherite`cb_can within w_pu05_00021
end type

type cb_search from w_inherite`cb_search within w_pu05_00021
end type
...
type gb_button1 from w_inherite`gb_button1 within w_pu05_00021
end type

type gb_button2 from w_inherite`gb_button2 within w_pu05_00021
end type
...
event clicked;/* 임시 복구처리 - 담당자 선택pop-up이 안뜨는 로직 - by shingoon 20180319 */
cb_2.TriggerEvent(Clicked!)

//string	syymm  ,sjucha ,syymmdd ,ls_confirm_t, stemp, ssaupj
//Long     ll_jucha , ll_cnt , ll_confirm
//String   sCvcod
//
//If dw_1.AcceptText() <> 1 Then Return
