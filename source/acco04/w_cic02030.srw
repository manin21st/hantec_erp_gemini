$PBExportHeader$w_cic02030.srw
$PBExportComments$제품별 소요량표
forward
global type w_cic02030 from w_standard_print
end type
type rr_1 from roundrectangle within w_cic02030
end type
end forward
...
integer x = 0
integer y = 0
string title = "제품별 소요량표"
rr_1 rr_1
end type
global w_cic02030 w_cic02030
...
type p_xls from w_standard_print`p_xls within w_cic02030
end type

type p_sort from w_standard_print`p_sort within w_cic02030
end type

type p_preview from w_standard_print`p_preview within w_cic02030
integer y = 8
end type

type p_exit from w_standard_print`p_exit within w_cic02030
integer y = 4
end type

type p_print from w_standard_print`p_print within w_cic02030
integer x = 4265
integer y = 4
end type

type p_retrieve from w_standard_print`p_retrieve within w_cic02030
integer x = 3918
integer y = 8
end type
...
Else
	...
	//dw_list.SetFocus()
	dw_print.Retrieve(sSaupj, sWorkym_f, sWorkym_t)
End If
...
type st_10 from w_standard_print`st_10 within w_cic02030
end type

type gb_10 from w_standard_print`gb_10 within w_cic02030
integer width = 3589
end type

type dw_print from w_standard_print`dw_print within w_cic02030
integer x = 3662
integer y = 24
integer width = 210
integer height = 148
string dataobject = "dw_cic02030_20_detail"
boolean hscrollbar = true
boolean vscrollbar = true
end type

type dw_ip from w_standard_print`dw_ip within w_cic02030
integer x = 37
integer y = 8
integer width = 2331
integer height = 152
string dataobject = "dw_cic02030_10"
end type
...
type dw_list from w_standard_print`dw_list within w_cic02030
integer x = 59
integer y = 220
integer width = 4549
integer height = 1972
string title = "제품별 소요량표"
string dataobject = "dw_cic02030_20"
