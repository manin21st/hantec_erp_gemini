$PBExportHeader$w_cic04200.srw
$PBExportComments$기초이월등록(제품)
forward
global type w_cic04200 from w_inherite
end type
type dw_2 from datawindow within w_cic04200
end type
type gb_4 from groupbox within w_cic04200
end type
type dw_1 from datawindow within w_cic04200
end type
type dw_choose from datawindow within w_cic04200
end type
type p_1 from uo_picture within w_cic04200
end type
type rr_1 from roundrectangle within w_cic04200
end type
end forward
...
type dw_insert from w_inherite`dw_insert within w_cic04200
...
type p_delrow from w_inherite`p_delrow within w_cic04200
integer x = 3877
integer taborder = 0
end type
...
type p_addrow from w_inherite`p_addrow within w_cic04200
integer x = 3694
integer taborder = 0
end type
...
dw_2.SetItem(dw_2.Rowcount(),'cic0110_workym',syymm)
dw_2.SetItem(dw_2.Rowcount(),'cic0110_saupj',saup)


end event

type p_search from w_inherite`p_search within w_cic04200
boolean visible = false
integer x = 5010
integer y = 184
integer taborder = 20
...
type p_ins from w_inherite`p_ins within w_cic04200
boolean visible = false
integer x = 5193
integer y = 184
integer taborder = 50
...
type p_exit from w_inherite`p_exit within w_cic04200
integer x = 4425
integer taborder = 70
end type

type p_can from w_inherite`p_can within w_cic04200
integer x = 4242
integer taborder = 60
end type
...
type p_print from w_inherite`p_print within w_cic04200
integer x = 5376
integer y = 184
integer taborder = 0
end type

type p_inq from w_inherite`p_inq within w_cic04200
integer x = 3511
integer taborder = 30
end type
...
type p_del from w_inherite`p_del within w_cic04200
integer x = 4827
integer y = 192
integer taborder = 0
end type
...
type p_mod from w_inherite`p_mod within w_cic04200
integer x = 4059
integer taborder = 40
end type
...
if ll_rowcount < 1 then return
	...
	for ll_row =  1 to ll_rowcount
		sqty   = dw_2.GetItemnumber(ll_row, 'cic0110_wp_qty')
		
		If IsNull(sqty) Or sqty = 0 Then
			f_messagechk(1, '[기말/기초수량]')
			dw_2.SetColumn('cic0110_wp_qty')
			dw_2.SetFocus()
			Return
		End If
...
type cb_exit from w_inherite`cb_exit within w_cic04200
integer x = 3026
integer y = 2752
end type

type cb_mod from w_inherite`cb_mod within w_cic04200
integer x = 2199
integer y = 2752
end type
...
type cb_ins from w_inherite`cb_ins within w_cic04200
integer x = 503
integer y = 2752
end type
...
type cb_del from w_inherite`cb_del within w_cic04200
integer x = 2551
integer y = 2752
end type
...
type cb_inq from w_inherite`cb_inq within w_cic04200
integer x = 142
integer y = 2752
end type
...
type cb_print from w_inherite`cb_print within w_cic04200
integer x = 1650
integer y = 2424
end type

type st_1 from w_inherite`st_1 within w_cic04200
integer width = 293
end type

type cb_can from w_inherite`cb_can within w_cic04200
integer x = 2907
integer y = 2752
end type
...
type cb_search from w_inherite`cb_search within w_cic04200
integer x = 2053
integer y = 2432
end type

type dw_datetime from w_inherite`dw_datetime within w_cic04200
integer height = 88
end type

type sle_msg from w_inherite`sle_msg within w_cic04200
integer x = 329
integer width = 2533
end type

type gb_10 from w_inherite`gb_10 within w_cic04200
integer width = 3607
end type

type gb_button1 from w_inherite`gb_button1 within w_cic04200
integer x = 110
integer y = 2696
end type

type gb_button2 from w_inherite`gb_button2 within w_cic04200
integer x = 2153
integer y = 2696
end type
...
integer taborder = 80
string title = "기초이월등록(제품)"
string dataobject = "dw_cic04200_20"
...
IF this.GetColumnName() ="cic0110_itnbr" THEN
	
	sitnbr = dw_2.GetItemString(dw_2.GetRow(),'cic0110_itnbr')
			...
			if count = '0' or isnull(count) or count = '' then
				...
				dw_2.insertrow(0)	
				dw_2.SetColumn('cic0110_itnbr')
				dw_2.SetFocus()
				return
			elseif ls_ittyp ='1' then
				...
				//dw_2.SetItem(dw_2.GetRow() ,'cic0110_workym',syymm)
				//dw_2.SetItem(dw_2.GetRow() ,'cic0110_saupj',saup)
			else
...
IF this.GetColumnName() ="cic0110_wp_qty" THEN

		sitnbr = dw_2.GetItemString(Getrow(),'cic0110_itnbr')
		syymm = dw_1.GetItemString(dw_1.Getrow(),'workym')
		...
		sqty = dw_2.GetItemnumber(Getrow(),'cic0110_wp_qty')
		samt = round(sqty * sdan,2)
		dw_2.Setitem(Getrow(),'dan',sdan)
		dw_2.Setitem(Getrow(),'cic0110_wp_amt',samt)
		
END IF

IF this.GetColumnName() ="cic0110_wp_amt" THEN
	
		samt = dw_2.GetItemnumber(Getrow(),'cic0110_wp_amt')
		sqty = dw_2.GetItemnumber(Getrow(),'cic0110_wp_qty')
...
if ll_lstrow < 1 then Return
	...
	ll_rowcount = dw_2.GetRow() 
		...
		For ll_row = 1 to ll_lstrow
			...
			This.SetItem(( ll_rowcount ), 'cic0110_itnbr', ls_itnbr )
			...
			dw_2.SetItem(ll_rowcount,'cic0110_workym',syymm)
			dw_2.SetItem(ll_rowcount,'cic0110_saupj',saup)
...
integer height = 160
integer taborder = 10
string dataobject = "dw_cic04200_10"
boolean border = false
boolean livescroll = true
end type
...
SetPointer(HourGlass!)
DECLARE cic0110_iwol_sp PROCEDURE FOR cic0110_iwol_sp(:sWorkym,:sImgbn);
EXECUTE cic0110_iwol_sp;
