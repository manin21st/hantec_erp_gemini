$PBExportHeader$w_cic02090.srw
$PBExportComments$제품수불집계표
forward
global type w_cic02090 from w_standard_print
end type
end forward

global type w_cic02090 from w_standard_print
string title = "제품수불집계표"
end type
global w_cic02090 w_cic02090
...
on w_cic02090.create
call super::create
end on

on w_cic02090.destroy
call super::destroy
...
type p_xls from w_standard_print`p_xls within w_cic02090
end type

type p_sort from w_standard_print`p_sort within w_cic02090
end type

type p_preview from w_standard_print`p_preview within w_cic02090
end type

type p_exit from w_standard_print`p_exit within w_cic02090
end type

type p_print from w_standard_print`p_print within w_cic02090
end type

type p_retrieve from w_standard_print`p_retrieve within w_cic02090
end type
...
type st_10 from w_standard_print`st_10 within w_cic02090
end type



type dw_print from w_standard_print`dw_print within w_cic02090
string dataobject = "dw_cic02090_2_p"
end type

type dw_ip from w_standard_print`dw_ip within w_cic02090
integer width = 2555
integer height = 216
string dataobject = "dw_cic02090_1"
end type
...
type dw_list from w_standard_print`dw_list within w_cic02090
integer y = 232
integer height = 2020
string dataobject = "dw_cic02090_2"
end type
