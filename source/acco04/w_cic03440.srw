$PBExportHeader$w_cic03440.srw
$PBExportComments$매출원가명세서 출력(추가)
forward
global type w_cic03440 from w_standard_print
end type
type rr_1 from roundrectangle within w_cic03440
end type
end forward
...
integer x = 0
integer y = 0
string title = "매출원가 명세서"
rr_1 rr_1
end type
global w_cic03440 w_cic03440
...
type p_xls from w_standard_print`p_xls within w_cic03440
end type

type p_sort from w_standard_print`p_sort within w_cic03440
end type

type p_preview from w_standard_print`p_preview within w_cic03440
integer y = 8
end type

type p_exit from w_standard_print`p_exit within w_cic03440
integer y = 8
end type

type p_print from w_standard_print`p_print within w_cic03440
integer x = 4265
integer y = 8
end type

type p_retrieve from w_standard_print`p_retrieve within w_cic03440
integer x = 3918
integer y = 8
end type
...
type st_10 from w_standard_print`st_10 within w_cic03440
end type

type gb_10 from w_standard_print`gb_10 within w_cic03440
integer width = 3589
end type

type dw_print from w_standard_print`dw_print within w_cic03440
integer x = 3662
integer y = 24
integer width = 210
integer height = 148
string dataobject = "d_cic03440_1_p"
boolean hscrollbar = true
boolean vscrollbar = true
end type

type dw_ip from w_standard_print`dw_ip within w_cic03440
integer x = 37
integer y = 8
integer width = 3035
integer height = 152
string dataobject = "dw_cic03440_10"
end type
...
type dw_list from w_standard_print`dw_list within w_cic03440
integer x = 55
integer y = 176
integer width = 4553
integer height = 2016
string title = "제조원가 계산명세서"
string dataobject = "dw_cic03440_20_detail"
