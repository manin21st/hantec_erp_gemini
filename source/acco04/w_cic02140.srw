$PBExportHeader$w_cic02140.srw
$PBExportComments$매출집계표
forward
global type w_cic02140 from w_standard_print
end type
end forward
...
on w_cic02140.create
call super::create
end on

on w_cic02140.destroy
call super::destroy
...
type dw_print from w_standard_print`dw_print within w_cic02140
string dataobject = "dw_cic02140_2_p"
end type

type dw_ip from w_standard_print`dw_ip within w_cic02140
integer x = 37
integer y = 0
integer width = 3584
integer height = 224
string dataobject = "dw_cic02140_1"
end type
...
if This.GetColumnName() = 'ittyp' then
	...
	if ls_ittyp = '1' then
		...
		dw_list.dataobject="dw_cic02140_2"
		dw_list.settransobject(sqlca)
		dw_print.dataobject="dw_cic02140_2_p"
		dw_print.settransobject(sqlca)	
		dw_ip.Modify('t_3.text = "분기"')
	elseif ls_ittyp = '2' then
		dw_ip.Modify('banki.visible = 1')
		dw_ip.Modify('bunki.visible = 0')
		dw_list.dataobject="dw_cic02140_3"
		dw_list.settransobject(sqlca)
		dw_print.dataobject="dw_cic02140_3_p"
		dw_print.settransobject(sqlca)
...
type dw_list from w_standard_print`dw_list within w_cic02140
integer y = 232
integer height = 2020
string dataobject = "dw_cic02140_2"
end type
