$PBExportHeader$w_cic04100.srw
$PBExportComments$기초이월등록(원부자재)
forward
global type w_cic04100 from w_inherite
end type
type dw_2 from datawindow within w_cic04100
end type
type gb_4 from groupbox within w_cic04100
end type
type dw_1 from datawindow within w_cic04100
end type
type dw_choose from datawindow within w_cic04100
end type
type p_1 from uo_picture within w_cic04100
end type
type rr_1 from roundrectangle within w_cic04100
end type
end forward

global type w_cic04100 from w_inherite
integer width = 4635
string title = "기초이월등록(원부자재)"
dw_2 dw_2
gb_4 gb_4
dw_1 dw_1
dw_choose dw_choose
...
type dw_insert from w_inherite`dw_insert within w_cic04100
...
type p_delrow from w_inherite`p_delrow within w_cic04100
integer x = 3877
integer taborder = 0
end type
...
type p_addrow from w_inherite`p_addrow within w_cic04100
integer x = 3694
integer taborder = 0
end type
...
string syymm, saup, sittyp

syymm   = dw_1.GetItemString(dw_1.GetRow(), 'workym')
saup = dw_1.GetItemString(dw_1.GetRow(),'saupj')
sittyp = dw_1.GetItemString(dw_1.GetRow(),'ittyp')

dw_2.SetItem(dw_2.Rowcount(),'cic0100_workym',syymm)
dw_2.SetItem(dw_2.Rowcount(),'cic0100_saupj',saup)
dw_2.SetItem(dw_2.Rowcount(),'cic0100_ittyp',sittyp)


end event

type p_search from w_inherite`p_search within w_cic04100
boolean visible = false
integer x = 5010
integer y = 184
integer taborder = 20
...
type p_ins from w_inherite`p_ins within w_cic04100
boolean visible = false
integer x = 5193
integer y = 184
integer taborder = 50
...
type p_exit from w_inherite`p_exit within w_cic04100
integer x = 4425
integer taborder = 70
end type

type p_can from w_inherite`p_can within w_cic04100
integer x = 4242
integer taborder = 60
end type
...
type p_print from w_inherite`p_print within w_cic04100
integer x = 5376
integer y = 184
integer taborder = 0
end type

type p_inq from w_inherite`p_inq within w_cic04100
integer x = 3511
integer taborder = 30
end type
...
lRowcnt = dw_2.Retrieve(sWorkym, sImgbn, sittyp)
...
type p_del from w_inherite`p_del within w_cic04100
integer x = 4827
integer y = 192
integer taborder = 0
end type
...
type p_mod from w_inherite`p_mod within w_cic04100
integer x = 4059
integer taborder = 40
end type

event p_mod::clicked;call super::clicked;String sWorkym, sImgbn, sittyp, sitnbr1, sitnbr2
long ll_rowcount,  ll_row, ll_rowcou, sqty
...
for ll_row =  1 to ll_rowcount
	sqty   = dw_2.GetItemnumber(ll_row, 'cic0100_wp_qty')
	
	If IsNull(sqty) Or sqty = 0 Then
		f_messagechk(1, '[기말/기초수량]')
		dw_2.SetColumn('cic0100_wp_qty')
		dw_2.SetFocus()
		Return
	End If
...
ll_rowcou =  dw_2.GetRow()
for ll_row =  1 to ll_rowcount
	sitnbr1   = dw_2.GetItemString(ll_rowcou, 'cic0100_itnbr')
	sitnbr2   = dw_2.GetItemString(ll_row, 'cic0100_itnbr')
	
	If sitnbr1 = sitnbr2 Then
		if ll_rowcou <> ll_row then
			MessageBox("알림", "동일한 자재코드가 존재합니다.!!!")
			dw_2.SetColumn('cic0100_itnbr')
			dw_2.SetFocus()
			Return
		End if
	End If
...
type cb_exit from w_inherite`cb_exit within w_cic04100
integer x = 3026
integer y = 2752
end type

type cb_mod from w_inherite`cb_mod within w_cic04100
integer x = 2199
integer y = 2752
end type
...
type cb_ins from w_inherite`cb_ins within w_cic04100
integer x = 503
integer y = 2752
end type
...
type cb_del from w_inherite`cb_del within w_cic04100
integer x = 2551
integer y = 2752
end type
...
type cb_inq from w_inherite`cb_inq within w_cic04100
integer x = 142
integer y = 2752
end type
...
type cb_print from w_inherite`cb_print within w_cic04100
integer x = 1650
integer y = 2424
end type

type st_1 from w_inherite`st_1 within w_cic04100
integer width = 293
end type

type cb_can from w_inherite`cb_can within w_cic04100
integer x = 2907
integer y = 2752
end type
...
type cb_search from w_inherite`cb_search within w_cic04100
integer x = 2053
integer y = 2432
end type

type dw_datetime from w_inherite`dw_datetime within w_cic04100
integer height = 88
end type

type sle_msg from w_inherite`sle_msg within w_cic04100
integer x = 329
integer width = 2533
end type

type gb_10 from w_inherite`gb_10 within w_cic04100
integer width = 3607
end type

type gb_button1 from w_inherite`gb_button1 within w_cic04100
integer x = 110
integer y = 2696
end type

type gb_button2 from w_inherite`gb_button2 within w_cic04100
integer x = 2153
integer y = 2696
end type
...
integer taborder = 80
string title = "기초이월등록(원부자재)"
string dataobject = "dw_cic04100_20"
...
IF this.GetColumnName() ="cic0100_itnbr" THEN
	
	sitnbr = dw_2.GetItemString(dw_2.GetRow(),'cic0100_itnbr')
			...
			if count = '0' or isnull(count) or count = '' then
				messagebox("확인","존재하지않는 자재코드 입니다.!I!")
				dw_2.deleterow( dw_2.GetRow())
				dw_2.insertrow(0)	
				dw_2.SetColumn('cic0100_itnbr')
				dw_2.SetFocus()
				return
			elseif ls_ittyp ='3' or ls_ittyp = '4' or ls_ittyp = '5' then
...
//				syymm   = dw_1.GetItemString(dw_1.GetRow(), 'workym')
//				saup = dw_1.GetItemString(dw_1.GetRow(),'saupj')
//				ls_ittyp = dw_1.GetItemString(dw_1.GetRow(),'ittyp')
//	
//				dw_2.SetItem(dw_2.GetRow() ,'cic0100_workym',syymm)
//				dw_2.SetItem(dw_2.GetRow() ,'cic0100_saupj',saup)
//				dw_2.SetItem(dw_2.GetRow() ,'cic0100_ittyp',ls_ittyp)
			else
				messagebox("확인","품목구분이 올바르지 않습니다.!!!")
				dw_2.deleterow( dw_2.GetRow())
				dw_2.insertrow(0)		
				dw_2.SetColumn('cic0100_itnbr')
				dw_2.SetFocus()
...
IF this.GetColumnName() ="cic0100_wp_qty" THEN

		sitnbr = dw_2.GetItemString(Getrow(),'cic0100_itnbr')
		syymm = dw_1.GetItemString(dw_1.Getrow(),'workym')
		...
		sqty = dw_2.GetItemnumber(Getrow(),'cic0100_wp_qty')
		samt = round(sqty * sdan,2)
		if  isnull(samt) then samt = 0
		dw_2.Setitem(Getrow(),'dan',sdan)
		dw_2.Setitem(Getrow(),'cic0100_wp_amt',samt)
		
END IF

IF this.GetColumnName() ="cic0100_wp_amt" THEN
	
		samt = dw_2.GetItemnumber(Getrow(),'cic0100_wp_amt')
		sqty = dw_2.GetItemnumber(Getrow(),'cic0100_wp_qty')
...
string ls_itnbr, ls_titnm, ls_ispec, syymm, saup, ls_ittyp, ls_filter
...
ll_rowcount = dw_2.GetRow() 
		...
		For ll_row = 1 to ll_lstrow
			...
			select titnm, ispec, ittyp
			into :ls_titnm, :ls_ispec, :ls_ittyp
			from cic_itemas_vw
			where itnbr = :ls_itnbr;
			
			This.SetItem(( ll_rowcount ), 'cic0100_itnbr', ls_itnbr )
			...
			dw_2.SetItem(ll_rowcount,'cic0100_workym',syymm)
			dw_2.SetItem(ll_rowcount,'cic0100_saupj',saup)
			dw_2.SetItem(ll_rowcount,'cic0100_ittyp',ls_ittyp)
...
integer height = 160
integer taborder = 10
string dataobject = "dw_cic04100_10"
boolean border = false
boolean livescroll = true
end type
...
SetPointer(HourGlass!)
DECLARE cic0100_iwol_sp PROCEDURE FOR cic0100_iwol_sp(:sWorkym,:sImgbn);
EXECUTE cic0100_iwol_sp;
