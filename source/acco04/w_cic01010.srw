$PBExportHeader$w_cic01010.srw
$PBExportComments$기말재공품등록
forward
global type w_cic01010 from w_inherite
end type
type dw_1 from datawindow within w_cic01010
end type
type dw_2 from datawindow within w_cic01010
end type
type dw_3 from datawindow within w_cic01010
end type
type dw_5 from datawindow within w_cic01010
end type
type dw_6 from datawindow within w_cic01010
end type
type p_new from uo_picture within w_cic01010
end type
type r_1 from rectangle within w_cic01010
end type
type r_2 from rectangle within w_cic01010
end type
end forward
...
type dw_insert from w_inherite`dw_insert within w_cic01010
integer y = 2476
end type

type p_delrow from w_inherite`p_delrow within w_cic01010
integer x = 3922
...
type p_addrow from w_inherite`p_addrow within w_cic01010
integer x = 3749
boolean originalsize = true
end type
...
type p_search from w_inherite`p_search within w_cic01010
...
String ls_filter1
double ll_jqty, ll_danga, ll_totqty, ll_qty, ll_amt
...
ELSE
	...
	ll_qty =   dw_2.GetItemNumber(dw_2.GetSelectedRow(0), "wp_qty")
...
type p_ins from w_inherite`p_ins within w_cic01010
boolean visible = false
integer x = 2706
boolean enabled = false
end type

type p_exit from w_inherite`p_exit within w_cic01010
end type

type p_can from w_inherite`p_can within w_cic01010
end type
...
type p_print from w_inherite`p_print within w_cic01010
boolean visible = false
integer x = 2533
boolean enabled = false
end type

type p_inq from w_inherite`p_inq within w_cic01010
integer x = 3570
boolean originalsize = true
end type
...
type p_del from w_inherite`p_del within w_cic01010
boolean visible = false
integer x = 2898
integer y = 28
boolean enabled = false
...
type p_mod from w_inherite`p_mod within w_cic01010
integer x = 4096
boolean originalsize = true
end type
...
type cb_exit from w_inherite`cb_exit within w_cic01010
end type

type cb_mod from w_inherite`cb_mod within w_cic01010
end type

type cb_ins from w_inherite`cb_ins within w_cic01010
end type

type cb_del from w_inherite`cb_del within w_cic01010
end type

type cb_inq from w_inherite`cb_inq within w_cic01010
end type

type cb_print from w_inherite`cb_print within w_cic01010
end type

type st_1 from w_inherite`st_1 within w_cic01010
end type

type cb_can from w_inherite`cb_can within w_cic01010
end type

type cb_search from w_inherite`cb_search within w_cic01010
end type
...
type gb_button1 from w_inherite`gb_button1 within w_cic01010
end type

type gb_button2 from w_inherite`gb_button2 within w_cic01010
end type
...
string title = "none"
string dataobject = "dw_cic01010_1"
...
boolean bringtotop = true
string title = "none"
string dataobject = "dw_cic01010_2"
boolean border = false
boolean livescroll = true
end type
...
event itemchanged;long ll_qty, ll_danga, ll_amt, ll_jqty, ll_totqty
int lrow, i
...
boolean bringtotop = true
string title = "none"
string dataobject = "dw_cic01010_3"
boolean border = false
boolean livescroll = true
end type
...
event clicked;call super::clicked;String sWorkym, snull 
Long   lRecCnt
SetNull(snull)
...
sWorkym = Trim(dw_1.GetItemString(dw_1.GetRow(), 'yymm'))
...
DECLARE SP_CREATE_CIC0120_SP PROCEDURE FOR CIC0120_SP (:sWorkym) USING SQLCA;
EXECUTE SP_CREATE_CIC0120_SP;
//STRING sPrcRtn
//FETCH SP_CREATE_CIC0120_SP INTO :sPrcRtn ;
CLOSE SP_CREATE_CIC0120_SP;
If SQLCA.SQLCODE < 0 Then
   f_message_chk(57, "~r~n~r~n[EXECUTE SP_CREATE_CIC0120_SP]~r~n~r~n" + SQLCA.SQLERRTEXT)	// 자료를 처리할 수 없습니다.
else
