$PBExportHeader$w_cic01090.srw
$PBExportComments$상품수불생성
forward
global type w_cic01090 from w_inherite
end type
type dw_2 from datawindow within w_cic01090
end type
type gb_4 from groupbox within w_cic01090
end type
type dw_1 from datawindow within w_cic01090
end type
type dw_print from datawindow within w_cic01090
end type
type rr_1 from roundrectangle within w_cic01090
end type
end forward
...
type dw_insert from w_inherite`dw_insert within w_cic01090
...
type p_delrow from w_inherite`p_delrow within w_cic01090
boolean visible = false
integer x = 5202
integer y = 184
integer taborder = 0
...
type p_addrow from w_inherite`p_addrow within w_cic01090
boolean visible = false
integer x = 5029
integer y = 184
integer taborder = 0
...
type p_search from w_inherite`p_search within w_cic01090
integer x = 3566
integer taborder = 20
...
DECLARE SP_CREATE_CIC0105_SP PROCEDURE FOR CIC0105_SP (:sWorkym) USING SQLCA;
EXECUTE SP_CREATE_CIC0105_SP;
//STRING sPrcRtn
//FETCH SP_CREATE_CIC0105_SP INTO :sPrcRtn ;
CLOSE SP_CREATE_CIC0105_SP;
If SQLCA.SQLCODE < 0 Then
   f_message_chk(57, "~r~n~r~n[EXECUTE SP_CREATE_CIC0105_SP]~r~n~r~n" + SQLCA.SQLERRTEXT)	// 자료를 처리할 수 없습니다.
else
...
type p_ins from w_inherite`p_ins within w_cic01090
integer x = 4087
integer taborder = 60
...
DELETE FROM cic0105 WHERE workym = :ls_workym;
IF SQLCA.SQLCODE = 0 THEN
	COMMIT;
...
type p_exit from w_inherite`p_exit within w_cic01090
integer x = 4434
end type

type p_can from w_inherite`p_can within w_cic01090
integer x = 4261
end type
...
type p_print from w_inherite`p_print within w_cic01090
boolean visible = false
integer x = 3397
integer taborder = 0
end type
...
type p_inq from w_inherite`p_inq within w_cic01090
integer x = 3739
integer taborder = 30
end type
...
type p_del from w_inherite`p_del within w_cic01090
integer x = 4855
integer y = 184
integer taborder = 0
end type
...
type p_mod from w_inherite`p_mod within w_cic01090
integer x = 3913
end type
...
type cb_exit from w_inherite`cb_exit within w_cic01090
integer x = 3026
integer y = 2752
end type

type cb_mod from w_inherite`cb_mod within w_cic01090
integer x = 2199
integer y = 2752
end type
...
type cb_ins from w_inherite`cb_ins within w_cic01090
integer x = 503
integer y = 2752
end type
...
type cb_del from w_inherite`cb_del within w_cic01090
integer x = 2551
integer y = 2752
end type
...
type cb_inq from w_inherite`cb_inq within w_cic01090
integer x = 142
integer y = 2752
end type
...
type cb_print from w_inherite`cb_print within w_cic01090
integer x = 1650
integer y = 2424
end type

type st_1 from w_inherite`st_1 within w_cic01090
integer width = 293
end type

type cb_can from w_inherite`cb_can within w_cic01090
integer x = 2907
integer y = 2752
end type
...
type cb_search from w_inherite`cb_search within w_cic01090
integer x = 2053
integer y = 2432
end type

type dw_datetime from w_inherite`dw_datetime within w_cic01090
integer height = 88
end type

type sle_msg from w_inherite`sle_msg within w_cic01090
integer x = 329
integer width = 2533
end type

type gb_10 from w_inherite`gb_10 within w_cic01090
integer width = 3607
end type

type gb_button1 from w_inherite`gb_button1 within w_cic01090
integer x = 110
integer y = 2696
end type

type gb_button2 from w_inherite`gb_button2 within w_cic01090
integer x = 2153
integer y = 2696
end type
...
integer taborder = 90
string title = "상품수불생성"
string dataobject = "dw_cic01090_20"
...
event constructor;Object.DataWindow.HorizontalScrollSplit = 1893
end event
...
integer height = 156
integer taborder = 10
string dataobject = "dw_cic01090_10"
boolean border = false
boolean livescroll = true
end type
