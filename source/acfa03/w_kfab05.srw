$PBExportHeader$w_kfab05.srw
$PBExportComments$고정자산감가상각집계표(계정별) 조회 출력
forward
global type w_kfab05 from w_standard_print
end type
type st_wait from statictext within w_kfab05
end type
type cb_excel from commandbutton within w_kfab05
end type
type rr_1 from roundrectangle within w_kfab05
end type
end forward
...
integer x = 0
integer y = 0
string title = "감가상각집계표(계정별)  조회 출력"
boolean maxbox = true
st_wait st_wait
cb_excel cb_excel
rr_1 rr_1
end type
global w_kfab05 w_kfab05
...
type p_preview from w_standard_print`p_preview within w_kfab05
integer x = 4101
integer y = 16
end type

type p_exit from w_standard_print`p_exit within w_kfab05
integer x = 4448
integer y = 16
end type

type p_print from w_standard_print`p_print within w_kfab05
integer x = 4274
integer y = 16
end type

type p_retrieve from w_standard_print`p_retrieve within w_kfab05
integer x = 3927
integer y = 16
end type
...
type st_10 from w_standard_print`st_10 within w_kfab05
end type



type dw_print from w_standard_print`dw_print within w_kfab05
string dataobject = "dw_kfab05_2_p"
end type

type dw_ip from w_standard_print`dw_ip within w_kfab05
integer x = 32
integer y = 24
integer width = 3822
integer height = 216
...
type dw_list from w_standard_print`dw_list within w_kfab05
integer x = 46
integer y = 248
integer width = 4521
integer height = 1964
string dataobject = "dw_kfab05_2"
