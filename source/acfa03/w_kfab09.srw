$PBExportHeader$w_kfab09.srw
$PBExportComments$고정자산감가상각비 명세서(내용년수별) 조회 출력
forward
global type w_kfab09 from w_standard_print
end type
type rr_1 from roundrectangle within w_kfab09
end type
end forward
...
integer x = 0
integer y = 0
string title = "감가상각비명세서(내용년수별) 조회 출력"
boolean maxbox = true
rr_1 rr_1
end type
global w_kfab09 w_kfab09
...
row_num = dw_print.Retrieve(dsaupj,dname,dkfcod1,string(dkfcod2),dtfcod1,string(dtfcod2),DCOMPUTE_YEARMMDD,DGBN1,DGBN2,dgbn1nm,dgbn2nm)
...
dw_ip.SetItem(dw_ip.GetRow(),"gubun","ALL")
proc_gu ="전 체"
...
type p_preview from w_standard_print`p_preview within w_kfab09
end type

type p_exit from w_standard_print`p_exit within w_kfab09
end type

type p_print from w_standard_print`p_print within w_kfab09
end type

type p_retrieve from w_standard_print`p_retrieve within w_kfab09
end type
...
type st_10 from w_standard_print`st_10 within w_kfab09
end type



type dw_print from w_standard_print`dw_print within w_kfab09
integer x = 3922
integer y = 188
integer height = 56
string dataobject = "dw_kfab09_2_p"
end type

type dw_ip from w_standard_print`dw_ip within w_kfab09
integer x = 27
integer width = 3826
integer height = 212
...
type dw_list from w_standard_print`dw_list within w_kfab09
integer x = 41
integer y = 244
integer width = 4562
integer height = 1960
string dataobject = "dw_kfab09_2"
