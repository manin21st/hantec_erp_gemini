$PBExportHeader$w_imt_03040.srw
$PBExportComments$수입비용관리
forward
global type w_imt_03040 from w_inherite
end type
type rr_3 from roundrectangle within w_imt_03040
end type
type rr_4 from roundrectangle within w_imt_03040
end type
type dw_detail from datawindow within w_imt_03040
end type
type rb_insert from radiobutton within w_imt_03040
end type
type rb_delete from radiobutton within w_imt_03040
end type
type rr_2 from roundrectangle within w_imt_03040
end type
end forward
...
global w_imt_03040 w_imt_03040
...
string	sGubun, sNo,		&
			sCode, sgub, slcno, 				&
			sTitle, sNull, sCvcod, sdate, get_nm, ssaupj 
dec{2}	damt, dvat
long		lRow, lcount
...
FOR	lRow = dw_insert.RowCount()		TO		1  STEP  -1
	...
	IF sGubun = '1'	THEN							// LC
		...
		dw_insert.SetItem(lRow, "polcno", sNo)
...
//   END IF
   ...
   lcount ++
    ...
    WHERE "REFFPF"."SABU" = '1'    AND  "REFFPF"."RFCOD" = '55'   AND  
          "REFFPF"."RFGUB" <> '00' AND  "REFFPF"."RFGUB" = :sCode AND 
...
type dw_insert from w_inherite`dw_insert within w_imt_03040
integer x = 27
integer y = 372
integer width = 4562
integer height = 1948
integer taborder = 20
string dataobject = "d_imt_03041"
...
event dw_insert::itemchanged;call super::itemchanged;string	sCode, sName,	&
			sDate,			&
			sNull, slcno, sBlno, smaxlc, sminlc 
long		lRow, i, icount
		
if dw_detail.accepttext() = -1 then return 

sBlno = dw_detail.getitemstring(1, 'no')
...
type p_delrow from w_inherite`p_delrow within w_imt_03040
integer taborder = 60
end type
...
type p_addrow from w_inherite`p_addrow within w_imt_03040
integer taborder = 50
end type
...
//////////////////////////////////////////////////////////
string	sNo, sGubun, sTitle, sBank, sBanknm, sMaxlc, sMinlc, ssaupj
long		lRow
...
type p_search from w_inherite`p_search within w_imt_03040
boolean visible = false
integer x = 2501
integer y = 12
integer taborder = 0
...
type p_ins from w_inherite`p_ins within w_imt_03040
integer taborder = 40
end type
...
type p_exit from w_inherite`p_exit within w_imt_03040
integer taborder = 100
end type

type p_can from w_inherite`p_can within w_imt_03040
integer taborder = 90
end type
...
type p_print from w_inherite`p_print within w_imt_03040
boolean visible = false
integer x = 2318
integer y = 16
integer taborder = 0
...
type p_inq from w_inherite`p_inq within w_imt_03040
integer taborder = 30
end type
...
type p_del from w_inherite`p_del within w_imt_03040
integer taborder = 80
end type
...
type p_mod from w_inherite`p_mod within w_imt_03040
integer taborder = 70
end type
...
type cb_exit from w_inherite`cb_exit within w_imt_03040
boolean visible = true
end type

type cb_mod from w_inherite`cb_mod within w_imt_03040
boolean visible = true
end type

type cb_ins from w_inherite`cb_ins within w_imt_03040
boolean visible = true
end type

type cb_del from w_inherite`cb_del within w_imt_03040
boolean visible = true
end type

type cb_inq from w_inherite`cb_inq within w_imt_03040
boolean visible = true
end type

type cb_print from w_inherite`cb_print within w_imt_03040
boolean visible = true
end type

type st_1 from w_inherite`st_1 within w_imt_03040
boolean visible = true
end type

type cb_can from w_inherite`cb_can within w_imt_03040
boolean visible = true
integer x = 2094
integer y = 2780
end type

type cb_search from w_inherite`cb_search within w_imt_03040
boolean visible = true
end type

type dw_datetime from w_inherite`dw_datetime within w_imt_03040
boolean visible = true
end type

type sle_msg from w_inherite`sle_msg within w_imt_03040
boolean visible = true
end type

type gb_10 from w_inherite`gb_10 within w_imt_03040
boolean visible = true
end type

type gb_button1 from w_inherite`gb_button1 within w_imt_03040
boolean visible = true
end type

type gb_button2 from w_inherite`gb_button2 within w_imt_03040
boolean visible = true
end type
...
ELSEIF this.GetColumnName() = 'jpno'		THEN
	...
	SELECT POLCNO, POBLNO, BIGU
	  INTO :sLcno, :sBlno, :sGubun
	  FROM IMPEXP
	 WHERE SABU = :gs_sabu		AND
	...
	IF sGubun = '1'	THEN
		...
		this.SetItem(1, "no", sLcno)
		dw_insert.DataObject = 'd_imt_03041'
		dw_insert.SetTransObject(SQLCA)
	ELSE
		this.SetItem(1, "gubun", '2')
		this.SetItem(1, "no", sBlno)		
		dw_insert.DataObject = 'd_imt_03042'
		dw_insert.SetTransObject(SQLCA)
	END IF
