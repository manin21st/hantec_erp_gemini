$PBExportHeader$w_imt_03035.srw
$PBExportComments$B/L 통관일자 등록
forward
global type w_imt_03035 from w_inherite
end type
type dw_1 from datawindow within w_imt_03035
end type
type dw_detail from datawindow within w_imt_03035
end type
type dw_hidden from datawindow within w_imt_03035
end type
type st_2 from statictext within w_imt_03035
end type
type st_3 from statictext within w_imt_03035
end type
type p_1 from uo_picture within w_imt_03035
end type
type st_22 from statictext within w_imt_03035
end type
type pb_1 from u_pb_cal within w_imt_03035
end type
type pb_2 from u_pb_cal within w_imt_03035
end type
type pb_3 from u_pb_cal within w_imt_03035
end type
type rr_2 from roundrectangle within w_imt_03035
end type
type rr_4 from roundrectangle within w_imt_03035
end type
type rr_44 from roundrectangle within w_imt_03035
end type
end forward

global type w_imt_03035 from w_inherite
string title = "B/L 통관일자 등록"
dw_1 dw_1
dw_detail dw_detail
dw_hidden dw_hidden
st_2 st_2
...
global w_imt_03035 w_imt_03035
...
type dw_insert from w_inherite`dw_insert within w_imt_03035
integer x = 1486
integer y = 228
integer width = 3122
integer height = 1304
integer taborder = 30
string dataobject = "d_imt_03035_1"
...
ELSE
	...
	sentdat = this.getitemstring(row, 'polcbl_entdat')
   dw_detail.Retrieve(gs_sabu, s_blno) 
...
type p_delrow from w_inherite`p_delrow within w_imt_03035
...
type p_addrow from w_inherite`p_addrow within w_imt_03035
boolean visible = false
integer x = 3026
integer y = 12
integer taborder = 0
...
type p_search from w_inherite`p_search within w_imt_03035
boolean visible = false
integer x = 2784
integer y = 0
integer taborder = 60
...
type p_ins from w_inherite`p_ins within w_imt_03035
integer x = 3749
integer taborder = 0
...
event p_ins::clicked;call super::clicked;string sdate, simpno
int    k
...
type p_exit from w_inherite`p_exit within w_imt_03035
integer taborder = 90
end type

type p_can from w_inherite`p_can within w_imt_03035
integer taborder = 80
end type
...
type p_print from w_inherite`p_print within w_imt_03035
boolean visible = false
integer x = 2967
integer y = 28
integer taborder = 0
...
type p_inq from w_inherite`p_inq within w_imt_03035
integer x = 3575
integer taborder = 20
end type

event p_inq::clicked;call super::clicked;string s_frblno, s_toblno, s_frdate, s_todate, s_cvcod, sgubun
...
type p_del from w_inherite`p_del within w_imt_03035
integer x = 3922
integer taborder = 0
string pointer = "C:\erpman\cur\point.cur"
...
type p_mod from w_inherite`p_mod within w_imt_03035
integer x = 4096
integer taborder = 70
end type
...
type cb_exit from w_inherite`cb_exit within w_imt_03035
boolean visible = false
integer x = 2130
integer y = 2680
end type

type cb_mod from w_inherite`cb_mod within w_imt_03035
boolean visible = false
integer x = 1426
integer y = 2680
end type
...
type cb_ins from w_inherite`cb_ins within w_imt_03035
boolean visible = false
integer x = 517
integer y = 2664
integer width = 352
...
type cb_del from w_inherite`cb_del within w_imt_03035
boolean visible = false
integer x = 887
integer y = 2664
integer width = 352
...
type cb_inq from w_inherite`cb_inq within w_imt_03035
boolean visible = false
integer x = 165
integer y = 2664
end type
...
type cb_print from w_inherite`cb_print within w_imt_03035
boolean visible = false
integer x = 1984
integer y = 2544
end type

type st_1 from w_inherite`st_1 within w_imt_03035
end type

type cb_can from w_inherite`cb_can within w_imt_03035
boolean visible = false
integer x = 1778
integer y = 2680
end type
...
type cb_search from w_inherite`cb_search within w_imt_03035
boolean visible = false
integer x = 2619
integer y = 2532
end type
...
type gb_10 from w_inherite`gb_10 within w_imt_03035
boolean visible = false
integer y = 2764
integer textsize = -9
...
type gb_button1 from w_inherite`gb_button1 within w_imt_03035
end type

type gb_button2 from w_inherite`gb_button2 within w_imt_03035
end type
...
string dataobject = "d_imt_03035_a"
boolean border = false
...
integer taborder = 40
boolean bringtotop = true
string dataobject = "d_imt_03035_2"
boolean vscrollbar = true
boolean border = false
boolean livescroll = true
end type
