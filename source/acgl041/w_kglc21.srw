$PBExportHeader$w_kglc21.srw
$PBExportComments$지급결제 전표-전표발행/취소 처리
forward
global type w_kglc21 from w_inherite
end type
type gb_2 from groupbox within w_kglc21
end type
type rb_1 from radiobutton within w_kglc21
end type
type rb_2 from radiobutton within w_kglc21
end type
type dw_method from u_key_enter within w_kglc21
end type
type dw_junpoy from datawindow within w_kglc21
end type
type dw_junpoylst from datawindow within w_kglc21
end type
type dw_sang from datawindow within w_kglc21
end type
type dw_jbill from datawindow within w_kglc21
end type
type dw_save from datawindow within w_kglc21
end type
type dw_sungin from datawindow within w_kglc21
end type
type dw_method2 from datawindow within w_kglc21
end type
type dw_list from u_d_select_sort within w_kglc21
end type
type dw_kfz12ote from datawindow within w_kglc21
end type
type dw_rbill from datawindow within w_kglc21
end type
type dw_bill_detail from datawindow within w_kglc21
end type
type dw_cond from u_key_enter within w_kglc21
end type
type rr_1 from roundrectangle within w_kglc21
end type
type rr_2 from roundrectangle within w_kglc21
end type
type rr_3 from roundrectangle within w_kglc21
end type
end forward
...
public function integer wf_insert_kfz12ote (string saupj, string baldate, string upmugu, long bjunno, long linno, string sacc1, string sacc2)
...
public function integer wf_insert_kfz12otd (integer irow, string ssaupj, string sbaldate, string supmugu, long ljunno, long llinno)
...
DELETE FROM "KFZ12OT3"  										/*전표송부내역 삭제*/
	WHERE ( "KFZ12OT3"."SAUPJ"    = :Saupj ) AND  
			( "KFZ12OT3"."BAL_DATE" = :BalDate ) AND  
			( "KFZ12OT3"."UPMU_GU"  = :UpmuGu ) AND  
			( "KFZ12OT3"."JUN_NO"   = :BJunNo )   ;
...
dCheckAmt   = dw_method.GetItemNumber(1,"checkamt")

dAccAmt     = dw_method.GetItemNumber(1,"accamt")
dSuIpIjaAmt = dw_method.GetItemNumber(1,"ijaamt")
dBillAmt		= dw_method.GetItemNumber(1,"billamt")
dBillCashAmt= dw_method.GetItemNumber(1,"bill_cashamt")

dChaIpAmt   = dw_method2.GetItemNumber(1,"chaip_amt")
dChaIpIjaAmt= dw_method2.GetItemNumber(1,"ija_amt")
...
IF dAccAmt <> 0 THEN											/*계정*/
	LsAryAcc1[7] = dw_method.GetItemString(1,"sacc1")
	LsAryAcc2[7] = dw_method.GetItemString(1,"sacc2")
...
public function integer wf_insert_kfz12ote (string saupj, string baldate, string upmugu, long bjunno, long linno, string sacc1, string sacc2);dw_kfz12ote.InsertRow(0)
			
dw_kfz12ote.SetItem(dw_kfz12ote.GetRow(),"lo_cd",      dw_method2.GetItemString(1,"chaip_no"))
dw_kfz12ote.SetItem(dw_kfz12ote.GetRow(),"lo_name",    &
							'구매결제 차입 -'+dw_method2.GetItemString(1,"chaip_no"))
dw_kfz12ote.SetItem(dw_kfz12ote.GetRow(),"lo_bnkno",   dw_method2.GetItemString(1,"yakjung_no"))
dw_kfz12ote.SetItem(dw_kfz12ote.GetRow(),"acc1_cd",    sacc1)
dw_kfz12ote.SetItem(dw_kfz12ote.GetRow(),"acc2_cd",    sacc2)
dw_kfz12ote.SetItem(dw_kfz12ote.GetRow(),"lo_bnkcd",   dw_method2.GetItemString(1,"chaip_bnk"))
dw_kfz12ote.SetItem(dw_kfz12ote.GetRow(),"lo_afdt",    dw_method2.GetItemString(1,"gisan_date"))
dw_kfz12ote.SetItem(dw_kfz12ote.GetRow(),"lo_atdt",    dw_method2.GetItemString(1,"mangi_date"))
dw_kfz12ote.SetItem(dw_kfz12ote.GetRow(),"lo_rat",     dw_method2.GetItemNumber(1,"chaip_rate"))
dw_kfz12ote.SetItem(dw_kfz12ote.GetRow(),"lo_camt",    dw_method2.GetItemNumber(1,"chaip_amt"))
...
public function integer wf_insert_kfz12otd (integer irow, string ssaupj, string sbaldate, string supmugu, long ljunno, long llinno);Integer iFindRow
String  sFullJunNo
...
dw_rbill.SetItem(iFindRow,"saup_no",			dw_junpoylst.GetItemString(1,"saup_no"))
...
FOR k = 1 TO 11
	...
	ELSEIF k = 6 THEN												/*받을어음*/
		...
		iBillCnt = dw_bill_detail.Retrieve(dw_method.GetItemString(1,"gyel_date"),dw_method.GetItemNumber(1,"seqno"),'R')	
		FOR i = 1 TO iBillCnt
			iCurRow = dw_junpoy.InsertRow(0)
	...
	ELSEIF k = 11 THEN												/*차입금*/
		...
		IF sCusGbn = 'Y' THEN
			IF sGbn1 = '2' THEN												/*은행*/
				dw_junpoy.SetItem(iCurRow,"saup_no", dw_method2.GetItemString(1,"chaip_bnk")) 
				dw_junpoy.SetItem(iCurRow,"in_nm",   &
													F_Get_PersonLst('2',dw_method2.GetItemString(1,"chaip_bnk"),'1')) 
			...
			ELSEIF sGbn1 = '6' THEN												/*차입금*/
				dw_junpoy.SetItem(iCurRow,"saup_no", dw_method2.GetItemString(1,"chaip_no")) 
			ELSE
				dw_junpoy.SetItem(iCurRow,"saup_no", dw_junpoylst.GetItemString(1,"saup_no")) 
					dw_junpoy.SetItem(iCurRow,"in_nm",   &
											F_Get_PersonLst('1',dw_junpoylst.GetItemString(1,"saup_no"),'1'))
	...
	ELSE
		...
		IF sGbn4 = 'Y' THEN						/*선급비용 처리*/
			dw_junpoy.SetItem(iCurRow,"k_symd",   dw_method2.GetItemString(1,"gisan_date"))
			dw_junpoy.SetItem(iCurRow,"k_eymd",   dw_method2.GetItemString(1,"mangi_date"))
			dw_junpoy.SetItem(iCurRow,"k_amt",    LdAryAmt[2])
			dw_junpoy.SetItem(iCurRow,"kwan_no",  dw_method2.GetItemString(1,"racccode"))
		END IF
...
this.Control[iCurrent+4]=this.dw_method
this.Control[iCurrent+5]=this.dw_junpoy
this.Control[iCurrent+6]=this.dw_junpoylst
this.Control[iCurrent+7]=this.dw_sang
this.Control[iCurrent+8]=this.dw_jbill
this.Control[iCurrent+9]=this.dw_save
this.Control[iCurrent+10]=this.dw_sungin
this.Control[iCurrent+11]=this.dw_method2
this.Control[iCurrent+12]=this.dw_list
this.Control[iCurrent+13]=this.dw_kfz12ote
this.Control[iCurrent+14]=this.dw_rbill
this.Control[iCurrent+15]=this.dw_bill_detail
this.Control[iCurrent+16]=this.dw_cond
...
type dw_insert from w_inherite`dw_insert within w_kglc21
...
type p_delrow from w_inherite`p_delrow within w_kglc21
boolean visible = false
integer x = 3502
integer y = 388
integer taborder = 0
...
type p_addrow from w_inherite`p_addrow within w_kglc21
boolean visible = false
integer x = 3328
integer y = 388
integer taborder = 0
...
type p_search from w_inherite`p_search within w_kglc21
integer x = 3653
integer y = 4
integer taborder = 60
...
String  sSaupj,sBalDate,sUpmuGbn,sAlcGbn
Long    lBJunNo
...
IF sModStatus = 'I' THEN												/*전표발행시*/
	...
	DO WHILE true
		...
		dw_method2.Retrieve(dw_list.GetItemString(iSelectRow,"gyel_date"),dw_list.GetItemNumber(iSelectRow,"seqno"))
...
type p_ins from w_inherite`p_ins within w_kglc21
boolean visible = false
integer x = 3154
integer y = 388
integer taborder = 0
...
type p_exit from w_inherite`p_exit within w_kglc21
integer x = 4000
integer y = 4
integer taborder = 50
end type

type p_can from w_inherite`p_can within w_kglc21
integer x = 3826
integer y = 4
integer taborder = 40
end type
...
type p_print from w_inherite`p_print within w_kglc21
boolean visible = false
integer x = 2981
integer y = 392
integer taborder = 0
...
type p_inq from w_inherite`p_inq within w_kglc21
integer x = 3479
integer y = 4
end type
...
dw_method2.Retrieve(dw_list.GetItemString(1,"gyel_date"),dw_list.GetItemNumber(1,"seqno"))
dw_bill_detail.Retrieve(dw_list.GetItemString(1,"gyel_date"),dw_list.GetItemNumber(1,"seqno"),'%')
end event

type p_del from w_inherite`p_del within w_kglc21
boolean visible = false
integer x = 3849
integer y = 388
integer taborder = 0
...
type p_mod from w_inherite`p_mod within w_kglc21
boolean visible = false
integer x = 3675
integer y = 388
integer taborder = 0
...
type cb_exit from w_inherite`cb_exit within w_kglc21
boolean visible = false
integer x = 3703
integer y = 3276
end type

type cb_mod from w_inherite`cb_mod within w_kglc21
boolean visible = false
integer x = 2683
integer y = 3276
integer width = 640
...
type cb_ins from w_inherite`cb_ins within w_kglc21
boolean visible = false
integer x = 2382
integer y = 3012
string text = "추가&A)"
...
type cb_del from w_inherite`cb_del within w_kglc21
boolean visible = false
integer x = 2720
integer y = 2896
end type

type cb_inq from w_inherite`cb_inq within w_kglc21
boolean visible = false
integer x = 2331
integer y = 3280
end type

type cb_print from w_inherite`cb_print within w_kglc21
boolean visible = false
integer x = 2496
integer y = 3248
end type

type st_1 from w_inherite`st_1 within w_kglc21
boolean visible = false
integer x = 142
integer y = 3240
end type

type cb_can from w_inherite`cb_can within w_kglc21
boolean visible = false
integer x = 3346
integer y = 3276
end type

type cb_search from w_inherite`cb_search within w_kglc21
boolean visible = false
integer x = 3072
integer y = 2896
end type

type dw_datetime from w_inherite`dw_datetime within w_kglc21
boolean visible = false
integer x = 2912
integer y = 3236
end type

type sle_msg from w_inherite`sle_msg within w_kglc21
boolean visible = false
integer x = 494
integer y = 3240
integer width = 2418
...
type gb_10 from w_inherite`gb_10 within w_kglc21
boolean visible = false
integer x = 123
integer y = 3188
integer width = 3547
...
type gb_button1 from w_inherite`gb_button1 within w_kglc21
boolean visible = false
integer x = 2807
integer y = 3028
integer width = 416
...
type gb_button2 from w_inherite`gb_button2 within w_kglc21
boolean visible = false
integer x = 2615
integer y = 2660
integer width = 1417
