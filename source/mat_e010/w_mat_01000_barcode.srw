$PBExportHeader$w_mat_01000_barcode.srw
$PBExportComments$구매발주입고 바코드 발행
forward
global type w_mat_01000_barcode from w_inherite_popup
end type
type dw_head from datawindow within w_mat_01000_barcode
end type
type p_print from uo_picture within w_mat_01000_barcode
end type
type p_close from uo_picture within w_mat_01000_barcode
end type
type cbx_1 from checkbox within w_mat_01000_barcode
end type
type dw_print from datawindow within w_mat_01000_barcode
end type
type rr_1 from roundrectangle within w_mat_01000_barcode
end type
type rr_2 from roundrectangle within w_mat_01000_barcode
end type
end forward
...
global w_mat_01000_barcode w_mat_01000_barcode

type variables
string  is_code , is_codename 
end variables

on w_mat_01000_barcode.create
int iCurrent
call super::create
...
on w_mat_01000_barcode.destroy
call super::destroy
...
event open;call super::open;string ls_jpno
...
//전표번호
is_code = gs_code
dw_head.SetItem(1, 'jpno', is_code)
...
dw_1.retrieve( gs_sabu, gs_saupj, ls_jpno) 
dw_1.setredraw(true)
end event

type dw_jogun from w_inherite_popup`dw_jogun within w_mat_01000_barcode
integer x = 91
integer y = 5000
end type

type p_exit from w_inherite_popup`p_exit within w_mat_01000_barcode
integer x = 4032
integer y = 28
end type
...
type p_inq from w_inherite_popup`p_inq within w_mat_01000_barcode
integer x = 3685
integer y = 28
end type
...
type p_choose from w_inherite_popup`p_choose within w_mat_01000_barcode
...
type dw_1 from w_inherite_popup`dw_1 within w_mat_01000_barcode
integer x = 50
integer y = 212
integer width = 4297
integer height = 1836
string dataobject = "d_mat_01000_bar_1"
end type
...
event dw_1::ue_pressenter;//cb_1.TriggerEvent(Clicked!)
end event

type sle_2 from w_inherite_popup`sle_2 within w_mat_01000_barcode
integer x = 558
end type

type cb_1 from w_inherite_popup`cb_1 within w_mat_01000_barcode
integer x = 1687
integer y = 5000
end type

type cb_return from w_inherite_popup`cb_return within w_mat_01000_barcode
integer x = 2322
integer y = 5000
end type

type cb_inq from w_inherite_popup`cb_inq within w_mat_01000_barcode
integer x = 2002
integer y = 5000
end type
...
type sle_1 from w_inherite_popup`sle_1 within w_mat_01000_barcode
integer width = 242
integer limit = 6
end type

type st_1 from w_inherite_popup`st_1 within w_mat_01000_barcode
long textcolor = 128
...
string title = "none"
string dataobject = "d_mat_01000_bar_p"
boolean border = false
end type
