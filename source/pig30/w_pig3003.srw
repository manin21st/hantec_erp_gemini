...
Choose Case dwo.name
	Case "carno"                        
      If wf_carinfo(arg) = -1 Then return 1  // 회사차량인가 확인
...
IF This.GetColumnName() =  "carno"  THEN
   ...
   If wf_carinfo(gs_code) = -1 Then return 1  // 회사차량인가 확인
