$PBExportHeader$wp02_jig.srw
$PBExportComments$치공구수리의뢰 접수 및 결과등록
forward
global type wp02_jig from w_inherite
end type
type dw_1 from datawindow within wp02_jig
end type
type dw_list from u_d_select_sort within wp02_jig
end type
type cbx_1 from checkbox within wp02_jig
end type
type pb_1 from u_pb_cal within wp02_jig
end type
type pb_2 from u_pb_cal within wp02_jig
end type
type pb_3 from u_pb_cal within wp02_jig
end type
type pb_4 from u_pb_cal within wp02_jig
end type
type p_1 from uo_picture within wp02_jig
end type
type dw_2 from datawindow within wp02_jig
end type
type cb_1 from commandbutton within wp02_jig
end type
type cb_2 from commandbutton within wp02_jig
end type
type cb_3 from commandbutton within wp02_jig
end type
type p_2 from picture within wp02_jig
end type
type dw_print from datawindow within wp02_jig
end type
type rr_1 from roundrectangle within wp02_jig
end type
end forward
...
type dw_insert from w_inherite`dw_insert within wp02_jig
integer x = 2162
integer y = 240
integer width = 2459
integer height = 2024
string dataobject = "d_kumpe01_00040_03_jig"
...
type p_delrow from w_inherite`p_delrow within wp02_jig
boolean visible = false
integer x = 901
integer y = 28
end type

type p_addrow from w_inherite`p_addrow within wp02_jig
boolean visible = false
integer x = 727
integer y = 28
end type

type p_search from w_inherite`p_search within wp02_jig
boolean visible = false
integer x = 32
integer y = 28
end type

type p_ins from w_inherite`p_ins within wp02_jig
boolean visible = false
integer x = 553
integer y = 28
end type

type p_exit from w_inherite`p_exit within wp02_jig
integer x = 4448
integer y = 20
end type

type p_can from w_inherite`p_can within wp02_jig
integer x = 4274
integer y = 20
end type
...
type p_print from w_inherite`p_print within wp02_jig
boolean visible = false
integer x = 206
integer y = 28
end type

type p_inq from w_inherite`p_inq within wp02_jig
integer x = 3753
integer y = 20
end type
...
type p_del from w_inherite`p_del within wp02_jig
integer x = 4101
integer y = 20
end type
...
type p_mod from w_inherite`p_mod within wp02_jig
integer x = 3927
integer y = 20
end type
...
type cb_exit from w_inherite`cb_exit within wp02_jig
boolean enabled = false
end type

type cb_mod from w_inherite`cb_mod within wp02_jig
boolean enabled = false
end type

type cb_ins from w_inherite`cb_ins within wp02_jig
boolean enabled = false
end type

type cb_del from w_inherite`cb_del within wp02_jig
boolean enabled = false
end type

type cb_inq from w_inherite`cb_inq within wp02_jig
boolean enabled = false
end type

type cb_print from w_inherite`cb_print within wp02_jig
boolean enabled = false
end type

type st_1 from w_inherite`st_1 within wp02_jig
end type

type cb_can from w_inherite`cb_can within wp02_jig
boolean enabled = false
end type

type cb_search from w_inherite`cb_search within wp02_jig
boolean enabled = false
end type
...
type gb_button1 from w_inherite`gb_button1 within wp02_jig
end type

type gb_button2 from w_inherite`gb_button2 within wp02_jig
end type
...
string dataobject = "d_kumpe01_00040_02_jig"
boolean border = false
...
integer taborder = 40
boolean bringtotop = true
string dataobject = "d_kumpe01_00040_01_jig"
boolean border = false
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_kumpe01_00030_p1_new_jig"
boolean border = false
boolean livescroll = true
end type
