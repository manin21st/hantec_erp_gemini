$PBExportHeader$w_kumpe01_pop01_jig.srw
$PBExportComments$치공구수리의뢰 선택
forward
global type w_kumpe01_pop01_jig from w_inherite_popup
end type
type rr_1 from roundrectangle within w_kumpe01_pop01_jig
end type
end forward
...
integer width = 3378
integer height = 2092
string title = "치공구 수리의뢰 선택"
event ue_open ( )
rr_1 rr_1
end type
global w_kumpe01_pop01_jig w_kumpe01_pop01_jig
...
on w_kumpe01_pop01_jig.destroy
call super::destroy
destroy(this.rr_1)
end on
...
type dw_jogun from w_inherite_popup`dw_jogun within w_kumpe01_pop01_jig
integer width = 3296
string dataobject = "d_kumpe01_00030_pop01_jig"
end type
...
type p_exit from w_inherite_popup`p_exit within w_kumpe01_pop01_jig
integer x = 3086
integer y = 16
end type
...
type p_inq from w_inherite_popup`p_inq within w_kumpe01_pop01_jig
integer x = 2738
integer y = 16
end type
...
type p_choose from w_inherite_popup`p_choose within w_kumpe01_pop01_jig
integer x = 2912
integer y = 16
end type
...
type dw_1 from w_inherite_popup`dw_1 within w_kumpe01_pop01_jig
integer x = 37
integer y = 352
integer width = 3259
integer height = 1604
string dataobject = "d_kumpe01_00030_pop02_jig"
...
type sle_2 from w_inherite_popup`sle_2 within w_kumpe01_pop01_jig
boolean visible = false
end type

type cb_1 from w_inherite_popup`cb_1 within w_kumpe01_pop01_jig
boolean visible = false
integer x = 946
integer y = 2068
end type

type cb_return from w_inherite_popup`cb_return within w_kumpe01_pop01_jig
boolean visible = false
integer x = 1582
integer y = 2068
end type

type cb_inq from w_inherite_popup`cb_inq within w_kumpe01_pop01_jig
boolean visible = false
integer x = 1266
integer y = 2068
end type

type sle_1 from w_inherite_popup`sle_1 within w_kumpe01_pop01_jig
boolean visible = false
end type

type st_1 from w_inherite_popup`st_1 within w_kumpe01_pop01_jig
boolean visible = false
end type
