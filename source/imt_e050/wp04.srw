$PBExportHeader$wp04.srw
$PBExportComments$금형 수리결과 현황
forward
global type wp04 from w_standard_print
end type
type rr_1 from roundrectangle within wp04
end type
end forward

global type wp04 from w_standard_print
integer height = 2504
string title = "금형 수리결과 현황"
rr_1 rr_1
end type
global wp04 wp04
...
type p_xls from w_standard_print`p_xls within wp04
...
type p_sort from w_standard_print`p_sort within wp04
integer x = 3465
integer y = 72
end type

type p_preview from w_standard_print`p_preview within wp04
integer x = 4078
end type

type p_exit from w_standard_print`p_exit within wp04
integer x = 4425
end type

type p_print from w_standard_print`p_print within wp04
boolean visible = false
integer x = 3296
integer y = 76
end type

type p_retrieve from w_standard_print`p_retrieve within wp04
integer x = 3904
end type
...
type st_10 from w_standard_print`st_10 within wp04
end type



type dw_print from w_standard_print`dw_print within wp04
integer x = 3712
string dataobject = "d_kumpe02_p2070_02p"
end type

type dw_ip from w_standard_print`dw_ip within wp04
integer x = 14
integer width = 3305
integer height = 252
string dataobject = "d_kumpe02_p2070_01"
end type
...
Choose Case dwo.name
	Case 'kumno'
		...
		SELECT COUNT('X')
		 ...
		 WHERE KUMNO = :data ;
		If ll_cnt < 1 Then
			MessageBox('금형코드 확인', '등록된 금형코드가 아닙니다.')
			Return 1
		End If 
...
type dw_list from w_standard_print`dw_list within wp04
integer x = 32
integer y = 292
integer width = 4558
integer height = 1944
string dataobject = "d_kumpe02_p2070_02"
