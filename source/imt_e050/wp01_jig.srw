$PBExportHeader$wp01_jig.srw
$PBExportComments$치공구수리의뢰등록
forward
global type wp01_jig from w_inherite
end type
type rr_1 from roundrectangle within wp01_jig
end type
type dw_top from datawindow within wp01_jig
end type
type rb_2 from radiobutton within wp01_jig
end type
type rb_1 from radiobutton within wp01_jig
end type
type dw_print from datawindow within wp01_jig
end type
type pb_3 from u_pb_cal within wp01_jig
end type
type pb_1 from u_pb_cal within wp01_jig
end type
type pb_2 from u_pb_cal within wp01_jig
end type
type pb_4 from u_pb_cal within wp01_jig
end type
type dw_list from u_d_select_sort within wp01_jig
end type
type pb_5 from u_pb_cal within wp01_jig
end type
type gb_5 from groupbox within wp01_jig
end type
end forward
...
type dw_insert from w_inherite`dw_insert within wp01_jig
integer x = 2341
integer y = 264
integer width = 2277
integer height = 1892
string dataobject = "d_kumpe01_00030_02_jig"
...
type p_delrow from w_inherite`p_delrow within wp01_jig
boolean visible = false
integer x = 786
integer y = 2392
end type

type p_addrow from w_inherite`p_addrow within wp01_jig
boolean visible = false
integer x = 613
integer y = 2392
end type

type p_search from w_inherite`p_search within wp01_jig
boolean visible = false
integer x = 439
integer y = 2392
end type

type p_ins from w_inherite`p_ins within wp01_jig
boolean visible = false
integer x = 992
integer y = 2396
end type

type p_exit from w_inherite`p_exit within wp01_jig
integer x = 4434
end type

type p_can from w_inherite`p_can within wp01_jig
integer x = 4261
end type
...
type p_print from w_inherite`p_print within wp01_jig
integer x = 3566
end type
...
type p_inq from w_inherite`p_inq within wp01_jig
integer x = 3739
end type
...
type p_del from w_inherite`p_del within wp01_jig
integer x = 4087
end type
...
type p_mod from w_inherite`p_mod within wp01_jig
integer x = 3913
end type
...
type cb_exit from w_inherite`cb_exit within wp01_jig
end type

type cb_mod from w_inherite`cb_mod within wp01_jig
end type

type cb_ins from w_inherite`cb_ins within wp01_jig
end type

type cb_del from w_inherite`cb_del within wp01_jig
end type

type cb_inq from w_inherite`cb_inq within wp01_jig
end type

type cb_print from w_inherite`cb_print within wp01_jig
end type

type st_1 from w_inherite`st_1 within wp01_jig
end type

type cb_can from w_inherite`cb_can within wp01_jig
end type

type cb_search from w_inherite`cb_search within wp01_jig
end type
...
type gb_button1 from w_inherite`gb_button1 within wp01_jig
end type

type gb_button2 from w_inherite`gb_button2 within wp01_jig
end type
...
string title = "none"
string dataobject = "d_kumpe01_00030_01_jig"
boolean border = false
...
string title = "none"
string dataobject = "d_kumpe01_00030_p_new_jig"
boolean border = false
end type
...
integer taborder = 50
boolean bringtotop = true
string dataobject = "d_kumpe01_00030_04_jig"
boolean border = false
