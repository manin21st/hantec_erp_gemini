...
$PBExportComments$미리보기-권
forward
global type w_print_preview from window
end type
type cb_13 from commandbutton within w_print_preview
end type
type cb_8 from commandbutton within w_print_preview
end type
type cb_12 from commandbutton within w_print_preview
end type
type cb_11 from commandbutton within w_print_preview
end type
type cb_10 from commandbutton within w_print_preview
end type
type cb_9 from commandbutton within w_print_preview
end type
type pb_4 from picturebutton within w_print_preview
end type
type gb_5 from groupbox within w_print_preview
end type
type st_4 from statictext within w_print_preview
end type
type pb_prior from picturebutton within w_print_preview
end type
type pb_first from picturebutton within w_print_preview
end type
type pb_last from picturebutton within w_print_preview
end type
type pb_next from picturebutton within w_print_preview
end type
type st_3 from statictext within w_print_preview
end type
type ddlb_zoom from dropdownlistbox within w_print_preview
end type
type st_2 from statictext within w_print_preview
end type
type st_1 from statictext within w_print_preview
end type
type ddlb_range from dropdownlistbox within w_print_preview
end type
type cbx_rulers from checkbox within w_print_preview
end type
type pb_3 from picturebutton within w_print_preview
end type
type pb_2 from picturebutton within w_print_preview
end type
type cb_7 from commandbutton within w_print_preview
end type
type cb_6 from commandbutton within w_print_preview
end type
type cb_5 from commandbutton within w_print_preview
end type
type cb_4 from commandbutton within w_print_preview
end type
type cb_3 from commandbutton within w_print_preview
end type
type cb_2 from commandbutton within w_print_preview
end type
type cb_1 from commandbutton within w_print_preview
end type
type dw_list from datawindow within w_print_preview
end type
...
type st_5 from statictext within w_print_preview
end type
end forward
...
event clicked;openwithparm(w_preview_option2, parent)
end event
...
event clicked;openwithparm(w_preview_option, dw_list)
...
IF dw_list.rowcount() > 0 then 
	gi_page = long(dw_list.Describe("evaluate('pagecount()', 1)" ))
//	gi_page = dw_list.GetItemNumber(1,"last_page")
ELSE
	gi_page = 1
END IF
