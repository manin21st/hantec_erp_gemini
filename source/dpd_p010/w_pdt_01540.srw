$PBExportHeader$w_pdt_01540.srw
$PBExportComments$** 연동 생산 계획 현황(일별)
forward
global type w_pdt_01540 from w_standard_print
end type
type rr_1 from roundrectangle within w_pdt_01540
end type
end forward

global type w_pdt_01540 from w_standard_print
string title = "연동 생산 계획 현황(일별)"
rr_1 rr_1
end type
global w_pdt_01540 w_pdt_01540
...
IF dw_print.Retrieve(gs_sabu, s_yymm,   i_seq,     s_plym,   s_lastday, &
                    s_frteam, s_toteam, s_fritnbr, s_toitnbr, sLmsgu, ssaupj) < 1 THEN
	f_message_chk(50,'')
	dw_ip.Setfocus()
	return -1
end if
...
type p_preview from w_standard_print`p_preview within w_pdt_01540
end type

type p_exit from w_standard_print`p_exit within w_pdt_01540
end type

type p_print from w_standard_print`p_print within w_pdt_01540
end type

type p_retrieve from w_standard_print`p_retrieve within w_pdt_01540
end type
...
type dw_print from w_standard_print`dw_print within w_pdt_01540
integer x = 4064
integer y = 176
integer height = 96
string dataobject = "d_pdt_01540_1_p"
end type

type dw_ip from w_standard_print`dw_ip within w_pdt_01540
integer x = 69
integer y = 28
integer width = 3845
integer height = 240
string dataobject = "d_pdt_01540_a"
end type
...
type dw_list from w_standard_print`dw_list within w_pdt_01540
integer x = 87
integer y = 296
integer width = 4507
integer height = 2008
string dataobject = "d_pdt_01540_1"
