$PBExportHeader$w_pdt_00320.srw
$PBExportComments$주간 외주 생산 계획서
forward
global type w_pdt_00320 from w_standard_print
end type
type pb_1 from u_pb_cal within w_pdt_00320
end type
type rr_1 from roundrectangle within w_pdt_00320
end type
end forward

global type w_pdt_00320 from w_standard_print
string title = "주간 외주 생산 계획서"
pb_1 pb_1
rr_1 rr_1
end type
global w_pdt_00320 w_pdt_00320
...
dw_print.Object.t_100.text = dw_ip.Describe("Evaluate('LookUpDisplay(porgu) ', 1)")
dw_list.retrieve(gs_sabu, ls_ymd, ls_porgu, ls_cvcod1, ls_cvcod2, ls_empno)

Return 1
end function

on w_pdt_00320.create
int iCurrent
call super::create
...
//
//IF gs_saupj              = '10' THEN
//	rtncode2    = dw_ip.GetChild('empno', state_child2)
//	
...
type p_preview from w_standard_print`p_preview within w_pdt_00320
integer x = 4073
end type

type p_exit from w_standard_print`p_exit within w_pdt_00320
integer x = 4421
end type

type p_print from w_standard_print`p_print within w_pdt_00320
integer x = 4247
end type

type p_retrieve from w_standard_print`p_retrieve within w_pdt_00320
integer x = 3899
end type
...
type st_10 from w_standard_print`st_10 within w_pdt_00320
end type



type dw_print from w_standard_print`dw_print within w_pdt_00320
integer x = 3707
string dataobject = "d_pdt_00320_p"
end type

type dw_ip from w_standard_print`dw_ip within w_pdt_00320
integer x = 55
integer y = 32
integer width = 3383
integer height = 164
string dataobject = "d_pdt_00320_h"
end type
...
Choose Case GetColumnName() 
	Case"prod_ymd"
		...
		END IF
	Case 'porgu'
		f_child_saupj(this, 'empno', gettext())
...
type dw_list from w_standard_print`dw_list within w_pdt_00320
integer x = 69
integer y = 244
integer width = 4498
integer height = 2000
string dataobject = "d_pdt_00320_d"
