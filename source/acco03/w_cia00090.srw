$PBExportHeader$w_cia00090.srw
$PBExportComments$제조경비 투입 명세서
forward
global type w_cia00090 from w_standard_print
end type
type rr_1 from roundrectangle within w_cia00090
end type
end forward

global type w_cia00090 from w_standard_print
string title = "제조경비 투입 명세서"
rr_1 rr_1
end type
global w_cia00090 w_cia00090

forward prototypes
public function integer wf_retrieve ()
end prototypes

public function integer wf_retrieve ();String sFromym,sToym,sAcc_cd1,sAcc_cd2,sWon_Gubn,sGubn,sAcc_cd,scost_sabu,scost_nm
...
IF sGubn = '1' THEN
	dw_list.DataObject = "dw_cia00090_2"   /*계정과목별*/
	dw_print.DataObject = "dw_cia00090_2_p"   /*계정과목별*/
ELSEIF sGubn = '2' THEN	
	dw_list.DataObject = "dw_cia00090_3"   /*원가부문별*/
	dw_print.DataObject = "dw_cia00090_3_p"   /*원가부문별*/
END IF		
...
type p_preview from w_standard_print`p_preview within w_cia00090
integer taborder = 30
end type

type p_exit from w_standard_print`p_exit within w_cia00090
end type

type p_print from w_standard_print`p_print within w_cia00090
end type

type p_retrieve from w_standard_print`p_retrieve within w_cia00090
end type
...
type st_10 from w_standard_print`st_10 within w_cia00090
end type



type dw_print from w_standard_print`dw_print within w_cia00090
integer x = 3936
integer y = 164
string dataobject = "dw_cia00090_2_p"
boolean border = false
end type

type dw_ip from w_standard_print`dw_ip within w_cia00090
integer x = 69
integer width = 3739
integer height = 204
string dataobject = "dw_cia00090_1"
end type
...
IF dwo.name = "sgubn" THEN
	CHOOSE CASE data
		CASE '1'
			dw_list.DataObject ="dw_cia00090_2"
			dw_list.SetTransObject(SQLCA)
			
			dw_print.DataObject ="dw_cia00090_2_p"
			dw_print.SetTransObject(SQLCA)

		CASE '2'
			dw_list.DataObject ="dw_cia00090_3"
			dw_list.SetTransObject(SQLCA)
			
			dw_print.DataObject ="dw_cia00090_3_p"
			dw_print.SetTransObject(SQLCA)	
	END CHOOSE
	w_mdi_frame.sle_msg.text =""
END IF
...
type dw_list from w_standard_print`dw_list within w_cia00090
integer x = 87
integer y = 232
integer width = 4494
integer height = 2000
integer taborder = 40
string dataobject = "dw_cia00090_2"
boolean border = false
end type
