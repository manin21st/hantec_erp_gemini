$PBExportHeader$w_cia60010.srw
$PBExportComments$원재료 배합표
forward
global type w_cia60010 from w_standard_print
end type
type rr_2 from roundrectangle within w_cia60010
end type
end forward
...
type p_preview from w_standard_print`p_preview within w_cia60010
integer taborder = 30
end type

type p_exit from w_standard_print`p_exit within w_cia60010
integer taborder = 70
end type

type p_print from w_standard_print`p_print within w_cia60010
end type

type p_retrieve from w_standard_print`p_retrieve within w_cia60010
end type
...
type st_10 from w_standard_print`st_10 within w_cia60010
end type



type dw_print from w_standard_print`dw_print within w_cia60010
string dataobject = "dw_cia00071_5_p"
end type

type dw_ip from w_standard_print`dw_ip within w_cia60010
integer x = 37
integer y = 20
integer width = 3721
integer height = 160
string dataobject = "dw_cia60010_2"
end type
...
type dw_list from w_standard_print`dw_list within w_cia60010
integer x = 41
integer y = 196
integer width = 4562
integer height = 2040
