$PBExportHeader$w_cia30060.srw
$PBExportComments$제품별 손익 명세서
forward
global type w_cia30060 from w_standard_print
end type
type rr_1 from roundrectangle within w_cia30060
end type
end forward

global type w_cia30060 from w_standard_print
string title = "제품별 손익 명세서"
rr_1 rr_1
end type
global w_cia30060 w_cia30060

forward prototypes
public function integer wf_retrieve ()
end prototypes

public function integer wf_retrieve ();String sYm,spdt_gubn,sitnbr,sittyp, sitcls, sYmTo,scost_sabu,scost_nm
...
IF dw_print.Retrieve(scost_sabu,scost_nm,sYm,sYmTo, spdt_gubn ,sittyp ,sitnbr, sitcls)  <= 0 THEN
   f_messagechk(14,"") 
	Return -1 	
END IF	
...
type p_preview from w_standard_print`p_preview within w_cia30060
integer x = 4082
end type

type p_exit from w_standard_print`p_exit within w_cia30060
integer x = 4430
end type

type p_print from w_standard_print`p_print within w_cia30060
integer x = 4256
end type

type p_retrieve from w_standard_print`p_retrieve within w_cia30060
integer x = 3909
end type
...
type st_10 from w_standard_print`st_10 within w_cia30060
end type



type dw_print from w_standard_print`dw_print within w_cia30060
string dataobject = "dw_cia30060_2_p"
end type

type dw_ip from w_standard_print`dw_ip within w_cia30060
integer x = 55
integer y = 0
integer width = 3813
integer height = 216
string dataobject = "dw_cia30060_1"
end type
...
type dw_list from w_standard_print`dw_list within w_cia30060
integer x = 69
integer y = 224
integer width = 4526
integer height = 2000
string dataobject = "dw_cia30060_2"
