$PBExportHeader$w_sal_06810.srw
$PBExportComments$B/L 등록 현황
forward
global type w_sal_06810 from w_standard_print
end type
type pb_1 from u_pb_cal within w_sal_06810
end type
type pb_2 from u_pb_cal within w_sal_06810
end type
type rr_1 from roundrectangle within w_sal_06810
end type
type rr_3 from roundrectangle within w_sal_06810
end type
end forward

global type w_sal_06810 from w_standard_print
string title = "B/L 등록 현황"
pb_1 pb_1
pb_2 pb_2
rr_1 rr_1
rr_3 rr_3
end type
global w_sal_06810 w_sal_06810
...
type p_xls from w_standard_print`p_xls within w_sal_06810
end type

type p_sort from w_standard_print`p_sort within w_sal_06810
end type

type p_preview from w_standard_print`p_preview within w_sal_06810
end type

type p_exit from w_standard_print`p_exit within w_sal_06810
end type

type p_print from w_standard_print`p_print within w_sal_06810
end type

type p_retrieve from w_standard_print`p_retrieve within w_sal_06810
end type
...
type dw_print from w_standard_print`dw_print within w_sal_06810
string dataobject = "d_sal_06810_p"
end type

type dw_ip from w_standard_print`dw_ip within w_sal_06810
integer x = 46
integer y = 40
integer width = 3680
integer height = 176
string dataobject = "d_sal_06810_01"
end type
...
type dw_list from w_standard_print`dw_list within w_sal_06810
integer x = 27
integer y = 260
integer width = 4567
integer height = 2056
string dataobject = "d_sal_06810"
