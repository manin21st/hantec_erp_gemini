$PBExportHeader$w_adt_00160.srw
$PBExportComments$제품 수불장
forward
global type w_adt_00160 from w_standard_print
end type
type rb_1 from radiobutton within w_adt_00160
end type
type rb_2 from radiobutton within w_adt_00160
end type
type rr_1 from roundrectangle within w_adt_00160
end type
type rr_2 from roundrectangle within w_adt_00160
end type
end forward
...
global w_adt_00160 w_adt_00160
...
IF dw_print.Retrieve(gs_sabu, ls_saupj, ls_sdate, ls_edate, ls_depot, ls_ittyp, ls_sitnbr, ls_eitnbr, ls_sitcls, ls_eitcls) < 1 THEN
	f_message_chk(300,'')
	dw_list.Reset()
	dw_ip.setfocus()
	dw_ip.setcolumn('syymm')
...
type p_xls from w_standard_print`p_xls within w_adt_00160
boolean visible = true
integer x = 4270
integer y = 24
end type

type p_sort from w_standard_print`p_sort within w_adt_00160
end type

type p_preview from w_standard_print`p_preview within w_adt_00160
end type

type p_exit from w_standard_print`p_exit within w_adt_00160
end type

type p_print from w_standard_print`p_print within w_adt_00160
boolean visible = false
integer x = 3813
integer y = 260
end type

type p_retrieve from w_standard_print`p_retrieve within w_adt_00160
end type
...
type dw_print from w_standard_print`dw_print within w_adt_00160
integer x = 3639
integer y = 240
string dataobject = "d_adt_00160_1_p"
end type

type dw_ip from w_standard_print`dw_ip within w_adt_00160
integer x = 59
integer y = 96
integer width = 3392
integer height = 268
string dataobject = "d_adt_00160"
end type
...
type dw_list from w_standard_print`dw_list within w_adt_00160
integer x = 64
integer y = 460
integer width = 4526
integer height = 1816
string dataobject = "d_adt_00160_1"
...
dw_list.reset()
dw_print.reset()
dw_list.dataobject  = 'd_adt_00160_1'
dw_print.dataobject = 'd_adt_00160_1_p'
...
dw_list.reset()
dw_print.reset()
dw_list.dataobject  = 'd_adt_00160_5'
dw_print.dataobject = 'd_adt_00160_5_p'
