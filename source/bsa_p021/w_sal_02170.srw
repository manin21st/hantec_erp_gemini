$PBExportHeader$w_sal_02170.srw
$PBExportComments$수주 취소 집계현황 - 거래처별
forward
global type w_sal_02170 from w_standard_print
end type
type pb_1 from u_pb_cal within w_sal_02170
end type
type pb_2 from u_pb_cal within w_sal_02170
end type
type rr_1 from roundrectangle within w_sal_02170
end type
end forward

global type w_sal_02170 from w_standard_print
string title = "수주 취소 집계 현황 - 거래처별"
boolean maxbox = true
pb_1 pb_1
pb_2 pb_2
rr_1 rr_1
end type
global w_sal_02170 w_sal_02170

forward prototypes
public function integer wf_retrieve ()
end prototypes

public function integer wf_retrieve ();String sFrom,sTo,sTeam,sArea,sCust, tx_name,ssaupj ,ls_emp_id
...
//IF dw_list.Retrieve(gs_sabu,sFrom, sTo, sTeam+'%', sArea+'%', sCust+'%',ssaupj,ls_emp_id) <=0 THEN
//	f_message_chk(50,'')
//   dw_ip.setcolumn('sdatef')
//	dw_ip.SetFocus()
//	Return -1
...
IF dw_print.Retrieve(gs_sabu,sFrom, sTo, sTeam+'%', sArea+'%', sCust+'%',ssaupj,ls_emp_id) <=0 THEN
	f_message_chk(50,'')
	dw_list.Reset()
   dw_ip.setcolumn('sdatef')
	dw_ip.SetFocus()
...
type p_preview from w_standard_print`p_preview within w_sal_02170
end type

type p_exit from w_standard_print`p_exit within w_sal_02170
end type

type p_print from w_standard_print`p_print within w_sal_02170
end type

type p_retrieve from w_standard_print`p_retrieve within w_sal_02170
end type
...
type dw_print from w_standard_print`dw_print within w_sal_02170
string dataobject = "d_sal_02170_p"
end type

type dw_ip from w_standard_print`dw_ip within w_sal_02170
integer y = 24
integer width = 3502
integer height = 248
string dataobject = "d_sal_021701"
end type
...
string  sCvcod, scvnas, sarea, steam, sSaupj, sName1, scode
...
type dw_list from w_standard_print`dw_list within w_sal_02170
integer x = 55
integer y = 296
integer width = 2523
integer height = 2016
string dataobject = "d_sal_02170"
