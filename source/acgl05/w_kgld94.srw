$PBExportHeader$w_kgld94.srw
$PBExportComments$일계표 조회/출력(대체현금 반영)
forward
global type w_kgld94 from w_standard_print
end type
type rr_1 from roundrectangle within w_kgld94
end type
end forward

global type w_kgld94 from w_standard_print
string title = "일계표(대체현금 반영) 조회 출력"
rr_1 rr_1
end type
global w_kgld94 w_kgld94
...
dw_print.modify("saup.text ='"+sabu_nm+"'") // 사업명 move
...
type p_preview from w_standard_print`p_preview within w_kgld94
integer y = 0
string pointer = ""
end type

type p_exit from w_standard_print`p_exit within w_kgld94
integer y = 0
string pointer = ""
end type

type p_print from w_standard_print`p_print within w_kgld94
integer y = 0
string pointer = ""
end type

type p_retrieve from w_standard_print`p_retrieve within w_kgld94
integer y = 0
string pointer = ""
end type
...
type st_10 from w_standard_print`st_10 within w_kgld94
end type



type dw_print from w_standard_print`dw_print within w_kgld94
integer x = 3671
integer y = 20
string dataobject = "dw_kgld94_2_p"
end type

type dw_ip from w_standard_print`dw_ip within w_kgld94
integer x = 37
integer y = 12
integer width = 2350
integer height = 124
string dataobject = "dw_kgld94"
end type

event dw_ip::itemerror;call super::itemerror;Return 1
end event

type dw_list from w_standard_print`dw_list within w_kgld94
integer x = 55
integer y = 168
integer width = 4544
integer height = 2048
string dataobject = "dw_kgld94_2"
