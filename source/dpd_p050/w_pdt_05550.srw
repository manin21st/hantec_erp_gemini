...
type rr_1 from roundrectangle within w_pdt_05550
end type
type rr_2 from roundrectangle within w_pdt_05550
end type
end forward
...
type p_preview from w_standard_print`p_preview within w_pdt_05550
integer x = 4027
end type

type p_exit from w_standard_print`p_exit within w_pdt_05550
integer x = 4375
end type

type p_print from w_standard_print`p_print within w_pdt_05550
integer x = 4201
end type

type p_retrieve from w_standard_print`p_retrieve within w_pdt_05550
integer x = 3854
end type
...
type st_10 from w_standard_print`st_10 within w_pdt_05550
end type
