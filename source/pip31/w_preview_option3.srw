$PBExportHeader$w_preview_option3.srw
$PBExportComments$액셀 다운로드 - DW넘김
forward
global type w_preview_option3 from window
end type
type cb_3 from commandbutton within w_preview_option3
end type
type cb_2 from commandbutton within w_preview_option3
end type
type dw_2 from datawindow within w_preview_option3
end type
type cb_1 from commandbutton within w_preview_option3
end type
type cbx_1 from checkbox within w_preview_option3
end type
type dw_1 from datawindow within w_preview_option3
end type
type gb_1 from groupbox within w_preview_option3
end type
end forward
...
global w_preview_option3 w_preview_option3
...
ls_objs = iDw_List.describe("datawindow.objects")
...
event open;iDw_List = message.powerobjectparm
...
//-----------------------------------------------------------------------------
setpointer(hourglass!)
wf_collect_objects(iDw_List,dw_1)
wf_filtering_objects(iDw_List,dw_1,'detail')
wf_distribute_objects(iDw_List,dw_1)

cbx_1.checked = true
cbx_1.triggerevent(clicked!)
end event

event close;iDw_List.modify(iscol+".color="+string(ilclr))
...
if wf_down_excel2(iDw_List,dw_1) = -1 then
...
//////////////////////////////////////////////////////////////////////
iDw_List.modify(iscol+".color="+string(ilclr))

iscol = this.getitemstring(row,'name')
lclr = long(iDw_List.describe(iscol+".color"))
if lclr <> RGB(128,0,128) then
	ilclr = lclr
	iDw_List.modify(iscol+".color="+string(RGB(128,0,128)))
end if
//////////////////////////////////////////////////////////////////////
