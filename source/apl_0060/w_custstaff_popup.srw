...
gs_code     = dw_1.GetItemString(Row, "custstaff_cust_no")       // 고객코드
gs_codename = dw_1.GetItemString(row,"custstaff_staffnm")        // 고객임직원명
gs_gubun    = String(dw_1.GetItemNumber(row,"custstaff_seq"))    // 순번
