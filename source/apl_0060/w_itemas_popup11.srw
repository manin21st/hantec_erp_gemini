$PBExportHeader$w_itemas_popup11.srw
$PBExportComments$** 품목코드 조회 선택(F1 KEY)완료처리된 품목
forward
global type w_itemas_popup11 from w_inherite_popup
end type
type rr_2 from roundrectangle within w_itemas_popup11
end type
end forward
...
global w_itemas_popup11 w_itemas_popup11
...
type dw_jogun from w_inherite_popup`dw_jogun within w_itemas_popup11
integer x = 0
integer y = 32
integer width = 2784
integer height = 400
string dataobject = "d_itemas_ittyp11"
end type
...
type p_exit from w_inherite_popup`p_exit within w_itemas_popup11
integer x = 3465
end type
...
type p_inq from w_inherite_popup`p_inq within w_itemas_popup11
integer x = 3118
...
type p_choose from w_inherite_popup`p_choose within w_itemas_popup11
integer x = 3291
end type
...
type dw_1 from w_inherite_popup`dw_1 within w_itemas_popup11
integer x = 27
integer y = 460
integer width = 3589
integer height = 1336
integer taborder = 100
string dataobject = "d_itemas_popup11"
...
type sle_2 from w_inherite_popup`sle_2 within w_itemas_popup11
end type

type cb_1 from w_inherite_popup`cb_1 within w_itemas_popup11
end type

type cb_return from w_inherite_popup`cb_return within w_itemas_popup11
end type

type cb_inq from w_inherite_popup`cb_inq within w_itemas_popup11
boolean default = false
end type

type sle_1 from w_inherite_popup`sle_1 within w_itemas_popup11
end type

type st_1 from w_inherite_popup`st_1 within w_itemas_popup11
end type
