$PBExportHeader$w_pstruc_popup_1.srw
$PBExportComments$** 하위품번(BOM) 조회 선택
forward
global type w_pstruc_popup_1 from w_inherite
end type
type dw_head from u_key_enter within w_pstruc_popup_1
end type
type st_splitbar from u_st_splitbar within w_pstruc_popup_1
end type
type p_6 from uo_picture within w_pstruc_popup_1
end type
type tv_1 from treeview within w_pstruc_popup_1
end type
type p_1 from picture within w_pstruc_popup_1
end type
end forward
...
global w_pstruc_popup_1 w_pstruc_popup_1
...
type dw_insert from w_inherite`dw_insert within w_pstruc_popup_1
integer x = 1330
integer y = 196
integer width = 2089
integer height = 1276
...
type p_delrow from w_inherite`p_delrow within w_pstruc_popup_1
...
type p_addrow from w_inherite`p_addrow within w_pstruc_popup_1
boolean visible = false
integer x = 2551
integer y = 28
boolean enabled = false
...
type p_search from w_inherite`p_search within w_pstruc_popup_1
boolean visible = false
integer x = 3369
integer y = 2428
end type

type p_ins from w_inherite`p_ins within w_pstruc_popup_1
boolean visible = false
integer x = 3991
integer y = 2432
end type

type p_exit from w_inherite`p_exit within w_pstruc_popup_1
integer x = 3246
integer y = 28
end type

event p_exit::clicked;SetNull(gs_code)
Close(parent)
end event

type p_can from w_inherite`p_can within w_pstruc_popup_1
boolean visible = false
integer x = 3072
integer y = 28
end type

type p_print from w_inherite`p_print within w_pstruc_popup_1
boolean visible = false
integer x = 3584
integer y = 2428
end type

type p_inq from w_inherite`p_inq within w_pstruc_popup_1
boolean visible = false
integer x = 3781
integer y = 2428
end type

type p_del from w_inherite`p_del within w_pstruc_popup_1
boolean visible = false
integer x = 4219
integer y = 2428
end type

type p_mod from w_inherite`p_mod within w_pstruc_popup_1
boolean visible = false
integer x = 2898
integer y = 28
boolean enabled = false
...
type cb_exit from w_inherite`cb_exit within w_pstruc_popup_1
end type

type cb_mod from w_inherite`cb_mod within w_pstruc_popup_1
end type

type cb_ins from w_inherite`cb_ins within w_pstruc_popup_1
end type

type cb_del from w_inherite`cb_del within w_pstruc_popup_1
end type

type cb_inq from w_inherite`cb_inq within w_pstruc_popup_1
end type

type cb_print from w_inherite`cb_print within w_pstruc_popup_1
end type

type st_1 from w_inherite`st_1 within w_pstruc_popup_1
integer x = 1422
integer y = 2484
integer width = 1582
string text = ""
...
type cb_can from w_inherite`cb_can within w_pstruc_popup_1
integer x = 2117
integer y = 2784
end type

type cb_search from w_inherite`cb_search within w_pstruc_popup_1
end type
...
type gb_button1 from w_inherite`gb_button1 within w_pstruc_popup_1
integer x = 910
integer y = 3244
end type

type gb_button2 from w_inherite`gb_button2 within w_pstruc_popup_1
end type
...
DECLARE erp_create_pstruc_to_soje PROCEDURE FOR erp_create_pstruc_to_soje(:ls_itnbr);
