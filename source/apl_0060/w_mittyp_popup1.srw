$PBExportHeader$w_mittyp_popup1.srw
$PBExportComments$설비/계측기  대/중/소 분류코드 조회 popup
forward
global type w_mittyp_popup1 from w_inherite_popup
end type
type dw_2 from datawindow within w_mittyp_popup1
end type
type rr_1 from roundrectangle within w_mittyp_popup1
end type
type ln_1 from line within w_mittyp_popup1
end type
type ln_2 from line within w_mittyp_popup1
end type
type rr_2 from roundrectangle within w_mittyp_popup1
end type
end forward
...
global w_mittyp_popup1 w_mittyp_popup1

on w_mittyp_popup1.create
int iCurrent
call super::create
...
type dw_jogun from w_inherite_popup`dw_jogun within w_mittyp_popup1
integer x = 0
integer y = 5000
end type

type p_exit from w_inherite_popup`p_exit within w_mittyp_popup1
integer x = 2286
end type
...
type p_inq from w_inherite_popup`p_inq within w_mittyp_popup1
integer x = 1938
end type
...
type p_choose from w_inherite_popup`p_choose within w_mittyp_popup1
integer x = 2112
end type
...
type dw_1 from w_inherite_popup`dw_1 within w_mittyp_popup1
integer x = 64
integer y = 352
integer width = 2377
integer height = 1452
integer taborder = 40
string dataobject = "d_mittyp_popup2"
end type
...
type sle_2 from w_inherite_popup`sle_2 within w_mittyp_popup1
integer x = 1230
integer y = 220
integer width = 955
integer height = 68
...
type cb_1 from w_inherite_popup`cb_1 within w_mittyp_popup1
integer x = 1815
integer y = 5000
integer taborder = 50
end type

type cb_return from w_inherite_popup`cb_return within w_mittyp_popup1
integer x = 2446
integer y = 5000
integer taborder = 70
end type

type cb_inq from w_inherite_popup`cb_inq within w_mittyp_popup1
integer x = 2130
integer y = 5000
integer taborder = 60
end type
...
type sle_1 from w_inherite_popup`sle_1 within w_mittyp_popup1
integer x = 891
integer y = 220
integer width = 325
integer height = 68
...
type st_1 from w_inherite_popup`st_1 within w_mittyp_popup1
integer x = 663
integer y = 232
integer width = 256
integer weight = 400
