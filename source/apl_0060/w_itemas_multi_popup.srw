$PBExportHeader$w_itemas_multi_popup.srw
$PBExportComments$** 품목코드 조회 선택(F1 KEY)완료처리된 품목
forward
global type w_itemas_multi_popup from w_inherite_popup
end type
type st_check from statictext within w_itemas_multi_popup
end type
type rr_2 from roundrectangle within w_itemas_multi_popup
end type
end forward
...
global w_itemas_multi_popup w_itemas_multi_popup
...
on w_itemas_multi_popup.create
int iCurrent
call super::create
this.st_check=create st_check
this.rr_2=create rr_2
iCurrent=UpperBound(this.Control)
this.Control[iCurrent+1]=this.st_check
this.Control[iCurrent+2]=this.rr_2
end on

on w_itemas_multi_popup.destroy
call super::destroy
...
//	dw_jogun.Modify("porgu.protect=1")
//End If
//dw_jogun.SetItem(1, 'porgu', sSaupj)
...
type dw_jogun from w_inherite_popup`dw_jogun within w_itemas_multi_popup
integer x = 0
integer y = 32
integer width = 2807
integer height = 400
...
type p_exit from w_inherite_popup`p_exit within w_itemas_multi_popup
integer x = 3465
end type
...
type p_inq from w_inherite_popup`p_inq within w_itemas_multi_popup
integer x = 3118
...
If IsNull(ls_itgu) Then ls_itgu = ""
   ...
   dw_1.dataobject = 'd_itemas_multi_popup'					 
...
type p_choose from w_inherite_popup`p_choose within w_itemas_multi_popup
integer x = 3291
end type
...
//		istr_itnbr.dgubun1[ii]  = dw_1.Object.itemas_cnvfat[i]
...
type dw_1 from w_inherite_popup`dw_1 within w_itemas_multi_popup
integer x = 27
integer y = 444
integer width = 3602
integer height = 1356
integer taborder = 100
string dataobject = "d_itemas_multi_popup"
...
type sle_2 from w_inherite_popup`sle_2 within w_itemas_multi_popup
end type

type cb_1 from w_inherite_popup`cb_1 within w_itemas_multi_popup
end type

type cb_return from w_inherite_popup`cb_return within w_itemas_multi_popup
end type

type cb_inq from w_inherite_popup`cb_inq within w_itemas_multi_popup
boolean default = false
end type

type sle_1 from w_inherite_popup`sle_1 within w_itemas_multi_popup
end type

type st_1 from w_inherite_popup`st_1 within w_itemas_multi_popup
end type
