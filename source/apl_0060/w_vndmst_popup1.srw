$PBExportHeader$w_vndmst_popup1.srw
$PBExportComments$** 거래처 조회 선택
forward
global type w_vndmst_popup1 from w_inherite_popup
end type
type cbx_1 from checkbox within w_vndmst_popup1
end type
type cbx_2 from checkbox within w_vndmst_popup1
end type
type cbx_3 from checkbox within w_vndmst_popup1
end type
type cbx_4 from checkbox within w_vndmst_popup1
end type
type cbx_5 from checkbox within w_vndmst_popup1
end type
type rr_1 from roundrectangle within w_vndmst_popup1
end type
type rr_2 from roundrectangle within w_vndmst_popup1
end type
end forward
...
global w_vndmst_popup1 w_vndmst_popup1

type variables
int  li_use  //거래처마스타는 거래중지인 경우도 조회
end variables

on w_vndmst_popup1.create
int iCurrent
call super::create
...
type dw_jogun from w_inherite_popup`dw_jogun within w_vndmst_popup1
boolean visible = false
integer x = 78
integer y = 2200
integer width = 1467
integer height = 196
string dataobject = "d_vndmst_popup1_1"
end type

event dw_jogun::itemerror;call super::itemerror;RETURN 1
end event

type p_exit from w_inherite_popup`p_exit within w_vndmst_popup1
integer x = 1833
integer y = 16
end type
...
type p_inq from w_inherite_popup`p_inq within w_vndmst_popup1
integer x = 1486
integer y = 16
...
type p_choose from w_inherite_popup`p_choose within w_vndmst_popup1
integer x = 1659
integer y = 16
end type
...
type dw_1 from w_inherite_popup`dw_1 within w_vndmst_popup1
integer x = 27
integer y = 184
integer width = 1966
integer height = 1536
integer taborder = 50
string dataobject = "d_vndmst_popup_1"
end type
...
type sle_2 from w_inherite_popup`sle_2 within w_vndmst_popup1
integer x = 599
integer y = 2392
integer width = 1225
end type

type cb_1 from w_inherite_popup`cb_1 within w_vndmst_popup1
integer x = 718
integer y = 2344
end type

type cb_return from w_inherite_popup`cb_return within w_vndmst_popup1
integer x = 1339
integer y = 2344
end type

type cb_inq from w_inherite_popup`cb_inq within w_vndmst_popup1
integer x = 1029
integer y = 2344
boolean default = false
end type

type sle_1 from w_inherite_popup`sle_1 within w_vndmst_popup1
integer x = 398
integer y = 2392
integer width = 197
integer limit = 6
...
type st_1 from w_inherite_popup`st_1 within w_vndmst_popup1
integer x = 69
integer y = 2408
integer width = 315
string text = "거래처코드"
