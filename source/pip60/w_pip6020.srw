$PBExportHeader$w_pip6020.srw
$PBExportComments$** 보수총액현황
forward
global type w_pip6020 from w_standard_print
end type
type rr_2 from roundrectangle within w_pip6020
end type
type st_2 from statictext within w_pip6020
end type
type rb_1 from radiobutton within w_pip6020
end type
type rb_2 from radiobutton within w_pip6020
end type
type rb_3 from radiobutton within w_pip6020
end type
type rb_4 from radiobutton within w_pip6020
end type
type rr_3 from roundrectangle within w_pip6020
end type
end forward
...
string sDeptcode,ls_gubun,sJikJong,sPbTag,sdwgubn, sKunmu, sempno, ls_sex,ls_date
...
IF dw_Print.Retrieve(sSaup,sStartYear,sEndYear,sKunmu,ls_date) <=0 THEN
...
type p_preview from w_standard_print`p_preview within w_pip6020
integer y = 20
boolean enabled = true
end type

type p_exit from w_standard_print`p_exit within w_pip6020
integer y = 20
end type

type p_print from w_standard_print`p_print within w_pip6020
integer y = 20
boolean enabled = true
end type

type p_retrieve from w_standard_print`p_retrieve within w_pip6020
integer y = 20
end type

type st_window from w_standard_print`st_window within w_pip6020
boolean visible = false
integer x = 2505
integer y = 2876
end type

type sle_msg from w_standard_print`sle_msg within w_pip6020
boolean visible = false
integer x = 521
integer y = 2872
end type

type dw_datetime from w_standard_print`dw_datetime within w_pip6020
boolean visible = false
integer x = 2990
integer y = 2872
end type

type st_10 from w_standard_print`st_10 within w_pip6020
boolean visible = false
integer x = 160
integer y = 2872
end type

type gb_10 from w_standard_print`gb_10 within w_pip6020
boolean visible = false
integer x = 146
integer y = 2820
end type

type dw_print from w_standard_print`dw_print within w_pip6020
integer x = 3781
string dataobject = "d_pip6020_2_p"
end type

type dw_ip from w_standard_print`dw_ip within w_pip6020
integer x = 37
integer y = 0
integer width = 2039
integer height = 220
string dataobject = "d_pip6020_1"
end type
...
type dw_list from w_standard_print`dw_list within w_pip6020
integer x = 23
integer y = 236
integer width = 4571
integer height = 2004
string dataobject = "d_pip6020_2"
...
event clicked;dw_list.Dataobject = "d_pip6020_2"
dw_list.SetTransobject(sqlca)

dw_print.Dataobject = "d_pip6020_2_p"
...
event clicked;dw_list.Dataobject = "d_pip6020_4"
dw_list.SetTransobject(sqlca)

dw_print.Dataobject = "d_pip6020_4_p"
dw_print.SetTransobject(sqlca)
end event
...
event clicked;dw_list.Dataobject = "d_pip6020_3"
dw_list.SetTransobject(sqlca)

dw_print.Dataobject = "d_pip6020_3_p"
dw_print.SetTransobject(sqlca)
end event
...
event clicked;dw_list.Dataobject = "d_pip6020_5"
dw_list.SetTransobject(sqlca)

dw_print.Dataobject = "d_pip6020_5_p"
dw_print.SetTransobject(sqlca)
end event
