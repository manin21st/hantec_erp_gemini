$PBExportHeader$w_han_01012.srw
$PBExportComments$생산실적 현황 - 블럭/품번별 집계
forward
global type w_han_01012 from w_standard_print
end type
type pb_1 from u_pb_cal within w_han_01012
end type
type pb_2 from u_pb_cal within w_han_01012
end type
type rr_1 from roundrectangle within w_han_01012
end type
end forward

global type w_han_01012 from w_standard_print
string title = "기간별 생산실적 집계현황"
pb_1 pb_1
pb_2 pb_2
rr_1 rr_1
end type
global w_han_01012 w_han_01012
...
dw_list.Retrieve(ls_jocod, ls_st + ls_stim, ls_ed + ls_etim, ls_itnbr)
...
type p_xls from w_standard_print`p_xls within w_han_01012
...
type p_sort from w_standard_print`p_sort within w_han_01012
integer x = 4375
integer y = 172
end type

type p_preview from w_standard_print`p_preview within w_han_01012
integer x = 4041
end type

type p_exit from w_standard_print`p_exit within w_han_01012
integer x = 4389
end type

type p_print from w_standard_print`p_print within w_han_01012
boolean visible = false
integer x = 4041
integer y = 172
end type

type p_retrieve from w_standard_print`p_retrieve within w_han_01012
integer x = 3867
end type
...
type st_10 from w_standard_print`st_10 within w_han_01012
end type



type dw_print from w_standard_print`dw_print within w_han_01012
integer x = 4238
integer y = 172
string dataobject = "d_han_01012_003"
end type

type dw_ip from w_standard_print`dw_ip within w_han_01012
integer x = 37
integer width = 3813
integer height = 180
string dataobject = "d_han_01012_001"
end type
...
type dw_list from w_standard_print`dw_list within w_han_01012
integer x = 46
integer y = 212
integer width = 4507
integer height = 2012
string dataobject = "d_han_01012_002"
