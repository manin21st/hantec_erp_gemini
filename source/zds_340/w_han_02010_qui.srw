$PBExportHeader$w_han_02010_qui.srw
$PBExportComments$생산불량 현황 - 귀책공정 기준
forward
global type w_han_02010_qui from w_standard_print
end type
type pb_1 from u_pb_cal within w_han_02010_qui
end type
type pb_2 from u_pb_cal within w_han_02010_qui
end type
type rr_1 from roundrectangle within w_han_02010_qui
end type
end forward

global type w_han_02010_qui from w_standard_print
string title = "생산불량 현황-귀책품번"
pb_1 pb_1
pb_2 pb_2
rr_1 rr_1
end type
global w_han_02010_qui w_han_02010_qui
...
//dw_list.Retrieve(ls_st, ls_ed, ls_itnbr, ls_itcls, ls_itnct, ls_jocod, ls_wkctr, ls_empnm, ls_ittyp, ls_roslt, ls_desc)
dw_list.Retrieve(ls_st, ls_ed, ls_itnbr, ls_jocod, ls_wkctr, ls_empnm, ls_ittyp, ls_roslt, ls_stim, ls_etim)
...
type p_xls from w_standard_print`p_xls within w_han_02010_qui
...
type p_sort from w_standard_print`p_sort within w_han_02010_qui
boolean visible = true
integer x = 3611
integer y = 28
...
type p_preview from w_standard_print`p_preview within w_han_02010_qui
integer x = 4224
end type

type p_exit from w_standard_print`p_exit within w_han_02010_qui
integer x = 4398
end type

type p_print from w_standard_print`p_print within w_han_02010_qui
boolean visible = false
integer x = 3927
integer y = 180
end type

type p_retrieve from w_standard_print`p_retrieve within w_han_02010_qui
integer x = 3877
end type
...
type st_10 from w_standard_print`st_10 within w_han_02010_qui
end type



type dw_print from w_standard_print`dw_print within w_han_02010_qui
integer x = 3771
integer y = 208
string dataobject = "d_han_02010_qui_003"
end type

type dw_ip from w_standard_print`dw_ip within w_han_02010_qui
integer x = 32
integer width = 3570
integer height = 272
string dataobject = "d_han_02010_qui_001"
end type
...
type dw_list from w_standard_print`dw_list within w_han_02010_qui
integer x = 41
integer y = 308
integer width = 4558
integer height = 1932
string dataobject = "d_han_02010_qui_002"
