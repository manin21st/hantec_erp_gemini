$PBExportHeader$w_kgle04.srw
$PBExportComments$회기 등록
forward
global type w_kgle04 from w_inherite
end type
type dw_1 from u_key_enter within w_kgle04
end type
end forward
...
type dw_insert from w_inherite`dw_insert within w_kgle04
boolean visible = false
integer x = 50
integer y = 2400
end type

type p_delrow from w_inherite`p_delrow within w_kgle04
boolean visible = false
integer x = 3543
integer y = 2932
end type

type p_addrow from w_inherite`p_addrow within w_kgle04
boolean visible = false
integer x = 3369
integer y = 2932
end type

type p_search from w_inherite`p_search within w_kgle04
boolean visible = false
integer x = 2651
integer y = 2960
end type

type p_ins from w_inherite`p_ins within w_kgle04
boolean visible = false
integer x = 3195
integer y = 2932
end type

type p_exit from w_inherite`p_exit within w_kgle04
end type

type p_can from w_inherite`p_can within w_kgle04
boolean visible = false
integer x = 3986
integer y = 2988
end type

type p_print from w_inherite`p_print within w_kgle04
boolean visible = false
integer x = 2848
integer y = 2932
end type

type p_inq from w_inherite`p_inq within w_kgle04
boolean visible = false
integer x = 3022
integer y = 2932
end type

type p_del from w_inherite`p_del within w_kgle04
boolean visible = false
integer x = 3771
integer y = 2952
end type

type p_mod from w_inherite`p_mod within w_kgle04
integer x = 4265
end type
...
type cb_exit from w_inherite`cb_exit within w_kgle04
boolean visible = false
integer x = 2153
integer y = 2508
integer taborder = 30
...
type cb_mod from w_inherite`cb_mod within w_kgle04
boolean visible = false
integer x = 1787
integer y = 2512
integer taborder = 40
...
type cb_ins from w_inherite`cb_ins within w_kgle04
boolean visible = false
integer x = 878
integer y = 2432
end type

type cb_del from w_inherite`cb_del within w_kgle04
boolean visible = false
integer x = 1591
integer y = 2428
end type

type cb_inq from w_inherite`cb_inq within w_kgle04
boolean visible = false
integer x = 1947
integer y = 2424
end type

type cb_print from w_inherite`cb_print within w_kgle04
integer x = 2304
integer y = 2428
end type

type st_1 from w_inherite`st_1 within w_kgle04
integer width = 306
end type

type cb_can from w_inherite`cb_can within w_kgle04
boolean visible = false
integer x = 2661
integer y = 2424
end type

type cb_search from w_inherite`cb_search within w_kgle04
integer x = 3017
integer y = 2428
end type

type dw_datetime from w_inherite`dw_datetime within w_kgle04
integer x = 2825
integer height = 88
end type

type sle_msg from w_inherite`sle_msg within w_kgle04
integer x = 343
integer width = 2482
end type

type gb_10 from w_inherite`gb_10 within w_kgle04
integer width = 3575
end type

type gb_button1 from w_inherite`gb_button1 within w_kgle04
boolean visible = false
boolean enabled = false
end type

type gb_button2 from w_inherite`gb_button2 within w_kgle04
boolean visible = false
integer x = 1737
integer y = 2456
integer width = 814
