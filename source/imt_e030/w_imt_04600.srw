$PBExportHeader$w_imt_04600.srw
$PBExportComments$일일 입고금액 현황(출력)
forward
global type w_imt_04600 from w_standard_print
end type
type rr_1 from roundrectangle within w_imt_04600
end type
end forward

global type w_imt_04600 from w_standard_print
integer height = 2424
string title = "일일 입고 현황"
rr_1 rr_1
end type
global w_imt_04600 w_imt_04600
...
public function integer wf_retrieve ();string   s_stdym, scvcod1, scvcod2, sitnbr1, sitnbr2, sempno1, sempno2, sitgu1, sitgu2, swaigu, s_saupj, smagam
string   sittyp
...
smagam   = TRIM(dw_ip.GetItemString(1,"magam"))
...
IF dw_print.Retrieve(gs_sabu, s_stdym, scvcod1, scvcod2, sitnbr1, sitnbr2, &
                    sitgu1, sitgu2, swaigu, s_saupj, sittyp, smagam ) < 1 THEN
	f_message_chk(50,"[일일 입고 금액 현황]")
...
type p_xls from w_standard_print`p_xls within w_imt_04600
end type

type p_sort from w_standard_print`p_sort within w_imt_04600
end type

type p_preview from w_standard_print`p_preview within w_imt_04600
end type

type p_exit from w_standard_print`p_exit within w_imt_04600
end type

type p_print from w_standard_print`p_print within w_imt_04600
end type

type p_retrieve from w_standard_print`p_retrieve within w_imt_04600
end type
...
type st_10 from w_standard_print`st_10 within w_imt_04600
end type



type dw_print from w_standard_print`dw_print within w_imt_04600
integer x = 3968
integer y = 168
string dataobject = "d_imt_04601_p3"
end type

type dw_ip from w_standard_print`dw_ip within w_imt_04600
integer x = 14
integer y = 20
integer width = 3909
integer height = 276
string dataobject = "d_imt_04600"
end type
...
type dw_list from w_standard_print`dw_list within w_imt_04600
integer x = 32
integer width = 4581
string dataobject = "d_imt_04601_3"
