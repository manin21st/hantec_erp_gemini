$PBExportHeader$w_kifa15a.srw
$PBExportComments$자동전표 관리 : NEGO(반제)
forward
global type w_kifa15a from window
end type
type p_exit from uo_picture within w_kifa15a
end type
type p_can from uo_picture within w_kifa15a
end type
type dw_new from datawindow within w_kifa15a
end type
type dw_insert from datawindow within w_kifa15a
end type
type dw_ins from datawindow within w_kifa15a
end type
type dw_disp from datawindow within w_kifa15a
end type
type rr_1 from roundrectangle within w_kifa15a
end type
end forward
