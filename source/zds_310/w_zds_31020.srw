$PBExportHeader$w_zds_31020.srw
$PBExportComments$주간 구매계획 현황
forward
global type w_zds_31020 from w_standard_print
end type
type pb_1 from u_pb_cal within w_zds_31020
end type
type rr_1 from roundrectangle within w_zds_31020
end type
end forward

global type w_zds_31020 from w_standard_print
string title = "주간 구매계획 현황"
pb_1 pb_1
rr_1 rr_1
end type
global w_zds_31020 w_zds_31020
...
String ls_date, ls_cvcod, ls_ittyp, ls_itnbr
...
dw_list.Retrieve(ls_saupj, ls_date, '1', '%', ls_cvcod, ls_ittyp,ls_itnbr)
...
type p_xls from w_standard_print`p_xls within w_zds_31020
...
type p_sort from w_standard_print`p_sort within w_zds_31020
integer x = 3168
end type

type p_preview from w_standard_print`p_preview within w_zds_31020
integer x = 4027
end type

type p_exit from w_standard_print`p_exit within w_zds_31020
integer x = 4375
end type

type p_print from w_standard_print`p_print within w_zds_31020
boolean visible = false
integer x = 2962
integer y = 40
end type

type p_retrieve from w_standard_print`p_retrieve within w_zds_31020
integer x = 3854
end type
...
type st_10 from w_standard_print`st_10 within w_zds_31020
end type



type dw_print from w_standard_print`dw_print within w_zds_31020
integer x = 3657
string dataobject = "d_zds_31020_003"
end type

type dw_ip from w_standard_print`dw_ip within w_zds_31020
integer x = 37
integer width = 3227
integer height = 236
string dataobject = "d_zds_31020_001"
end type
...
type dw_list from w_standard_print`dw_list within w_zds_31020
integer x = 46
integer y = 276
integer width = 4526
integer height = 1972
string dataobject = "d_zds_31020_002"
