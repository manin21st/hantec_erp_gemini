$PBExportHeader$w_zds_31940.srw
$PBExportComments$BOX 출고 등록
forward
global type w_zds_31940 from w_inherite
end type
type rr_1 from roundrectangle within w_zds_31940
end type
type dw_1 from datawindow within w_zds_31940
end type
end forward

global type w_zds_31940 from w_inherite
string title = "BOX출고 등록"
rr_1 rr_1
dw_1 dw_1
end type
global w_zds_31940 w_zds_31940
...
type dw_insert from w_inherite`dw_insert within w_zds_31940
integer x = 46
integer y = 344
integer width = 4558
integer height = 1904
string dataobject = "d_zds_31940_002"
...
type p_delrow from w_inherite`p_delrow within w_zds_31940
...
type p_addrow from w_inherite`p_addrow within w_zds_31940
boolean visible = false
integer x = 3749
integer y = 284
end type

type p_search from w_inherite`p_search within w_zds_31940
boolean visible = false
integer y = 284
boolean enabled = false
end type

type p_ins from w_inherite`p_ins within w_zds_31940
boolean visible = false
integer y = 284
boolean enabled = false
end type

type p_exit from w_inherite`p_exit within w_zds_31940
end type

type p_can from w_inherite`p_can within w_zds_31940
end type

type p_print from w_inherite`p_print within w_zds_31940
boolean visible = false
integer y = 284
boolean enabled = false
end type

type p_inq from w_inherite`p_inq within w_zds_31940
boolean visible = false
integer x = 3749
end type
...
type p_del from w_inherite`p_del within w_zds_31940
boolean visible = false
integer y = 284
boolean enabled = false
end type

type p_mod from w_inherite`p_mod within w_zds_31940
integer x = 4096
end type
...
type cb_exit from w_inherite`cb_exit within w_zds_31940
end type

type cb_mod from w_inherite`cb_mod within w_zds_31940
end type

type cb_ins from w_inherite`cb_ins within w_zds_31940
end type

type cb_del from w_inherite`cb_del within w_zds_31940
end type

type cb_inq from w_inherite`cb_inq within w_zds_31940
end type

type cb_print from w_inherite`cb_print within w_zds_31940
end type

type st_1 from w_inherite`st_1 within w_zds_31940
end type

type cb_can from w_inherite`cb_can within w_zds_31940
end type

type cb_search from w_inherite`cb_search within w_zds_31940
end type
...
type gb_button1 from w_inherite`gb_button1 within w_zds_31940
end type

type gb_button2 from w_inherite`gb_button2 within w_zds_31940
end type
...
integer taborder = 10
string title = "none"
string dataobject = "d_zds_31940_001"
boolean border = false
