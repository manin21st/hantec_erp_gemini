$PBExportHeader$w_pdm_01440_settime.srw
$PBExportComments$** 공정별 준비시간
forward
global type w_pdm_01440_settime from w_inherite_popup
end type
type p_mod from uo_picture within w_pdm_01440_settime
end type
type p_del from uo_picture within w_pdm_01440_settime
end type
type p_1 from uo_picture within w_pdm_01440_settime
end type
type p_ins from uo_picture within w_pdm_01440_settime
end type
type rr_2 from roundrectangle within w_pdm_01440_settime
end type
end forward
...
global w_pdm_01440_settime w_pdm_01440_settime
...
on w_pdm_01440_settime.destroy
call super::destroy
destroy(this.p_mod)
destroy(this.p_del)
destroy(this.p_1)
...
type dw_jogun from w_inherite_popup`dw_jogun within w_pdm_01440_settime
...
type p_exit from w_inherite_popup`p_exit within w_pdm_01440_settime
integer x = 1435
integer y = 4
end type
...
type p_inq from w_inherite_popup`p_inq within w_pdm_01440_settime
boolean visible = false
integer x = 2542
integer y = 692
...
type p_choose from w_inherite_popup`p_choose within w_pdm_01440_settime
boolean visible = false
integer x = 2542
integer y = 844
boolean enabled = false
...
type dw_1 from w_inherite_popup`dw_1 within w_pdm_01440_settime
integer x = 27
integer y = 180
integer width = 1586
integer height = 724
integer taborder = 40
string dataobject = "d_pdm_01440_settime_1"
...
type sle_2 from w_inherite_popup`sle_2 within w_pdm_01440_settime
integer x = 599
integer y = 2392
integer width = 1225
integer taborder = 30
...
type cb_1 from w_inherite_popup`cb_1 within w_pdm_01440_settime
boolean visible = false
integer x = 718
integer y = 2344
integer taborder = 50
...
type cb_return from w_inherite_popup`cb_return within w_pdm_01440_settime
boolean visible = false
integer x = 1339
integer y = 2344
integer taborder = 70
...
type cb_inq from w_inherite_popup`cb_inq within w_pdm_01440_settime
boolean visible = false
integer x = 1029
integer y = 2344
integer taborder = 60
...
type sle_1 from w_inherite_popup`sle_1 within w_pdm_01440_settime
integer x = 398
integer y = 2392
integer width = 197
integer taborder = 20
...
type st_1 from w_inherite_popup`st_1 within w_pdm_01440_settime
integer x = 69
integer y = 2408
integer width = 315
string text = "거래처코드"
...
gs_gubun = 'OK'
gi_page = dw_1.GetItemNumber(1, 'stdst1') + dw_1.GetItemNumber(1, 'stdst2') + dw_1.GetItemNumber(1, 'stdst3')
Close(Parent)
end event
