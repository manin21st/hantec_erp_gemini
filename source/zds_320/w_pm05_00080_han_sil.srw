$PBExportHeader$w_pm05_00080_han_sil.srw
$PBExportComments$주간 생산계획 대비 실적현황
forward
global type w_pm05_00080_han_sil from w_standard_print
end type
type pb_1 from u_pb_cal within w_pm05_00080_han_sil
end type
type pb_2 from u_pb_cal within w_pm05_00080_han_sil
end type
type dw_1 from datawindow within w_pm05_00080_han_sil
end type
type cbx_1 from checkbox within w_pm05_00080_han_sil
end type
type pb_3 from u_pb_cal within w_pm05_00080_han_sil
end type
type rr_1 from roundrectangle within w_pm05_00080_han_sil
end type
end forward
...
global w_pm05_00080_han_sil w_pm05_00080_han_sil
...
ls_gbn = dw_ip.GetItemString(ll_row, 'gbn')
...
dw_list.Retrieve(ls_st,ls_ed, ls_itnbr, ls_jocod, ls_wkctr,ls_mchno,ls_stim,ls_etim,ls_gbn)
dw_list.SetRedraw(True)

//dw_print.Retrieve(ls_st,ls_ed, ls_itnbr, ls_jocod, ls_wkctr,ls_mchno,ls_stim,ls_etim)
dw_list.ShareData(dw_print)

dw_print.modify("st_date.text = '" + string(ls_st, "@@@@.@@.@@")  + "'")
dw_print.modify("et_date.text = '" + string(f_afterday(ls_st, 6), "@@@@.@@.@@")  + "'")

Return 1
end function

on w_pm05_00080_han_sil.create
int iCurrent
call super::create
...
on w_pm05_00080_han_sil.destroy
call super::destroy
...
dw_list.DataObject = 'd_pm05_00080_han1_sil_1'
dw_list.settransobject(sqlca)


String sDate, eDate,stoday
...
SELECT TO_CHAR(TO_DATE(:sDate) +7,'YYYYMMDD') INTO :eDate FROM DUAL ;

dw_ip.SetItem(1, 'd_ed', eDate)
end event

type p_xls from w_standard_print`p_xls within w_pm05_00080_han_sil
...
type p_sort from w_standard_print`p_sort within w_pm05_00080_han_sil
boolean visible = true
integer x = 3698
integer y = 24
...
type p_preview from w_standard_print`p_preview within w_pm05_00080_han_sil
integer x = 4073
end type

type p_exit from w_standard_print`p_exit within w_pm05_00080_han_sil
integer x = 4421
end type

type p_print from w_standard_print`p_print within w_pm05_00080_han_sil
boolean visible = false
integer x = 4073
integer y = 164
end type

type p_retrieve from w_standard_print`p_retrieve within w_pm05_00080_han_sil
integer x = 3899
end type
...
IF wf_retrieve() = -1 THEN
	...
	Return
Else
	ls_gubun = dw_ip.GetItemString(1, 'gbn')
//	If ls_gubun = '3' then	
//		p_preview.enabled = false
//		p_preview.picturename = "C:\erpman\image\미리보기_d.gif"
//	ELSE
...
type st_10 from w_standard_print`st_10 within w_pm05_00080_han_sil
end type



type dw_print from w_standard_print`dw_print within w_pm05_00080_han_sil
integer x = 3424
integer y = 32
string dataobject = "d_pm05_00080_han1_p_sil_1"
end type

type dw_ip from w_standard_print`dw_ip within w_pm05_00080_han_sil
integer x = 14
integer y = 0
integer width = 3694
integer height = 352
string dataobject = "d_pm05_00080_han0_sil"
end type
...
Choose Case dwo.name
	Case 'd_st'
		...
		//SELECT TO_CHAR(TO_DATE(:data) +7,'YYYYMMDD') INTO :ls_eDate FROM DUAL ;

		//This.SetItem(1, 'd_ed', ls_eDate)
	...
	Case 'gbn'
		If data = '3' Then
			dw_list.DataObject = 'd_pm05_00080_han1_sil_1'
			dw_print.DataObject = 'd_pm05_00080_han1_p_sil_1'
		Else
			dw_list.DataObject = 'd_pm05_00080_han1_sil'
			dw_print.DataObject = 'd_pm05_00080_han1_p_sil'
		End If
...
type dw_list from w_standard_print`dw_list within w_pm05_00080_han_sil
integer y = 368
integer width = 4558
integer height = 1936
string dataobject = "d_pm05_00080_han1_sil"
...
dw_ip.SetItem(1, 'd_ed', f_afterday(gs_code, 7))
...
string dataobject = "d_pm05_00080_han1_ntime_sil"
