$PBExportHeader$w_qa02_00099.srw
$PBExportComments$** 공정검사승인
forward
global type w_qa02_00099 from w_inherite
end type
type dw_1 from datawindow within w_qa02_00099
end type
type rb_1 from radiobutton within w_qa02_00099
end type
type rb_2 from radiobutton within w_qa02_00099
end type
type rb_3 from radiobutton within w_qa02_00099
end type
type rb_4 from radiobutton within w_qa02_00099
end type
type p_1 from picture within w_qa02_00099
end type
type dw_imhist from datawindow within w_qa02_00099
end type
type rr_1 from roundrectangle within w_qa02_00099
end type
end forward
...
global w_qa02_00099 w_qa02_00099
...
FOR lRow = 1	TO	dw_insert.RowCount()
	...
	IF sGubun = '2' THEN
		...
		/* shpfat에 불량폐기 전표번호가 기록되어 있으면 skip - by shingoon 20180705 */
		ls_fatjpno = dw_insert.GetItemString(lRow, 'shpfat_iojpno')
		If Trim(ls_fatjpno) <> '' OR Not IsNull(ls_fatjpno) Then
			Continue
		End If
...
type dw_insert from w_inherite`dw_insert within w_qa02_00099
integer x = 32
integer y = 216
integer width = 4558
integer height = 2064
integer taborder = 20
string dataobject = "d_qa02_00099_a"
...
type p_delrow from w_inherite`p_delrow within w_qa02_00099
...
type p_addrow from w_inherite`p_addrow within w_qa02_00099
boolean visible = false
integer x = 1714
integer y = 2420
boolean enabled = false
...
type p_search from w_inherite`p_search within w_qa02_00099
boolean visible = false
integer x = 1385
integer y = 2424
boolean enabled = false
...
type p_ins from w_inherite`p_ins within w_qa02_00099
boolean visible = false
integer x = 1541
integer y = 2420
boolean enabled = false
...
type p_exit from w_inherite`p_exit within w_qa02_00099
integer x = 4425
end type

type p_can from w_inherite`p_can within w_qa02_00099
integer x = 4251
end type
...
type p_print from w_inherite`p_print within w_qa02_00099
boolean visible = false
integer x = 4827
integer y = 132
end type
...
type p_inq from w_inherite`p_inq within w_qa02_00099
integer x = 3904
end type
...
type p_del from w_inherite`p_del within w_qa02_00099
boolean visible = false
integer x = 2235
integer y = 2420
boolean enabled = false
...
type p_mod from w_inherite`p_mod within w_qa02_00099
integer x = 4078
end type
...
// 폐기자료 생성
Long	l
l = wf_imhist_o10_insert()
if l < 0 then
	messagebox("확인", "폐기자료 생성 실패(1)!!!")
	return
ElseIf l = 0 Then
	/* 처리대상이 없으면 종료 */
	/* 수정 후 저장을 위해 0이면 Return 주석처리 19.07.26 bhkim */
	//Return
end if
...
type cb_exit from w_inherite`cb_exit within w_qa02_00099
end type

type cb_mod from w_inherite`cb_mod within w_qa02_00099
integer x = 672
integer y = 2452
integer taborder = 40
end type

type cb_ins from w_inherite`cb_ins within w_qa02_00099
integer x = 311
integer y = 2452
integer taborder = 30
end type

type cb_del from w_inherite`cb_del within w_qa02_00099
integer x = 1033
integer y = 2452
integer taborder = 50
end type

type cb_inq from w_inherite`cb_inq within w_qa02_00099
integer x = 1403
integer y = 2460
integer taborder = 60
end type

type cb_print from w_inherite`cb_print within w_qa02_00099
integer x = 1755
integer y = 2452
integer taborder = 70
end type

type st_1 from w_inherite`st_1 within w_qa02_00099
end type

type cb_can from w_inherite`cb_can within w_qa02_00099
end type

type cb_search from w_inherite`cb_search within w_qa02_00099
end type
...
type gb_button1 from w_inherite`gb_button1 within w_qa02_00099
end type

type gb_button2 from w_inherite`gb_button2 within w_qa02_00099
end type
...
string dataobject = "d_qa02_00099_1"
boolean border = false
