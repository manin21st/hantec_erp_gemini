$PBExportHeader$w_qa02_00062.srw
$PBExportComments$** 매입클레임 통보
forward
global type w_qa02_00062 from window
end type
type dw_1 from datawindow within w_qa02_00062
end type
type st_1 from statictext within w_qa02_00062
end type
type p_delrow from uo_picture within w_qa02_00062
end type
type p_addrow from uo_picture within w_qa02_00062
end type
type p_search from uo_picture within w_qa02_00062
end type
type p_exit from uo_picture within w_qa02_00062
end type
type p_can from uo_picture within w_qa02_00062
end type
type p_del from uo_picture within w_qa02_00062
end type
type p_mod from uo_picture within w_qa02_00062
end type
type p_inq from uo_picture within w_qa02_00062
end type
type cb_1 from commandbutton within w_qa02_00062
end type
type cb_delete from commandbutton within w_qa02_00062
end type
type cb_cancel from commandbutton within w_qa02_00062
end type
type rb_delete from radiobutton within w_qa02_00062
end type
type rb_insert from radiobutton within w_qa02_00062
end type
type dw_detail from datawindow within w_qa02_00062
end type
type cb_save from commandbutton within w_qa02_00062
end type
type cb_exit from commandbutton within w_qa02_00062
end type
type cb_retrieve from commandbutton within w_qa02_00062
end type
type rr_1 from roundrectangle within w_qa02_00062
end type
type rr_2 from roundrectangle within w_qa02_00062
end type
type rr_3 from roundrectangle within w_qa02_00062
end type
type dw_list from datawindow within w_qa02_00062
end type
type rr_4 from roundrectangle within w_qa02_00062
end type
end forward
...
global w_qa02_00062 w_qa02_00062
...
integer taborder = 70
string title = "none"
string dataobject = "w_qa02_00062_a"
...
if this.getcolumnname() = "chk" then
	...
	if sgubun = 'N' then  // 미통보자료 조회인 경우
		if schk = 'Y' then
			this.setitem(row,'okyn','2')  // 통보
			this.setitem(row,'tbdate',f_today())
		else
			this.setitem(row,'okyn','1')  // 승인
			this.setitem(row,'tbdate',snull)
		end if
	else						 // 통보자료 조회인 경우
		if schk = 'Y' then
			this.setitem(row,'okyn','1')  // 승인
...
for lrow = 1 to dw_1.rowcount()
	if dw_1.getitemstring(lrow,'okyn') > '2' then continue
	if dw_1.getitemstring(lrow,'chk') = 'Y' then continue
	dw_1.setitem(lrow,'chk','Y')
	if sgubun = 'N' then
		dw_1.setitem(lrow,'okyn','2')
		dw_1.setitem(lrow,'tbdate',f_today())
	else
		dw_1.setitem(lrow,'okyn','1')
		dw_1.setitem(lrow,'tbdate',snull)
	end if
next
dw_1.setredraw(true)
end event
...
if sokyn = 'N' then
	dw_1.dataobject = 'w_qa02_00062_a'
else
	dw_1.dataobject = 'w_qa02_00062_b'
end if
dw_1.settransobject(sqlca)

setpointer(hourglass!)
if dw_1.retrieve(gs_saupj,sdate1,sdeptcode1,sokyn) < 1 then
	f_message_chk(50, '[매입 클레임 통보]')
	dw_detail.setfocus()
	return
end if
...
integer height = 92
integer taborder = 10
string dataobject = "w_qa02_00062_1"
boolean border = false
boolean livescroll = true
end type
