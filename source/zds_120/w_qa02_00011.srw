$PBExportHeader$w_qa02_00011.srw
$PBExportComments$** 개선대책 수립
forward
global type w_qa02_00011 from w_inherite
end type
type dw_1 from datawindow within w_qa02_00011
end type
type dw_print from datawindow within w_qa02_00011
end type
type p_1 from picture within w_qa02_00011
end type
type p_2 from picture within w_qa02_00011
end type
type dw_img from datawindow within w_qa02_00011
end type
type p_3 from picture within w_qa02_00011
end type
type p_4 from picture within w_qa02_00011
end type
type gb_3 from groupbox within w_qa02_00011
end type
type gb_1 from groupbox within w_qa02_00011
end type
end forward
...
global w_qa02_00011 w_qa02_00011
...
public function integer wf_required_chk ();String ls_fagno, ls_baldat , ls_balsite_dt , ls_jochydat , ls_jochydat2 ,ls_murmks, ls_submit, ls_submitdt, ls_submitdt2
String ls_sfile, ls_dexe ,ls_remote_f ,ls_result, ls_jochan, ls_datrmks
int    li_p
...
ls_jochydat2= Trim(dw_insert.Object.jochwdat[1])
...
ls_submitdt2= Trim(dw_insert.Object.submit_dt[1])
ls_jochan	= Trim(dw_insert.Object.jochan[1])
ls_datrmks	= Trim(dw_insert.Object.datrmks[1])
//ls_sfile    = Trim(dw_insert.getitemstring(1,"filename_temp"))


// 개선대책요구서 발행
if dw_insert.dataobject = 'd_qa02_00011_a_new' then
...
// 개선대책 등록 - 사내부서
if dw_insert.dataobject = 'd_qa02_00011_b_new' then
//	If ls_submitdt2 = '' Or isNull(ls_submitdt2) Or f_datechk(ls_submitdt2) < 1 Then 
//		f_message_chk(35,'[제출일자]')
//		dw_insert.setcolumn("submit_dt")
//		dw_insert.setfocus()
//		Return
//	End If
	
//	If ls_jochydat2 = '' Or isNull(ls_jochydat2) Or f_datechk(ls_jochydat2) < 1 Then 
...
//	End If
	...
	If ls_jochan = '' Or isNull(ls_jochan) Then 
		f_message_chk(40,'[원인]')
		dw_insert.setcolumn("jochan")
		dw_insert.setfocus()
		Return -1
	End If

	If ls_datrmks = '' Or isNull(ls_datrmks) Then 
		f_message_chk(40,'[개선방안]')
		dw_insert.setcolumn("datrmks")
		dw_insert.setfocus()
		Return -1
	End If
	
	dw_insert.Object.submit_dt[1] = f_today()
end if

return 1
end function

on w_qa02_00011.create
int iCurrent
call super::create
...
/* 이상발생 조치내역 */
if gs_gubun = 'B' then
	dw_insert.dataobject = 'd_qa02_00011_b_new'		// 개선대책 요구서 발행
elseif gs_gubun = 'C' then
	dw_insert.dataobject = 'd_qa02_00011_c_new'		// 개선대책 등록 - 사내부서
elseif gs_gubun = 'D' then
	dw_insert.dataobject = 'd_qa02_00011_d_new'		// 개선대책 요구서 보기
else
	dw_insert.dataobject = 'd_qa02_00011_a_new'		// 개선대책 검토승인
end if
...
type dw_insert from w_inherite`dw_insert within w_qa02_00011
integer x = 46
integer y = 208
integer width = 3360
integer height = 2400
string dataobject = "d_qa02_00011_b_new"
...
type p_delrow from w_inherite`p_delrow within w_qa02_00011
boolean visible = false
integer x = 4663
integer y = 928
end type

type p_addrow from w_inherite`p_addrow within w_qa02_00011
boolean visible = false
integer x = 4489
integer y = 928
end type

type p_search from w_inherite`p_search within w_qa02_00011
boolean visible = false
integer x = 4850
integer y = 916
integer height = 140
...
type p_ins from w_inherite`p_ins within w_qa02_00011
boolean visible = false
integer x = 4315
integer y = 928
end type

type p_exit from w_inherite`p_exit within w_qa02_00011
integer x = 3177
end type
...
type p_can from w_inherite`p_can within w_qa02_00011
boolean visible = false
integer x = 5184
integer y = 928
end type

type p_print from w_inherite`p_print within w_qa02_00011
integer x = 2656
end type

event p_print::clicked;call super::clicked;gi_page = 1
OpenWithParm(w_print_options, dw_print)
end event

type p_inq from w_inherite`p_inq within w_qa02_00011
boolean visible = false
integer x = 3529
integer y = 448
end type
...
type p_del from w_inherite`p_del within w_qa02_00011
integer x = 3003
end type
...
gs_code = dw_insert.Object.fagno[1]
Close(parent)
end event

type p_mod from w_inherite`p_mod within w_qa02_00011
integer x = 2830
end type
...
type cb_exit from w_inherite`cb_exit within w_qa02_00011
integer x = 5358
integer y = 588
integer taborder = 110
end type

type cb_mod from w_inherite`cb_mod within w_qa02_00011
integer x = 4352
integer y = 320
integer taborder = 50
end type
...
type cb_ins from w_inherite`cb_ins within w_qa02_00011
integer x = 110
integer y = 3600
end type

type cb_del from w_inherite`cb_del within w_qa02_00011
integer x = 4699
integer y = 320
integer taborder = 60
end type
...
type cb_inq from w_inherite`cb_inq within w_qa02_00011
integer x = 4745
integer y = 604
integer width = 475
integer taborder = 70
...
type cb_print from w_inherite`cb_print within w_qa02_00011
integer x = 4763
integer y = 752
integer width = 475
integer taborder = 80
...
type st_1 from w_inherite`st_1 within w_qa02_00011
integer x = 59
integer y = 3572
end type

type cb_can from w_inherite`cb_can within w_qa02_00011
integer x = 462
integer y = 3616
integer taborder = 90
end type

type cb_search from w_inherite`cb_search within w_qa02_00011
integer x = 1499
integer y = 3636
integer taborder = 100
end type

type dw_datetime from w_inherite`dw_datetime within w_qa02_00011
integer x = 3520
integer y = 2408
end type

type sle_msg from w_inherite`sle_msg within w_qa02_00011
integer x = 411
integer y = 3608
integer height = 48
end type

type gb_10 from w_inherite`gb_10 within w_qa02_00011
integer x = 41
integer y = 3520
end type

type gb_button1 from w_inherite`gb_button1 within w_qa02_00011
integer x = 1193
integer y = 3840
end type

type gb_button2 from w_inherite`gb_button2 within w_qa02_00011
integer x = 1737
integer y = 3864
end type
...
string dataobject = "d_qa02_00011_e_new"
boolean minbox = true
boolean maxbox = true
boolean vscrollbar = true
