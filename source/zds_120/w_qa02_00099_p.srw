$PBExportHeader$w_qa02_00099_p.srw
$PBExportComments$공정검사승인 현황
forward
global type w_qa02_00099_p from w_standard_print
end type
type pb_1 from u_pb_cal within w_qa02_00099_p
end type
type pb_2 from u_pb_cal within w_qa02_00099_p
end type
type rr_1 from roundrectangle within w_qa02_00099_p
end type
end forward
...
integer width = 4667
integer height = 2596
string title = "공정검사 승인 현황"
pb_1 pb_1
pb_2 pb_2
rr_1 rr_1
end type
global w_qa02_00099_p w_qa02_00099_p
...
ls_gbn = dw_ip.GetItemString(1, 'gbn')
...
type p_xls from w_standard_print`p_xls within w_qa02_00099_p
...
type p_sort from w_standard_print`p_sort within w_qa02_00099_p
integer x = 4206
integer y = 180
end type

type p_preview from w_standard_print`p_preview within w_qa02_00099_p
integer x = 4041
end type

type p_exit from w_standard_print`p_exit within w_qa02_00099_p
integer x = 4389
end type

type p_print from w_standard_print`p_print within w_qa02_00099_p
boolean visible = false
integer x = 4389
integer y = 184
end type

type p_retrieve from w_standard_print`p_retrieve within w_qa02_00099_p
integer x = 3867
end type
...
type st_10 from w_standard_print`st_10 within w_qa02_00099_p
end type



type dw_print from w_standard_print`dw_print within w_qa02_00099_p
integer x = 4069
integer y = 176
string dataobject = "d_qa02_00099_p_ap"
end type

type dw_ip from w_standard_print`dw_ip within w_qa02_00099_p
integer x = 37
integer width = 2775
integer height = 256
string dataobject = "d_qa02_00099_p_1"
end type
...
type dw_list from w_standard_print`dw_list within w_qa02_00099_p
integer x = 50
integer y = 300
integer width = 4535
integer height = 1944
