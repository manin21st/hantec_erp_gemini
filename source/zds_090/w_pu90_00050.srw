$PBExportHeader$w_pu90_00050.srw
$PBExportComments$** 정기구매 계획 현황
forward
global type w_pu90_00050 from w_standard_print
end type
type st_1 from statictext within w_pu90_00050
end type
type rr_1 from roundrectangle within w_pu90_00050
end type
type rr_2 from roundrectangle within w_pu90_00050
end type
end forward

global type w_pu90_00050 from w_standard_print
string title = "월 정기 구매 계획"
st_1 st_1
rr_1 rr_1
rr_2 rr_2
end type
global w_pu90_00050 w_pu90_00050
...
type p_preview from w_standard_print`p_preview within w_pu90_00050
end type

type p_exit from w_standard_print`p_exit within w_pu90_00050
end type

type p_print from w_standard_print`p_print within w_pu90_00050
end type

type p_retrieve from w_standard_print`p_retrieve within w_pu90_00050
end type
...
type st_10 from w_standard_print`st_10 within w_pu90_00050
end type



type dw_print from w_standard_print`dw_print within w_pu90_00050
integer x = 3689
integer y = 52
integer height = 148
string dataobject = "d_pu90_00050_p2"
end type

type dw_ip from w_standard_print`dw_ip within w_pu90_00050
integer x = 91
integer y = 40
integer width = 3223
integer height = 188
string dataobject = "d_pu90_00050_1"
end type
...
type dw_list from w_standard_print`dw_list within w_pu90_00050
integer x = 46
integer y = 280
integer width = 4562
integer height = 1980
string dataobject = "d_pu90_00050_a2"
