$PBExportHeader$w_pu90_00070.srw
$PBExportComments$** 주간 발주 대비 실적 [품목별]
forward
global type w_pu90_00070 from w_standard_print
end type
type st_1 from statictext within w_pu90_00070
end type
type rr_1 from roundrectangle within w_pu90_00070
end type
type rr_2 from roundrectangle within w_pu90_00070
end type
end forward

global type w_pu90_00070 from w_standard_print
string title = "주간 발주 대비 실적 [품목별]"
st_1 st_1
rr_1 rr_1
rr_2 rr_2
end type
global w_pu90_00070 w_pu90_00070

forward prototypes
public function integer wf_retrieve ()
end prototypes

public function integer wf_retrieve ();String	ls_yymmdd, ls_itnbr1, ls_itnbr2, ls_waigb, ls_saupj, ls_gubun, ls_ittyp
...
if dw_list.Retrieve(ls_saupj, ls_yymmdd, ls_waigb, ls_itnbr1, ls_itnbr2, ls_gubun, ls_ittyp) <= 0 then
	f_message_chk(50,'[주간 발주 대비 실적]')
	dw_ip.Setfocus()
	return -1
end if
...
event open;call super::open;//dw_ip.Object.yymm[1] = left(f_today(),6)
...
if isnull(smaxdate) or smaxdate = '' then
	...
	dw_ip.Object.yymmdd[1] = smaxdate
else
	dw_ip.Object.yymmdd[1] = smaxdate
end if
end event

type p_preview from w_standard_print`p_preview within w_pu90_00070
end type

type p_exit from w_standard_print`p_exit within w_pu90_00070
end type

type p_print from w_standard_print`p_print within w_pu90_00070
end type

type p_retrieve from w_standard_print`p_retrieve within w_pu90_00070
end type
...
type st_10 from w_standard_print`st_10 within w_pu90_00070
end type



type dw_print from w_standard_print`dw_print within w_pu90_00070
integer x = 3899
integer y = 184
integer height = 76
string dataobject = "d_pu90_00070_p"
end type

type dw_ip from w_standard_print`dw_ip within w_pu90_00070
integer x = 91
integer y = 40
integer width = 3575
integer height = 188
string dataobject = "d_pu90_00070_1"
end type
...
type dw_list from w_standard_print`dw_list within w_pu90_00070
integer x = 46
integer y = 280
integer width = 4562
integer height = 1980
string dataobject = "d_pu90_00070_a"
