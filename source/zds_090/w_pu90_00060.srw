$PBExportHeader$w_pu90_00060.srw
$PBExportComments$** 주간 발주 대비 실적 [공급업체별]
forward
global type w_pu90_00060 from w_standard_print
end type
type st_1 from statictext within w_pu90_00060
end type
type rr_1 from roundrectangle within w_pu90_00060
end type
type rr_2 from roundrectangle within w_pu90_00060
end type
end forward

global type w_pu90_00060 from w_standard_print
string title = "주간 발주 대비 실적 [공급업체별]"
st_1 st_1
rr_1 rr_1
rr_2 rr_2
end type
global w_pu90_00060 w_pu90_00060

forward prototypes
public function integer wf_retrieve ()
end prototypes

public function integer wf_retrieve ();String	ls_yymmdd, ls_cvcod1, ls_cvcod2, ls_waigb, ls_saupj, ls_gubun, ls_ittyp
...
if dw_list.Retrieve(ls_saupj, ls_yymmdd, ls_waigb, ls_cvcod1, ls_cvcod2, ls_gubun, ls_ittyp) <= 0 then
...
type p_xls from w_standard_print`p_xls within w_pu90_00060
...
type p_sort from w_standard_print`p_sort within w_pu90_00060
end type

type p_preview from w_standard_print`p_preview within w_pu90_00060
end type

type p_exit from w_standard_print`p_exit within w_pu90_00060
end type

type p_print from w_standard_print`p_print within w_pu90_00060
boolean visible = false
integer x = 3415
integer y = 40
end type

type p_retrieve from w_standard_print`p_retrieve within w_pu90_00060
end type
...
type st_10 from w_standard_print`st_10 within w_pu90_00060
end type



type dw_print from w_standard_print`dw_print within w_pu90_00060
integer x = 3739
integer y = 40
integer height = 76
string dataobject = "d_pu90_00060_p"
end type

type dw_ip from w_standard_print`dw_ip within w_pu90_00060
integer x = 91
integer y = 40
integer width = 3278
integer height = 188
string dataobject = "d_pu90_00060_1"
end type
...
type dw_list from w_standard_print`dw_list within w_pu90_00060
integer x = 46
integer y = 280
integer width = 4562
integer height = 1980
string dataobject = "d_pu90_00060_a"
