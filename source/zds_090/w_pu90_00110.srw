$PBExportHeader$w_pu90_00110.srw
$PBExportComments$** 주간 외주 계획 현황 [공급업체별]
forward
global type w_pu90_00110 from w_standard_print
end type
type st_1 from statictext within w_pu90_00110
end type
type rr_1 from roundrectangle within w_pu90_00110
end type
type rr_2 from roundrectangle within w_pu90_00110
end type
end forward

global type w_pu90_00110 from w_standard_print
string title = "주간 외주 계획 현황 [공급업체별]"
st_1 st_1
rr_1 rr_1
rr_2 rr_2
end type
global w_pu90_00110 w_pu90_00110

forward prototypes
public function integer wf_retrieve ()
end prototypes

public function integer wf_retrieve ();String	ls_yymmdd, ls_cvcod1, ls_cvcod2, ls_waigb, ls_saupj
...
if dw_list.Retrieve(gs_sabu, ls_yymmdd, ls_waigb, ls_cvcod1, ls_cvcod2) <= 0 then
...
type p_preview from w_standard_print`p_preview within w_pu90_00110
end type

type p_exit from w_standard_print`p_exit within w_pu90_00110
end type

type p_print from w_standard_print`p_print within w_pu90_00110
end type

type p_retrieve from w_standard_print`p_retrieve within w_pu90_00110
end type
...
type st_10 from w_standard_print`st_10 within w_pu90_00110
end type



type dw_print from w_standard_print`dw_print within w_pu90_00110
integer x = 3543
integer y = 52
integer height = 76
string dataobject = "d_pu90_00110_p"
end type

type dw_ip from w_standard_print`dw_ip within w_pu90_00110
integer x = 91
integer y = 40
integer width = 2496
integer height = 188
string dataobject = "d_pu90_00110_1"
end type
...
ELSEIF this.GetColumnName() = "gubun" THEN
	s_empno = this.GetText()
	if s_empno = '1' then // 수량기준
		dw_list.dataobject = 'd_pu90_00110_a'
		dw_print.dataobject = 'd_pu90_00110_p'
		st_1.visible = false
	else
		dw_list.dataobject = 'd_pu90_00110_b'
		dw_print.dataobject = 'd_pu90_00110_p2'
		st_1.visible = true
	end if
	dw_list.settransobject(sqlca)
	dw_print.settransobject(sqlca)
...
type dw_list from w_standard_print`dw_list within w_pu90_00110
integer x = 46
integer y = 280
integer width = 4562
integer height = 1980
string dataobject = "d_pu90_00110_b"
