$PBExportHeader$w_pu90_00090.srw
$PBExportComments$** 부정기 발주서
forward
global type w_pu90_00090 from w_standard_print
end type
type rr_1 from roundrectangle within w_pu90_00090
end type
type rr_2 from roundrectangle within w_pu90_00090
end type
end forward

global type w_pu90_00090 from w_standard_print
string title = "부정기 발주서"
rr_1 rr_1
rr_2 rr_2
end type
global w_pu90_00090 w_pu90_00090
...
String	ls_date1, ls_date2, ls_cvcod1, ls_saupj
...
if dw_list.Retrieve(ls_saupj, ls_date1, ls_date2, ls_cvcod1) <= 0 then
	f_message_chk(50,'[부정기 발주서]')
	dw_ip.Setfocus()
	return -1
end if
...
dw_ip.Object.date1[1] = left(f_today(),6)+'01'
dw_ip.Object.date2[1] = f_today()
//dw_ip.Object.saupj[1] = '10'
end event

type p_preview from w_standard_print`p_preview within w_pu90_00090
end type

type p_exit from w_standard_print`p_exit within w_pu90_00090
end type

type p_print from w_standard_print`p_print within w_pu90_00090
end type

type p_retrieve from w_standard_print`p_retrieve within w_pu90_00090
end type
...
type st_10 from w_standard_print`st_10 within w_pu90_00090
end type



type dw_print from w_standard_print`dw_print within w_pu90_00090
integer x = 4261
integer y = 152
integer height = 76
string dataobject = "d_pu90_00090_p"
end type

type dw_ip from w_standard_print`dw_ip within w_pu90_00090
integer x = 91
integer y = 80
integer width = 2176
integer height = 124
string dataobject = "d_pu90_00090_1"
end type
...
type dw_list from w_standard_print`dw_list within w_pu90_00090
integer x = 46
integer y = 280
integer width = 4562
integer height = 1980
string dataobject = "d_pu90_00090_a"
