$PBExportHeader$w_pu90_00040.srw
$PBExportComments$** 월 구매 계획 현황 [품목별]
forward
global type w_pu90_00040 from w_standard_print
end type
type st_1 from statictext within w_pu90_00040
end type
type rr_1 from roundrectangle within w_pu90_00040
end type
type rr_2 from roundrectangle within w_pu90_00040
end type
end forward

global type w_pu90_00040 from w_standard_print
string title = "월 구매 계획 현황 [품목별]"
st_1 st_1
rr_1 rr_1
rr_2 rr_2
end type
global w_pu90_00040 w_pu90_00040

forward prototypes
public function integer wf_retrieve ()
end prototypes

public function integer wf_retrieve ();String	ls_yymm, ls_itnbr1, ls_itnbr2, ls_waigb, ls_saupj, ls_gubun, ls_ittyp
...
if dw_list.Retrieve(ls_saupj, ls_yymm, ls_waigb, ls_itnbr1, ls_itnbr2,ls_gubun,ls_ittyp) <= 0 then
...
type p_xls from w_standard_print`p_xls within w_pu90_00040
boolean visible = true
integer x = 4270
integer y = 24
end type

type p_sort from w_standard_print`p_sort within w_pu90_00040
end type

type p_preview from w_standard_print`p_preview within w_pu90_00040
end type

type p_exit from w_standard_print`p_exit within w_pu90_00040
end type

type p_print from w_standard_print`p_print within w_pu90_00040
boolean visible = false
integer x = 3273
integer y = 80
end type

type p_retrieve from w_standard_print`p_retrieve within w_pu90_00040
end type
...
type st_10 from w_standard_print`st_10 within w_pu90_00040
end type



type dw_print from w_standard_print`dw_print within w_pu90_00040
integer x = 3643
integer y = 64
integer height = 76
string dataobject = "d_pu90_00040_p2"
end type

type dw_ip from w_standard_print`dw_ip within w_pu90_00040
integer x = 91
integer y = 40
integer width = 3493
integer height = 188
string dataobject = "d_pu90_00040_1"
end type
...
IF this.GetColumnName() = "itnbr1" THEN
	...
	s_name  = this.getitemstring(1,'itnbr2')
	
	ireturn = f_get_name2('품번', 'Y', s_empno, get_nm, s_name)
	this.setitem(1, "itnbr1", s_empno)	
	this.setitem(1, "itdsc1", get_nm)
	
	if isnull(s_name) or s_name = '' then
		this.setitem(1, "itnbr2", s_empno)	
		this.setitem(1, "itdsc2", get_nm)
	end if
	RETURN ireturn
...
type dw_list from w_standard_print`dw_list within w_pu90_00040
integer x = 46
integer y = 280
integer width = 4562
integer height = 1980
string dataobject = "d_pu90_00040_b"
