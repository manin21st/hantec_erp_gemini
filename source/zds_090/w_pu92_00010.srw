$PBExportHeader$w_pu92_00010.srw
$PBExportComments$발주 대비 입고 현황(공급업체별)
forward
global type w_pu92_00010 from w_standard_print
end type
type rb_1 from radiobutton within w_pu92_00010
end type
type rb_2 from radiobutton within w_pu92_00010
end type
type rb_3 from radiobutton within w_pu92_00010
end type
type gb_1 from groupbox within w_pu92_00010
end type
type rr_1 from roundrectangle within w_pu92_00010
end type
end forward

global type w_pu92_00010 from w_standard_print
string title = "발주 대비 입고 현황(공급업체별)"
rb_1 rb_1
rb_2 rb_2
rb_3 rb_3
gb_1 gb_1
...
global w_pu92_00010 w_pu92_00010
...
If dw_print.Retrieve(gs_sabu,ls_sdate ,ls_edate ,ls_depot ,ls_cvcod1 , ls_cvcod2 ,ls_gubun) <= 0 then
...
type p_preview from w_standard_print`p_preview within w_pu92_00010
end type

type p_exit from w_standard_print`p_exit within w_pu92_00010
end type

type p_print from w_standard_print`p_print within w_pu92_00010
end type

type p_retrieve from w_standard_print`p_retrieve within w_pu92_00010
end type
...
type st_10 from w_standard_print`st_10 within w_pu92_00010
end type



type dw_print from w_standard_print`dw_print within w_pu92_00010
string dataobject = "d_pu92_00010_p"
end type

type dw_ip from w_standard_print`dw_ip within w_pu92_00010
integer x = 23
integer y = 32
integer width = 2674
integer height = 344
string dataobject = "d_pu92_00010_1"
end type
...
type dw_list from w_standard_print`dw_list within w_pu92_00010
integer x = 41
integer y = 392
integer width = 4539
integer height = 1860
string dataobject = "d_pu92_00010_a"
