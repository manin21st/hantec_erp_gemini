$PBExportHeader$w_pu90_00020.srw
$PBExportComments$** 년 구매 계획 현황 [품목별]
forward
global type w_pu90_00020 from w_standard_print
end type
type st_1 from statictext within w_pu90_00020
end type
type rr_1 from roundrectangle within w_pu90_00020
end type
type rr_2 from roundrectangle within w_pu90_00020
end type
end forward

global type w_pu90_00020 from w_standard_print
string title = "년 구매 계획 현황 [품목별]"
st_1 st_1
rr_1 rr_1
rr_2 rr_2
end type
global w_pu90_00020 w_pu90_00020

forward prototypes
public function integer wf_retrieve ()
end prototypes

public function integer wf_retrieve ();String	ls_yyyy, ls_itnbr1, ls_itnbr2, ls_saupj, ls_gubun, ls_ittyp
...
if dw_list.Retrieve(ls_saupj, ls_yyyy, ls_itnbr1, ls_itnbr2,ls_gubun,ls_ittyp) <= 0 then
...
type p_preview from w_standard_print`p_preview within w_pu90_00020
end type

type p_exit from w_standard_print`p_exit within w_pu90_00020
end type

type p_print from w_standard_print`p_print within w_pu90_00020
end type

type p_retrieve from w_standard_print`p_retrieve within w_pu90_00020
end type
...
type st_10 from w_standard_print`st_10 within w_pu90_00020
end type



type dw_print from w_standard_print`dw_print within w_pu90_00020
integer x = 3525
integer y = 44
integer height = 76
string dataobject = "d_pu90_00020_p2"
end type

type dw_ip from w_standard_print`dw_ip within w_pu90_00020
integer x = 91
integer y = 48
integer width = 2926
integer height = 188
string dataobject = "d_pu90_00020_1"
end type
...
type dw_list from w_standard_print`dw_list within w_pu90_00020
integer x = 46
integer y = 280
integer width = 4562
integer height = 1980
string dataobject = "d_pu90_00020_b"
