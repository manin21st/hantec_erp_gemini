$PBExportHeader$w_pu90_00100.srw
$PBExportComments$** 외주 발주서
forward
global type w_pu90_00100 from w_standard_print
end type
type rr_1 from roundrectangle within w_pu90_00100
end type
type rr_2 from roundrectangle within w_pu90_00100
end type
end forward
...
global w_pu90_00100 w_pu90_00100
...
type p_preview from w_standard_print`p_preview within w_pu90_00100
end type

type p_exit from w_standard_print`p_exit within w_pu90_00100
end type

type p_print from w_standard_print`p_print within w_pu90_00100
end type

type p_retrieve from w_standard_print`p_retrieve within w_pu90_00100
end type
...
type st_10 from w_standard_print`st_10 within w_pu90_00100
end type



type dw_print from w_standard_print`dw_print within w_pu90_00100
integer x = 3406
integer y = 156
integer height = 76
string dataobject = "d_pu90_00100_p"
end type

type dw_ip from w_standard_print`dw_ip within w_pu90_00100
integer x = 91
integer y = 80
integer width = 2176
integer height = 124
string dataobject = "d_pu90_00100_1"
end type
...
type dw_list from w_standard_print`dw_list within w_pu90_00100
integer x = 46
integer y = 280
integer width = 4562
integer height = 1980
string dataobject = "d_pu90_00100_a"
