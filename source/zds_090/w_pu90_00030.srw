$PBExportHeader$w_pu90_00030.srw
$PBExportComments$** 월 구매 계획 현황 [공급업체별]
forward
global type w_pu90_00030 from w_standard_print
end type
type st_1 from statictext within w_pu90_00030
end type
type rr_1 from roundrectangle within w_pu90_00030
end type
type rr_2 from roundrectangle within w_pu90_00030
end type
end forward

global type w_pu90_00030 from w_standard_print
string title = "월 구매 계획 현황 [공급업체별]"
st_1 st_1
rr_1 rr_1
rr_2 rr_2
end type
global w_pu90_00030 w_pu90_00030

forward prototypes
public function integer wf_retrieve ()
end prototypes

public function integer wf_retrieve ();String	ls_yymm, ls_cvcod1, ls_cvcod2, ls_waigb, ls_saupj, ls_gubun, ls_gb1, ls_gb2, ls_gb3
Double   dAmt
...
ls_gb1   = Trim(dw_ip.Object.gb1[1])
ls_gb2   = Trim(dw_ip.Object.gb2[1])
ls_gb3   = Trim(dw_ip.Object.gb3[1])
...
if ls_gb1 = '1' then 
	dw_list.dataobject =  'd_pu90_00030_3'   
	dw_print.dataobject = 'd_pu90_00030_p3'
elseif ls_gb2 = '1' then
	dw_list.dataobject =  'd_pu90_00030_5'   
	dw_print.dataobject = 'd_pu90_00030_p5'
elseif ls_gb3 = '1' then
	dw_list.dataobject =  'd_pu90_00030_6'   
	dw_print.dataobject = 'd_pu90_00030_p6'
else
	dw_list.dataobject =  'd_pu90_00030_b'   
	dw_print.dataobject = 'd_pu90_00030_p2'
end if
...
if ls_gb1 = '1' then 
	if dw_list.Retrieve(ls_saupj, ls_yymm) <= 0 then
		f_message_chk(50,'[월 구매 계획 현황]')
		dw_ip.Setfocus()
		return -1
	end if
	dw_print.Object.tx_ym.text = Left(ls_yymm,4) + '.' + Right(ls_yymm,2)
	
elseif ls_gb2 = '1' then
	dAmt = 0
	
	SELECT sum(monlot1 * fun_erp100000012(:ls_yymm||'31',a.itnbr,'.'))
	  into :dAmt
	...
	if dw_list.Retrieve(ls_saupj, ls_yymm, dAmt) <= 0 then
		f_message_chk(50,'[월 구매 계획 현황]')
		dw_ip.Setfocus()
		return -1
	end if
...
elseif ls_gb3 = '1' then
	...
	if dw_list.Retrieve(ls_saupj, ls_yymm) <= 0 then
		f_message_chk(50,'[월 사급매출 계획 현황]')
		dw_ip.Setfocus()
		return -1
	end if
	dw_print.Object.tx_ym.text = Left(ls_yymm,4) + '.' + Right(ls_yymm,2)
else
	if dw_list.Retrieve(ls_saupj, ls_yymm, ls_waigb, ls_cvcod1, ls_cvcod2, ls_gubun) <= 0 then
		f_message_chk(50,'[월 구매 계획 현황]')
		dw_ip.Setfocus()
		return -1
	end if
...
event open;call super::open;string	smaxyymm

select max(yymm) into :smaxyymm from pu02_monplan
 where waigb = '1' ;
if isnull(smaxyymm) or smaxyymm = '' then
	dw_ip.Object.yymm[1] = Left(f_today(),6)
else	
	dw_ip.Object.yymm[1] = smaxyymm
end if
...
type p_xls from w_standard_print`p_xls within w_pu90_00030
boolean visible = true
integer x = 4270
integer y = 24
end type

type p_sort from w_standard_print`p_sort within w_pu90_00030
end type

type p_preview from w_standard_print`p_preview within w_pu90_00030
end type

type p_exit from w_standard_print`p_exit within w_pu90_00030
end type

type p_print from w_standard_print`p_print within w_pu90_00030
boolean visible = false
integer x = 3575
integer y = 56
end type

type p_retrieve from w_standard_print`p_retrieve within w_pu90_00030
end type
...
type st_10 from w_standard_print`st_10 within w_pu90_00030
end type



type dw_print from w_standard_print`dw_print within w_pu90_00030
integer x = 4027
integer y = 188
integer height = 76
string dataobject = "d_pu90_00030_p2"
end type

type dw_ip from w_standard_print`dw_ip within w_pu90_00030
integer x = 91
integer y = 32
integer width = 3662
integer height = 200
string dataobject = "d_pu90_00030_1"
end type
...
type dw_list from w_standard_print`dw_list within w_pu90_00030
integer x = 46
integer y = 280
integer width = 4562
integer height = 1980
string dataobject = "d_pu90_00030_b"
