$PBExportHeader$w_pin3020.srw
$PBExportComments$교육현황
forward
global type w_pin3020 from w_standard_print
end type
type rr_1 from roundrectangle within w_pin3020
end type
end forward
...
if ls_prtgbn2 = '1' then
	dw_print.Dataobject = "d_pin3020_02_p"  /*부서별*/	
elseif ls_prtgbn2 = '2' then	
	dw_print.Dataobject = "d_pin3020_03_p"  /*유형별*/	
elseif ls_prtgbn2 = '3' then
	dw_print.Dataobject = "d_pin3020_04_p"  /*교육기관별*/	
elseif ls_prtgbn2 = '4' then	
	dw_print.Dataobject = "d_pin3020_05_p"  /*일자별*/	
elseif ls_prtgbn2 = '5' then
	dw_print.Dataobject = "d_pin3020_06_p"  /*개인별*/	
end if
...
type p_preview from w_standard_print`p_preview within w_pin3020
end type

type p_exit from w_standard_print`p_exit within w_pin3020
end type

type p_print from w_standard_print`p_print within w_pin3020
end type
...
type p_retrieve from w_standard_print`p_retrieve within w_pin3020
end type

type st_window from w_standard_print`st_window within w_pin3020
integer x = 2633
integer y = 3976
end type

type sle_msg from w_standard_print`sle_msg within w_pin3020
integer x = 658
integer y = 3976
end type

type dw_datetime from w_standard_print`dw_datetime within w_pin3020
integer x = 3127
integer y = 3976
end type

type st_10 from w_standard_print`st_10 within w_pin3020
integer x = 297
integer y = 3976
end type

type gb_10 from w_standard_print`gb_10 within w_pin3020
integer x = 283
integer y = 3940
end type

type dw_print from w_standard_print`dw_print within w_pin3020
string dataobject = "d_pin3020_02_p"
end type

type dw_ip from w_standard_print`dw_ip within w_pin3020
integer x = 489
integer y = 28
integer width = 3186
integer height = 316
string dataobject = "d_pin3020_01"
end type
...
type dw_list from w_standard_print`dw_list within w_pin3020
integer x = 215
integer y = 372
integer width = 4219
integer height = 1768
string dataobject = "d_pin3020_02"
