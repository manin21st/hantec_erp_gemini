...
type pb_1 from u_pic_cal within w_sal_02045
end type
end forward
...
//	dw_input.Modify("iojpno.background.color = 80859087")

	dw_input.Modify('iogbn.protect = 0')
//	dw_input.Modify("iogbn.background.color = '"+String(Rgb(190,225,184))+"'")

	dw_input.Modify('cvcod.protect = 0')
	dw_input.Modify('vndname.protect = 0')
//	dw_input.Modify("cvcod.background.color = '"+String(Rgb(255,255,0))+"'")
//	dw_input.Modify("vndname.background.color = '"+String(Rgb(255,255,255))+"'")

	dw_input.Modify('pjt_cd.protect = 0')
//	dw_input.Modify("pjt_cd.background.color = '"+String(Rgb(255,255,255))+"'")
		
	dw_input.Modify('sudat.protect = 0')
// dw_input.Modify("sudat.background.color = '"+String(Rgb(190,225,184))+"'")
	...
	// 구분 변경 불가
	dw_input.Object.area_cd.protect = '0'
ELSE
...
// dw_input.Modify("sudat.background.color = 80859087")
//	dw_input.Modify("cvcod.background.color = 80859087")
//	dw_input.Modify("vndname.background.color = 80859087")

	dw_input.Modify('pjt_cd.protect = 1')
//	dw_input.Modify("pjt_cd.background.color = 80859087")
   ...
   dw_input.SetRow(1)
	...
	// 구분 변경 불가
	dw_input.Object.area_cd.protect = '1'
END IF
...
For k = 1 TO nRcnt
   ...
   dw_insert.SetItem(k,"pjt_cd",	    dw_input.GetItemString(1,"pjt_cd")) /* 프로젝트 */
	...
	dw_insert.SetItem(k,"area_cd",    dw_input.GetItemString(1,"area_cd"))
	...
	dw_insert.SetItem(k,"imhist_lclgbn",    dw_input.GetItemString(1,"lclgbn"))
...
//iRtnValue = sqlca.Fun_Erp100000010(sOrderDate,dw_input.GetItemString(1,"cvcod"),Itnbr,' ','1',dItemPrice,dDcRate)
...
event ue_preview;call super::ue_preview;if p_print.Enabled = False then return
...
type sle_msg from w_inherite`sle_msg within w_sal_02045
integer x = 5783
integer y = 3408
end type

type dw_datetime from w_inherite`dw_datetime within w_sal_02045
integer x = 5783
integer y = 3408
end type
...
event p_print::clicked;call super::clicked;if this.Enabled = False then return
...
type p_new from w_inherite`p_new within w_sal_02045
integer x = 2162
integer y = 3412
end type

type dw_input from w_inherite`dw_input within w_sal_02045
...
type cb_delrow from w_inherite`cb_delrow within w_sal_02045
boolean visible = false
integer y = 3224
end type

type cb_addrow from w_inherite`cb_addrow within w_sal_02045
boolean visible = false
integer y = 3224
end type
...
type gb_10 from w_inherite`gb_10 within w_sal_02045
integer x = 5490
integer y = 3408
end type
...
type r_head from w_inherite`r_head within w_sal_02045
integer width = 2889
integer height = 252
end type

type r_detail from w_inherite`r_detail within w_sal_02045
integer y = 324
end type
