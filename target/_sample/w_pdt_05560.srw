$PBExportHeader$w_pdt_05560.srw
$PBExportComments$** 품목별 재고 소진 현황
forward
global type w_pdt_05560 from w_standard_print
end type
type pb_1 from u_pic_cal within w_pdt_05560
end type
type pb_2 from u_pic_cal within w_pdt_05560
end type
end forward

global type w_pdt_05560 from w_standard_print
string title = "품목별 재고 소진 현황"
pb_1 pb_1
pb_2 pb_2
end type
global w_pdt_05560 w_pdt_05560
...
if sgub = '1' then //거래처순
   dw_list.DataObject = 'd_pdt_05560_02'
   dw_print.DataObject = 'd_pdt_05560_02_p'
else
   dw_list.DataObject = 'd_pdt_05560_03'
   dw_print.DataObject = 'd_pdt_05560_03_p'  
end if
...
type dw_list from w_standard_print`dw_list within w_pdt_05560
integer height = 1964
string dataobject = "d_pdt_05560_02"
boolean hsplitscroll = false
end type

type cb_print from w_standard_print`cb_print within w_pdt_05560
end type

type cb_excel from w_standard_print`cb_excel within w_pdt_05560
end type

type cb_preview from w_standard_print`cb_preview within w_pdt_05560
end type

type cb_1 from w_standard_print`cb_1 within w_pdt_05560
end type

type dw_print from w_standard_print`dw_print within w_pdt_05560
string dataobject = "d_pdt_05560_02_p"
end type

type dw_ip from w_standard_print`dw_ip within w_pdt_05560
integer y = 56
integer height = 188
string dataobject = "d_pdt_05560_01"
end type
...
type r_1 from w_standard_print`r_1 within w_pdt_05560
end type

type r_2 from w_standard_print`r_2 within w_pdt_05560
end type
...
type rr_1 from roundrectangle within w_pdt_05560
