...
type pb_1 from u_pic_cal within w_mat_01025
end type
end forward
...
type cb_print from w_standard_print`cb_print within w_mat_01025
end type

type cb_excel from w_standard_print`cb_excel within w_mat_01025
end type

type cb_preview from w_standard_print`cb_preview within w_mat_01025
end type

type cb_1 from w_standard_print`cb_1 within w_mat_01025
end type
...
type r_1 from w_standard_print`r_1 within w_mat_01025
integer width = 3707
integer height = 1988
end type

type r_2 from w_standard_print`r_2 within w_mat_01025
integer width = 3707
end type
