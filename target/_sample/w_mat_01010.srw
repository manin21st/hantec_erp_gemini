...
type cb_2 from commandbutton within w_mat_01010
end type
type cb_delrow from commandbutton within w_mat_01010
end type
type cb_1 from commandbutton within w_mat_01010
end type
type p_bar from uo_picture within w_mat_01010
end type
type pb_1 from u_pic_cal within w_mat_01010
end type
...
type r_head from rectangle within w_mat_01010
end type
type r_detail from rectangle within w_mat_01010
end type
type rb_insert from radiobutton within w_mat_01010
end type
type rb_delete from radiobutton within w_mat_01010
end type
type istr_resize from structure within w_mat_01010
end type
end forward
...
event ue_print();p_print.TriggerEvent(Clicked!)
end event
...
m_main2.m_window.m_addrow.enabled = true  //// 행추가
m_main2.m_window.m_delrow.enabled = false //// 행삭제
