...
type cb_print from w_standard_print`cb_print within w_pdm_11660
end type

type cb_excel from w_standard_print`cb_excel within w_pdm_11660
end type

type cb_preview from w_standard_print`cb_preview within w_pdm_11660
end type

type cb_1 from w_standard_print`cb_1 within w_pdm_11660
end type
...
type r_1 from w_standard_print`r_1 within w_pdm_11660
integer y = 220
integer height = 2032
end type

type r_2 from w_standard_print`r_2 within w_pdm_11660
integer height = 136
end type
