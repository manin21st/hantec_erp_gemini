...
event ue_update;call super::ue_update;p_search.TriggerEvent(Clicked!)
...
type sle_msg from w_inherite`sle_msg within w_sal_02040
end type

type dw_datetime from w_inherite`dw_datetime within w_sal_02040
end type
...
type p_new from w_inherite`p_new within w_sal_02040
end type

type dw_input from w_inherite`dw_input within w_sal_02040
boolean visible = false
end type

type cb_delrow from w_inherite`cb_delrow within w_sal_02040
boolean visible = false
end type

type cb_addrow from w_inherite`cb_addrow within w_sal_02040
boolean visible = false
end type
...
type r_head from w_inherite`r_head within w_sal_02040
boolean visible = false
end type

type r_detail from w_inherite`r_detail within w_sal_02040
end type
