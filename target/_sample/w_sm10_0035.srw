$PBExportHeader$w_sm10_0035.srw
$PBExportComments$VAN 접수(CKD미납 납기일 수정)
forward
global type w_sm10_0035 from w_inherite
end type
type pb_1 from u_pic_cal within w_sm10_0035
end type
type pb_2 from u_pic_cal within w_sm10_0035
end type
type dw_2 from datawindow within w_sm10_0035
end type
type pb_3 from u_pic_cal within w_sm10_0035
end type
type cb_1 from commandbutton within w_sm10_0035
end type
type cb_2 from commandbutton within w_sm10_0035
end type
type st_2 from statictext within w_sm10_0035
end type
type st_3 from statictext within w_sm10_0035
end type
type st_4 from statictext within w_sm10_0035
end type
type r_1 from rectangle within w_sm10_0035
end type
end forward
...
global w_sm10_0035 w_sm10_0035
...
type cb_exit from w_inherite`cb_exit within w_sm10_0035
end type

type sle_msg from w_inherite`sle_msg within w_sm10_0035
end type

type dw_datetime from w_inherite`dw_datetime within w_sm10_0035
end type

type st_1 from w_inherite`st_1 within w_sm10_0035
integer y = 3400
end type

type p_search from w_inherite`p_search within w_sm10_0035
end type

type p_addrow from w_inherite`p_addrow within w_sm10_0035
end type

type p_delrow from w_inherite`p_delrow within w_sm10_0035
end type

type p_mod from w_inherite`p_mod within w_sm10_0035
integer y = 3200
end type
...
type p_del from w_inherite`p_del within w_sm10_0035
integer y = 3200
end type
...
type p_inq from w_inherite`p_inq within w_sm10_0035
integer y = 3200
end type
...
dw_insert.Retrieve(gs_saupj, ls_st, ls_ed)
dw_insert.SetRedraw(True)

end event

type p_print from w_inherite`p_print within w_sm10_0035
integer y = 3200
end type

type p_can from w_inherite`p_can within w_sm10_0035
integer y = 3200
end type
...
type p_exit from w_inherite`p_exit within w_sm10_0035
integer y = 3200
end type

type p_ins from w_inherite`p_ins within w_sm10_0035
integer y = 3200
end type

type p_new from w_inherite`p_new within w_sm10_0035
integer y = 3200
end type

type dw_input from w_inherite`dw_input within w_sm10_0035
integer y = 56
integer width = 1280
integer height = 188
integer taborder = 50
...
string title = "none"
string dataobject = "d_sm10_0030_001"
end type
...
type cb_delrow from w_inherite`cb_delrow within w_sm10_0035
boolean visible = false
integer y = 3400
end type

type cb_addrow from w_inherite`cb_addrow within w_sm10_0035
boolean visible = false
integer y = 3400
end type

type dw_insert from w_inherite`dw_insert within w_sm10_0035
integer x = 37
integer y = 324
integer width = 3489
integer height = 1948
string dataobject = "d_sm10_0030_002"
end type
...
type cb_mod from w_inherite`cb_mod within w_sm10_0035
boolean visible = false
integer y = 3400
end type

type cb_ins from w_inherite`cb_ins within w_sm10_0035
boolean visible = false
integer y = 3400
end type

type cb_del from w_inherite`cb_del within w_sm10_0035
boolean visible = false
integer y = 3400
end type

type cb_inq from w_inherite`cb_inq within w_sm10_0035
boolean visible = false
integer y = 3400
end type

type cb_print from w_inherite`cb_print within w_sm10_0035
boolean visible = false
integer y = 3400
end type

type cb_can from w_inherite`cb_can within w_sm10_0035
boolean visible = false
integer y = 3400
end type

type cb_search from w_inherite`cb_search within w_sm10_0035
boolean visible = false
integer y = 3400
end type

type gb_10 from w_inherite`gb_10 within w_sm10_0035
end type

type gb_button1 from w_inherite`gb_button1 within w_sm10_0035
end type

type gb_button2 from w_inherite`gb_button2 within w_sm10_0035
end type

type r_head from w_inherite`r_head within w_sm10_0035
integer width = 1288
end type

type r_detail from w_inherite`r_detail within w_sm10_0035
integer y = 320
end type
...
boolean bringtotop = true
string title = "none"
string dataobject = "d_sm10_0030_003"
...
long textcolor = 128
long backcolor = 16777215
string text = "※ Y, K, L1, L2, L3, C1, C2, C3, C4공장의 납품일을 수정합니다."
boolean focusrectangle = false
end type
