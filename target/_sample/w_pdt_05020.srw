$PBExportHeader$w_pdt_05020.srw
$PBExportComments$외주처 기초재고 등록
forward
global type w_pdt_05020 from w_inherite
end type
end forward
...
global w_pdt_05020 w_pdt_05020
...
on w_pdt_05020.create
call super::create
end on

on w_pdt_05020.destroy
call super::destroy
end on
...
event ue_retrieve;p_inq.TriggerEvent(Clicked!)

end event

event ue_append;p_ins.TriggerEvent(Clicked!)
...
type cb_exit from w_inherite`cb_exit within w_pdt_05020
integer x = 3241
integer y = 5000
end type

type sle_msg from w_inherite`sle_msg within w_pdt_05020
end type

type dw_datetime from w_inherite`dw_datetime within w_pdt_05020
end type

type st_1 from w_inherite`st_1 within w_pdt_05020
end type

type p_search from w_inherite`p_search within w_pdt_05020
integer y = 5000
end type

type p_addrow from w_inherite`p_addrow within w_pdt_05020
integer y = 5000
end type

type p_delrow from w_inherite`p_delrow within w_pdt_05020
integer y = 5000
end type

type p_mod from w_inherite`p_mod within w_pdt_05020
integer x = 3881
end type

event p_mod::clicked;call super::clicked;string sdepot, syymm, sitnbr, spspec, get_nm, sopseq
long i, k
dec  dqty
...
IF Messagebox('저 장','저장 하시겠습니까?'  +'~n~n'+&
  '저장하시면 입력하신 창고, 품번, 사양, 공정에 대한 이월수량이 외주처 재고수량으로 '  +'~n'+&
...
type p_del from w_inherite`p_del within w_pdt_05020
integer x = 4055
end type
...
type p_inq from w_inherite`p_inq within w_pdt_05020
integer x = 3534
end type
...
type p_print from w_inherite`p_print within w_pdt_05020
integer y = 5000
end type

type p_can from w_inherite`p_can within w_pdt_05020
integer x = 4229
end type
...
type p_exit from w_inherite`p_exit within w_pdt_05020
integer x = 4402
end type

type p_ins from w_inherite`p_ins within w_pdt_05020
integer x = 3707
end type
...
type p_new from w_inherite`p_new within w_pdt_05020
end type

type dw_input from w_inherite`dw_input within w_pdt_05020
integer y = 56
integer width = 3488
integer height = 188
...
event dw_input::itemchanged;call super::itemchanged;string  snull, s_depot, s_depnm, s_depnm2, sdate
integer ireturn 
...
event dw_input::itemerror;call super::itemerror;return 1
end event

event dw_input::losefocus;call super::losefocus;if this.accepttext() = -1 then return 
end event

type cb_delrow from w_inherite`cb_delrow within w_pdt_05020
boolean visible = false
end type

type cb_addrow from w_inherite`cb_addrow within w_pdt_05020
boolean visible = false
end type

type dw_insert from w_inherite`dw_insert within w_pdt_05020
integer x = 37
integer y = 284
integer width = 3488
integer height = 1964
integer taborder = 40
string dataobject = "d_pdt_05020"
...
IF this.GetColumnName() = "itnbr"	THEN
	...
	this.setitem(lrow, "jijil", ls_jijil)
	this.setitem(lrow, "ispec_code", ls_ispec_code)
...
type cb_mod from w_inherite`cb_mod within w_pdt_05020
integer x = 2185
integer y = 5000
integer taborder = 50
end type

type cb_ins from w_inherite`cb_ins within w_pdt_05020
integer x = 2958
integer y = 5000
integer taborder = 30
end type

type cb_del from w_inherite`cb_del within w_pdt_05020
integer x = 2537
integer y = 5000
integer taborder = 60
end type

type cb_inq from w_inherite`cb_inq within w_pdt_05020
integer x = 2606
integer y = 5000
integer taborder = 20
end type

type cb_print from w_inherite`cb_print within w_pdt_05020
boolean visible = false
integer x = 1984
integer y = 2544
end type

type cb_can from w_inherite`cb_can within w_pdt_05020
integer x = 2889
integer y = 5000
integer taborder = 70
end type

type cb_search from w_inherite`cb_search within w_pdt_05020
boolean visible = false
integer x = 2619
integer y = 2532
end type

type gb_10 from w_inherite`gb_10 within w_pdt_05020
integer y = 5000
integer height = 144
integer textsize = -9
...
type gb_button1 from w_inherite`gb_button1 within w_pdt_05020
end type

type gb_button2 from w_inherite`gb_button2 within w_pdt_05020
end type

type r_head from w_inherite`r_head within w_pdt_05020
end type

type r_detail from w_inherite`r_detail within w_pdt_05020
end type
