$PBExportHeader$w_pdt_05530.srw
$PBExportComments$** 월 외주 수불 원장
forward
global type w_pdt_05530 from w_standard_print
end type
end forward

global type w_pdt_05530 from w_standard_print
string title = "월 외주 수불 원장"
end type
global w_pdt_05530 w_pdt_05530
...
dw_print.object.txt_title.text = String(sdate,"@@@@년 @@월") + " 외주 수불 원장"

if dw_print.Retrieve(gs_sabu, sdate, cvcod1, cvcod2, fitnbr, titnbr, ls_gubun) <= 0 then
	f_message_chk(50,'[월 외주 수불 원장]')
	dw_ip.Setfocus()
	return -1
Else
	dw_list.Retrieve(gs_sabu, sdate, cvcod1, cvcod2, fitnbr, titnbr, ls_gubun)
end if
...
on w_pdt_05530.create
call super::create
end on

on w_pdt_05530.destroy
call super::destroy
end on
...
type dw_list from w_standard_print`dw_list within w_pdt_05530
integer height = 1964
string dataobject = "d_pdt_05530_d"
boolean hsplitscroll = false
end type

type cb_print from w_standard_print`cb_print within w_pdt_05530
end type

type cb_excel from w_standard_print`cb_excel within w_pdt_05530
end type

type cb_preview from w_standard_print`cb_preview within w_pdt_05530
end type

type cb_1 from w_standard_print`cb_1 within w_pdt_05530
end type

type dw_print from w_standard_print`dw_print within w_pdt_05530
string dataobject = "d_pdt_05530_02"
end type

type dw_ip from w_standard_print`dw_ip within w_pdt_05530
integer y = 56
integer height = 188
string dataobject = "d_pdt_05530_h"
end type
...
type r_1 from w_standard_print`r_1 within w_pdt_05530
end type

type r_2 from w_standard_print`r_2 within w_pdt_05530
end type

type rr_1 from roundrectangle within w_pdt_05530
