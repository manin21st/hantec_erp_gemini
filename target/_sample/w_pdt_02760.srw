...
type cb_print from w_standard_print`cb_print within w_pdt_02760
integer x = 2336
integer y = 864
end type

type cb_excel from w_standard_print`cb_excel within w_pdt_02760
integer x = 1669
integer y = 864
end type

type cb_preview from w_standard_print`cb_preview within w_pdt_02760
integer x = 2002
integer y = 864
end type

type cb_1 from w_standard_print`cb_1 within w_pdt_02760
integer x = 1335
integer y = 864
end type
...
type r_1 from w_standard_print`r_1 within w_pdt_02760
end type

type r_2 from w_standard_print`r_2 within w_pdt_02760
end type
