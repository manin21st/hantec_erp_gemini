...
type r_list from rectangle within w_pdm_01420
end type
type r_2 from rectangle within w_pdm_01420
end type
type r_boyu from rectangle within w_pdm_01420
end type
end forward
...
string is_add = 'N', is_save = 'N', is_delete = 'N'
...
//	
//	 lRow = dw_input.InsertRow(0)
//	
//	 dw_input.SetItem(lRow, "ccode", 	sCode)
//	 dw_input.SetItem(lRow, "reffpf_rfna1", sName)
//	
//Next
//
//destroy ds
...
this.r_2=create r_2
this.r_boyu=create r_boyu
iCurrent=UpperBound(this.Control)
this.Control[iCurrent+1]=this.dw_list
this.Control[iCurrent+2]=this.rb_1
this.Control[iCurrent+3]=this.dw_2
this.Control[iCurrent+4]=this.cb_1
this.Control[iCurrent+5]=this.dw_boyu
this.Control[iCurrent+6]=this.st_2
this.Control[iCurrent+7]=this.dw_mon
this.Control[iCurrent+8]=this.cb_2
this.Control[iCurrent+9]=this.r_list
this.Control[iCurrent+10]=this.r_2
this.Control[iCurrent+11]=this.r_boyu
end on
...
dw_input.SetItem(1, 'pdtgu', lsPdtgu)
dw_input.TriggerEvent(ItemChanged!)
...
r_2.height = this.height - r_2.y - 65
dw_2.height = this.height - dw_2.y - 70

r_boyu.width = this.width - r_boyu.x - 30
r_boyu.height = this.height - r_boyu.y - 65
dw_boyu.width = this.width - dw_boyu.x - 40
dw_boyu.height = this.height - dw_boyu.y - 70
end event
...
type sle_msg from w_inherite`sle_msg within w_pdm_01420
integer x = 5303
integer y = 3520
end type

type dw_datetime from w_inherite`dw_datetime within w_pdm_01420
integer x = 5303
integer y = 3520
end type
...
event p_mod::clicked;call super::clicked;if is_save = 'N' then return
...
event p_ins::clicked;call super::clicked;if is_add = 'N' then return

wf_New()
end event

type p_new from w_inherite`p_new within w_pdm_01420
integer x = 1678
integer y = 3724
end type

type dw_input from w_inherite`dw_input within w_pdm_01420
integer y = 56
integer width = 1198
integer height = 152
integer taborder = 10
...
lsPdtgu = Trim(dw_input.GetItemString(1, 'pdtgu'))
...
type cb_delrow from w_inherite`cb_delrow within w_pdm_01420
boolean visible = false
integer y = 3600
end type

type cb_addrow from w_inherite`cb_addrow within w_pdm_01420
boolean visible = false
integer y = 3600
end type
...
event dw_insert::itemfocuschanged;Any wnd
...
type r_head from w_inherite`r_head within w_pdm_01420
integer width = 1207
integer height = 160
end type

type r_detail from w_inherite`r_detail within w_pdm_01420
integer x = 1659
integer y = 252
integer width = 1294
integer height = 1120
