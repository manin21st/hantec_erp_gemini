...
event resize;call super::resize;st_state.x = (this.width - st_state.width) / 2
...
type sle_msg from w_inherite`sle_msg within w_tht_1210
end type

type dw_datetime from w_inherite`dw_datetime within w_tht_1210
end type
...
type p_new from w_inherite`p_new within w_tht_1210
integer y = 3200
end type

type dw_input from w_inherite`dw_input within w_tht_1210
integer y = 56
integer width = 3489
integer height = 188
integer taborder = 50
...
type cb_delrow from w_inherite`cb_delrow within w_tht_1210
boolean visible = false
integer y = 3400
end type

type cb_addrow from w_inherite`cb_addrow within w_tht_1210
boolean visible = false
integer y = 3400
end type
...
type gb_10 from w_inherite`gb_10 within w_tht_1210
end type
...
type r_head from w_inherite`r_head within w_tht_1210
end type

type r_detail from w_inherite`r_detail within w_tht_1210
end type
