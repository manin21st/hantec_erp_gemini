$PBExportHeader$w_sal_06042.srw
$PBExportComments$수출창고 이동출고
forward
global type w_sal_06042 from w_inherite
end type
type dw_hidden from datawindow within w_sal_06042
end type
type dw_imhist from datawindow within w_sal_06042
end type
type dw_imhist_in from datawindow within w_sal_06042
end type
type dw_print from datawindow within w_sal_06042
end type
type dw_prt from datawindow within w_sal_06042
end type
type cbx_2 from checkbox within w_sal_06042
end type
type cbx_1 from checkbox within w_sal_06042
end type
type rb_delete from radiobutton within w_sal_06042
end type
type rb_insert from radiobutton within w_sal_06042
end type
type p_1 from uo_picture within w_sal_06042
end type
type p_3 from picture within w_sal_06042
end type
type cb_1 from commandbutton within w_sal_06042
end type
type cb_2 from commandbutton within w_sal_06042
end type
type cb_3 from commandbutton within w_sal_06042
end type
type gb_2 from groupbox within w_sal_06042
end type
end forward
...
global w_sal_06042 w_sal_06042
...
FOR	lRow = 1		TO		dw_insert.RowCount()
	...
	IF abs(dOutQty) > 0		THEN
		...
		dw_imHist.SetItem(lRowHist, "field_cd",	  dw_insert.GetItemString(lRow, "field_cd"))
...
//			end if
			...
			dw_imHist_in.SetItem(lRowHist_in, "field_cd",	  dw_insert.GetItemString(lRow, "field_cd"))
...
FOR lrow = 1 TO lRowCount
   ...
   if sDelgub = 'N' then continue
	...
	select COUNT('X')
	  into :lCnt
	  from expasn_han
	 where pino = :sField_cd
	   and itnbr = :sItnbr;
	
	if lCnt > 0 then
		MessageBox("롹인", "'" + sField_cd + "' P/I의 '" + sItnbr + "' 품목 중 ASN 등록된 이력이 있습니다.")
		RETURN -1
	end if
...
public function integer wf_initial ();string sCvnas, sEmpno, sEmpname
...
dw_input.setitem(1, "house", 'ZZZ')

SELECT A.EMPNO, B.EMPNAME INTO :sEmpno, :sEmpname
...
If isNull(sEmpno) Or sEmpno = '' Then
	dw_input.SetItem(1,"empno2", '')
	dw_input.SetItem(1,"empnm2", '')
Else
	dw_input.SetItem(1,"empno2", sEmpno)
	dw_input.SetItem(1,"empnm2", sEmpname)
End If
...
string sNull, sRelcod, sNaougu, sTagbn, sCvnas, sEmpno, sEmpname
SetNull(sNull)
dw_input.SetItem(1, "gubun", 'O05')
p_print.Visible = False
cbx_1.Visible = False
...
event activate;call super::activate;gw_window = this
...
type cb_exit from w_inherite`cb_exit within w_sal_06042
end type

type sle_msg from w_inherite`sle_msg within w_sal_06042
end type

type dw_datetime from w_inherite`dw_datetime within w_sal_06042
end type

type st_1 from w_inherite`st_1 within w_sal_06042
end type

type p_search from w_inherite`p_search within w_sal_06042
integer y = 260
end type

type p_addrow from w_inherite`p_addrow within w_sal_06042
integer x = 3383
end type
...
type p_delrow from w_inherite`p_delrow within w_sal_06042
integer x = 3557
end type
...
type p_mod from w_inherite`p_mod within w_sal_06042
end type
...
type p_del from w_inherite`p_del within w_sal_06042
...
type p_inq from w_inherite`p_inq within w_sal_06042
integer x = 3749
boolean enabled = false
...
type p_print from w_inherite`p_print within w_sal_06042
integer x = 3195
integer y = 252
boolean enabled = false
end type

type p_can from w_inherite`p_can within w_sal_06042
end type
...
type p_exit from w_inherite`p_exit within w_sal_06042
end type

type p_ins from w_inherite`p_ins within w_sal_06042
integer y = 260
boolean enabled = false
end type

type p_new from w_inherite`p_new within w_sal_06042
end type

type dw_input from w_inherite`dw_input within w_sal_06042
...
type cb_delrow from w_inherite`cb_delrow within w_sal_06042
...
type cb_addrow from w_inherite`cb_addrow within w_sal_06042
boolean visible = false
integer x = 3634
integer y = 84
end type
...
type dw_insert from w_inherite`dw_insert within w_sal_06042
event ue_downenter pbm_dwnprocessenter
event ue_key pbm_dwnkey
integer x = 37
integer y = 404
...
type cb_mod from w_inherite`cb_mod within w_sal_06042
boolean visible = false
end type

type cb_ins from w_inherite`cb_ins within w_sal_06042
boolean visible = false
end type

type cb_del from w_inherite`cb_del within w_sal_06042
boolean visible = false
end type

type cb_inq from w_inherite`cb_inq within w_sal_06042
boolean visible = false
end type

type cb_print from w_inherite`cb_print within w_sal_06042
boolean visible = false
end type

type cb_can from w_inherite`cb_can within w_sal_06042
boolean visible = false
end type

type cb_search from w_inherite`cb_search within w_sal_06042
boolean visible = false
end type

type gb_10 from w_inherite`gb_10 within w_sal_06042
end type

type gb_button1 from w_inherite`gb_button1 within w_sal_06042
end type

type gb_button2 from w_inherite`gb_button2 within w_sal_06042
end type

type r_head from w_inherite`r_head within w_sal_06042
integer width = 4750
integer height = 320
end type

type r_detail from w_inherite`r_detail within w_sal_06042
integer y = 400
integer width = 4750
end type
...
dw_insert.DataObject = 'd_sal_06042_2'
dw_insert.SetTransObject(SQLCA)
...
dw_insert.DataObject = 'd_sal_06042_1'
dw_insert.SetTransObject(SQLCA)
