...
type pb_1 from u_pic_cal within w_sm10_0040
end type
...
type pb_2 from u_pic_cal within w_sm10_0040
end type
...
type cb_11 from commandbutton within w_sm10_0040
end type
...
event ue_update();p_1.TriggerEvent(Clicked!)
end event
...
type cb_print from w_standard_print`cb_print within w_sm10_0040
end type

type cb_excel from w_standard_print`cb_excel within w_sm10_0040
end type

type cb_preview from w_standard_print`cb_preview within w_sm10_0040
end type

type cb_1 from w_standard_print`cb_1 within w_sm10_0040
end type
...
type r_1 from w_standard_print`r_1 within w_sm10_0040
...
type r_2 from w_standard_print`r_2 within w_sm10_0040
integer width = 3322
integer height = 444
end type
...
//listbox
//VAN 처리시 디렉토리("..\as\") 안에꺼 다 처리하도록 수정 2005.01.06. 이수철
if ls_gubun = 'AL' then
