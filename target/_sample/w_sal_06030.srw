...
type sle_msg from w_inherite`sle_msg within w_sal_06030
end type

type dw_datetime from w_inherite`dw_datetime within w_sal_06030
end type
...
string picturename = "..\image\마감처리_up.gif"
end type
...
event p_search::ue_lbuttondown;PictureName = "..\image\마감처리_dn.gif"
end event

event p_search::ue_lbuttonup;PictureName = "..\image\마감처리_up.gif"
end event
...
string picturename = "..\image\마감취소_up.gif"
end type
...
event p_can::ue_lbuttondown;PictureName = "..\image\마감취소_dn.gif"
end event

event p_can::ue_lbuttonup;PictureName = "..\image\마감취소_up.gif"
end event
...
integer height = 144
boolean originalsize = true
string picturename = "..\image\닫기W_up.gif"
end type

event p_exit::ue_lbuttondown;PictureName = "..\image\닫기W_dn.gif"
end event

event p_exit::ue_lbuttonup;PictureName = "..\image\닫기W_up.gif"
end event
...
type p_new from w_inherite`p_new within w_sal_06030
integer x = 1874
integer y = 2260
end type

type dw_input from w_inherite`dw_input within w_sal_06030
boolean visible = false
integer x = 5
integer y = 2636
end type

type cb_delrow from w_inherite`cb_delrow within w_sal_06030
boolean visible = false
integer x = 1911
integer y = 2276
end type

type cb_addrow from w_inherite`cb_addrow within w_sal_06030
boolean visible = false
integer x = 1600
integer y = 2276
end type
...
type gb_10 from w_inherite`gb_10 within w_sal_06030
end type
...
type r_head from w_inherite`r_head within w_sal_06030
boolean visible = false
integer x = 0
integer y = 2624
end type

type r_detail from w_inherite`r_detail within w_sal_06030
boolean visible = false
integer x = 0
integer y = 2852
integer height = 196
